...
class UpdateSubscriptionSubscriptionsLinksTypedDict(TypedDict):
    documentation: UpdateSubscriptionSubscriptionsDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class UpdateSubscriptionSubscriptionsLinks(BaseModel):
    documentation: UpdateSubscriptionSubscriptionsDocumentation
    r"""The URL to the generic Mollie API error handling guide."""
...
class UpdateSubscriptionSubscriptionsResponseBodyData(BaseModel):
    ...
    links: Annotated[
        UpdateSubscriptionSubscriptionsLinks, pydantic.Field(alias="_links")
    ]
