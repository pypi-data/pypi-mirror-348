...
class GetMandateMandatesLinksTypedDict(TypedDict):
    documentation: GetMandateMandatesDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class GetMandateMandatesLinks(BaseModel):
    documentation: GetMandateMandatesDocumentation
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetMandateMandatesResponseBodyData(BaseModel):
    ...
    links: Annotated[GetMandateMandatesLinks, pydantic.Field(alias="_links")]
