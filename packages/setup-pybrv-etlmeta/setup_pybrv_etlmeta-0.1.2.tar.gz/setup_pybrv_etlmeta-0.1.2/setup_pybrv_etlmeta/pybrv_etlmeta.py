...
class PybrvEtlmeta:
    def __init__(self, spark_session=None):
        """
        Initializes the PybrvEtlmeta class with an existing SparkSession.
        If none is provided, it tries to use the default 'spark' session in Databricks.
        """
        self.spark = spark_session or globals().get("spark") or SparkSession.builder.getOrCreate()
