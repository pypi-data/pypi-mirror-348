...
class TestAskQueriesCorpus(unittest.TestCase):
    ...
    def test_openwebui_rag_ask_queries(self):
        ...
        nb_docs_processed, config = openwebui_rag.upload_corpus(corpus=corpus,config=config)
        ...
        answers: List[AnswerModel] = openwebui_rag.ask_queries(queries, config=config)
