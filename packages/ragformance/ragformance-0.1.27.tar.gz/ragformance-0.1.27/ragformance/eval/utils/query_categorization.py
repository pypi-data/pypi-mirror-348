...
def categorize_queries(queries, configpath = "config.json"):
    ...
    question_categories = ["Simple (Factual/ Simple with conditions)", 
    ...
    for q in tqdm(queries, desc="Queries categorizations"):
        ...
        prompt_and_query = "Tell me if this question belongs to one of the following category. Answer with just the categories as a comma separated list."+query+str(question_categories)
