...
class ConnectionManager:
    ...
    def get_all_connections(self):
        ...
        return {
            ...
            "timescaledb": self.get_timescaledb,
            "rabbitmq": self.get_rabbitmq(),
            "mongodb": self.get_mongo(),
        }
    def get_mongo(self):
        """
        Returns mongodb conenction.
        """
        return self.mongo_client
    def get_timescaledb(self):
        """
        Returns timescaledb conenction.
        """
        return self.timescaledb_client
    def get_redis(self):
        """
        Returns redis conenction.
        """
        return self.redis_client 
    def get_rabbitmq(self):
        """
        Returns rabbitmq conenction.
        """
