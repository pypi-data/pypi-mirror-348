...
class YaraStringInstance(BaseModel):
    ...
    YaraStringInstance
    """ # noqa: E501
    matched_length: StrictInt
    offset: StrictInt
    plaintext: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["matched_length", "offset", "plaintext"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if plaintext (nullable) is None
        # and model_fields_set contains the field
        if self.plaintext is None and "plaintext" in self.model_fields_set:
            _dict['plaintext'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matched_length": obj.get("matched_length"),
