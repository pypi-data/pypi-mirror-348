...
class YaraResult(BaseModel):
    ...
    """ # noqa: E501
    rules: StrictStr
    matches: Optional[List[YaraMatch]] = None
    __properties: ClassVar[List[str]] = ["rules", "matches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": obj.get("rules"),
            "matches": [YaraMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
