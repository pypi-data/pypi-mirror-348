...
class YaraString(BaseModel):
    ...
    instances: Optional[List[YaraStringInstance]] = None
    __properties: ClassVar[List[str]] = ["identifier", "instances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instances": [YaraStringInstance.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None
        })
        return _obj
