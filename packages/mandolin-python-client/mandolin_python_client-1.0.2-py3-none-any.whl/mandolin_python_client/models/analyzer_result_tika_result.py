...
class AnalyzerResultTikaResult(BaseModel):
    """
    ...
    analysis: Optional[TikaResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "analysis": TikaResult.from_dict(obj["analysis"]) if obj.get("analysis") is not None else None
        })
        return _obj
