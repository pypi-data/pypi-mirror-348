...
def test_logs_message_params(sentry_init, capture_envelopes):
    ...
    sentry_sdk_alpha.logger.warning("The recorded value was '{float_var}'", float_var=2.0)
    sentry_sdk_alpha.logger.warning("The recorded value was '{bool_var}'", bool_var=False)
    sentry_sdk_alpha.logger.warning(
