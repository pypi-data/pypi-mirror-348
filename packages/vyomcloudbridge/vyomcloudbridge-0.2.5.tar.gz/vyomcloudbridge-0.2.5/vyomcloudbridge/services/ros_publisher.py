    ...
    def create_listener_function(self, msg_type, f_topic):
        ...
        def f(msg):
            ...
            if msg_type == "sensor_msgs.msg.Image":
                ...
                # print(
                #     f"Image data type: {type(cleaned_value)}, filename: {filename}, data_type: {data_type}"
                # )
            else:
                filename = f"{epoch_ms}.json"
                data_type = "json"
                # print(
                #     f"Image data type: {type(cleaned_value)}, filename: {filename}, data_type: {data_type} epoch_ms"
                # )
