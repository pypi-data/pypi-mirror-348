...
# Required settings
SAS_TOKEN = get_env("SAS_TOKEN", required=True) # SAS token for Azure Blob Storage
STORAGE_ACCOUNT_NAME = get_env("STORAGE_ACCOUNT_NAME", required=True)
STORAGE_QUEUE_NAME = get_env("STORAGE_QUEUE_NAME", required=True)
