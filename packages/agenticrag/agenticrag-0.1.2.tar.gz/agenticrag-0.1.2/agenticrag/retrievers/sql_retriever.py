...
from agenticrag.types.schemas import ExternalDBData
...
class SQLRetriever(BaseRetriever):
    ...
    def __init__(self,  store: ExternalDBStore, llm: BaseChatModel, persistent_dir: str = "."):
        self.store = store
    ...
    def description(self) -> str:
        return (
            ...
            f"and saves the result as '{self.persistent_dir}/retrieved_data/table_data.csv'."
    ...
    def retrieve(self, query: str, db_name: str) -> str:
        ...
        try:
            ...
            output_path = os.path.join(self.persistent_dir, "retrieved_data", "table_data.csv")
