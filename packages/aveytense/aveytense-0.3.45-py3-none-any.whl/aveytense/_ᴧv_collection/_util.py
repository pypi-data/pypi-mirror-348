...
class ParamVar:
    ...
    def variable(self): # 0.3.42
        ...
        if c.co_flags & _compiler_flags["varargs"] and c.co_flags & _compiler_flags["varkeywords"]:
            ...
            return tuple([(c.co_varnames[self.allCount - 2], "<args>"), (c.co_varnames[self.allCount - 1], "<kwargs>")]) # < 0.3.45: self.allCount, self.allCount + 1
            ...
            return tuple([(c.co_varnames[self.allCount - 1], self.__vartype.lstrip())]) # < 0.3.45: self.allCount
