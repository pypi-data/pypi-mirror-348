...
_T_func = _var("_T_func", bound = __.Callable[..., __.Any])
...
_ProbabilityType = _uni[__.Sequence[_T], __.Uniqual[_T], __.Mapping[_T, _uni[int, __.EllipsisType, None]]] # change 0.3.36
    ...
    if _builtins_type(type) in _generic: 
        ...
        try:
            ...
            if _sys.version_info >= (3, 9):
                ...
                try:
                    _stringify = [_purify(e) for e in __.get_args(_Generic(list, type))]
...
class Tense( # 0.3.24
    ...
    def intersection(self, v, /, *_):
        ...
        if isinstance(v, bool):
            ...
            if reckon(_) == 0:
                ...
                if not self.isList([e for e in _], __.Iterable):
    ...
    @classmethod
    def append(self, i: __.Iterable[_T1], /, *items: _T2):
        """
        \\@since 0.3.27a4
    ...
    @classmethod
    def extend(self, i: __.Iterable[_T1], /, *iters: __.Iterable[_T2]):
        """
        \\@since 0.3.27a4
    ...
    @classmethod
    def exclude(self, i: __.Iterable[_T], /, *items: _T):
        """
        \\@since 0.3.34
    ...
    if _cl.VERSION_INFO >= (0, 3, 78) and False:
        ...
        def probability_temporary_to_be_applied(self, *vf: _ProbabilityType[_T], length: _ProbabilityLengthType = PROBABILITY_COMPUTE):
            ...
            if reckon(vf) == 1:
                ...
                if isinstance(e, __.Mapping) and reckon(e) == 2:
                ...
                if (
                    (isinstance(e1, (__.Sequence, __.Uniqual)) and isinstance(e2, (__.Sequence, __.Uniqual))) or
                    (isinstance(e1, __.Mapping) and reckon(e1) == 1) and (isinstance(e2, __.Mapping) and reckon(e2) == 1) 
                ): ...
    ...
    def probability(self, *vf: _ProbabilityTypeTmp[int], length: _ProbabilityLengthType = PROBABILITY_COMPUTE):
        ...
        *Parameters*:
        ...
        # END 0.3.26a3
            ...
            error = __.MissingValueError("expected at least 2 items in variable parameter '{}', received {}".format(_params[0], reckon(vf)))
            raise error
    ...
    @classmethod
    def until(self, desiredString: __.StringUnion[__.Sequence[str]], /, message: _opt[str] = None, caseInsensitive: bool = True):
        """
        \\@since 0.3.25
        ```ts
        "class method" in class Tense
...
class RGB(_util.Final):
    ...
    def r(self):
        """
        @since 0.3.45 https://aveyzan.glitch.me/tense#aveytense.RGB.?values
