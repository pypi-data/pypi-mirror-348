...
class ErrorHandler:
    ...
    def __new__(cls, code: int, *args: str):
        ...
        if code == 100:
            ...
            _error = (RuntimeError, "this file is not for compiling, moreover, this file does not have a complete TensePy declarations collection. Consider importing module 'aveytense' instead.")
        elif code == 112:
