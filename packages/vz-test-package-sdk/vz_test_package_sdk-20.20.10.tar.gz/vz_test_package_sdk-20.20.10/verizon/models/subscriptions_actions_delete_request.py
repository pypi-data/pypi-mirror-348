...
class SubscriptionsActionsDeleteRequest(object):

    """Implementation of the 'Subscriptions Actions Delete Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsActionsDeleteRequest class"""
