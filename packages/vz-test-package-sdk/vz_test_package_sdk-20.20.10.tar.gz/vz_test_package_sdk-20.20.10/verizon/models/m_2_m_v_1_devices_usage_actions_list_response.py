...
class M2mV1DevicesUsageActionsListResponse(object):

    """Implementation of the 'M2m V1 Devices Usage Actions List Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesUsageActionsListResponse class"""
