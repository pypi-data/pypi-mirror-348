...
class LocationreportsReportResponse(object):

    """Implementation of the 'Locationreports Report Response' model.
    ...
    def __init__(self,
                 txid=APIHelper.SKIP):
        """Constructor for the LocationreportsReportResponse class"""
