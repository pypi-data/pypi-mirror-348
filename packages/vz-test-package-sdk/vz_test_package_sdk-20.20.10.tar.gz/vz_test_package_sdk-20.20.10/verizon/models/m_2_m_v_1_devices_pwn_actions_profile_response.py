...
class M2mV1DevicesPwnActionsProfileResponse(object):

    """Implementation of the 'M2m V1 Devices Pwn Actions Profile Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPwnActionsProfileResponse class"""
