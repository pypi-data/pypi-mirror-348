...
class DmV1HealthscoreSummaryResponse(object):

    """Implementation of the 'Dm V1 Healthscore Summary Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DmV1HealthscoreSummaryResponse class"""
