...
class M2mV1DevicesPwnActionsIpaddressResponse(object):

    """Implementation of the 'M2m V1 Devices Pwn Actions Ipaddress Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPwnActionsIpaddressResponse class"""
