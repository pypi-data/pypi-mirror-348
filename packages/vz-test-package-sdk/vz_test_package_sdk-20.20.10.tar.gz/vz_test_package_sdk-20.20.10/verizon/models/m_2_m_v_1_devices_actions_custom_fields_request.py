...
class M2mV1DevicesActionsCustomFieldsRequest(object):

    """Implementation of the 'M2m V1 Devices Actions CustomFields Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsCustomFieldsRequest class"""
