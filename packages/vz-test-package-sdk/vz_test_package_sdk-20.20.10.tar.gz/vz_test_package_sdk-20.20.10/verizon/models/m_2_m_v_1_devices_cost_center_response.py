...
class M2mV1DevicesCostCenterResponse(object):

    """Implementation of the 'M2m V1 Devices CostCenter Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesCostCenterResponse class"""
