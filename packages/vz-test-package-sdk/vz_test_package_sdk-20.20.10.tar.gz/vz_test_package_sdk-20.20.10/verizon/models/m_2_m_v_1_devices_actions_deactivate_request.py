...
class M2mV1DevicesActionsDeactivateRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Deactivate Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsDeactivateRequest class"""
