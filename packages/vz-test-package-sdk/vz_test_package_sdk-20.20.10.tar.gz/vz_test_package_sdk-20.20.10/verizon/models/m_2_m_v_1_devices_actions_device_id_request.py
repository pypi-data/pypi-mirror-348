...
class M2mV1DevicesActionsDeviceIdRequest(object):

    """Implementation of the 'M2m V1 Devices Actions DeviceId Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsDeviceIdRequest class"""
