...
class M2mV1DevicesActionsUploadactivateResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Uploadactivate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsUploadactivateResponse class"""
