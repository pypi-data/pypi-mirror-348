...
class M2mV1DevicesActionsDeviceIdResponse(object):

    """Implementation of the 'M2m V1 Devices Actions DeviceId Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsDeviceIdResponse class"""
