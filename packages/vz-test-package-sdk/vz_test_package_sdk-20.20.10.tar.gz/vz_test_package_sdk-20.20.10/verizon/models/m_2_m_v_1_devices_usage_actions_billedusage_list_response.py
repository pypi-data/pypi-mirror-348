...
class M2mV1DevicesUsageActionsBilledusageListResponse(object):

    """Implementation of the 'M2m V1 Devices Usage Actions Billedusage List Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesUsageActionsBilledusageListResponse class"""
