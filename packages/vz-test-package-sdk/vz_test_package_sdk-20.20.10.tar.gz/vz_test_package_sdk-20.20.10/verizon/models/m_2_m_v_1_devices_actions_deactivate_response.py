...
class M2mV1DevicesActionsDeactivateResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Deactivate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsDeactivateResponse class"""
