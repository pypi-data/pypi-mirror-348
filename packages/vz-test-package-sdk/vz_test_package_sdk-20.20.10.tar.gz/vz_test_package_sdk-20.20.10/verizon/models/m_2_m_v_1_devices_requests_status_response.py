...
class M2mV1DevicesRequestsStatusResponse(object):

    """Implementation of the 'M2m V1 Devices Requests Status Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesRequestsStatusResponse class"""
