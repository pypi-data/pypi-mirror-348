...
class M2mV1DevicesActionsActivateRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Activate Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsActivateRequest class"""
