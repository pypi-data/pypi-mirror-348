...
class TargetsActionsNewaicRequest(object):

    """Implementation of the 'Targets Actions Newaic Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TargetsActionsNewaicRequest class"""
