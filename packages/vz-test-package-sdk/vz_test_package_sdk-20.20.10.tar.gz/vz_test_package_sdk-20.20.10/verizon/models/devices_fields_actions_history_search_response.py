...
class DevicesFieldsActionsHistorySearchResponse(object):

    """Implementation of the 'Devices Fields Actions History Search Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesFieldsActionsHistorySearchResponse class"""
