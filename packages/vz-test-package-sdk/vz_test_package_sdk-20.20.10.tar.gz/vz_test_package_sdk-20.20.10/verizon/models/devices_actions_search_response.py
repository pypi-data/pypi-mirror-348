...
class DevicesActionsSearchResponse(object):

    """Implementation of the 'Devices Actions Search Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesActionsSearchResponse class"""
