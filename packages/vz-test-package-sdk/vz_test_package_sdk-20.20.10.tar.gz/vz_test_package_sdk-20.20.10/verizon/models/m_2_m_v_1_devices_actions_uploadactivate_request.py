...
class M2mV1DevicesActionsUploadactivateRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Uploadactivate Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsUploadactivateRequest class"""
