...
class M2mV1DevicesActionsActivateResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Activate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsActivateResponse class"""
