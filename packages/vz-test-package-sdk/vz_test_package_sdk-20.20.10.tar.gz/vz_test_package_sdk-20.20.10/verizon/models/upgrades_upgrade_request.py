...
class UpgradesUpgradeRequest(object):

    """Implementation of the 'Upgrades Upgrade Request' model.

    Attributes:
        mtype (FirmwareTypeListEnum): The model property of type
    ...
    def __init__(self,
                 mtype=None,
                 device_list=None):
        """Constructor for the UpgradesUpgradeRequest class"""
