...
class M2mV1SmsStartCallbacksResponse(object):

    """Implementation of the 'M2m V1 Sms StartCallbacks Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1SmsStartCallbacksResponse class"""
