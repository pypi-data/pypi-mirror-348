...
class M2mV1DevicesActionsRestoreResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Restore Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsRestoreResponse class"""
