...
class SubscriptionsActionsQueryRequest(object):

    """Implementation of the 'Subscriptions Actions Query Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsActionsQueryRequest class"""
