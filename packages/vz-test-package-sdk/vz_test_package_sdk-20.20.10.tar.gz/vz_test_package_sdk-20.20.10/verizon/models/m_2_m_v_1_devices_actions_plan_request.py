...
class M2mV1DevicesActionsPlanRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Plan Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsPlanRequest class"""
