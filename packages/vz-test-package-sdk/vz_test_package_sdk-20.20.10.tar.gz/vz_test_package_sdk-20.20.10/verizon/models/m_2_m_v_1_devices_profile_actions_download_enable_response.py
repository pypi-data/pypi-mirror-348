...
class M2mV1DevicesProfileActionsDownloadEnableResponse(object):

    """Implementation of the 'M2m V1 Devices Profile Actions Download Enable Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesProfileActionsDownloadEnableResponse class"""
