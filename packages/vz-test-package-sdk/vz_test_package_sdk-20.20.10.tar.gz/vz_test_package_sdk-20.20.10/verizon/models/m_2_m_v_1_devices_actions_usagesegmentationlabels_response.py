...
class M2mV1DevicesActionsUsagesegmentationlabelsResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Usagesegmentationlabels Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsUsagesegmentationlabelsResponse class"""
