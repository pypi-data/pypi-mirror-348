...
class DevicesActionsQueryResponse(object):

    """Implementation of the 'Devices Actions Query Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesActionsQueryResponse class"""
