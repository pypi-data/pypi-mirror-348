...
class M2mV1DiagnosticsBasicDevicereachabilityMonitorsResponse(object):

    """Implementation of the 'M2m V1 Diagnostics Basic Devicereachability Monitors Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DiagnosticsBasicDevicereachabilityMonitorsResponse class"""
