...
class M2mV1DevicesActionsContactInfoResponse(object):

    """Implementation of the 'M2m V1 Devices Actions ContactInfo Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsContactInfoResponse class"""
