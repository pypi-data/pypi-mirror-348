...
class M2mV1DevicesProfileActionsDownloadDisableResponse(object):

    """Implementation of the 'M2m V1 Devices Profile Actions Download Disable Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesProfileActionsDownloadDisableResponse class"""
