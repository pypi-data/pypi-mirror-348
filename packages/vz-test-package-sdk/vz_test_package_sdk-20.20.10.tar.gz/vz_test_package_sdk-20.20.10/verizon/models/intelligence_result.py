...
class IntelligenceResult(object):

    """Implementation of the 'IntelligenceResult' model.

    An error occurred.

    Attributes:
        error_code (str): The 3-digit HTML error code.
    ...
    def __init__(self,
        ...
        """Constructor for the IntelligenceResult class"""
