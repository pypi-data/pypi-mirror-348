...
class M2mV1DevicesCostCenterRequest(object):

    """Implementation of the 'M2m V1 Devices CostCenter Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesCostCenterRequest class"""
