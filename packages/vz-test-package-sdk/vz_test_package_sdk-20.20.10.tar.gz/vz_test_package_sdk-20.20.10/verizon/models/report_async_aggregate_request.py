...
class ReportAsyncAggregateRequest(object):

    """Implementation of the 'Report Async Aggregate Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ReportAsyncAggregateRequest class"""
