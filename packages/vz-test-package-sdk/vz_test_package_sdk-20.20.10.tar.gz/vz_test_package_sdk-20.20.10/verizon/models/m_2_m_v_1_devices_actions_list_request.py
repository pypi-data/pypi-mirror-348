...
from verizon.models.filter import Filter


class M2mV1DevicesActionsListRequest(object):

    """Implementation of the 'M2m V1 Devices Actions List Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsListRequest class"""
