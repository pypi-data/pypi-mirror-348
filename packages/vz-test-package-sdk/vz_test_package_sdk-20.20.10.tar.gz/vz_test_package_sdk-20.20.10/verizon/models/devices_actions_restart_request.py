...
class DevicesActionsRestartRequest(object):

    """Implementation of the 'Devices Actions Restart Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesActionsRestartRequest class"""
