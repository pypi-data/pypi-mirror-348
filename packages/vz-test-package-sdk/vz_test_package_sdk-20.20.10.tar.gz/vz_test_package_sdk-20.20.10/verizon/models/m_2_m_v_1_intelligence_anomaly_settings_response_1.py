...
from verizon.models.sensitivity_parameter import SensitivityParameter


class M2mV1IntelligenceAnomalySettingsResponse1(object):

    """Implementation of the 'M2m V1 Intelligence Anomaly Settings Response1' model.
    ...
    Attributes:
        ...
        sensitivity_parameter (SensitivityParameter): The model property of
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1IntelligenceAnomalySettingsResponse1 class"""
    ...
    def from_dictionary(cls,
        ...
        sensitivity_parameter = SensitivityParameter.from_dictionary(dictionary.get('sensitivityParameter')) if 'sensitivityParameter' in dictionary.keys() else APIHelper.SKIP
