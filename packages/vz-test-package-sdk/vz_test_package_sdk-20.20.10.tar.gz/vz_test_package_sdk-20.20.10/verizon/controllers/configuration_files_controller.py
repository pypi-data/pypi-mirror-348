...
from verizon.exceptions.files_400_error_exception import Files400ErrorException
...
class ConfigurationFilesController(BaseController):
    ...
    def get_list_of_files(self,
        ...
        Returns:
            RetrievesAvailableFilesResponseList: Response from the API.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Unexpected error.', Files400ErrorException)
        ).execute()
    ...
    def upload_config_file(self,
        ...
        Returns:
            UploadConfigurationFilesResponse: Response from the API.
                Successful responses.
