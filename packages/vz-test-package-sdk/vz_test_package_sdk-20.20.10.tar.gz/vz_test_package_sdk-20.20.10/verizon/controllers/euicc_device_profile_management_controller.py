...
from verizon.models.m_2_m_v_1_devices_profile_actions_download_enable_response import M2mV1DevicesProfileActionsDownloadEnableResponse
from verizon.models.m_2_m_v_1_devices_profile_actions_download_disable_response import M2mV1DevicesProfileActionsDownloadDisableResponse
from verizon.models.request_response import RequestResponse
from verizon.exceptions.m_2_m_v_1_devices_profile_actions_download_enable_400_error_exception import M2mV1DevicesProfileActionsDownloadEnable400ErrorException
from verizon.exceptions.m_2_m_v_1_devices_profile_actions_download_disable_400_error_exception import M2mV1DevicesProfileActionsDownloadDisable400ErrorException
...
class EUICCDeviceProfileManagementController(BaseController):
    ...
    def download_local_profile_to_enable(self,
        ...
        Returns:
            M2mV1DevicesProfileActionsDownloadEnableResponse: Response from
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(M2mV1DevicesProfileActionsDownloadEnableResponse.from_dictionary)
            .local_error('400', 'Error response.', M2mV1DevicesProfileActionsDownloadEnable400ErrorException)
        ).execute()
    ...
    def download_local_profile_to_disable(self,
        ...
        Returns:
            M2mV1DevicesProfileActionsDownloadDisableResponse: Response from
                the API. Request ID received on a successful response.
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(M2mV1DevicesProfileActionsDownloadDisableResponse.from_dictionary)
            .local_error('400', 'Error response.', M2mV1DevicesProfileActionsDownloadDisable400ErrorException)
        ).execute()
