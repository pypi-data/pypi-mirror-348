...
class DeviceActionsController(BaseController):
    ...
    def daily_usage(self,
        ...
        Returns:
            DailyUsageResponse: Response from the API. Syncronous response of
                device usage
    ...
    def service_plan_list(self,
        ...
        Returns:
            AccountDetails: Response from the API. Account details **Note:**
                The response will have placeholders. You can identify the
                placeholders by `"sizeKb":0` and that the record will only
                have `name` and `sizeKb` values.
    ...
    def get_asynchronous_request_status(self,
        ...
        Returns:
            StatusResponse: Response from the API. Request ID
