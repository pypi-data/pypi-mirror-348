...
from verizon.exceptions.m_2_m_v_1_plans_400_error_exception import M2mV1Plans400ErrorException
...
class ServicePlansController(BaseController):
    ...
    def list_account_service_plans(self,
        ...
        Returns:
            List[ServicePlan]: Response from the API. The list of service
                plans associated with the account.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Error response.', M2mV1Plans400ErrorException)
        ).execute()
