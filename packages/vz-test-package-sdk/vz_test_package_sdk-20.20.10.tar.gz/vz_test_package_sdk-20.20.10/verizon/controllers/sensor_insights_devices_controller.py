...
class SensorInsightsDevicesController(BaseController):
    ...
    def sensor_insights_list_devices_request(self,
        ...
        Returns:
            List[DtoExpandedDeviceResponse]: Response from the API. OK
    ...
    def sensor_insights_patch_device_request(self,
        ...
        Returns:
            ResourceDevice: Response from the API. OK
    ...
    def sensor_insights_last_reported_time_request(self,
        ...
        Returns:
            DtoLastReportedTimeResponse: Response from the API. OK
    ...
    def sensor_insights_device_action_set_request(self,
        ...
        Args:
            body (DtoDeviceActionSetRequest): Set device configuration

        Returns:
            DtoDeviceActionSetResponse: Response from the API. OK
    ...
    def sensor_insights_list_device_experience_history_request(self,
        ...
        Returns:
            List[UserDeviceExperienceHistory]: Response from the API. OK
    ...
    def sensor_insights_list_network_experience_history_request(self,
        ...
        Args:
            body (DtoListDeviceExperienceHistoryRequest): List the network
                experience

        Returns:
            List[UserNetworkExperienceHistory]: Response from the API. OK
