...
from verizon.exceptions.usage_triggers_400_error_exception import UsageTriggers400ErrorException
from verizon.exceptions.usage_accounts_triggers_400_error_exception import UsageAccountsTriggers400ErrorException
...
class UsageTriggerManagementController(BaseController):
    ...
    def create_new_trigger(self,
        ...
        Returns:
            UsageTriggerResponse: Response from the API. Usage trigger Add
                result
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Unexpected error', UsageTriggers400ErrorException)
        ).execute()
    ...
    def update_trigger(self,
        ...
        Returns:
            UsageTriggerResponse: Response from the API. Usage trigger Modify
                result
    ...
    def delete_trigger(self,
        ...
        Returns:
            SuccessResponse: Response from the API. Delete result
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Unexpected error', UsageAccountsTriggers400ErrorException)
        ).execute()
