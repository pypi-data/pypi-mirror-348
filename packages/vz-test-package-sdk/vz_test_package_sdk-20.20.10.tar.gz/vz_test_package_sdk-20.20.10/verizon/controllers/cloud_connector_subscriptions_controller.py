...
from verizon.models.subscriptions_response_4 import SubscriptionsResponse4
...
class CloudConnectorSubscriptionsController(BaseController):
    ...
    def create_subscription(self,
        ...
        Args:
            body (SubscriptionsRequest): The request body provides the details
                of the subscription that you want to create.

        Returns:
            SubscriptionsResponse4: Response from the API. Returns full
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SubscriptionsResponse4.from_dictionary)
        ).execute()
    ...
    def query_subscription(self,
        ...
        Args:
            body (SubscriptionsActionsQueryRequest): The request body
                specifies fields and values to match.

        Returns:
            List[Subscription]: Response from the API. Returns an array of all
                matching subscriptions. Each subscription includes the full
                subscription resource definition.
    ...
    def delete_subscription(self,
        ...
        Args:
            body (SubscriptionsActionsDeleteRequest): The request body
