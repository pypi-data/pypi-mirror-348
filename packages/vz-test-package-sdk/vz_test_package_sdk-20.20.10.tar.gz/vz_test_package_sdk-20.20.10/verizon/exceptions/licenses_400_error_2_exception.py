...
class Licenses400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Licenses400Error2Exception class
        ...
        """
        super(Licenses400Error2Exception, self).__init__(reason, response)
