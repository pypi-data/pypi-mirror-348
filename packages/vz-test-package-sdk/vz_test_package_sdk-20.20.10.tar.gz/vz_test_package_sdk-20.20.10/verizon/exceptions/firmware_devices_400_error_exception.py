...
class FirmwareDevices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the FirmwareDevices400ErrorException class
        ...
        """
        super(FirmwareDevices400ErrorException, self).__init__(reason, response)
