...
class CampaignsFirmware400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CampaignsFirmware400ErrorException class
        ...
        """
        super(CampaignsFirmware400ErrorException, self).__init__(reason, response)
