...
class LicensesCancel400Error3Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesCancel400Error3Exception class
        ...
        """
        super(LicensesCancel400Error3Exception, self).__init__(reason, response)
