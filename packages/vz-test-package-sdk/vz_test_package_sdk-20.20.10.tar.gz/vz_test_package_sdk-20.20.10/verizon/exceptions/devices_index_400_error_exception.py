...
class DevicesIndex400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesIndex400ErrorException class
        ...
        """
        super(DevicesIndex400ErrorException, self).__init__(reason, response)
