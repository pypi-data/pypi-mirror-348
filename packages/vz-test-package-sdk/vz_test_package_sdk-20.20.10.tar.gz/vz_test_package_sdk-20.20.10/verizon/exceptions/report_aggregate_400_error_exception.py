...
class ReportAggregate400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate400ErrorException class
        ...
        """
        super(ReportAggregate400ErrorException, self).__init__(reason, response)
