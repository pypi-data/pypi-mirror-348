...
class ReportSessions401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportSessions401ErrorException class
        ...
        """
        super(ReportSessions401ErrorException, self).__init__(reason, response)
