...
class Callbacks400Error5Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Callbacks400Error5Exception class
        ...
        """
        super(Callbacks400Error5Exception, self).__init__(reason, response)
