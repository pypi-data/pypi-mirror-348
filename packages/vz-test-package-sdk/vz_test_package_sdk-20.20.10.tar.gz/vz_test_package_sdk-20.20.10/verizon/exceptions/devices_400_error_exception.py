...
class Devices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Devices400ErrorException class
        ...
        """
        super(Devices400ErrorException, self).__init__(reason, response)
