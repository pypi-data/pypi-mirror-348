...
class LoggingDevicesLogs400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LoggingDevicesLogs400ErrorException class
        ...
        """
        super(LoggingDevicesLogs400ErrorException, self).__init__(reason, response)
