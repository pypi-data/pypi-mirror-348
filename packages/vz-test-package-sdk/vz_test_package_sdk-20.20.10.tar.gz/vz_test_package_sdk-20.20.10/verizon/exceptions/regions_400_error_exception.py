...
class Regions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Regions400ErrorException class
        ...
        """
        super(Regions400ErrorException, self).__init__(reason, response)
