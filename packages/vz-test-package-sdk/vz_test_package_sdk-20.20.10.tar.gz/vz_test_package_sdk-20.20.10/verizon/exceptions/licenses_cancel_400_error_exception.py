...
class LicensesCancel400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesCancel400ErrorException class
        ...
        """
        super(LicensesCancel400ErrorException, self).__init__(reason, response)
