...
class ReportAggregate404ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate404ErrorException class
        ...
        """
        super(ReportAggregate404ErrorException, self).__init__(reason, response)
