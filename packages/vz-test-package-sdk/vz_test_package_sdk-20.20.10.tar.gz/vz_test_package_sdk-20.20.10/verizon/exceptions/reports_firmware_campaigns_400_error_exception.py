...
class ReportsFirmwareCampaigns400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsFirmwareCampaigns400ErrorException class
        ...
        """
        super(ReportsFirmwareCampaigns400ErrorException, self).__init__(reason, response)
