...
class Firmware400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Firmware400ErrorException class
        ...
        """
        super(Firmware400ErrorException, self).__init__(reason, response)
