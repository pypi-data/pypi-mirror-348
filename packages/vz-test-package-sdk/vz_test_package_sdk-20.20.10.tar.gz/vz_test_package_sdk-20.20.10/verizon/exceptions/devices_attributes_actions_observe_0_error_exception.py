...
class DevicesAttributesActionsObserve0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesAttributesActionsObserve0ErrorException class
        ...
        """
        super(DevicesAttributesActionsObserve0ErrorException, self).__init__(reason, response)
