...
class ReportsCampaignsDevices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsCampaignsDevices400ErrorException class
        ...
        """
        super(ReportsCampaignsDevices400ErrorException, self).__init__(reason, response)
