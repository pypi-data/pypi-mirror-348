...
class ReportAggregate500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate500ErrorException class
        ...
        """
        super(ReportAggregate500ErrorException, self).__init__(reason, response)
