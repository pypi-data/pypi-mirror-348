...
class M2mV1Triggers404ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Triggers404ErrorException class
        ...
        """
        super(M2mV1Triggers404ErrorException, self).__init__(reason, response)
