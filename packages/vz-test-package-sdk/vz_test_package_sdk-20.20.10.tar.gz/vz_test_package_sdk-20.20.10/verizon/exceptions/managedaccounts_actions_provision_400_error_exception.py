...
class ManagedaccountsActionsProvision400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ManagedaccountsActionsProvision400ErrorException class
        ...
        """
        super(ManagedaccountsActionsProvision400ErrorException, self).__init__(reason, response)
