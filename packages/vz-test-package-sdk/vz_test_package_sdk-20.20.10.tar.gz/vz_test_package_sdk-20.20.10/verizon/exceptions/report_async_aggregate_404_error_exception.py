...
class ReportAsyncAggregate404ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate404ErrorException class
        ...
        """
        super(ReportAsyncAggregate404ErrorException, self).__init__(reason, response)
