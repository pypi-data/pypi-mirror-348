...
class ManagedaccountsService400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ManagedaccountsService400ErrorException class
        ...
        """
        super(ManagedaccountsService400ErrorException, self).__init__(reason, response)
