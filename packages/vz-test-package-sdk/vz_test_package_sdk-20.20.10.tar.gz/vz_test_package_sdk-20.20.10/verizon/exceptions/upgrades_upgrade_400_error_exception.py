...
class UpgradesUpgrade400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the UpgradesUpgrade400ErrorException class
        ...
        """
        super(UpgradesUpgrade400ErrorException, self).__init__(reason, response)
