...
class ReportAsyncAggregate500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate500ErrorException class
        ...
        """
        super(ReportAsyncAggregate500ErrorException, self).__init__(reason, response)
