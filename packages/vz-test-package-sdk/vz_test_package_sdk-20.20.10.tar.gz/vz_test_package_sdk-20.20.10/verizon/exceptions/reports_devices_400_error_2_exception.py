...
class ReportsDevices400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsDevices400Error2Exception class
        ...
        """
        super(ReportsDevices400Error2Exception, self).__init__(reason, response)
