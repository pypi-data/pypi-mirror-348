...
class ReportSessions403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportSessions403ErrorException class
        ...
        """
        super(ReportSessions403ErrorException, self).__init__(reason, response)
