...
class ReportSessions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportSessions400ErrorException class
        ...
        """
        super(ReportSessions400ErrorException, self).__init__(reason, response)
