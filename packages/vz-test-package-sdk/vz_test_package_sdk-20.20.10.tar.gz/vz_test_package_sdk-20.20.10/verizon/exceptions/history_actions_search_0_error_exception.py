...
class HistoryActionsSearch0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the HistoryActionsSearch0ErrorException class
        ...
        """
        super(HistoryActionsSearch0ErrorException, self).__init__(reason, response)
