...
class ManagedaccountsActionsAdd400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ManagedaccountsActionsAdd400ErrorException class
        ...
        """
        super(ManagedaccountsActionsAdd400ErrorException, self).__init__(reason, response)
