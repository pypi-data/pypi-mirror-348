...
class Firmware400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Firmware400Error2Exception class
        ...
        """
        super(Firmware400Error2Exception, self).__init__(reason, response)
