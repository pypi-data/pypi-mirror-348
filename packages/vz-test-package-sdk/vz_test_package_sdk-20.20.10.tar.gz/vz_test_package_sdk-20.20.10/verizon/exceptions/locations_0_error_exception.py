...
class Locations0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Locations0ErrorException class
        ...
        """
        super(Locations0ErrorException, self).__init__(reason, response)
