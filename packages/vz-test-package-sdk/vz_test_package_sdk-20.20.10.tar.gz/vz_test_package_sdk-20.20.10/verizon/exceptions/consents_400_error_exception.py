...
class Consents400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Consents400ErrorException class
        ...
        """
        super(Consents400ErrorException, self).__init__(reason, response)
