...
class LoggingDevices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LoggingDevices400ErrorException class
        ...
        """
        super(LoggingDevices400ErrorException, self).__init__(reason, response)
