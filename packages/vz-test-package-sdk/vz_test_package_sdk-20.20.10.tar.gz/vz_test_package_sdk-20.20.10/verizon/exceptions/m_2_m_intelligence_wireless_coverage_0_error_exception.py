...
class M2mIntelligenceWirelessCoverage0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mIntelligenceWirelessCoverage0ErrorException class
        ...
        """
        super(M2mIntelligenceWirelessCoverage0ErrorException, self).__init__(reason, response)
