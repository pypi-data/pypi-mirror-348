...
class CampaignsSoftware400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CampaignsSoftware400ErrorException class
        ...
        """
        super(CampaignsSoftware400ErrorException, self).__init__(reason, response)
