...
class M2mV1GroupsName400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1GroupsName400ErrorException class
        ...
        """
        super(M2mV1GroupsName400ErrorException, self).__init__(reason, response)
