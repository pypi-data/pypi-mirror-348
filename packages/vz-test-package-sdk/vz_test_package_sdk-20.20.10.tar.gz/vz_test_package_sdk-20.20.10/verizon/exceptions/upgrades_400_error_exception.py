...
class Upgrades400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Upgrades400ErrorException class
        ...
        """
        super(Upgrades400ErrorException, self).__init__(reason, response)
