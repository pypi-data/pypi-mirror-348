...
class M2mV1Sms400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Sms400ErrorException class
        ...
        """
        super(M2mV1Sms400ErrorException, self).__init__(reason, response)
