...
class LocationreportsReportStatus0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LocationreportsReportStatus0ErrorException class
        ...
        """
        super(LocationreportsReportStatus0ErrorException, self).__init__(reason, response)
