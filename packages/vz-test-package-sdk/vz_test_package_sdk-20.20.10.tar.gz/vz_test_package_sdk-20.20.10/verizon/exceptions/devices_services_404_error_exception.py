...
class DevicesServices404ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices404ErrorException class
        ...
        """
        super(DevicesServices404ErrorException, self).__init__(reason, response)
