...
class DevicelocationsActionConsents0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicelocationsActionConsents0ErrorException class
        ...
        """
        super(DevicelocationsActionConsents0ErrorException, self).__init__(reason, response)
