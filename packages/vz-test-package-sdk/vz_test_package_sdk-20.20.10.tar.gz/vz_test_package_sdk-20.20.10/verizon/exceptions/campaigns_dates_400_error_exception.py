...
class CampaignsDates400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CampaignsDates400ErrorException class
        ...
        """
        super(CampaignsDates400ErrorException, self).__init__(reason, response)
