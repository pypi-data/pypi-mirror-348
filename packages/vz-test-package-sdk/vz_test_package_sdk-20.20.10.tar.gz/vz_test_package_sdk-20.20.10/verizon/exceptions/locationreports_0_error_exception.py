...
class Locationreports0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Locationreports0ErrorException class
        ...
        """
        super(Locationreports0ErrorException, self).__init__(reason, response)
