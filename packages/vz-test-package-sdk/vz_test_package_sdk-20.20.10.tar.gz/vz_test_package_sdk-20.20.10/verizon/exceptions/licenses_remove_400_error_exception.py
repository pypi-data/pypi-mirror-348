...
class LicensesRemove400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesRemove400ErrorException class
        ...
        """
        super(LicensesRemove400ErrorException, self).__init__(reason, response)
