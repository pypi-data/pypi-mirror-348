...
class Subscriptions400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Subscriptions400Error2Exception class
        ...
        """
        super(Subscriptions400Error2Exception, self).__init__(reason, response)
