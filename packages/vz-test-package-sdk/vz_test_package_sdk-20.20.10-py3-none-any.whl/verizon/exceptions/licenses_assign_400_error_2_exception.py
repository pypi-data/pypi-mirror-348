...
class LicensesAssign400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesAssign400Error2Exception class
        ...
        """
        super(LicensesAssign400Error2Exception, self).__init__(reason, response)
