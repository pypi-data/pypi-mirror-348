...
class ReportAsyncAggregate409ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate409ErrorException class
        ...
        """
        super(ReportAsyncAggregate409ErrorException, self).__init__(reason, response)
