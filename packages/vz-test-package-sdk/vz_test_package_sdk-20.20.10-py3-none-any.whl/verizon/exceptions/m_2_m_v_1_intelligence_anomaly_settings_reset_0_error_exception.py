...
class M2mV1IntelligenceAnomalySettingsReset0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1IntelligenceAnomalySettingsReset0ErrorException class
        ...
        """
        super(M2mV1IntelligenceAnomalySettingsReset0ErrorException, self).__init__(reason, response)
