...
class M2mV2Triggers0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV2Triggers0ErrorException class
        ...
        """
        super(M2mV2Triggers0ErrorException, self).__init__(reason, response)
