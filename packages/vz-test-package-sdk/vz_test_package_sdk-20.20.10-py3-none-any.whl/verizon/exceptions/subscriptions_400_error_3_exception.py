...
class Subscriptions400Error3Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Subscriptions400Error3Exception class
        ...
        """
        super(Subscriptions400Error3Exception, self).__init__(reason, response)
