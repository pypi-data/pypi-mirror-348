...
class ReportSessions404ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportSessions404ErrorException class
        ...
        """
        super(ReportSessions404ErrorException, self).__init__(reason, response)
