...
class M2mV1IntelligenceAnomalySettings0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1IntelligenceAnomalySettings0ErrorException class
        ...
        """
        super(M2mV1IntelligenceAnomalySettings0ErrorException, self).__init__(reason, response)
