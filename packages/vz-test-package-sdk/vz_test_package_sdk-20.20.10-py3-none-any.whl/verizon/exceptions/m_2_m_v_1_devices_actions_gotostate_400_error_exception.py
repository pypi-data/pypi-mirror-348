...
class M2mV1DevicesActionsGotostate400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1DevicesActionsGotostate400ErrorException class
        ...
        """
        super(M2mV1DevicesActionsGotostate400ErrorException, self).__init__(reason, response)
