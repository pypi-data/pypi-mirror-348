...
class Campaigns400Error5Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Campaigns400Error5Exception class
        ...
        """
        super(Campaigns400Error5Exception, self).__init__(reason, response)
