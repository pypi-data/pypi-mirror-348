...
class ReportsStatusIndexStartIndex400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsStatusIndexStartIndex400ErrorException class
        ...
        """
        super(ReportsStatusIndexStartIndex400ErrorException, self).__init__(reason, response)
