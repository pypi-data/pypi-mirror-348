...
class ReportAggregate409ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate409ErrorException class
        ...
        """
        super(ReportAggregate409ErrorException, self).__init__(reason, response)
