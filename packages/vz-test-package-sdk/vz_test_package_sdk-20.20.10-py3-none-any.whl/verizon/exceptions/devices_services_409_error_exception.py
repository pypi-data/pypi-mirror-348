...
class DevicesServices409ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices409ErrorException class
        ...
        """
        super(DevicesServices409ErrorException, self).__init__(reason, response)
