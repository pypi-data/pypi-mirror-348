...
class ReportsCampaigns400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsCampaigns400ErrorException class
        ...
        """
        super(ReportsCampaigns400ErrorException, self).__init__(reason, response)
