...
class Campaigns400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Campaigns400ErrorException class
        ...
        """
        super(Campaigns400ErrorException, self).__init__(reason, response)
