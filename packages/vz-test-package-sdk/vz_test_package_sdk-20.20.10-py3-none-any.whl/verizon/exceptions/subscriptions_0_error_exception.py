...
class Subscriptions0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Subscriptions0ErrorException class
        ...
        """
        super(Subscriptions0ErrorException, self).__init__(reason, response)
