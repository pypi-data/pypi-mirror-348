...
class DevicesSettings0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesSettings0ErrorException class
        ...
        """
        super(DevicesSettings0ErrorException, self).__init__(reason, response)
