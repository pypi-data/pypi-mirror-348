...
class LoggingDevicesCheckInHistory400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LoggingDevicesCheckInHistory400ErrorException class
        ...
        """
        super(LoggingDevicesCheckInHistory400ErrorException, self).__init__(reason, response)
