...
class ReportAggregate403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate403ErrorException class
        ...
        """
        super(ReportAggregate403ErrorException, self).__init__(reason, response)
