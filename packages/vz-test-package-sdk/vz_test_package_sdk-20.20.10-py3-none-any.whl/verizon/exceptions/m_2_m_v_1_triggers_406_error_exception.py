...
class M2mV1Triggers406ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Triggers406ErrorException class
        ...
        """
        super(M2mV1Triggers406ErrorException, self).__init__(reason, response)
