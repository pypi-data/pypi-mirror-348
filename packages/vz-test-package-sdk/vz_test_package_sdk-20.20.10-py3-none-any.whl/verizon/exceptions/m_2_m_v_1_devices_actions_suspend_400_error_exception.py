...
class M2mV1DevicesActionsSuspend400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1DevicesActionsSuspend400ErrorException class
        ...
        """
        super(M2mV1DevicesActionsSuspend400ErrorException, self).__init__(reason, response)
