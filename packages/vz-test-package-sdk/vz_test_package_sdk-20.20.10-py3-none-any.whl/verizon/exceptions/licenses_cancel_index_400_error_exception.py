...
class LicensesCancelIndex400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesCancelIndex400ErrorException class
        ...
        """
        super(LicensesCancelIndex400ErrorException, self).__init__(reason, response)
