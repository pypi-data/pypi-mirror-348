...
class ManagedaccountsActionsCancel400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ManagedaccountsActionsCancel400ErrorException class
        ...
        """
        super(ManagedaccountsActionsCancel400ErrorException, self).__init__(reason, response)
