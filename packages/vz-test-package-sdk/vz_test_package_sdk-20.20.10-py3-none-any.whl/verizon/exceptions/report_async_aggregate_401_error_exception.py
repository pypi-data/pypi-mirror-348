...
class ReportAsyncAggregate401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate401ErrorException class
        ...
        """
        super(ReportAsyncAggregate401ErrorException, self).__init__(reason, response)
