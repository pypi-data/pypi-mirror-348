...
class DevicesActionsRestart0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesActionsRestart0ErrorException class
        ...
        """
        super(DevicesActionsRestart0ErrorException, self).__init__(reason, response)
