...
class Callbacks400Error3Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Callbacks400Error3Exception class
        ...
        """
        super(Callbacks400Error3Exception, self).__init__(reason, response)
