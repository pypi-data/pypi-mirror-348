...
class M2mV1Triggers403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Triggers403ErrorException class
        ...
        """
        super(M2mV1Triggers403ErrorException, self).__init__(reason, response)
