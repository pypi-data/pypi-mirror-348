...
class ReportsDevices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsDevices400ErrorException class
        ...
        """
        super(ReportsDevices400ErrorException, self).__init__(reason, response)
