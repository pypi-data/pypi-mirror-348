...
class LicensesAssign400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesAssign400ErrorException class
        ...
        """
        super(LicensesAssign400ErrorException, self).__init__(reason, response)
