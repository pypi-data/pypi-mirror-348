...
class ReportAggregate401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAggregate401ErrorException class
        ...
        """
        super(ReportAggregate401ErrorException, self).__init__(reason, response)
