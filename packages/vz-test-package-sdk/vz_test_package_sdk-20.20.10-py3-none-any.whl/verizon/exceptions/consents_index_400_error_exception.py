...
class ConsentsIndex400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ConsentsIndex400ErrorException class
        ...
        """
        super(ConsentsIndex400ErrorException, self).__init__(reason, response)
