...
class DevicesServices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices400ErrorException class
        ...
        """
        super(DevicesServices400ErrorException, self).__init__(reason, response)
