...
class LicensesIndex400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesIndex400ErrorException class
        ...
        """
        super(LicensesIndex400ErrorException, self).__init__(reason, response)
