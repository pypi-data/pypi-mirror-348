...
class M2mV1AccountsStatesandservices400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1AccountsStatesandservices400ErrorException class
        ...
        """
        super(M2mV1AccountsStatesandservices400ErrorException, self).__init__(reason, response)
