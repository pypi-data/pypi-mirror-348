...
class CallbacksName400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the CallbacksName400Error2Exception class
        ...
        """
        super(CallbacksName400Error2Exception, self).__init__(reason, response)
