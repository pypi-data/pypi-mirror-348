...
class CampaignsFirmwareDates400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CampaignsFirmwareDates400ErrorException class
        ...
        """
        super(CampaignsFirmwareDates400ErrorException, self).__init__(reason, response)
