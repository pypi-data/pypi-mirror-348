...
class CallbacksName400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CallbacksName400ErrorException class
        ...
        """
        super(CallbacksName400ErrorException, self).__init__(reason, response)
