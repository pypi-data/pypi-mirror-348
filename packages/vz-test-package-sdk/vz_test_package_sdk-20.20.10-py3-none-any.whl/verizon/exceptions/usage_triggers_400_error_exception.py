...
class UsageTriggers400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the UsageTriggers400ErrorException class
        ...
        """
        super(UsageTriggers400ErrorException, self).__init__(reason, response)
