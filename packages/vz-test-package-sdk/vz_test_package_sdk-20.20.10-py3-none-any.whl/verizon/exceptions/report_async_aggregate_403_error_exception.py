...
class ReportAsyncAggregate403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate403ErrorException class
        ...
        """
        super(ReportAsyncAggregate403ErrorException, self).__init__(reason, response)
