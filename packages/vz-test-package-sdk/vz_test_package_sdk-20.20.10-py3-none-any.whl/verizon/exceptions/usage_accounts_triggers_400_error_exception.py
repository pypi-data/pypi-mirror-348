...
class UsageAccountsTriggers400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the UsageAccountsTriggers400ErrorException class
        ...
        """
        super(UsageAccountsTriggers400ErrorException, self).__init__(reason, response)
