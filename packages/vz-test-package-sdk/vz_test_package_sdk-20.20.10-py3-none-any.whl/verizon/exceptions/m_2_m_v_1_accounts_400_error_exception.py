...
class M2mV1Accounts400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Accounts400ErrorException class
        ...
        """
        super(M2mV1Accounts400ErrorException, self).__init__(reason, response)
