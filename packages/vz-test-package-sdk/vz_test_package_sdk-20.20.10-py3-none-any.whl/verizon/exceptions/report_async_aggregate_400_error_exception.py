...
class ReportAsyncAggregate400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportAsyncAggregate400ErrorException class
        ...
        """
        super(ReportAsyncAggregate400ErrorException, self).__init__(reason, response)
