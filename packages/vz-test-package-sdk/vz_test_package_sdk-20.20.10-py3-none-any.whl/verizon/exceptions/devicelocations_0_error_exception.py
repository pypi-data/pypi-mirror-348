...
class Devicelocations0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Devicelocations0ErrorException class
        ...
        """
        super(Devicelocations0ErrorException, self).__init__(reason, response)
