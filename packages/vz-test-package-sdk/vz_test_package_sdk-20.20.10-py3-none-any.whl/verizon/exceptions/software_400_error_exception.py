...
class Software400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Software400ErrorException class
        ...
        """
        super(Software400ErrorException, self).__init__(reason, response)
