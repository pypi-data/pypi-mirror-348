...
class Callbacks400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Callbacks400ErrorException class
        ...
        """
        super(Callbacks400ErrorException, self).__init__(reason, response)
