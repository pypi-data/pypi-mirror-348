...
class Devices400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Devices400Error2Exception class
        ...
        """
        super(Devices400Error2Exception, self).__init__(reason, response)
