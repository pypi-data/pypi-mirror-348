...
class M2mV1Plans400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Plans400ErrorException class
        ...
        """
        super(M2mV1Plans400ErrorException, self).__init__(reason, response)
