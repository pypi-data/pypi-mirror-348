...
class Callbacks400Error7Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Callbacks400Error7Exception class
        ...
        """
        super(Callbacks400Error7Exception, self).__init__(reason, response)
