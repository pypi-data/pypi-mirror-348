...
class ReportSessions409ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportSessions409ErrorException class
        ...
        """
        super(ReportSessions409ErrorException, self).__init__(reason, response)
