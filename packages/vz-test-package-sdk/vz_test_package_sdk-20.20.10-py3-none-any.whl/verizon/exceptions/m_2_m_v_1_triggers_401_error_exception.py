...
class M2mV1Triggers401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Triggers401ErrorException class
        ...
        """
        super(M2mV1Triggers401ErrorException, self).__init__(reason, response)
