...
class M2mV1DevicesActionsAdd400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1DevicesActionsAdd400ErrorException class
        ...
        """
        super(M2mV1DevicesActionsAdd400ErrorException, self).__init__(reason, response)
