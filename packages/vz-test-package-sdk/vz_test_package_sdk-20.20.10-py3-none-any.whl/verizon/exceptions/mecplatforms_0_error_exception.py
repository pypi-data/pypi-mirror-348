...
class Mecplatforms0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Mecplatforms0ErrorException class
        ...
        """
        super(Mecplatforms0ErrorException, self).__init__(reason, response)
