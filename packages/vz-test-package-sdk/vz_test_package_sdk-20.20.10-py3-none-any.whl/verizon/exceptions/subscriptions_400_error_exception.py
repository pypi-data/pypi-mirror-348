...
class Subscriptions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Subscriptions400ErrorException class
        ...
        """
        super(Subscriptions400ErrorException, self).__init__(reason, response)
