...
class CampaignsFiles400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the CampaignsFiles400ErrorException class
        ...
        """
        super(CampaignsFiles400ErrorException, self).__init__(reason, response)
