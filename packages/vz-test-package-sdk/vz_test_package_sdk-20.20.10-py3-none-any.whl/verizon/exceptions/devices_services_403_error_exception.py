...
class DevicesServices403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices403ErrorException class
        ...
        """
        super(DevicesServices403ErrorException, self).__init__(reason, response)
