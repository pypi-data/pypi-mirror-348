...
class Regions401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Regions401ErrorException class
        ...
        """
        super(Regions401ErrorException, self).__init__(reason, response)
