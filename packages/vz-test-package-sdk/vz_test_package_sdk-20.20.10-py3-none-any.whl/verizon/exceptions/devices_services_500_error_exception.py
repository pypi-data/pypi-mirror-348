...
class DevicesServices500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices500ErrorException class
        ...
        """
        super(DevicesServices500ErrorException, self).__init__(reason, response)
