...
class DevicesServices401ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DevicesServices401ErrorException class
        ...
        """
        super(DevicesServices401ErrorException, self).__init__(reason, response)
