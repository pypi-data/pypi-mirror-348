...
class LocationreportsReport0ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the LocationreportsReport0ErrorException class
        ...
        """
        super(LocationreportsReport0ErrorException, self).__init__(reason, response)
