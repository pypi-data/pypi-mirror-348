...
class ReportsCampaignsDevices400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the ReportsCampaignsDevices400Error2Exception class
        ...
        """
        super(ReportsCampaignsDevices400Error2Exception, self).__init__(reason, response)
