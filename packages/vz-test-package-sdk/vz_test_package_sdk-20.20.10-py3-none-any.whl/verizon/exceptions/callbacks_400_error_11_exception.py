...
class Callbacks400Error11Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the Callbacks400Error11Exception class
        ...
        """
        super(Callbacks400Error11Exception, self).__init__(reason, response)
