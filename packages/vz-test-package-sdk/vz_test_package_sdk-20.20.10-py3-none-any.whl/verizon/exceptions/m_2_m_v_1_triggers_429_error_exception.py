...
class M2mV1Triggers429ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the M2mV1Triggers429ErrorException class
        ...
        """
        super(M2mV1Triggers429ErrorException, self).__init__(reason, response)
