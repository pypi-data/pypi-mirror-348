...
class Licenses400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Licenses400ErrorException class
        ...
        """
        super(Licenses400ErrorException, self).__init__(reason, response)
