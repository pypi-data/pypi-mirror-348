...
class LicensesRemove400Error2Exception(APIException):
    def __init__(self, reason, response):
        """Constructor for the LicensesRemove400Error2Exception class
        ...
        """
        super(LicensesRemove400Error2Exception, self).__init__(reason, response)
