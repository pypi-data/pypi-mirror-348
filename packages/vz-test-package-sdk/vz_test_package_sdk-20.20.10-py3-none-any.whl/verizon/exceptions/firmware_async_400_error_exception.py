...
class FirmwareAsync400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the FirmwareAsync400ErrorException class
        ...
        """
        super(FirmwareAsync400ErrorException, self).__init__(reason, response)
