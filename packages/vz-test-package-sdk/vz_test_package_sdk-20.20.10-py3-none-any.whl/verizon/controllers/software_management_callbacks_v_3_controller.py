...
from verizon.models.callbacks_response_4 import CallbacksResponse4
from verizon.models.callbacks_response_2 import CallbacksResponse2
from verizon.models.callbacks_response_7 import CallbacksResponse7
from verizon.exceptions.callbacks_400_error_7_exception import Callbacks400Error7Exception
...
class SoftwareManagementCallbacksV3Controller(BaseController):
    ...
    def get_list_registered_callbacks_3(self,
                                        acc):
        ...
        Returns:
            CallbacksResponse4: Response from the API. Return callback
                registration.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(CallbacksResponse4.from_dictionary)
            .local_error('400', 'Unexpected error.', Callbacks400Error7Exception)
        ).execute()

    def put_update_callback(self,
                            acc,
                            body):
    ...
    def post_register_callback_3(self,
                                 acc,
                                 body):
    ...
    def delete_deregister_callback_3(self,
                                     acc):
        ...
        Returns:
            CallbacksResponse7: Response from the API. Delete request result.
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(CallbacksResponse7.from_dictionary)
            .local_error('400', 'Unexpected error.', Callbacks400Error7Exception)
        ).execute()
