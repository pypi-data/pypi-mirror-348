...
class SIMActionsController(BaseController):
    ...
    def newactivatecode(self,
        ...
        Returns:
            M201success: Response from the API. Request ID
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Bad request', DefaultResponseException)
            .local_error('401', 'Unauthorized', DefaultResponseException)
            .local_error('403', 'Forbidden', DefaultResponseException)
            .local_error('404', 'Not Found / Does not exist', DefaultResponseException)
            .local_error('406', 'Format / Request Unacceptable', DefaultResponseException)
            .local_error('429', 'Too many requests', DefaultResponseException)
