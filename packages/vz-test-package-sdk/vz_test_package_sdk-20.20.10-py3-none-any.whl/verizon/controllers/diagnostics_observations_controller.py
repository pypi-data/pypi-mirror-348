...
from verizon.models.devices_attributes_actions_observe_response import DevicesAttributesActionsObserveResponse
from verizon.exceptions.devices_attributes_actions_observe_0_error_exception import DevicesAttributesActionsObserve0ErrorException
...
class DiagnosticsObservationsController(BaseController):
    ...
    def start_diagnostics_observation(self,
        ...
        Args:
            body (DevicesAttributesActionsObserveRequest): Request for device
                observation information.

        Returns:
            DevicesAttributesActionsObserveResponse: Response from the API.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DevicesAttributesActionsObserveResponse.from_dictionary)
            .local_error('default', 'Error response.', DevicesAttributesActionsObserve0ErrorException)
        ).execute()
