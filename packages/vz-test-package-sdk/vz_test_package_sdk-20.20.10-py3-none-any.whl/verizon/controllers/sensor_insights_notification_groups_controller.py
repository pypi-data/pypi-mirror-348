...
class SensorInsightsNotificationGroupsController(BaseController):
    ...
    def sensor_insights_list_notification_group_request(self,
        ...
        Args:
            body (DtoListDeviceExperienceHistoryRequest): Retrieve a
                notification group

        Returns:
            List[DtoNotificationGroupResponseEntity]: Response from the API. OK
    ...
    def sensor_insights_update_notification_group_request(self,
        ...
        Returns:
            DtoNotificationGroupResponseEntity: Response from the API. OK
    ...
    def sensor_insights_remove_users_from_notification_group_request(self,
        ...
        Args:
            body (DtoAddUsersToNotificationGroupRequest): Remove users from a
                notification group
