...
from verizon.exceptions.devices_settings_0_error_exception import DevicesSettings0ErrorException
...
class DiagnosticsSettingsController(BaseController):
    ...
    def list_diagnostics_settings(self,
        ...
        Returns:
            List[DiagnosticObservationSetting]: Response from the API.
                Diagnostic settings.
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('default', 'Error response.', DevicesSettings0ErrorException)
        ).execute()
