...
class M2mV1DevicesActionsSuspendResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Suspend Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsSuspendResponse class"""
