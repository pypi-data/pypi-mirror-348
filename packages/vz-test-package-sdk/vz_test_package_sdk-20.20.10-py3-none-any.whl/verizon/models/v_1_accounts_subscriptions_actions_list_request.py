...
class V1AccountsSubscriptionsActionsListRequest(object):

    """Implementation of the 'V1 Accounts Subscriptions Actions List Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the V1AccountsSubscriptionsActionsListRequest class"""
