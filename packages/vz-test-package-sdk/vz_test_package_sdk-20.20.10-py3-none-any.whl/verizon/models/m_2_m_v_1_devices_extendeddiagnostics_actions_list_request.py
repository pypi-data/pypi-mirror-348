...
class M2mV1DevicesExtendeddiagnosticsActionsListRequest(object):

    """Implementation of the 'M2m V1 Devices Extendeddiagnostics Actions List Request' model.
    ...
    def __init__(self,
                 account_name=None,
                 device_list=None):
        """Constructor for the M2mV1DevicesExtendeddiagnosticsActionsListRequest class"""
