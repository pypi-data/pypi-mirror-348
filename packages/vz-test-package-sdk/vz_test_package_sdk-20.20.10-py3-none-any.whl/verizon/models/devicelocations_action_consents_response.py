...
class DevicelocationsActionConsentsResponse(object):

    """Implementation of the 'Devicelocations Action Consents Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicelocationsActionConsentsResponse class"""
