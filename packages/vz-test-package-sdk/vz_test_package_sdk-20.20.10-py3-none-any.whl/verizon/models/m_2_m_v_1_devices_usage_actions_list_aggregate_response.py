...
class M2mV1DevicesUsageActionsListAggregateResponse(object):

    """Implementation of the 'M2m V1 Devices Usage Actions List Aggregate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesUsageActionsListAggregateResponse class"""
