...
class M2mIntelligenceWirelessCoverageRequest(object):

    """Implementation of the 'M2m Intelligence Wireless Coverage Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mIntelligenceWirelessCoverageRequest class"""
    ...
    def from_dictionary(cls,
        ...
        locations = Locations1.from_dictionary(dictionary.get('locations')) if dictionary.get('locations') else None
        network_types_list = None
