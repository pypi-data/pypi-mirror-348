...
class M2mV1IntelligenceAnomalySettingsRequest(object):

    """Implementation of the 'M2m V1 Intelligence Anomaly Settings Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1IntelligenceAnomalySettingsRequest class"""
