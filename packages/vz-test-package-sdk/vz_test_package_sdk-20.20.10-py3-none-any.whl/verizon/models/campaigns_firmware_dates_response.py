...
from verizon.models.v_3_time_window import V3TimeWindow


class CampaignsFirmwareDatesResponse(object):

    """Implementation of the 'Campaigns Firmware Dates Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CampaignsFirmwareDatesResponse class"""
