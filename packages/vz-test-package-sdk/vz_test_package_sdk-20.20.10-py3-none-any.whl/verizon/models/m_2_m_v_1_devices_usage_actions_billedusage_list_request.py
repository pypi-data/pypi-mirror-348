...
class M2mV1DevicesUsageActionsBilledusageListRequest(object):

    """Implementation of the 'M2m V1 Devices Usage Actions Billedusage List Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesUsageActionsBilledusageListRequest class"""
