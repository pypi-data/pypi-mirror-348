...
class M2mV1DevicesPwnActionsStateActivateResponse(object):

    """Implementation of the 'M2m V1 Devices Pwn Actions State Activate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPwnActionsStateActivateResponse class"""
