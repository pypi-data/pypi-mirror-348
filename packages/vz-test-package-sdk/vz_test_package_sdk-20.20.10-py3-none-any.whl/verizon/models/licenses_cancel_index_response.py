...
class LicensesCancelIndexResponse(object):

    """Implementation of the 'Licenses Cancel Index Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LicensesCancelIndexResponse class"""
