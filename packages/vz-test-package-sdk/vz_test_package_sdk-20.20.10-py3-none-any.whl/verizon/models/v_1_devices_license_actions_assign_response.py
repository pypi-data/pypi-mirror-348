...
class V1DevicesLicenseActionsAssignResponse(object):

    """Implementation of the 'V1 Devices License Actions Assign Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the V1DevicesLicenseActionsAssignResponse class"""
