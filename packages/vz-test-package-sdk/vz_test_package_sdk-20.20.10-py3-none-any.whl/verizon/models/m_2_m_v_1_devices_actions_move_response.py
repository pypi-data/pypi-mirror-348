...
class M2mV1DevicesActionsMoveResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Move Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsMoveResponse class"""
