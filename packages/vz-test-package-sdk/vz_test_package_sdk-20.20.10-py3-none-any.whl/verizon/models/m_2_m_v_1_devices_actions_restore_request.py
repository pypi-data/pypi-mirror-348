...
class M2mV1DevicesActionsRestoreRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Restore Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsRestoreRequest class"""
