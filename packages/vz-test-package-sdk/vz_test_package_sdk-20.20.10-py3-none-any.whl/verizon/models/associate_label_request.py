...
"""
from verizon.models.labels import Labels
...
class AssociateLabelRequest(object):
    ...
    Attributes:
        ...
        labels (Labels): The model property of type Labels.
    ...
    def from_dictionary(cls,
        ...
        labels = Labels.from_dictionary(dictionary.get('labels')) if dictionary.get('labels') else None
