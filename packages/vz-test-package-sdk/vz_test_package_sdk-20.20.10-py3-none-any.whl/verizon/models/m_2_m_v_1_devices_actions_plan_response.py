...
class M2mV1DevicesActionsPlanResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Plan Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsPlanResponse class"""
