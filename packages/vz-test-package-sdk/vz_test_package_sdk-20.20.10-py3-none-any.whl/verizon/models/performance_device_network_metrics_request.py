...
class PerformanceDeviceNetworkMetricsRequest(object):

    """Implementation of the 'Performance Device Network Metrics Request' model.
    ...
    def __init__(self,
                 imei=None,
                 msisdn=None):
        """Constructor for the PerformanceDeviceNetworkMetricsRequest class"""
