...
class ConnectivityManagementResult(object):

    """Implementation of the 'ConnectivityManagementResult' model.

    Response to errors.

    Attributes:
        error_code (str): Code of the error.
    ...
    def __init__(self,
        ...
        """Constructor for the ConnectivityManagementResult class"""
