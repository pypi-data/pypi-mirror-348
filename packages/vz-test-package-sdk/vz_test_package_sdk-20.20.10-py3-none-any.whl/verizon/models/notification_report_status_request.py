...
from verizon.models.device_5 import Device5
...
class NotificationReportStatusRequest(object):
    ...
    Attributes:
        ...
        device (Device5): The model property of type Device5.
    ...
    def from_dictionary(cls,
        ...
        device = Device5.from_dictionary(dictionary.get('device')) if dictionary.get('device') else None
