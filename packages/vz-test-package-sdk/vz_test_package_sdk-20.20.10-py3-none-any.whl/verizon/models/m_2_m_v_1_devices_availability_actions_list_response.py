...
class M2mV1DevicesAvailabilityActionsListResponse(object):

    """Implementation of the 'M2m V1 Devices Availability Actions List Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesAvailabilityActionsListResponse class"""
