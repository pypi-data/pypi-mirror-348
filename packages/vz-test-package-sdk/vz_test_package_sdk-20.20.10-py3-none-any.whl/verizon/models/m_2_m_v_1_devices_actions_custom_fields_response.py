...
class M2mV1DevicesActionsCustomFieldsResponse(object):

    """Implementation of the 'M2m V1 Devices Actions CustomFields Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsCustomFieldsResponse class"""
