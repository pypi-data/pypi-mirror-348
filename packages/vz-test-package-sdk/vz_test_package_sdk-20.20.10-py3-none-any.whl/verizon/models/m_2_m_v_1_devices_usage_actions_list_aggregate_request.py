...
class M2mV1DevicesUsageActionsListAggregateRequest(object):

    """Implementation of the 'M2m V1 Devices Usage Actions List Aggregate Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesUsageActionsListAggregateRequest class"""
