...
class M2mV1DevicesActionsGotostateResponse(object):

    """Implementation of the 'M2m V1 Devices Actions Gotostate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsGotostateResponse class"""
