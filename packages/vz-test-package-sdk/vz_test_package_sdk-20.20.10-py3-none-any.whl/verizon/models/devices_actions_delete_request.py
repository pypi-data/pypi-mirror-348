...
class DevicesActionsDeleteRequest(object):

    """Implementation of the 'Devices Actions Delete Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesActionsDeleteRequest class"""
