...
class TargetsActionsNewaicResponse(object):

    """Implementation of the 'Targets Actions Newaic Response' model.
    ...
    def __init__(self,
                 ...
                 url=APIHelper.SKIP):
        """Constructor for the TargetsActionsNewaicResponse class"""
