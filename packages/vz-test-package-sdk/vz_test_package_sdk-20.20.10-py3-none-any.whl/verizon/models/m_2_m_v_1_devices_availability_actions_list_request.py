...
class M2mV1DevicesAvailabilityActionsListRequest(object):

    """Implementation of the 'M2m V1 Devices Availability Actions List Request' model.
    ...
    def __init__(self,
                 account_name=None,
                 devices=None):
        """Constructor for the M2mV1DevicesAvailabilityActionsListRequest class"""
