...
class DevicesActionsRestartResponse(object):

    """Implementation of the 'Devices Actions Restart Response' model.
    ...
    def __init__(self,
                 ...
                 status=None,
                 created_on=None):
        """Constructor for the DevicesActionsRestartResponse class"""
