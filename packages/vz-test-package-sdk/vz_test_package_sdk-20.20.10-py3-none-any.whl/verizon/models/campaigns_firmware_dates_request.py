...
class CampaignsFirmwareDatesRequest(object):

    """Implementation of the 'Campaigns Firmware Dates Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CampaignsFirmwareDatesRequest class"""
