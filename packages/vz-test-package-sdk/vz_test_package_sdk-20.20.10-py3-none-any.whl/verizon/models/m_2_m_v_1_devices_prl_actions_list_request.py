...
class M2mV1DevicesPrlActionsListRequest(object):

    """Implementation of the 'M2m V1 Devices Prl Actions List Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPrlActionsListRequest class"""
