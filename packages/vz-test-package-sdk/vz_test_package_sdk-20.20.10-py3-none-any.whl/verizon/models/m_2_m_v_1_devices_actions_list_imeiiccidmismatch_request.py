...
from verizon.models.filter_1 import Filter1


class M2mV1DevicesActionsListImeiiccidmismatchRequest(object):

    """Implementation of the 'M2m V1 Devices Actions List Imeiiccidmismatch Request' model.

    Attributes:
        filter (Filter1): The model property of type Filter1.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsListImeiiccidmismatchRequest class"""
    ...
    def from_dictionary(cls,
        ...
        filter = Filter1.from_dictionary(dictionary.get('filter')) if dictionary.get('filter') else None
        devices = None
