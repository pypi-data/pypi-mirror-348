...
class M2mV1DevicesActionsListResponse(object):

    """Implementation of the 'M2m V1 Devices Actions List Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsListResponse class"""
