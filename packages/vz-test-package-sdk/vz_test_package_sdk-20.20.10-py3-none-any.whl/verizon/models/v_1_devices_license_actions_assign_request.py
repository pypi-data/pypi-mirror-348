...
class V1DevicesLicenseActionsAssignRequest(object):

    """Implementation of the 'V1 Devices License Actions Assign Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the V1DevicesLicenseActionsAssignRequest class"""
