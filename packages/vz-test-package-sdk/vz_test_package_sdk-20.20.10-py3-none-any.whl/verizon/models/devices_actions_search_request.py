...
class DevicesActionsSearchRequest(object):

    """Implementation of the 'Devices Actions Search Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesActionsSearchRequest class"""
