...
class M2mV1DevicesActionsAddRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Add Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsAddRequest class"""
