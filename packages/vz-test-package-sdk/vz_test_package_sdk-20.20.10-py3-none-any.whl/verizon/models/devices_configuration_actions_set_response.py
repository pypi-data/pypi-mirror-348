...
from verizon.models.fields_12 import Fields12


class DevicesConfigurationActionsSetResponse(object):

    """Implementation of the 'Devices Configuration Actions Set Response' model.
    ...
    Attributes:
        ...
        fields (Fields12): The model property of type Fields12.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesConfigurationActionsSetResponse class"""
    ...
    def from_dictionary(cls,
        ...
        fields = Fields12.from_dictionary(dictionary.get('fields')) if 'fields' in dictionary.keys() else APIHelper.SKIP
