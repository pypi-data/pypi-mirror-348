...
class M2mV1DevicesConnectionsActionsListHistoryResponse(object):

    """Implementation of the 'M2m V1 Devices Connections Actions ListHistory Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesConnectionsActionsListHistoryResponse class"""
