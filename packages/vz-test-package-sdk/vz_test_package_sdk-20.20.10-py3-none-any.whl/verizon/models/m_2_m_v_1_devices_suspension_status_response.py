...
class M2mV1DevicesSuspensionStatusResponse(object):

    """Implementation of the 'M2m V1 Devices Suspension Status Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesSuspensionStatusResponse class"""
