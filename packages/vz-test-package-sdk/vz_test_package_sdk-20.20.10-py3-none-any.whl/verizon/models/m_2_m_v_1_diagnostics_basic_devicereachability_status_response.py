...
class M2mV1DiagnosticsBasicDevicereachabilityStatusResponse(object):

    """Implementation of the 'M2m V1 Diagnostics Basic Devicereachability Status Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DiagnosticsBasicDevicereachabilityStatusResponse class"""
