...
class M2mV1DevicesPrlActionsListResponse(object):

    """Implementation of the 'M2m V1 Devices Prl Actions List Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPrlActionsListResponse class"""
