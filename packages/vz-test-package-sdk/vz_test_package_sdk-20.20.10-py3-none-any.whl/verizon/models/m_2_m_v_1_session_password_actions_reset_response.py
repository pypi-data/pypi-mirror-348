...
class M2mV1SessionPasswordActionsResetResponse(object):

    """Implementation of the 'M2m V1 Session Password Actions Reset Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1SessionPasswordActionsResetResponse class"""
