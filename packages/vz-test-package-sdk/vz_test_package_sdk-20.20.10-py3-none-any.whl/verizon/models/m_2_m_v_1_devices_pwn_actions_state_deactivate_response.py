...
class M2mV1DevicesPwnActionsStateDeactivateResponse(object):

    """Implementation of the 'M2m V1 Devices Pwn Actions State Deactivate Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesPwnActionsStateDeactivateResponse class"""
