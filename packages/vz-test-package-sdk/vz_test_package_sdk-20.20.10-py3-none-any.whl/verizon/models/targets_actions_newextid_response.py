...
class TargetsActionsNewextidResponse(object):

    """Implementation of the 'Targets Actions Newextid Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TargetsActionsNewextidResponse class"""
