...
class HistoryActionsSearchRequest(object):

    """Implementation of the 'History Actions Search Request' model.
    ...
    def __init__(self,
                 ...
                 page=APIHelper.SKIP):
        """Constructor for the HistoryActionsSearchRequest class"""
