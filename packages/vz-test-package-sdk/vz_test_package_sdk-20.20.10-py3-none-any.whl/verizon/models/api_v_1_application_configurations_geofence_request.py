...
class ApiV1ApplicationConfigurationsGeofenceRequest(object):

    """Implementation of the 'Api V1 Application Configurations Geofence Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApiV1ApplicationConfigurationsGeofenceRequest class"""
