...
class M2mV1DevicesActionsDeleteRequest(object):

    """Implementation of the 'M2m V1 Devices Actions Delete Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the M2mV1DevicesActionsDeleteRequest class"""
