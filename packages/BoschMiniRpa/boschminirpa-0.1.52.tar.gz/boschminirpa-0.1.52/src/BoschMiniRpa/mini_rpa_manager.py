...
class MiniRpaManager(MiniRpaFunction):
    ...
    def start_bot(self):
        ...
        if self.process_data:
            ...
            from_file_path = from_folder_path + os.sep + from_file_name if from_folder_path else self.from_file_path
            ...
            update_file_path = update_folder_path + os.sep + update_file_name if update_folder_path else self.update_file_path
            ...
            if function_name == 'keep':
                self.keep(from_file_path, self.from_file_name, self.from_sheet_name, process_number, is_save, has_from_file_condition)
            elif function_name == 'vlookup':
                self.vlookup(process_number, from_file_path, self.from_file_name, self.from_sheet_name, from_column_name, from_column_by,
                             update_file_path, self.update_file_name, self.update_sheet_name, update_column_name, update_column_by, has_from_file_condition,
