    ...
    def start_bot(self):
        ...
        if self.download_data:
            ...
            for process_step_dict in self.sap_operation_list:
                ...
                elif function_name == 'select_y01f_report_left_menu_item':
                    sap_automation.select_y01f_report_left_menu_item(sap_operation_dict['report_name'], sap_operation_dict['no_data_message'])
                elif function_name == 'download_y01k_report_data':
                    sap_automation.download_y01k_report_data(file_name, shortcut_list)
