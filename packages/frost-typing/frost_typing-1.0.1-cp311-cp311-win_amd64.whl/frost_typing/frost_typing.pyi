...
class StringConstraints:
    ...
    Attributes:
        ...
        strict (bool, optional): Whether to enforce strict type checking.
    ...
    Example:
        ...
        class Model(ValidModel):
            ...
            email: Annotated[str, StringConstraints(pattern=r"^[\w\.-]+@[\w\.-]+\.\w+$", strict=True)]
...
def con_string(
    ...
    *,
    ...
    whitespace stripping, strict type enforcement, length constraints, and regex pattern validation.
    ...
    Example:
        ...
        class Model(ValidModel):
            ...
            email: con_string(str, pattern=r"^[\w\.-]+@[\w\.-]+\.\w+$", strict=True)
