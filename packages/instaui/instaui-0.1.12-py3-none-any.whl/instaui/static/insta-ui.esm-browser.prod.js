...
import { customRef as je, toValue as q, unref as W, watch as G, nextTick as Ne, isRef as qt, ref as Z, shallowRef as J, watchEffect as Ht, computed as U, readonly as Gn, provide as Ve, inject as ee, shallowReactive as qn, defineComponent as F, reactive as Hn, h as A, getCurrentInstance as zt, normalizeStyle as zn, normalizeClass as Qe, toDisplayString as Jt, onUnmounted as Ce, Fragment as xe, vModelDynamic as Jn, vShow as Qn, resolveDynamicComponent as ft, normalizeProps as Yn, withDirectives as Xn, onErrorCaptured as Zn, openBlock as he, createElementBlock as Pe, createElementVNode as er, createVNode as tr, withCtx as nr, renderList as rr, createBlock as or, TransitionGroup as Qt, KeepAlive as sr } from "vue";
let Yt;
function ir(e) {
  Yt = e;
}
...
function tt(e, t = !1) {
  function n(u, { flush: f = "sync", deep: d = !1, timeout: v, throwOnTimeout: p } = {}) {
    ...
    return v != null && _.push(
      et(v, p).then(() => de(e)).finally(() => g == null ? void 0 : g())
    ), Promise.race(_);
  }
  function r(u, f) {
    if (!qt(u))
    ...
    return p != null && O.push(
      et(p, g).then(() => de(e)).finally(() => (y == null || y(), de(e)))
    ), Promise.race(O);
  }
  function o(u) {
    return n((f) => !!f, u);
...
function lr(e, t, n) {
  ...
  async function v(y = 0, ..._) {
    c && (a.value = t), d.value = void 0, u.value = !1, f.value = !0, y > 0 && await et(y);
...
function gr(e, t, n) {
  ...
  const d = L(o), v = l === 0 ? J(null) : nn(null), p = { immediate: !0, deep: !0 };
  return rn(d) ? (v.value = c, G(
    u,
    async () => {
      f().some(Ie) || (v.value = await d(...f()));
    },
    p
  )) : G(
    u,
...
function on(e, t) {
  ...
  return (s = e.refs) == null || s.forEach((a) => {
    ...
    const { init: u } = a, f = a.deepEqOnInput === void 0 ? J(u ?? nt) : nn(u ?? nt);
    o(a, f);
...
const ln = /* @__PURE__ */ new Map(), dt = we(() => /* @__PURE__ */ new Map()), fn = /* @__PURE__ */ new Set(), hn = Symbol("vfor");
function Pr(e) {
  const t = dn() ?? {};
  Ve(hn, { ...t, [e.fid]: e.key });
}
...
const Uo = Symbol(S.NODE_ENV !== "production" ? "router view location matched" : ""), Mt = Symbol(S.NODE_ENV !== "production" ? "router view depth" : ""), Fe = Symbol(S.NODE_ENV !== "production" ? "router" : ""), mt = Symbol(S.NODE_ENV !== "production" ? "route location" : ""), ct = Symbol(S.NODE_ENV !== "production" ? "router view location" : "");
function pe() {
  let e = [];
  function t(r) {
    return e.push(r), () => {
...
function Ft(e) {
  const t = ee(Fe), n = ee(mt);
  let r = !1, o = null;
  const s = U(() => {
    const a = W(e.to);
    return S.NODE_ENV !== "production" && (!r || a !== o) && (Te(a) || (r ? P(`Invalid value for prop "to" in useLink()
- to:`, a, `
- previous to:`, o, `
  ...
  if (S.NODE_ENV !== "production" && z) {
    ...
    if (a) {
      ...
      a.__vrl_devtools = a.__vrl_devtools || [], a.__vrl_devtools.push(u), Ht(() => {
        u.route = s.value, u.isActive = c.value, u.isExactActive = l.value, u.error = Te(W(e.to)) ? null : 'Invalid "to" value';
      }, { flush: "post" });
    }
  }
  return {
...
const qo = /* @__PURE__ */ F({
  ...
  useLink: Ft,
  setup(e, { slots: t }) {
    const n = Hn(Ft(e)), { options: r } = ee(Fe), o = U(() => ({
...
const Lt = (e, t, n) => e ?? t ?? n, Qo = /* @__PURE__ */ F({
  ...
  setup(e, { attrs: t, slots: n }) {
    ...
    Ve(Mt, U(() => i.value + 1)), Ve(Uo, c), Ve(ct, o);
    const l = Z();
...
function es(e, t, n) {
  ...
  Kr({
    ...
    t.beforeEach((a, u) => {
      ...
      }, d.status = ke("❌")) : d.status = ke("✅"), d.from = me(u, "Current Location during this navigation"), d.to = me(a, "Target location"), o.addTimelineEvent({
        layerId: s,
        event: {
...
function ls(e) {
  ...
  const a = qe.bind(null, (m) => "" + m), u = qe.bind(null, oo), f = (
  ...
  function y(m, E) {
    if (E = I({}, E || l.value), typeof m == "string") {
      const k = He(n, m, E.path), $ = t.resolve({ path: k.path }, E), re = o.createHref(k.fullPath);
...
${JSON.stringify(b, null, 2)}
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`), Promise.reject(new Error("Infinite redirect in navigation guard"))) : x(
  ...
  function gt(m, E) {
    let w;
    const [b, T, j] = fs(m, E);
    w = Je(b.reverse(), "beforeRouteLeave", m, E);
    for (const k of b)
      k.leaveGuards.forEach(($) => {
        w.push(X($, m, E));
      });
    const V = Be.bind(null, m, E);
    return w.push(V), se(w).then(() => {
      ...
      return w.push(V), se(w);
    }).then(() => (m.matched.forEach((k) => k.enterCallbacks = {}), w = Je(j, "beforeRouteEnter", m, E, le), w.push(V), se(w))).then(() => {
      w = [];
  ...
  function yt(m, E, w, b, T) {
    ...
    w && (b || V ? o.replace(m.fullPath, I({
      scroll: V && k && k.scroll
    }, T)) : o.push(m.fullPath, T)), l.value = m, Et(m, E, w, V), Ue();
  }
  let fe;
  function Bn() {
    fe || (fe = o.listen((m, E, w) => {
      ...
      h = b;
      const j = l.value;
      z && po(Vt(j.fullPath, w.delta), Me()), gt(b, j).catch((V) => H(
        V,
        12
        /* ErrorTypes.NAVIGATION_CANCELLED */
      ) ? V : H(
      ...
      }).catch(ve), Promise.reject()) : (w.delta && o.go(-w.delta, !1), We(V, b, j))).then((V) => {
        V = V || yt(
  ...
  function Ue(m) {
    return Se || (Se = !m, Bn(), Le.list().forEach(([E, w]) => m ? w(m) : E()), Le.reset()), m;
  }
  function Et(m, E, w, b) {
    ...
    return Ne().then(() => T(m, E, j)).then((V) => V && ho(V)).catch((V) => We(V, m, E));
  }
  const Ke = (m) => o.go(m);
  let Ge;
  const Re = /* @__PURE__ */ new Set(), _t = {
    currentRoute: l,
    listening: !0,
    addRoute: d,
    removeRoute: v,
    ...
    install(m) {
      ...
      !Ge && l.value === Y && (Ge = !0, R(o.location).catch((T) => {
      ...
      m.provide(Fe, E), m.provide(mt, qn(w)), m.provide(ct, l);
      const b = m.unmount;
      Re.add(m), m.unmount = function() {
        Re.delete(m), Re.size < 1 && (h = Y, fe && fe(), fe = null, l.value = Y, Ge = !1, Se = !1), b();
...
function ne(e) {
  ...
  function d(p, g) {
    ...
    g.forEach((O, R) => {
      ...
      if (N.isElementRef(O)) {
        const C = o.getRef(O).value, x = y[R], { method: Be, args: le = [] } = x;
        C[Be](...le);
        return;
      }
      if (N.isJsOutput(O)) {
...
class ps {
  async eventSend(t, n) {
    const { fType: r, hKey: o, key: s } = t, i = Ye().webServerInfo, c = s !== void 0 ? { key: s } : {}, l = r === "sync" ? i.event_url : i.event_async_url;
    let h = {};
  ...
  async watchSend(t) {
    const { outputs: n, fType: r, key: o } = t.watchConfig, s = Ye().webServerInfo, i = r === "sync" ? s.watch_url : s.watch_async_url, c = t.getServerInputs(), l = {
      key: o,
      input: c,
      page: ye()
    };
  ...
  constructor(t, n, r) {
    ...
    t == null || t.forEach((i) => {
      ...
      G(
        f,
        (d) => {
          d.some(Ie) || (i.modify = !0, this.taskQueue.push(new Es(i)), this._scheduleNextTick());
        },
        u
      );
    });
...
function Os(e, t) {
  const {
    ...
    onData: h,
    bindData: a
  } = e, u = h || new Array(n.length).fill(0), f = a || new Array(Object.keys(l).length).fill(0), d = Ee(
    l,
...
function Fs(e) {
  ...
  return Ae(r, !0), () => {
    const { tag: o } = e.component, s = N.IsBinding(o) ? t.getObjectToValue(o) : o, i = ft(s), c = typeof i == "string", l = Is(e.component, t), { styles: h, hasStyle: a } = Ns(e.component, t), u = Ss(e.component.events ?? {}, t), f = xs(e.component, c), d = As(e.component, r, t), { newProps: v, directiveArray: p } = Ds(
      e.component.dir,
      t
    ), g = Ms(
      e.component,
...
function Dn(e, t) {
  ...
  if (e) {
    ...
    vs(e.py_watch, e.web_computed, i), (n = e.vue_watch) == null || n.forEach((c) => Os(c, i)), (r = e.js_watch) == null || r.forEach((c) => bs(c, i)), Ce(() => {
      cn(e.id, s), _r(e.id, o);
    });
  }
}
...
const Ks = { class: "app-box" }, Gs = {
  ...
  setup(e) {
    const t = e, { config: n, isLoading: r } = Ws(
      t.config,
      t.configUrl
    );
    let o = null;
    ...
    }), Zn(Us), (s, i) => (he(), Pe("div", Ks, [
      W(r) ? (he(), Pe("div", Gs, i[0] || (i[0] = [
        er("p", { style: { margin: "auto" } }, "Loading ...", -1)
      ]))) : (he(), Pe("div", {
        key: 1,
        class: Qe(["insta-main", W(n).class])
      }, [
        tr(W(be), {
          scope: W(o).scope
        }, {
          default: nr(() => [
            (he(!0), Pe(xe, null, rr(W(o).items, (c) => (he(), or(W(Q), { component: c }, null, 8, ["component"]))), 256))
          ]),
          _: 1
        }, 8, ["scope"])
      ], 2))
...
const oi = F(
  (e) => {
    ...
    return $e.createDynamicWatchRefresh(n, i, async () => {
      const { items: c, on: l } = await $e.fetchRemote(e, i);
      return o.value = c, l;
    }), Ce(() => {
      cn(t.id, s);
    }), () => ri(o.value);
...
function Fn(e, t) {
  ...
  const { server: n = !1, vueItem: r, scope: o } = e, s = () => {
    ...
    return Promise.resolve(di(r, o, t));
...
function vi(e, t) {
  e.component("insta-ui", qs), e.component("vif", zs), e.component("vfor", Ys), e.component("match", ai), e.component("refresh", oi), e.component("ts-group", ui), e.component("content", fi), t.router && pi(e, t);
}
export {
