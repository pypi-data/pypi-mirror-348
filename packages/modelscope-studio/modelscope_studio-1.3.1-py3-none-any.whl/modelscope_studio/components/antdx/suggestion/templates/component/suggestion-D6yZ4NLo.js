...
var cr = /^\s+/;
function lr(t) {
  return t && t.slice(0, ar(t) + 1).replace(cr, "");
}
var Ge = NaN, ur = /^[-+]0x[0-9a-f]+$/i, fr = /^0b[01]+$/i, hr = /^0o[0-7]+$/i, dr = parseInt;
function Ke(t) {
  if (typeof t == "number")
    return t;
  if (Wt(t))
  ...
  t = lr(t);
  var n = fr.test(t);
  return n || hr.test(t) ? dr(t.slice(2), n ? 2 : 8) : ur.test(t) ? Ge : +t;
}
var ye = function() {
  return Gt.Date.now();
}, gr = "Expected a function", pr = Math.max, mr = Math.min;
function br(t, e, n) {
  var o, r, s, i, a, c, l = 0, h = !1, u = !1, d = !0;
  if (typeof t != "function")
    throw new TypeError(gr);
  e = Ke(e) || 0, Oe(n) && (h = !!n.leading, u = "maxWait" in n, s = u ? pr(Ke(n.maxWait) || 0, e) : s, d = "trailing" in n ? !!n.trailing : d);
  function f(S) {
    var T = o, C = r;
 ...
 */
var vr = w, Sr = Symbol.for("react.element"), xr = Symbol.for("react.fragment"), _r = Object.prototype.hasOwnProperty, Cr = vr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, wr = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
function _t(t, e, n) {
  ...
  for (o in e) _r.call(e, o) && !wr.hasOwnProperty(o) && (r[o] = e[o]);
...
function tt(t) {
  ...
  return {
    ...
    l(s) {
      ...
      var i = Ct(e);
      r && r.l(i), i.forEach(W), this.h();
    },
    h() {
      Tt(e, "class", "svelte-1rt0kpf");
    },
    m(s, i) {
...
function Fr(t) {
  ...
  return {
    c() {
      e = Ot("react-portal-target"), n = Ar(), s && s.c(), o = Ye(), this.h();
    },
    l(i) {
      e = wt(i, "REACT-PORTAL-TARGET", {
        class: !0
      }), Ct(e).forEach(W), n = Mr(i), s && s.l(i), o = Ye(), this.h();
    },
    h() {
      Tt(e, "class", "svelte-1rt0kpf");
    },
    ...
    p(i, [a]) {
      ...
      16 && ee(s, 1)) : (s = tt(i), s.c(), ee(s, 1), s.m(o.parentNode, o)) : s && (jr(), Me(s, 1, 1, () => {
        s = null;
      }), Tr());
    },
    i(i) {
    ...
    d(i) {
      i && (W(e), W(n), W(o)), t[8](null), s && s.d(i);
    }
  };
}
function rt(t) {
...
function Vr(t, e, n) {
  ...
  const u = Z();
  Ze(t, u, (y) => n(1, r = y));
  const d = [], f = zr("$$ms-gr-react-wrapper"), {
    slotKey: b,
    slotIndex: m,
    subSlotIndex: g
  } = qt() || {}, p = c({
  ...
  return t.$$set = (y) => {
    n(17, e = Qe(Qe({}, e), et(y))), "svelteInit" in y && n(5, c = y.svelteInit), "$$scope" in y && n(6, i = y.$$scope);
  }, e = et(e), [o, r, h, u, a, c, i, s, v, x];
}
class Xr extends Or {
  constructor(e) {
    super(), Rr(this, e, Vr, Fr, Lr, {
      svelteInit: 5
    });
  }
}
const {
  SvelteComponent: Yn
} = window.__gradio__svelte__internal, nt = window.ms_globals.rerender, ve = window.ms_globals.tree;
function Nr(t, e = {}) {
  function n(o) {
    const r = Z(), s = new Xr({
      ...o,
      props: {
        svelteInit(i) {
          ...
          return c.nodes = [...c.nodes, a], nt({
            createPortal: we,
            node: ve
          }), i.onDestroy(() => {
            c.nodes = c.nodes.filter((l) => l.svelteInstance !== r), nt({
              createPortal: we,
              node: ve
            });
          }), a;
...
function Gr(t, e) {
  return typeof e == "number" && !Ur.includes(t) ? e + "px" : e;
}
function Pe(t) {
...
const Ee = bt(({
  ...
  return vt(() => {
    ...
    function d() {
      let g = u;
      if (u.tagName.toLowerCase() === "svelte-slot" && u.children.length === 1 && u.children[0] && (g = u.children[0], g.tagName.toLowerCase() === "react-portal-target" && g.children[0] && (g = g.children[0])), Kr(s, g), n && g.classList.add(...n.split(" ")), o) {
        const p = Wr(o);
...
}), qr = "1.2.0", Qr = /* @__PURE__ */ w.createContext({}), Jr = {
  classNames: {},
  styles: {},
  className: "",
  style: {}
...
function ke(t, e) {
  return Yr(t) || en(t, e) || tn(t, e) || rn();
}
function nn() {
  return !!(typeof window < "u" && window.document && window.document.createElement);
}
var st = nn() ? V.useLayoutEffect : V.useEffect, on = function(e, n) {
  var o = V.useRef(!0);
  st(function() {
    return e(o.current);
  }, n), st(function() {
...
function at(t) {
  var e = V.useRef(!1), n = V.useState(t), o = ke(n, 2), r = o[0], s = o[1];
...
function sn(t, e) {
  var n = e || {}, o = n.defaultValue, r = n.value, s = n.onChange, i = n.postState, a = at(function() {
    return Se(r) ? r : Se(o) ? typeof o == "function" ? o() : o : t;
  }), c = ke(a, 2), l = c[0], h = c[1], u = r !== void 0 ? r : l, d = i ? i(u) : u, f = re(s), b = at([u]), m = ke(b, 2), g = m[0], p = m[1];
  it(function() {
    var x = g[0];
    l !== x && f(l, x);
  }, [g]), it(function() {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var Ae = Symbol.for("react.element"), De = Symbol.for("react.portal"), se = Symbol.for("react.fragment"), ie = Symbol.for("react.strict_mode"), ae = Symbol.for("react.profiler"), ce = Symbol.for("react.provider"), le = Symbol.for("react.context"), an = Symbol.for("react.server_context"), ue = Symbol.for("react.forward_ref"), fe = Symbol.for("react.suspense"), he = Symbol.for("react.suspense_list"), de = Symbol.for("react.memo"), ge = Symbol.for("react.lazy"), cn = Symbol.for("react.offscreen"), Mt;
...
_.ContextConsumer = le;
_.ContextProvider = ce;
_.Element = Ae;
_.ForwardRef = ue;
_.Fragment = se;
_.Lazy = ge;
...
_.isValidElementType = function(t) {
  return typeof t == "string" || typeof t == "function" || t === se || t === ae || t === ie || t === fe || t === he || t === cn || typeof t == "object" && t !== null && (t.$$typeof === ge || t.$$typeof === de || t.$$typeof === ce || t.$$typeof === le || t.$$typeof === ue || t.$$typeof === Mt || t.getModuleId !== void 0);
};
_.typeOf = H;
Number(Ut.split(".")[0]);
function z(t) {
...
function me(t, e, n) {
  return e && gn(t.prototype, e), Object.defineProperty(t, "prototype", {
    writable: !1
  }), t;
}
function je(t, e) {
  return je = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(n, o) {
...
var jt = /* @__PURE__ */ me(function t() {
  pe(this, t);
}), Rt = "CALC_UNIT", mn = new RegExp(Rt, "g");
function xe(t) {
...
var bn = /* @__PURE__ */ function(t) {
  ...
  function n(o, r) {
    var s;
    pe(this, n), s = e.call(this), M(K(s), "result", ""), M(K(s), "unitlessCssVar", void 0), M(K(s), "lowPriority", void 0);
    var i = z(o);
  ...
  return me(n, [{
    ...
    value: function(r) {
      ...
      }) && (c = !1), this.result = this.result.replace(mn, c ? "px" : ""), typeof this.lowPriority < "u" ? "calc(".concat(this.result, ")") : this.result;
    }
  }]), n;
}(jt), yn = /* @__PURE__ */ function(t) {
  Et(n, t);
  var e = kt(n);
  function n(o) {
    var r;
    return pe(this, n), r = e.call(this), M(K(r), "result", 0), o instanceof n ? r.result = o.result : typeof o == "number" && (r.result = o), r;
  }
  return me(n, [{
    key: "add",
    value: function(r) {
...
var Lt = typeof CSSINJS_STATISTIC < "u", Re = !0;
function He() {
...
var xn = function(e) {
  ...
  return Lt && typeof Proxy < "u" && (n = /* @__PURE__ */ new Set(), o = new Proxy(e, {
    ...
    ht[i] = {
      global: Array.from(n),
      component: L(L({}, (c = ht[i]) === null || c === void 0 ? void 0 : c.component), a)
    };
  }), {
    token: o,
    keys: n,
...
var Cn = 1e3 * 60 * 10, wn = /* @__PURE__ */ function() {
  function t() {
    ...
    value: function() {
      ...
      if (this.accessBeat > 1e4) {
        ...
        this.lastAccessBeat.forEach(function(r, s) {
          o - r > Cn && (n.map.delete(s), n.lastAccessBeat.delete(s));
        }), this.accessBeat = 0;
      }
    }
  }]), t;
...
function Mn(t) {
  ...
  function c(d, f, b, m) {
    ...
    var v = (m == null ? void 0 : m.unitless) || {}, x = typeof a == "function" ? a(d) : {}, y = L(L({}, x), {}, M({}, p("zIndexPopup"), !0));
    ...
    return function(C) {
      var E = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : C, j = S(C, E), $ = te(j, 2), I = $[1], B = T(E), R = te(B, 2), D = R[0], N = R[1];
      return [D, I, N];
    };
  }
  function l(d, f, b) {
    var m = b.unitless, g = b.injectStyle, p = g === void 0 ? !0 : g, v = b.prefixToken, x = b.ignore, y = function(T) {
      var C = T.rootCls, E = T.cssVar, j = E === void 0 ? {} : E, $ = o(), I = $.realToken;
      return nr({
        path: [d],
        prefix: j.prefix,
        key: j.key,
      ...
      var C = o(), E = C.cssVar;
      return [function(j) {
        return p && E ? /* @__PURE__ */ w.createElement(w.Fragment, null, /* @__PURE__ */ w.createElement(y, {
          rootCls: T,
          cssVar: E,
          component: d
        }), j) : j;
  ...
  function h(d, f, b) {
    var m = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, g = Array.isArray(d) ? d : [d, d], p = te(g, 1), v = p[0], x = g.join("-"), y = t.layer || {
      name: "antd"
    };
    return function(O) {
      var S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : O, T = o(), C = T.theme, E = T.realToken, j = T.hashId, $ = T.token, I = T.cssVar, B = r(), R = B.rootPrefixCls, D = B.iconPrefixCls, N = n(), P = I ? "css" : "js", Ht = On(function() {
        var X = /* @__PURE__ */ new Set();
        return I && Object.keys(m.unitless || {}).forEach(function(Q) {
          X.add(be(Q, I.prefix)), X.add(be(Q, ut(v, I.prefix)));
        }), vn(P, X);
      }, [P, v, I == null ? void 0 : I.prefix]), ze = _n(P), zt = ze.max, $t = ze.min, $e = {
        theme: C,
        token: $,
        hashId: j,
        nonce: function() {
      ...
      var Bt = We(L(L({}, $e), {}, {
        ...
        if (m.injectStyle === !1)
          return [];
        var X = xn($), Q = X.token, Ft = X.flush, U = dt(v, E, b), Vt = ".".concat(O), Be = ft(v, E, U, {
          deprecatedTokens: m.deprecatedTokens
        });
        I && U && z(U) === "object" && Object.keys(U).forEach(function(Ve) {
          U[Ve] = "var(".concat(be(Ve, ut(v, I.prefix)), ")");
        });
        var Fe = He(Q, {
          componentCls: Vt,
          prefixCls: O,
        ...
        Ft(v, Be);
        var Nt = typeof i == "function" ? i(Fe, O, S, m.resetFont) : null;
...
const Pn = {
  ...
  gold: "#FAAD14",
  lime: "#A0D911"
}, En = Object.assign(Object.assign({}, Pn), {
  // Color
  colorPrimary: "#1677ff",
  colorSuccess: "#52c41a",
  colorWarning: "#faad14",
...
const jn = {
  ...
  return i = kn(i), s && Object.entries(s).forEach(([a, c]) => {
    const {
      theme: l,
      ...h
    } = c;
...
function Dn() {
  const {
    ...
    override: o,
    cssVar: r
  } = w.useContext(Te._internalContext), [s, i, a] = sr(n, [Te.defaultSeed, t], {
    salt: `${qr}-${e || ""}`,
    override: o,
    getComputedToken: At,
    cssVar: r && {
...
function Fn(t, e, n, o, r) {
  const [s, i] = w.useState([]), a = (f, b = s) => {
    ...
    const b = s.length || 1, m = a(b), g = m.findIndex((x) => x.value === s[b - 1]), p = m.length, v = m[(g + f + p) % p];
...
function Vn(t) {
  const {
    ...
    direction: u,
    getPrefixCls: d
  } = Ie(), f = d("suggestion", e), b = `${f}-item`, m = u === "rtl", g = Zr("suggestion"), [p, v, x] = Bn(f), [y, O] = sn(!1, {
    value: i
  }), [S, T] = Le(), C = (P) => {
    O(P), a == null || a(P);
  }, E = re((P) => {
    ...
    C(!1);
  }, $ = w.useMemo(() => typeof c == "function" ? c(S) : c, [c, S]), I = (P) => /* @__PURE__ */ w.createElement(rr, {
    className: b
    ...
    l && l(P[P.length - 1]), C(!1);
  }, [R, D] = Fn($, y, m, B, j), N = s == null ? void 0 : s({
    onTrigger: E,
    onKeyDown: D
  });
  return p(/* @__PURE__ */ w.createElement(tr, {
    options: $,
    open: y,
    value: R,
    ...
    optionRender: I,
    rootClassName: Xe(o, f, v, x, {
      [`${f}-block`]: h
    }),
    onChange: B,
    dropdownMatchSelectWidth: h
  }, /* @__PURE__ */ w.createElement("div", {
    className: Xe(f, g.className, o, n, `${f}-wrapper`, v, x),
    style: {
      ...g.style,
      ...r
    }
...
function Un(t) {
  const e = yt();
  return q(() => yr(t, e.current) ? e.current : (e.current = t, t), [t]);
}
function Wn(t, e) {
  return e((o, r) => St(o) ? r ? (...s) => o(...s, ...t) : o(...t) : o);
}
const Gn = ({
  children: t,
  ...e
  ...
  if (o.length !== 0)
    return o.map((r, s) => {
      ...
      Object.keys(r.slots).forEach((h) => {
        ...
        const u = h.split(".");
        u.forEach((p, v) => {
          a[p] || (a[p] = {}), v !== u.length - 1 && (a = i[p]);
        });
        const d = r.slots[h];
        let f, b, m = (e == null ? void 0 : e.clone) ?? !1, g = e == null ? void 0 : e.forceClone;
        d instanceof Element ? f = d : (f = d.el, b = d.callback, m = d.clone ?? m, g = d.forceClone ?? g), g = g ?? !!b, a[u[u.length - 1]] = f ? b ? (...p) => (b(u[u.length - 1], p), /* @__PURE__ */ A.jsx(Ne, {
          ...r.ctx,
          params: p,
          forceClone: g,
      ...
      return r[c] ? i[c] = Dt(r[c], e, `${s}`) : e != null && e.children && (i[c] = void 0, Reflect.deleteProperty(i, c)), i;
    });
}
const {
  useItems: qn,
  withItemsContextProvider: Qn,
  ItemHandler: eo
} = Yt("antdx-suggestion-chain-items"), Jn = bt(({
  children: t,
  props: e,
  shouldTrigger: n
}, o) => {
  const r = Un(e);
  return /* @__PURE__ */ A.jsx(Zt.Provider, {
    value: q(() => ({
      ...r,
      onKeyDown: (s) => {
        var i;
  ...
  const [s, i] = Le(() => r.open ?? !1), {
    items: a
  } = qn(), c = a.items.length > 0 ? a.items : a.default, l = mt(e), h = mt(n), u = q(() => e || Dt(c, {
    clone: !0
  }) || [{}], [e, c]), d = q(() => (...f) => u.map((b) => Wn(f, (m) => {
    const g = (p) => {
      var v;
      return {
        ...p,
  ...
  return vt(() => {
    ...
    children: /* @__PURE__ */ A.jsx(Vn, {
      ...r,
      items: l || d,
      onOpenChange: (f, ...b) => {
        var m;
        qe(r.open) && i(f), (m = r.onOpenChange) == null || m.call(r, f, ...b);
      },
      children: (f) => /* @__PURE__ */ A.jsx(Jt.Provider, {
        value: s,
        children: /* @__PURE__ */ A.jsxs(Jn, {
          props: f,
          shouldTrigger: h,
