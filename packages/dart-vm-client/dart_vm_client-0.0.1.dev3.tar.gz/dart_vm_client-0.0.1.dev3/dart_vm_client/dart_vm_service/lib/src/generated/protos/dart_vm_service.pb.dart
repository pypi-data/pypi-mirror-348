...
/// Request to get screen items with optional depth
class ScreenItemsRequest extends $pb.GeneratedMessage {
  factory ScreenItemsRequest({
    $core.int? maxDepth,
  }) {
    final $result = create();
    if (maxDepth != null) {
  ...
  ScreenItemsRequest._() : super();
  factory ScreenItemsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ScreenItemsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScreenItemsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'dart_vm_service'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'maxDepth', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ScreenItemsRequest clone() => ScreenItemsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ScreenItemsRequest copyWith(void Function(ScreenItemsRequest) updates) => super.copyWith((message) => updates(message as ScreenItemsRequest)) as ScreenItemsRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ScreenItemsRequest create() => ScreenItemsRequest._();
  ScreenItemsRequest createEmptyInstance() => create();
  static $pb.PbList<ScreenItemsRequest> createRepeated() => $pb.PbList<ScreenItemsRequest>();
  @$core.pragma('dart2js:noInline')
  static ScreenItemsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScreenItemsRequest>(create);
  static ScreenItemsRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get maxDepth => $_getIZ(0);
  @$pb.TagNumber(1)
  set maxDepth($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxDepth() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxDepth() => $_clearField(1);
}
