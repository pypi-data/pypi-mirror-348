...
@$core.Deprecated('Use enterTextKeyRequestDescriptor instead')
const EnterTextKeyRequest$json = {
  '1': 'EnterTextKeyRequest',
  '2': [
    {'1': 'key_value', '3': 1, '4': 1, '5': 9, '10': 'keyValue'},
    {'1': 'text', '3': 2, '4': 1, '5': 9, '10': 'text'},
  ],
...
/// Descriptor for `EnterTextKeyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enterTextKeyRequestDescriptor = $convert.base64Decode(
    'ChNFbnRlclRleHRLZXlSZXF1ZXN0EhsKCWtleV92YWx1ZRgBIAEoCVIIa2V5VmFsdWUSEgoEdG'
    'V4dBgCIAEoCVIEdGV4dA==');

@$core.Deprecated('Use enterTextTypeRequestDescriptor instead')
const EnterTextTypeRequest$json = {
  '1': 'EnterTextTypeRequest',
  '2': [
    {'1': 'widget_type', '3': 1, '4': 1, '5': 9, '10': 'widgetType'},
    {'1': 'text', '3': 2, '4': 1, '5': 9, '10': 'text'},
  ],
};

/// Descriptor for `EnterTextTypeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enterTextTypeRequestDescriptor = $convert.base64Decode(
    'ChRFbnRlclRleHRUeXBlUmVxdWVzdBIfCgt3aWRnZXRfdHlwZRgBIAEoCVIKd2lkZ2V0VHlwZR'
    'ISCgR0ZXh0GAIgASgJUgR0ZXh0');

@$core.Deprecated('Use enterTextTextRequestDescriptor instead')
const EnterTextTextRequest$json = {
  '1': 'EnterTextTextRequest',
  '2': [
    {'1': 'widget_text', '3': 1, '4': 1, '5': 9, '10': 'widgetText'},
    {'1': 'text', '3': 2, '4': 1, '5': 9, '10': 'text'},
  ],
};

/// Descriptor for `EnterTextTextRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enterTextTextRequestDescriptor = $convert.base64Decode(
    'ChRFbnRlclRleHRUZXh0UmVxdWVzdBIfCgt3aWRnZXRfdGV4dBgBIAEoCVIKd2lkZ2V0VGV4dB'
    'ISCgR0ZXh0GAIgASgJUgR0ZXh0');

@$core.Deprecated('Use enterTextTooltipRequestDescriptor instead')
const EnterTextTooltipRequest$json = {
  '1': 'EnterTextTooltipRequest',
  '2': [
    {'1': 'tooltip', '3': 1, '4': 1, '5': 9, '10': 'tooltip'},
    {'1': 'text', '3': 2, '4': 1, '5': 9, '10': 'text'},
  ],
};

/// Descriptor for `EnterTextTooltipRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enterTextTooltipRequestDescriptor = $convert.base64Decode(
    'ChdFbnRlclRleHRUb29sdGlwUmVxdWVzdBIYCgd0b29sdGlwGAEgASgJUgd0b29sdGlwEhIKBH'
    'RleHQYAiABKAlSBHRleHQ=');

@$core.Deprecated('Use enterTextAncestorDescendantRequestDescriptor instead')
const EnterTextAncestorDescendantRequest$json = {
  '1': 'EnterTextAncestorDescendantRequest',
  '2': [
    {'1': 'ancestor_type', '3': 1, '4': 1, '5': 9, '10': 'ancestorType'},
    {'1': 'descendant_type', '3': 2, '4': 1, '5': 9, '10': 'descendantType'},
...
/// Descriptor for `EnterTextAncestorDescendantRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enterTextAncestorDescendantRequestDescriptor = $convert.base64Decode(
    'CiJFbnRlclRleHRBbmNlc3RvckRlc2NlbmRhbnRSZXF1ZXN0EiMKDWFuY2VzdG9yX3R5cGUYAS'
    'ABKAlSDGFuY2VzdG9yVHlwZRInCg9kZXNjZW5kYW50X3R5cGUYAiABKAlSDmRlc2NlbmRhbnRU'
    'eXBlEhIKBHRleHQYAyABKAlSBHRleHQ=');

@$core.Deprecated('Use scrollKeyRequestDescriptor instead')
const ScrollKeyRequest$json = {
  '1': 'ScrollKeyRequest',
  '2': [
    {'1': 'key_value', '3': 1, '4': 1, '5': 9, '10': 'keyValue'},
    {'1': 'dx', '3': 2, '4': 1, '5': 1, '10': 'dx'},
    {'1': 'dy', '3': 3, '4': 1, '5': 1, '10': 'dy'},
    {'1': 'duration_microseconds', '3': 4, '4': 1, '5': 3, '10': 'durationMicroseconds'},
    {'1': 'frequency', '3': 5, '4': 1, '5': 5, '10': 'frequency'},
  ],
};

/// Descriptor for `ScrollKeyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollKeyRequestDescriptor = $convert.base64Decode(
    'ChBTY3JvbGxLZXlSZXF1ZXN0EhsKCWtleV92YWx1ZRgBIAEoCVIIa2V5VmFsdWUSDgoCZHgYAi'
    'ABKAFSAmR4Eg4KAmR5GAMgASgBUgJkeRIzChVkdXJhdGlvbl9taWNyb3NlY29uZHMYBCABKANS'
    'FGR1cmF0aW9uTWljcm9zZWNvbmRzEhwKCWZyZXF1ZW5jeRgFIAEoBVIJZnJlcXVlbmN5');

@$core.Deprecated('Use scrollTypeRequestDescriptor instead')
const ScrollTypeRequest$json = {
  '1': 'ScrollTypeRequest',
  '2': [
    {'1': 'widget_type', '3': 1, '4': 1, '5': 9, '10': 'widgetType'},
    {'1': 'dx', '3': 2, '4': 1, '5': 1, '10': 'dx'},
...
/// Descriptor for `ScrollTypeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollTypeRequestDescriptor = $convert.base64Decode(
    'ChFTY3JvbGxUeXBlUmVxdWVzdBIfCgt3aWRnZXRfdHlwZRgBIAEoCVIKd2lkZ2V0VHlwZRIOCg'
    'JkeBgCIAEoAVICZHgSDgoCZHkYAyABKAFSAmR5EjMKFWR1cmF0aW9uX21pY3Jvc2Vjb25kcxgE'
    'IAEoA1IUZHVyYXRpb25NaWNyb3NlY29uZHMSHAoJZnJlcXVlbmN5GAUgASgFUglmcmVxdWVuY3'
    'k=');

@$core.Deprecated('Use scrollTextRequestDescriptor instead')
const ScrollTextRequest$json = {
  '1': 'ScrollTextRequest',
  '2': [
...
/// Descriptor for `ScrollTextRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollTextRequestDescriptor = $convert.base64Decode(
    'ChFTY3JvbGxUZXh0UmVxdWVzdBISCgR0ZXh0GAEgASgJUgR0ZXh0Eg4KAmR4GAIgASgBUgJkeB'
    'IOCgJkeRgDIAEoAVICZHkSMwoVZHVyYXRpb25fbWljcm9zZWNvbmRzGAQgASgDUhRkdXJhdGlv'
    'bk1pY3Jvc2Vjb25kcxIcCglmcmVxdWVuY3kYBSABKAVSCWZyZXF1ZW5jeQ==');

@$core.Deprecated('Use scrollTooltipRequestDescriptor instead')
const ScrollTooltipRequest$json = {
  '1': 'ScrollTooltipRequest',
  '2': [
    {'1': 'tooltip', '3': 1, '4': 1, '5': 9, '10': 'tooltip'},
    {'1': 'dx', '3': 2, '4': 1, '5': 1, '10': 'dx'},
    {'1': 'dy', '3': 3, '4': 1, '5': 1, '10': 'dy'},
...
/// Descriptor for `ScrollTooltipRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollTooltipRequestDescriptor = $convert.base64Decode(
    'ChRTY3JvbGxUb29sdGlwUmVxdWVzdBIYCgd0b29sdGlwGAEgASgJUgd0b29sdGlwEg4KAmR4GA'
    'IgASgBUgJkeBIOCgJkeRgDIAEoAVICZHkSMwoVZHVyYXRpb25fbWljcm9zZWNvbmRzGAQgASgD'
    'UhRkdXJhdGlvbk1pY3Jvc2Vjb25kcxIcCglmcmVxdWVuY3kYBSABKAVSCWZyZXF1ZW5jeQ==');

@$core.Deprecated('Use scrollAncestorDescendantRequestDescriptor instead')
const ScrollAncestorDescendantRequest$json = {
  '1': 'ScrollAncestorDescendantRequest',
  '2': [
    {'1': 'ancestor_type', '3': 1, '4': 1, '5': 9, '10': 'ancestorType'},
    {'1': 'descendant_type', '3': 2, '4': 1, '5': 9, '10': 'descendantType'},
    {'1': 'dx', '3': 3, '4': 1, '5': 1, '10': 'dx'},
    {'1': 'dy', '3': 4, '4': 1, '5': 1, '10': 'dy'},
    {'1': 'duration_microseconds', '3': 5, '4': 1, '5': 3, '10': 'durationMicroseconds'},
    {'1': 'frequency', '3': 6, '4': 1, '5': 5, '10': 'frequency'},
  ],
};

/// Descriptor for `ScrollAncestorDescendantRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollAncestorDescendantRequestDescriptor = $convert.base64Decode(
    'Ch9TY3JvbGxBbmNlc3RvckRlc2NlbmRhbnRSZXF1ZXN0EiMKDWFuY2VzdG9yX3R5cGUYASABKA'
    'lSDGFuY2VzdG9yVHlwZRInCg9kZXNjZW5kYW50X3R5cGUYAiABKAlSDmRlc2NlbmRhbnRUeXBl'
    'Eg4KAmR4GAMgASgBUgJkeBIOCgJkeRgEIAEoAVICZHkSMwoVZHVyYXRpb25fbWljcm9zZWNvbm'
    'RzGAUgASgDUhRkdXJhdGlvbk1pY3Jvc2Vjb25kcxIcCglmcmVxdWVuY3kYBiABKAVSCWZyZXF1'
    'ZW5jeQ==');

@$core.Deprecated('Use scrollIntoViewKeyRequestDescriptor instead')
const ScrollIntoViewKeyRequest$json = {
  '1': 'ScrollIntoViewKeyRequest',
  '2': [
    {'1': 'key_value', '3': 1, '4': 1, '5': 9, '10': 'keyValue'},
    {'1': 'alignment', '3': 2, '4': 1, '5': 1, '10': 'alignment'},
  ],
};

/// Descriptor for `ScrollIntoViewKeyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollIntoViewKeyRequestDescriptor = $convert.base64Decode(
    'ChhTY3JvbGxJbnRvVmlld0tleVJlcXVlc3QSGwoJa2V5X3ZhbHVlGAEgASgJUghrZXlWYWx1ZR'
    'IcCglhbGlnbm1lbnQYAiABKAFSCWFsaWdubWVudA==');

@$core.Deprecated('Use scrollIntoViewTypeRequestDescriptor instead')
const ScrollIntoViewTypeRequest$json = {
  '1': 'ScrollIntoViewTypeRequest',
  '2': [
    {'1': 'widget_type', '3': 1, '4': 1, '5': 9, '10': 'widgetType'},
    {'1': 'alignment', '3': 2, '4': 1, '5': 1, '10': 'alignment'},
  ],
...
/// Descriptor for `ScrollIntoViewTypeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollIntoViewTypeRequestDescriptor = $convert.base64Decode(
    'ChlTY3JvbGxJbnRvVmlld1R5cGVSZXF1ZXN0Eh8KC3dpZGdldF90eXBlGAEgASgJUgp3aWRnZX'
    'RUeXBlEhwKCWFsaWdubWVudBgCIAEoAVIJYWxpZ25tZW50');

@$core.Deprecated('Use scrollIntoViewTextRequestDescriptor instead')
const ScrollIntoViewTextRequest$json = {
  '1': 'ScrollIntoViewTextRequest',
  '2': [
    {'1': 'text', '3': 1, '4': 1, '5': 9, '10': 'text'},
    {'1': 'alignment', '3': 2, '4': 1, '5': 1, '10': 'alignment'},
  ],
...
/// Descriptor for `ScrollIntoViewTextRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollIntoViewTextRequestDescriptor = $convert.base64Decode(
    'ChlTY3JvbGxJbnRvVmlld1RleHRSZXF1ZXN0EhIKBHRleHQYASABKAlSBHRleHQSHAoJYWxpZ2'
    '5tZW50GAIgASgBUglhbGlnbm1lbnQ=');

@$core.Deprecated('Use scrollIntoViewTooltipRequestDescriptor instead')
const ScrollIntoViewTooltipRequest$json = {
  '1': 'ScrollIntoViewTooltipRequest',
  '2': [
    {'1': 'tooltip', '3': 1, '4': 1, '5': 9, '10': 'tooltip'},
    {'1': 'alignment', '3': 2, '4': 1, '5': 1, '10': 'alignment'},
  ],
...
/// Descriptor for `ScrollIntoViewTooltipRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollIntoViewTooltipRequestDescriptor = $convert.base64Decode(
    'ChxTY3JvbGxJbnRvVmlld1Rvb2x0aXBSZXF1ZXN0EhgKB3Rvb2x0aXAYASABKAlSB3Rvb2x0aX'
    'ASHAoJYWxpZ25tZW50GAIgASgBUglhbGlnbm1lbnQ=');

@$core.Deprecated('Use scrollIntoViewAncestorDescendantRequestDescriptor instead')
const ScrollIntoViewAncestorDescendantRequest$json = {
  '1': 'ScrollIntoViewAncestorDescendantRequest',
  '2': [
    {'1': 'ancestor_type', '3': 1, '4': 1, '5': 9, '10': 'ancestorType'},
    {'1': 'descendant_type', '3': 2, '4': 1, '5': 9, '10': 'descendantType'},
    {'1': 'alignment', '3': 3, '4': 1, '5': 1, '10': 'alignment'},
  ],
};

/// Descriptor for `ScrollIntoViewAncestorDescendantRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scrollIntoViewAncestorDescendantRequestDescriptor = $convert.base64Decode(
    'CidTY3JvbGxJbnRvVmlld0FuY2VzdG9yRGVzY2VuZGFudFJlcXVlc3QSIwoNYW5jZXN0b3JfdH'
    'lwZRgBIAEoCVIMYW5jZXN0b3JUeXBlEicKD2Rlc2NlbmRhbnRfdHlwZRgCIAEoCVIOZGVzY2Vu'
    'ZGFudFR5cGUSHAoJYWxpZ25tZW50GAMgASgBUglhbGlnbm1lbnQ=');
