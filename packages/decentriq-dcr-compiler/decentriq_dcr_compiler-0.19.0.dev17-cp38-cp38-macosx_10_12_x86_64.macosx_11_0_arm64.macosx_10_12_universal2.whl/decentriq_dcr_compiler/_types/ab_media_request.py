...
class AbMediaCompute9(TypedDict):
    v2: AbMediaComputeV2


class AbMediaCompute10(TypedDict):
    v3: AbMediaComputeV3
...
AbMediaCompute6 = Union[
    AbMediaCompute, AbMediaCompute8, AbMediaCompute9, AbMediaCompute10, AbMediaCompute11
]


AbMediaComputeOrUnknown = Optional[AbMediaCompute6]
