...
class DataLabCompute10(
    RootModel[Union[DataLabCompute, DataLabCompute12, DataLabCompute13]]
):
    root: Union[DataLabCompute, DataLabCompute12, DataLabCompute13]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute10]]):
    root: Optional[DataLabCompute10]
...
class DataScienceDataRoomV12(DataScienceDataRoomV01):
    pass
...
class DataScienceDataRoomV13(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV1(
    RootModel[Union[DataScienceDataRoomV12, DataScienceDataRoomV13]]
):
    root: Union[DataScienceDataRoomV12, DataScienceDataRoomV13]
