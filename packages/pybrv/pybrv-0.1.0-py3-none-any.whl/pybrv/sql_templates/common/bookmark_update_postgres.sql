...
UPDATE com_data_validator.etl_meta.vf_metadata AS target
SET
...
INSERT INTO com_data_validator.etl_meta.vf_metadata (
...
FROM source
WHERE NOT EXISTS (
    SELECT 1 FROM com_data_validator.ETL_META.VF_METADATA 
    WHERE com_data_validator.ETL_META.VF_METADATA.UNIQUE_RULE_IDENTIFIER = source.UNIQUE_RULE_IDENTIFIER
);
