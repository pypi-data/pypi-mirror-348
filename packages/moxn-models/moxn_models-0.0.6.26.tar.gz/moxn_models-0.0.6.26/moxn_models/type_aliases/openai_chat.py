...
if TYPE_CHECKING:
    ...
    OpenAIChatFile = Any
    OpenAIChatFileFile = Any
    OpenAIChatToolUseBlockParam = Any
    OpenAIChatToolResponseParam = Any
    OpenAIChatCompletionContentPartTextParam = Any
    OpenAIChatFunction = Any
    OpenAIChatAssistantMessageParam = Any
    OpenAIChatDeveloperMessageParam = Any
    OpenAIChatSystemMessageParam = Any
    OpenAIChatUserMessageParam = Any
