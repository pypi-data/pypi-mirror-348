...
parameters["acquisition_orientation"]= 'right' # Value of the rotation of the microscope between stacks , left means +90 , right -90
```
...
The parameter find can be found [here](https://drive.google.com/file/d/1mwNXfdzhFBawC7C8o9qVmAI0PtiHxHf-/view?usp=sharing)
