...
class ProcessManager:
    ...
    def register(self, name: str, engine: BaseEngine) -> BaseEngine:
        ...
        self.logger.INFO(f"Engine '{name}' registered")
        return engine
    ...
    def unregister(self, name: str) -> bool:
        ...
        if name in self.engines:
            ...
            self.logger.INFO(f"Engine '{name}' unregistered")
            return True
        return False
    ...
    def start(self, name: str) -> bool:
        ...
        try:
            ...
            self.logger.ERROR(f"Error starting engine '{name}': {e}")
            return False
    ...
    def stop(self, name: str) -> bool:
        ...
        try:
            ...
            self.logger.ERROR(f"Error stopping engine '{name}': {e}")
            return False
    ...
    def start_component(self, engine_name: str, component_id: str) -> bool:
        ...
        if engine_name not in self.engines:
            self.logger.WARNING(f"Engine '{engine_name}' not found")
            return False
