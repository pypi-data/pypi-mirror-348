...
class GoogleCalendar(GoogleInterface):
    ...
    def calendar_list_events(self, event_count: int = 10, start_date_time: dt.datetime = None, end_date_time: dt.datetime = None) -> list[any]:
        ...
        """
        self.log_newline()
        self.log(f'Getting up to {event_count} events...')
        self.log(
        ...
        for event in events:
            ...
            self.log(f'{start_fmt}: {event.get("summary", "No title")}')
        self.log('}')
    ...
    def calendar_create_event(self, summary: str, start_date_time: dt.datetime, end_date_time: dt.datetime, **keyargs) -> None:
        ...
        """
        self.log_newline()
        self.log(f'Creating event: {summary}')
        ...
        self.log(f'Event created: {event.get("htmlLink")}')