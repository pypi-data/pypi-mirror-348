...
from zapp.features.core.settings import PROJECT_KEY, ENV
from zapp.features.core.tms import (
    TIME_ZONE,
    DATE_FORMAT,
    ZEPHYR_TEST_RUN,
    JIRA_TOKEN,
...
from zapp.features.core.tms.allure_integration import (
    AllureTag,
    get_tms_key,
    get_issue_links,
)
from zapp.features.core.tms.zephyr_ext import ZephyrFrontApi
...
class ZephyrSync:
    ...
    def __write_screenshot_to_file(browser):
        scr_bytes = browser.screenshot()
        file_name = f"screenshot-{str(uuid.UUID())}.png"
        bytes_to_file(scr_bytes, file_name)
        return file_name
