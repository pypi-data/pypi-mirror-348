...
class StepAdjustment(Boto3Model):
    ...
    * The upper and lower bound can't be null in the same step adjustment."""
    ...
    If the metric value is above the breach threshold, the lower bound is inclusive (the metric must be greater than or
    equal to the threshold plus the lower bound). Otherwise, it's exclusive (the metric must be greater than the
    threshold plus the lower bound). A null value indicates negative infinity.
    """
    MetricIntervalUpperBound: Optional[float] = None
    """
    The upper bound for the difference between the alarm threshold and the CloudWatch metric.

    If the metric value is above the breach threshold, the upper bound is exclusive (the metric must be less than the
    threshold plus the upper bound). Otherwise, it's inclusive (the metric must be less than or equal to the threshold
    ...
    A positive value adds to the current capacity while a negative number removes from the current capacity. For exact
    capacity, you must specify a non-negative value.
    """
...
class ApplicationAutoscalingStepScalingPolicyConfiguration(Boto3Model):
    ...
    AdjustmentType: Optional[
        Literal["ChangeInCapacity", "PercentChangeInCapacity", "ExactCapacity"]
    ] = None
    """
...
``ExactCapacity``, and ``PercentChangeInCapacity``.
    ...
    """
    MetricAggregationType: Optional[Literal["Average", "Minimum", "Maximum"]] = None
    """
...
class TargetTrackingMetric(Boto3Model):
    ...
    For the list of available dimensions, see the Amazon Web Services documentation available from the table in
...
class TargetTrackingMetricStat(Boto3Model):
    ...
    It can include any CloudWatch statistic or extended statistic. For a list of valid values, see the table in
...
class ApplicationAutoscalingCustomizedMetricSpecification(Boto3Model):
    ...
    * Choose a metric that changes proportionally with capacity. The value of the metric should increase or decrease in
    ...
    """
    Statistic: Optional[
        Literal["Average", "Minimum", "Maximum", "SampleCount", "Sum"]
    ] = None
    """
...
class ApplicationAutoscalingTargetTrackingScalingPolicyConfiguration(Boto3Model):
    ...
    Although this property accepts numbers of type Double, it won't accept values that are either too small or too
    large. Values must be in the range of -2^360 to 2^360. The value must be a valid number based on the choice of
    metric. For example, if the metric is CPU utilization, then the target value is a percent value that represents how
...
class PredictiveScalingMetricDataQuery(Boto3Model):
    ...
    Also defines whether this call is returning data for one metric only, or whether it is performing a math expression
    on the values of returned metric statistics to create a new time series. A time series is a series of data points,
...
class PredictiveScalingMetricSpecification(Boto3Model):
    ...
    instead of individual metrics provides a simpler way to configure metrics for a scaling policy. You choose the
    metric pair, and the policy automatically knows the correct sum and average statistics to use for the load metric
    and the scaling metric.
    """
...
class ApplicationAutoscalingPredictiveScalingPolicyConfiguration(Boto3Model):
    ...
    """
    Mode: Optional[Literal["ForecastOnly", "ForecastAndScale"]] = None
    """
...
class ScalingPolicy(PrimaryBoto3Model):
    ...
    """
    PredictiveScalingPolicyConfiguration: Optional[
        ApplicationAutoscalingPredictiveScalingPolicyConfiguration
    ] = None
    """
    ...
    def arn(self) -> Optional[str]:
        """
        Return the ARN of the model.   This is the value of the :py:attr:`PolicyARN` attribute.
    ...
    def name(self) -> Optional[str]:
        """
        Return the name of the model.   This is the value of the :py:attr:`PolicyName` attribute.
    ...
    def scalable_target(self) -> Optional["ScalableTarget"]:
        """
        Return the :py:class:`ScalableTarget` object that this scaling policy applies to.
...
class ScalableTarget(ScalableTargetModelMixin, PrimaryBoto3Model):
    ...
    """
    SuspendedState: Optional[ApplicationAutoscalingSuspendedState] = None
    """
    Specifies whether the scaling activities for a scalable target are in a suspended state.
    """
    ...
    def arn(self) -> Optional[str]:
        """
        Return the ARN of the model.   This is the value of the :py:attr:`ScalableTargetARN` attribute.
    ...
    def name(self) -> Optional[str]:
        """
        Return the name of the model.   This is the value of the :py:attr:`ResourceId` attribute.
...
class ScheduledAction(PrimaryBoto3Model):
    ...
    """
    The time zone used when referring to the date and time of a scheduled action, when the scheduled action uses an at
    or cron expression.
    """
    ResourceId: str
    """
    ...
    """
    ScalableTargetAction: Optional[ApplicationAutoscalingScalableTargetAction] = None
    """
    The new minimum and maximum capacity.

    You can set both values or just one. At the scheduled time, if the current capacity is below the minimum capacity,
    Application Auto Scaling scales out to the minimum capacity. If the current capacity is above the maximum capacity,
    ...
    def arn(self) -> Optional[str]:
        """
        Return the ARN of the model.   This is the value of the :py:attr:`ScheduledActionARN` attribute.
    ...
    def name(self) -> Optional[str]:
        """
        Return the name of the model.   This is the value of the :py:attr:`ScheduledActionName` attribute.
...
class DescribeScalableTargetsResponse(Boto3Model):
    ScalableTargets: Optional[List["ScalableTarget"]] = None
    """
...
class DescribeScheduledActionsResponse(Boto3Model):
    ScheduledActions: Optional[List["ScheduledAction"]] = None
    """
