...
class BaseCollectionRepository(Generic[T]):
    ...
    async def delete_field(self, column_name: str, collection_name: Optional[str] ,protected_fields:List[str]=None) -> bool:
        """
        ...
        try:
            ...
            for index_name, index_info in indexes.items():
                indexed_fields = [field for field, _ in index_info["key"]]
                if column_name in indexed_fields and index_name != "_id_":
