...
class BaseRepository:
    ...
    async def create(self, obj: T, collection_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return await self.get_by_attr("_id", model._id)
    ...
    async def update(self, _id: Union[str, ObjectId], obj: T, collection_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if collection_name:
                ...
                if result.matched_count == 0:
                    raise NotFoundError(detail=f"Document with id {_id} not found")
    ...
    async def delete(self, _id: Union[str, ObjectId], collection_name: Optional[str] = None) -> bool:
