...
MONGO_URI = "MONGO_URI=mongodb+srv://gayatri:12211312@energydb.et7jn.mongodb.net/?retryWrites=true&w=majority&appName=energydb"
...
class EnergyMonitor:
    ...
    def stop(self):
        ...
        if self.user_id:
            ...
            # Filter keys that start with 'run'
            run_keys = [key for key in project_data.keys() if key.startswith("run")]
            new_run_key = f"run{len(run_keys) + 1}"
