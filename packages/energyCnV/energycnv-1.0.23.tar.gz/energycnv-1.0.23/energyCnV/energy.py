...
class EnergyMonitor:
    ...
    def stop(self):
        ...
        if self.user_id:
            ...
            # Get projects dictionary from user
            projects = user_data.get("projects", {})

            # Normalize project name (remove leading/trailing spaces)
            normalized_project_name = self.project_name.strip()

            # Debug: Show all existing project keys
            ...
            # Debug: Show existing project data
