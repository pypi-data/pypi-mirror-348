...
**Application Configurstion and Setup Utilities**
...
The package ``ka_uts_cfg`` can be installed from PyPI or Anaconda.

To install with ``pip``:

.. code-block:: shell

	$ python -m pip install ka_uts_cfg

To install with ``conda``:

.. code-block:: shell

	$ conda install -c conda-forge ka_uts_cfg
...
The Package ``ka_uts_cfg`` consist of the following file types (c.f.: **Appendix**):
...
The Package ``ka_uts_cfg`` contains the following Control modules.

  .. ka_uts_cfg-Control-Modules-label:
  .. table:: *ka_uts_cfg Control Modules*
...
The Package ``ka_uts_cfg`` contains the following Application modules.

  .. ka_uts_cfg-Application-Modules-label:
  .. table:: *ka_uts_cfg Application Modules*
