...
class GreenTensorReal:
    ...
    @overload
    def set_entries(self, arg0: int, arg1: int, arg2: Annotated[ArrayLike, dict(dtype='float64', shape=(None, None), order='F')], /) -> None: ...

    @overload
    def set_entries(self, arg0: int, arg1: int, arg2: Sequence[Annotated[ArrayLike, dict(dtype='float64', shape=(None, None), order='F')]], arg3: Sequence[float], /) -> None: ...

    def get_entries(self, arg0: int, arg1: int, /) -> list[Union[ConstantEntryReal, OmegaDependentEntryReal]]: ...
...
class GreenTensorComplex:
    ...
    @overload
    def set_entries(self, arg0: int, arg1: int, arg2: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None), order='F')], /) -> None: ...

    @overload
    def set_entries(self, arg0: int, arg1: int, arg2: Sequence[Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None), order='F')]], arg3: Sequence[float], /) -> None: ...

    def get_entries(self, arg0: int, arg1: int, /) -> list[Union[ConstantEntryComplex, OmegaDependentEntryComplex]]: ...
