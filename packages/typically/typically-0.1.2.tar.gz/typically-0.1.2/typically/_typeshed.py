"""
Some types copied from `_typeshed`, as it's normally only usable by type checkers.
See `_typeshed` module for more info.
"""
...
class structseq(Generic[_T_co]):
    n_fields: Final[int] # type: ignore
    n_unnamed_fields: Final[int] # type: ignore
    n_sequence_fields: Final[int] # type: ignore
...
AnyOrLiteralStr = TypeVar(
    "AnyOrLiteralStr", str, bytes, LiteralString
)  # noqa: Y001
...
TraceFunction: TypeAlias = Callable[
    [FrameType, str, Any], "TraceFunction | None"
]
