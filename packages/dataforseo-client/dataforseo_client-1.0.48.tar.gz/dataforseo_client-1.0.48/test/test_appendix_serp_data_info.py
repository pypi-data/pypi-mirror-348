...
class TestAppendixSerpDataInfo(unittest.TestCase):
    """AppendixSerpDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixSerpDataInfo:
        """Test AppendixSerpDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixSerpDataInfo`
        """
        model = AppendixSerpDataInfo()
        if include_optional:
            return AppendixSerpDataInfo(
                task_post = 1.337,
    ...
    def testAppendixSerpDataInfo(self):
        """Test AppendixSerpDataInfo"""
