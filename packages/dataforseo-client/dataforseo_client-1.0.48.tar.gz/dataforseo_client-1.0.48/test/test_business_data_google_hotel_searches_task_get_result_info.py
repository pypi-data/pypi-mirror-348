...
class TestBusinessDataGoogleHotelSearchesTaskGetResultInfo(unittest.TestCase):
    """BusinessDataGoogleHotelSearchesTaskGetResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessDataGoogleHotelSearchesTaskGetResultInfo:
        """Test BusinessDataGoogleHotelSearchesTaskGetResultInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessDataGoogleHotelSearchesTaskGetResultInfo`
        """
        model = BusinessDataGoogleHotelSearchesTaskGetResultInfo()
        if include_optional:
            return BusinessDataGoogleHotelSearchesTaskGetResultInfo(
                keyword = '',
                location_code = 56,
                language_code = '',
                check_url = '',
    ...
    def testBusinessDataGoogleHotelSearchesTaskGetResultInfo(self):
        """Test BusinessDataGoogleHotelSearchesTaskGetResultInfo"""
