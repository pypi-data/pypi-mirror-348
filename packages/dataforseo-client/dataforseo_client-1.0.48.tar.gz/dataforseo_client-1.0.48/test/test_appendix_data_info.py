        ...
        if include_optional:
            return AppendixDataInfo(
                ...
                reviews = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    ...
                    screenshot = 1.337, ),
                total_social = 1.337,
                social = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
                ...
                traffic_analytics = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
