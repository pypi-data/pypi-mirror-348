...
class TestAppendixSerpsRatesDataInfo(unittest.TestCase):
    """AppendixSerpsRatesDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixSerpsRatesDataInfo:
        """Test AppendixSerpsRatesDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixSerpsRatesDataInfo`
        """
        model = AppendixSerpsRatesDataInfo()
        if include_optional:
            return AppendixSerpsRatesDataInfo(
                task_post = 1.337,
    ...
    def testAppendixSerpsRatesDataInfo(self):
        """Test AppendixSerpsRatesDataInfo"""
