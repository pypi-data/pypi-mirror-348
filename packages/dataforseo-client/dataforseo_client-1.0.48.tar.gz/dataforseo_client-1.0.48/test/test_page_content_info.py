        ...
        if include_optional:
            return PageContentInfo(
                header = dataforseo_client.models.page_section_content_info.PageSectionContentInfo(
                    ...
                    table_content = [
                        dataforseo_client.models.table_content_info.TableContentInfo(
                            header = [
                ...
                ratings = [
                    dataforseo_client.models.content_rating_info.ContentRatingInfo(
                        name = '', 
                        rating_value = '', 
                        rating_count = '', 
                        max_rating_value = '', 
                ...
                offers = [
                    dataforseo_client.models.content_offer_info.ContentOfferInfo(
                        name = '', 
                        price = 1.337, 
                        price_currency = '', 
                        price_valid_until = '', )
                ...
                comments = [
                    dataforseo_client.models.content_comment_info.ContentCommentInfo(
                ...
                contacts = dataforseo_client.models.contacts.Contacts(
                    telephones = [
                        ''
                        ], )
            )
