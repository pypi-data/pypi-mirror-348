...
class TestAppendixAppendixPriceData(unittest.TestCase):
    """AppendixAppendixPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixAppendixPriceData:
        """Test AppendixAppendixPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixAppendixPriceData`
        """
        model = AppendixAppendixPriceData()
        if include_optional:
            return AppendixAppendixPriceData(
    ...
    def testAppendixAppendixPriceData(self):
        """Test AppendixAppendixPriceData"""
