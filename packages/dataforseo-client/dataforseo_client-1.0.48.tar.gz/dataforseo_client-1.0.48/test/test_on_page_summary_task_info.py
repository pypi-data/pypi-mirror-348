...
class TestOnPageSummaryTaskInfo(unittest.TestCase):
    """OnPageSummaryTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnPageSummaryTaskInfo:
        """Test OnPageSummaryTaskInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnPageSummaryTaskInfo`
        """
        model = OnPageSummaryTaskInfo()
        if include_optional:
            return OnPageSummaryTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.on_page_summary_result_info.OnPageSummaryResultInfo(
                        crawl_progress = '', 
    ...
    def testOnPageSummaryTaskInfo(self):
        """Test OnPageSummaryTaskInfo"""
