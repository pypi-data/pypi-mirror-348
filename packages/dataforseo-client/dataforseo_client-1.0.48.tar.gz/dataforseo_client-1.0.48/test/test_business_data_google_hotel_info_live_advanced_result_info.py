...
class TestBusinessDataGoogleHotelInfoLiveAdvancedResultInfo(unittest.TestCase):
    """BusinessDataGoogleHotelInfoLiveAdvancedResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessDataGoogleHotelInfoLiveAdvancedResultInfo:
        """Test BusinessDataGoogleHotelInfoLiveAdvancedResultInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessDataGoogleHotelInfoLiveAdvancedResultInfo`
        """
        model = BusinessDataGoogleHotelInfoLiveAdvancedResultInfo()
        if include_optional:
            return BusinessDataGoogleHotelInfoLiveAdvancedResultInfo(
                hotel_identifier = '',
                location_code = 56,
                language_code = '',
                check_url = '',
    ...
    def testBusinessDataGoogleHotelInfoLiveAdvancedResultInfo(self):
        """Test BusinessDataGoogleHotelInfoLiveAdvancedResultInfo"""
