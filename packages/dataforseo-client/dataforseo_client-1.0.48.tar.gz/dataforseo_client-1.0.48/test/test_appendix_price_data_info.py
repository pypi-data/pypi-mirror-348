...
class TestAppendixPriceDataInfo(unittest.TestCase):
    """AppendixPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixPriceDataInfo:
        """Test AppendixPriceDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixPriceDataInfo`
        """
        model = AppendixPriceDataInfo()
        if include_optional:
            return AppendixPriceDataInfo(
    ...
    def testAppendixPriceDataInfo(self):
        """Test AppendixPriceDataInfo"""
