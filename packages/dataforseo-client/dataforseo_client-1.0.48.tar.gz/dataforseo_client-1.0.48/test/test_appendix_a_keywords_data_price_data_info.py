...
class TestAppendixAKeywordsDataPriceDataInfo(unittest.TestCase):
    """AppendixAKeywordsDataPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixAKeywordsDataPriceDataInfo:
        """Test AppendixAKeywordsDataPriceDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixAKeywordsDataPriceDataInfo`
        """
        model = AppendixAKeywordsDataPriceDataInfo()
        if include_optional:
            return AppendixAKeywordsDataPriceDataInfo(
    ...
    def testAppendixAKeywordsDataPriceDataInfo(self):
        """Test AppendixAKeywordsDataPriceDataInfo"""
