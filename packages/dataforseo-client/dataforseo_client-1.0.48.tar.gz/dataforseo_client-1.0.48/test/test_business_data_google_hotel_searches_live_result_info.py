...
class TestBusinessDataGoogleHotelSearchesLiveResultInfo(unittest.TestCase):
    """BusinessDataGoogleHotelSearchesLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessDataGoogleHotelSearchesLiveResultInfo:
        """Test BusinessDataGoogleHotelSearchesLiveResultInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessDataGoogleHotelSearchesLiveResultInfo`
        """
        model = BusinessDataGoogleHotelSearchesLiveResultInfo()
        if include_optional:
            return BusinessDataGoogleHotelSearchesLiveResultInfo(
                keyword = '',
                location_code = 56,
                language_code = '',
                check_url = '',
    ...
    def testBusinessDataGoogleHotelSearchesLiveResultInfo(self):
        """Test BusinessDataGoogleHotelSearchesLiveResultInfo"""
