...
class TestAppendixSellersGoogleMerchantPriceData(unittest.TestCase):
    """AppendixSellersGoogleMerchantPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixSellersGoogleMerchantPriceData:
        """Test AppendixSellersGoogleMerchantPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixSellersGoogleMerchantPriceData`
        """
        model = AppendixSellersGoogleMerchantPriceData()
        if include_optional:
            return AppendixSellersGoogleMerchantPriceData(
    ...
    def testAppendixSellersGoogleMerchantPriceData(self):
        """Test AppendixSellersGoogleMerchantPriceData"""
