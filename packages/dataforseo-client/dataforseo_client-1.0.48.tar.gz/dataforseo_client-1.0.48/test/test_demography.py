...
class TestDemography(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Demography:
        """Test Demography
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Demography`
        """
        model = Demography()
        if include_optional:
            return Demography(
