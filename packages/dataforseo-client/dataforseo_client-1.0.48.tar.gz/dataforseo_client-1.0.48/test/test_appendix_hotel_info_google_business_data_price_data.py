...
class TestAppendixHotelInfoGoogleBusinessDataPriceData(unittest.TestCase):
    """AppendixHotelInfoGoogleBusinessDataPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixHotelInfoGoogleBusinessDataPriceData:
        """Test AppendixHotelInfoGoogleBusinessDataPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixHotelInfoGoogleBusinessDataPriceData`
        """
        model = AppendixHotelInfoGoogleBusinessDataPriceData()
        if include_optional:
            return AppendixHotelInfoGoogleBusinessDataPriceData(
    ...
    def testAppendixHotelInfoGoogleBusinessDataPriceData(self):
        """Test AppendixHotelInfoGoogleBusinessDataPriceData"""
