...
class TestAppendixContentGenerationPriceDataInfo(unittest.TestCase):
    """AppendixContentGenerationPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixContentGenerationPriceDataInfo:
        """Test AppendixContentGenerationPriceDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixContentGenerationPriceDataInfo`
        """
        model = AppendixContentGenerationPriceDataInfo()
        if include_optional:
            return AppendixContentGenerationPriceDataInfo(
    ...
    def testAppendixContentGenerationPriceDataInfo(self):
        """Test AppendixContentGenerationPriceDataInfo"""
