...
class TestBusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo(unittest.TestCase):
    """BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo:
        """Test BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo`
        """
        model = BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo()
        if include_optional:
            return BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo(
                hotel_identifier = '',
                location_code = 56,
                language_code = '',
                check_url = '',
    ...
    def testBusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo(self):
        """Test BusinessDataGoogleHotelInfoTaskGetAdvancedResultInfo"""
