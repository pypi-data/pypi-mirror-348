            ...
            return AppendixAppDataDayStatisticsRatesData(
                ...
                app_list = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    ...
                    jobs = dataforseo_client.models.appendix_jobs_serp_limits_rates_data_info.AppendixJobsSerpLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    screenshot = 1.337, ),
                app_reviews = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
                    ...
                    jobs = dataforseo_client.models.appendix_jobs_serp_limits_rates_data_info.AppendixJobsSerpLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    screenshot = 1.337, ),
                app_searches = dataforseo_client.models.appendix_serps_rates_data_info.AppendixSerpsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
