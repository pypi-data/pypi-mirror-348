...
class TestAppendixAmazonMerchantPriceData(unittest.TestCase):
    """AppendixAmazonMerchantPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixAmazonMerchantPriceData:
        """Test AppendixAmazonMerchantPriceData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixAmazonMerchantPriceData`
        """
        model = AppendixAmazonMerchantPriceData()
        if include_optional:
            return AppendixAmazonMerchantPriceData(
                ...
                products = dataforseo_client.models.appendix_product_google_merchant_price_data_info.AppendixProductGoogleMerchantPriceDataInfo(
                    ...
                    task_post = , 
                    tasks_ready = , ),
                sellers = dataforseo_client.models.appendix_product_google_merchant_price_data_info.AppendixProductGoogleMerchantPriceDataInfo(
                    task_get = dataforseo_client.models.appendix_task_get_product_google_merchant_price_data_info.AppendixTaskGetProductGoogleMerchantPriceDataInfo(
                        advanced = dataforseo_client.models.appendix_task_keywords_data_price_data_info.AppendixTaskKeywordsDataPriceDataInfo(
                            priority_low = [
                                dataforseo_client.models.appendix_priority_tasks_ready_keywords_data_price_data_info.AppendixPriorityTasksReadyKeywordsDataPriceDataInfo(
    ...
    def testAppendixAmazonMerchantPriceData(self):
        """Test AppendixAmazonMerchantPriceData"""
