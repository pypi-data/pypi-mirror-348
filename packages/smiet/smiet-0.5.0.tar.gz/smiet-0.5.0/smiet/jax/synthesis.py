...
class TemplateSynthesis:
    ...
    def _initialise_antennas(self: Self, shower: SlicedShower) -> None:
        ...
        self.antenna_positions_vvB = shower.get_antennas_showerplane()
    ...
    def _calculate_normalisation_factor(self: Self, shower: BaseShower) -> np.ndarray:
        ...
        shower :  smiet.jax.io.base_shower.BaseShower
            the shower object containing the geometry (zenith, azimtuh), geomagnetic angle
    ...
    def save_template(
        ...
        with h5py.File(os.path.join(save_dir, template_file), "w") as f:
            ...
            ant_grp.create_dataset("ant_positions_vvB", data=self.antenna_positions_vvB)
    ...
    def load_template(
        ...
        with h5py.File(file_path, "r") as f:
            ...
            self.antenna_positions_vvB = f["antennas/ant_positions_vvB"][()]
