...
- It can be used with JAX's automatic vectorization (vmap) to efficiently process batches of data.
...
- ``jaxlib``
- ``jax_radio_tools``
- `interpax <https://github.com/kwat0308/interpax.git@extrap>`_  (NB: this may be removed in a future update.)
