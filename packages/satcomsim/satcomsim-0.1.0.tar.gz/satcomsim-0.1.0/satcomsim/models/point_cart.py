...
class PointCart(Point):
    ...
    def __eq__(self, p):
        ...
        """
        return self.m_x == p.get_x() and self.m_y == p.get_y() and self.m_z == p.get_z()
    ...
    def get_r(self):
        ...
        return math.sqrt(
            self.m_x * self.m_x + self.m_y * self.m_y + self.m_z * self.m_z
        )
    ...
    def print(self):
        ...
        print(
            f"Polar: r={self.get_r()}, theta={self.get_theta()}, phi={self.get_phi()}"
        )
