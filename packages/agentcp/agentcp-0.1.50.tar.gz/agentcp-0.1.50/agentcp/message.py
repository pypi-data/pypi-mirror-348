...
class AssistantMessageBlock:
    type: Literal["llm","content", "search",
                  ...
                  'image','tool_call','text/event-stream',"video","audio","form","form_result","add_agent"]
    status: Literal["success", "loading", "cancel", "error", "reading", "optimizing"]
    timestamp: int
    block_id: Optional[str] = None
    content: Optional[Union[str,OpenAIMessage,AgentFormResultBlock,AgentAddFriendBlock,AgentFileBlock,list[AgentFormBlock]]] = None
    type_format: str = ""
