...
def test_yaml_loader_speed_no_superclass(benchmark):
    def load():
        path = os.path.join(TEST_REPO_DIR, "test/test/test-1.1.yaml")
        _safe_load_file(path)
...
def test_yaml_loader_speed_superclass(benchmark):
    def load():
        path = os.path.join(TEST_REPO_DIR, "test/test/test-1.2.yaml")
        _safe_load_file(path)
