...
class SystemConfigurationDatastores:
    ...
    additional_properties: Dict[
        str,
        Union["SystemConfigurationDatastoresLocal", "SystemConfigurationDatastoresS3"],
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            ...
            def _parse_additional_property(
                ...
                "SystemConfigurationDatastoresLocal", "SystemConfigurationDatastoresS3"
            ]:
                try:
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                additional_property_type_1 = SystemConfigurationDatastoresS3.from_dict(
                    data
                )
