...
from ..models.system_configuration_datastores_s3_cache_file import (
    SystemConfigurationDatastoresS3CacheFile,
)
from ..models.system_configuration_datastores_s3_cache_mem import (
...
class SystemConfigurationDatastoresS3:
    ...
    Attributes:
        ...
        cache (Union['SystemConfigurationDatastoresS3CacheFile', 'SystemConfigurationDatastoresS3CacheMem', Unset]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.cache, Unset):
            cache = UNSET
        elif isinstance(self.cache, SystemConfigurationDatastoresS3CacheMem):
        ...
        def _parse_cache(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                cache_type_0 = SystemConfigurationDatastoresS3CacheMem.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            cache_type_1 = SystemConfigurationDatastoresS3CacheFile.from_dict(data)
