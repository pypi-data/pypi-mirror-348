#!/usr/bin/env python
"""
Redis-Backed Search Engine Example
...
def main():
    ...
    try:
        ...
        while True:
            ...
            print("2. AND search with multiple terms")
            print("3. OR search with multiple terms")
            print("4. Get document by ID")
            print("5. Show engine stats")
            print("6. Exit")
            ...
            if choice == '1':
                ...
                limit = int(input("Results limit (default 5): ") or 5)
                ...
                terms_input = input("Enter terms separated by spaces: ")
                terms = terms_input.split()
                
                print(f"\nExecuting AND query for terms: {terms}")
                results = search_engine.build_and_query(terms)
                ...
                print(f"\nExecuting OR query for terms: {terms}")
                results = search_engine.build_or_query(terms)
