...
class Sampler:
    ...
    def __init__(
        ...
        data_for_simulation: Dict[str, Any]
            Initialized motifs, backgrounds, topics, and frequencies
        reader: Reader
        ...
        self.frequencer = FrequencySampler(
            ...
            num_topics_per_seq=self.sampling_params.num_topics_per_sequence,
            rng=self.rng)
    ...
    def select_topics(self) -> List[str]:
        ...
        _: List[str]
            List of topic IDs
        """
        return self.frequencer.select_topics()
    ...
    def select_motifs(
        ...
        """
        return self.frequencer.select_motifs_from_topics(
            topic_ids=topic_ids,
