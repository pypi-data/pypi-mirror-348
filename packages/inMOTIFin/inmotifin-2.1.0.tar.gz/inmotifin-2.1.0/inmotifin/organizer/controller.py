...
class Controller:
    ...
    def create_motif_in_seq(
            ...
            to_replace: bool = True) -> Dict[str, str]:
        """
        ...
        motifs: Dict[str, np.ndarray]
            Dictionary of motif IDs and PWMs.
        orientations: List[List[int]]
            List of list of motif instance orientations per sequence \
            and per motif in the inner list.
        alphabet: str
            Alphabet of the motifs.
        alphabet_revcomp_pairs: Dict[str, str]
            Reverse complement pairs of the motif alphabet of the motifs.
        to_replace: bool
        ...
        instancer = MotifInstancer(
            motifs=Motifs(
                motifs=motifs,
                alphabet=alphabet,
                alphabet_revcomp_pairs=alphabet_revcomp_pairs),
            rng=self.rng)

        full_zip = zip(background_ids, motif_ids, positions, orientations)
        motif_in_sequences = {}
    ...
    def setup_simulation(
        ...
        self.data_for_simulation["topics"] = setupper.create_topics()
