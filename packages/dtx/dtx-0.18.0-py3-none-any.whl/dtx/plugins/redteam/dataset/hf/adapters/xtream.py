...
class XtreamRiskPromptGenerator(BaseRiskPromptGenerator):

    ## Script to index the dataset is here https://www.kaggle.com/code/jitendradetoxio/index-xtrain-faiss/

    REGISTERED_DATASET_NAME = PromptDataset.HF_XTREAM  # Ensure this Enum value exists
...
if __name__ == "__main__":
    ...
    generator = XtreamRiskPromptGenerator()
