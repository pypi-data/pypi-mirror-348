...
class ReNeLLMRiskPromptGenerator(BaseRiskPromptGenerator):
    ...
    def __init__(self):
        ...
        ## Required to map dataset goal to plugin and policies
...
if __name__ == "__main__":
    from dtx.config.globals import ensure_initialized, get_adv_repo
    from dotenv import load_dotenv
    load_dotenv()
    ensure_initialized(init_adv_repo=True)

    generator = ReNeLLMRiskPromptGenerator()
