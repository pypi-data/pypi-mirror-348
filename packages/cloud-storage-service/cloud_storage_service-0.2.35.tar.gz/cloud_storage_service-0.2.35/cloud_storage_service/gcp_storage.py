...
class GCPStorage:
    ...
    def save_json_metadata(self, processing_info, trident_changes_metadata_df, hr_metadata_df, mr_metadata_df, json_metadata_path):
        ...
        trident_changes_gcp_path = f"summary/{summary_version}/trident_changes/{person_id}_trident-changes.parquet"
        hr_gcp_path = f"summary/{summary_version}/hr_metadata_info/{person_id}_hr-metadata.parquet"
        mr_gcp_path = f"summary/{summary_version}/mr_metadata_info/{person_id}_mr-metadata.parquet"
