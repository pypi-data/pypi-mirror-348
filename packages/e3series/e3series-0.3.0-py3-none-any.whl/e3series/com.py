...
# This file was created for E3.series 26.00 (TLB version 26.00)
# 
# mypy: ignore-errors
...
import pythoncom
from .tools import _get_default_dbe, _get_default_app, _raw_connect_dbe, _raw_connect_app, _variant_to_dict
...
class AttributeDefinition:
	...
	def Get(self) -> tuple[int, tuple[tuple[str,str],...]]:
		"""
		:attributeDefinition [OUT]: tuple[tuple[str,str],...]
		:Return: int
	...
	def Set(self, attributeDefinition:list[tuple[str,str]]) -> int:
		"""
		:attributeDefinition [IN]: list[tuple[str,str]]
		:Return: int
	...
	def GetFromDatabase(self) -> tuple[int, dict[str,list[tuple[str,str]]]]:
		"""
		:attributeDefinitions [OUT]: dict[str,list[tuple[str,str]]]
		:Return: int
		...
		for i0 in attributeDefinitions.keys():
			attributeDefinitions[i0] = attributeDefinitions[i0][1:] if type(attributeDefinitions[i0]) == list and len(attributeDefinitions[i0]) > 0 else []
...
class Device:
	...
	def GetTerminalPlanSettings(self) -> tuple[int, dict[str,str]]:
		"""
		:parameters [OUT]: dict[str,str]
		:Return: int

		Available since TLB-Versions: 8.50
		"""
		dummy=0
		ret, parameters = self._obj.GetTerminalPlanSettings(dummy)
...
class Job:
	...
	def GetTerminalPlanSettings(self) -> tuple[bool, dict[str,str]]:
		"""
		:settings [OUT]: dict[str,str]
		:Return: bool

		Available since TLB-Versions: 8.50
		"""
		dummy=0
		ret, settings = self._obj.GetTerminalPlanSettings(dummy)
