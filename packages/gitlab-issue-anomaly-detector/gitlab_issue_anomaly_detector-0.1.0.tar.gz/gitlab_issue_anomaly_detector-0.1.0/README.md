...
```
cd existing_repo
git remote add origin https://gitlab.com/my-group-name2452611/my-project-name.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/my-group-name2452611/my-project-name/-/settings/integrations)
