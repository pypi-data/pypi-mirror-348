...
class JsonBodyInputSchemaOptionsInner(BaseModel):
    ...
    """ # noqa: E501
    label: StrictStr
    value: IFilterSuggestionsSuccessResponseAttributesInnerValue
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "value": IFilterSuggestionsSuccessResponseAttributesInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
