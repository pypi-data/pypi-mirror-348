...
from bitbadgespy_sdk.models.i_filter_suggestions_success_response_attributes_inner_value import IFilterSuggestionsSuccessResponseAttributesInnerValue

class TestIFilterSuggestionsSuccessResponseAttributesInnerValue(unittest.TestCase):
    """IFilterSuggestionsSuccessResponseAttributesInnerValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IFilterSuggestionsSuccessResponseAttributesInnerValue:
        """Test IFilterSuggestionsSuccessResponseAttributesInnerValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IFilterSuggestionsSuccessResponseAttributesInnerValue`
        """
        model = IFilterSuggestionsSuccessResponseAttributesInnerValue()
        if include_optional:
            return IFilterSuggestionsSuccessResponseAttributesInnerValue(
            )
        else:
            return IFilterSuggestionsSuccessResponseAttributesInnerValue(
        )
    ...
    def testIFilterSuggestionsSuccessResponseAttributesInnerValue(self):
        """Test IFilterSuggestionsSuccessResponseAttributesInnerValue"""
