...
class JsonBodyInputSchema(BaseModel):
    ...
    default_value: Optional[IFilterSuggestionsSuccessResponseAttributesInnerValue] = Field(default=None, alias="defaultValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultValue": IFilterSuggestionsSuccessResponseAttributesInnerValue.from_dict(obj["defaultValue"]) if obj.get("defaultValue") is not None else None,
