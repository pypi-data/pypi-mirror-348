...
class EmergencyStopButton(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/SafetySystem/EmergencyStopButton/EmergencyStopButton.json')
    ...
    def _factory(cls, data):
        if isinstance(data, EmergencyStopButton):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define EmergencyStopButton models')
        return EmergencyStopButton.parse_obj(data)
