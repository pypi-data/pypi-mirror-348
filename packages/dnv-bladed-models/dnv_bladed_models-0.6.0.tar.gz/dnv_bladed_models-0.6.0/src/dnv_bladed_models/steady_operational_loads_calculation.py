...
class SteadyOperationalLoadsCalculation(SteadyCalculation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/SteadyOperationalLoadsCalculation.json')

    SteadyCalculationType: Literal['SteadyOperationalLoads'] = Field(alias="SteadyCalculationType", default='SteadyOperationalLoads', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, SteadyOperationalLoadsCalculation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SteadyOperationalLoadsCalculation models')
        return SteadyOperationalLoadsCalculation.parse_obj(data)
