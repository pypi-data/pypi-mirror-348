...
class LidarFocalDistanceControlInsert(CommonRoot):
    r"""
    A LidarFocalDistanceControl is to be inserted from an external resource. The exact type of LidarFocalDistanceControl is not currently known.
    
    Attributes
    ----------
    FocalDistanceControlType : Literal['__insert__'], default='__insert__'
    ...
    FocalDistanceControlType: Literal['__insert__'] = Field(alias="FocalDistanceControlType", default='__insert__', allow_mutation=False, const=True)
...
LidarFocalDistanceControlInsert.update_forward_refs()
