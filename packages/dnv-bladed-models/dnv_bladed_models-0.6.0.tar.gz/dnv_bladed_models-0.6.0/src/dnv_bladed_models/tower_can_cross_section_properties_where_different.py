...
class TowerCanCrossSectionPropertiesWhereDifferent(TowerCanCrossSectionWithSensors, ABC):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/common/TowerCanCrossSectionPropertiesWhereDifferent.json')
...
TowerCanCrossSectionPropertiesWhereDifferent.update_forward_refs()
