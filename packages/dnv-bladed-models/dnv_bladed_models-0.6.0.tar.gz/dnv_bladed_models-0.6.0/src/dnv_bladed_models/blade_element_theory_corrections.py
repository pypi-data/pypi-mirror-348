...
class BladeElementTheoryCorrections(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/AerodynamicSettings/AerodynamicModel/BladeElementTheoryCorrections/BladeElementTheoryCorrections.json')
    ...
    def _factory(cls, data):
        if isinstance(data, BladeElementTheoryCorrections):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeElementTheoryCorrections models')
        return BladeElementTheoryCorrections.parse_obj(data)
