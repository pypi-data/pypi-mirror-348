...
class SteadyCalculationInsert(CommonRoot):
    r"""
    A SteadyCalculation is to be inserted from an external resource. The exact type of SteadyCalculation is not currently known.
    
    Attributes
    ----------
    SteadyCalculationType : Literal['__insert__'], default='__insert__'
    ...
    SteadyCalculationType: Literal['__insert__'] = Field(alias="SteadyCalculationType", default='__insert__', allow_mutation=False, const=True)
...
SteadyCalculationInsert.update_forward_refs()
