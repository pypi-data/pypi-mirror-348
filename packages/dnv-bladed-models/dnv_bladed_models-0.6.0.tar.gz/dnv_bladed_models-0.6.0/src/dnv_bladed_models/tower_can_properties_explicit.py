...
class TowerCanPropertiesExplicit(TowerCanCrossSectionProperties):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/TowerCanPropertiesExplicit/TowerCanPropertiesExplicit.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerCanPropertiesExplicit):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerCanPropertiesExplicit models')
        return TowerCanPropertiesExplicit.parse_obj(data)
