...
class BladeStabilityAnalysisParked(BladeStabilityAnalysisModeOfOperation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/BladeStabilityAnalysisModeOfOperation/BladeStabilityAnalysisParked.json')

    BladeStabilityAnalysisModeOfOperationType: Literal['Parked'] = Field(alias="BladeStabilityAnalysisModeOfOperationType", default='Parked', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, BladeStabilityAnalysisParked):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeStabilityAnalysisParked models')
        return BladeStabilityAnalysisParked.parse_obj(data)
