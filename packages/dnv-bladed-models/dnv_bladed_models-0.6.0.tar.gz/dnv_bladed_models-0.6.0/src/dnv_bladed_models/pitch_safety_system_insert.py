...
class PitchSafetySystemInsert(CommonRoot):
    r"""
    A PitchSafetySystem is to be inserted from an external resource. The exact type of PitchSafetySystem is not currently known.
    
    Attributes
    ----------
    PitchSafetySystemType : Literal['__insert__'], default='__insert__'
    ...
    PitchSafetySystemType: Literal['__insert__'] = Field(alias="PitchSafetySystemType", default='__insert__', allow_mutation=False, const=True)
...
PitchSafetySystemInsert.update_forward_refs()
