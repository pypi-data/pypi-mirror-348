...
class Translation(Component):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Translation.json')

    ComponentType: Literal['Translation'] = Field(alias="ComponentType", default='Translation', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, Translation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Translation models')
        return Translation.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = Translation.from_file('/path/to/file')
        """
