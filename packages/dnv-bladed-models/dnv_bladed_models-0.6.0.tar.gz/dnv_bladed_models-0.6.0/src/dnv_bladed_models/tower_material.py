...
class TowerMaterial(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerMaterialsLibrary/TowerMaterial/TowerMaterial.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerMaterial):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerMaterial models')
        return TowerMaterial.parse_obj(data)
