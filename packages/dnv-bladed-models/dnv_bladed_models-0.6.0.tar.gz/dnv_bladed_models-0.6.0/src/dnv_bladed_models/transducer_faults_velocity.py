...
class TransducerFaultsVelocity(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesVelocity/TransducerFaultsVelocity/TransducerFaultsVelocity.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsVelocity):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsVelocity models')
        return TransducerFaultsVelocity.parse_obj(data)
