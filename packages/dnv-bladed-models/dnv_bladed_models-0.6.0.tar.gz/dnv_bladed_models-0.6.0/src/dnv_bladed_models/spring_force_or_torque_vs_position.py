...
class SpringForceOrTorqueVsPosition(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchController/PitchSafetySystem/SpringForceOrTorqueVsPosition/SpringForceOrTorqueVsPosition.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SpringForceOrTorqueVsPosition):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SpringForceOrTorqueVsPosition models')
        return SpringForceOrTorqueVsPosition.parse_obj(data)
