...
class SecondOrderActuatorResponse(ActuatorResponse):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchActuator/ActuatorResponse/SecondOrderActuatorResponse.json')

    ActuatorResponseType: Literal['SecondOrderActuatorResponse'] = Field(alias="ActuatorResponseType", default='SecondOrderActuatorResponse', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, SecondOrderActuatorResponse):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SecondOrderActuatorResponse models')
        return SecondOrderActuatorResponse.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = SecondOrderActuatorResponse.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = SecondOrderActuatorResponse.from_json('{ ... }')
        """
