...
class RadiusVsDeficit(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/SteadyWakeDeficit/RadiusVsDeficit/RadiusVsDeficit.json')
    ...
    def _factory(cls, data):
        if isinstance(data, RadiusVsDeficit):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define RadiusVsDeficit models')
        return RadiusVsDeficit.parse_obj(data)
