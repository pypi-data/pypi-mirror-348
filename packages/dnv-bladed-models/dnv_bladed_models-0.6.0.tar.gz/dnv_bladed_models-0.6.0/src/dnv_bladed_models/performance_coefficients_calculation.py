...
class PerformanceCoefficientsCalculation(SteadyCalculation):
    ...
    SteadyCalculationType: Literal['PerformanceCoefficients'] = Field(alias="SteadyCalculationType", default='PerformanceCoefficients', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, PerformanceCoefficientsCalculation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PerformanceCoefficientsCalculation models')
        return PerformanceCoefficientsCalculation.parse_obj(data)
