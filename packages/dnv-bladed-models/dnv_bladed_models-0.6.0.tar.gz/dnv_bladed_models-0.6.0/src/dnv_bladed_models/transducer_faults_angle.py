...
class TransducerFaultsAngle(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesAngle/TransducerFaultsAngle/TransducerFaultsAngle.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsAngle):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsAngle models')
        return TransducerFaultsAngle.parse_obj(data)
