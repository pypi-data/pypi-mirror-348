...
class ShaftSpeedVsShaftInputTorqueVsResistingTorque(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/MechanicalLosses/ShaftSpeedVsShaftInputTorqueVsResistingTorque/ShaftSpeedVsShaftInputTorqueVsResistingTorque.json')
    ...
    def _factory(cls, data):
        if isinstance(data, ShaftSpeedVsShaftInputTorqueVsResistingTorque):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ShaftSpeedVsShaftInputTorqueVsResistingTorque models')
        return ShaftSpeedVsShaftInputTorqueVsResistingTorque.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = ShaftSpeedVsShaftInputTorqueVsResistingTorque.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = ShaftSpeedVsShaftInputTorqueVsResistingTorque.from_json('{ ... }')
        """
...
ShaftSpeedVsShaftInputTorqueVsResistingTorque.update_forward_refs()
