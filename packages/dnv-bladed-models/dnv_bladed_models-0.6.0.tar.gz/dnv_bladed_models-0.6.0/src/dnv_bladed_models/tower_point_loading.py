...
class TowerPointLoading(SupportStructurePointLoading):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/AppliedLoad/TowerPointLoading.json')

    AppliedLoadType: Literal['TowerPointLoading'] = Field(alias="AppliedLoadType", default='TowerPointLoading', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, TowerPointLoading):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerPointLoading models')
        return TowerPointLoading.parse_obj(data)
