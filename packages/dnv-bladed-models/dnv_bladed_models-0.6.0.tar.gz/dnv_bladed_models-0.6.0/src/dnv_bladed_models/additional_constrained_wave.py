...
class AdditionalConstrainedWave(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Waves/AdditionalConstrainedWave/AdditionalConstrainedWave.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AdditionalConstrainedWave):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AdditionalConstrainedWave models')
        return AdditionalConstrainedWave.parse_obj(data)
