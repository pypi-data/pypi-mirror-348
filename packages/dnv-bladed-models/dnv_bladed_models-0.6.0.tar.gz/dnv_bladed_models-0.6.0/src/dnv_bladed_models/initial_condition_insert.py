...
class InitialConditionInsert(CommonRoot):
    ...
    InitialConditionType: Literal['__insert__'] = Field(alias="InitialConditionType", default='__insert__', allow_mutation=False, const=True)
...
InitialConditionInsert.update_forward_refs()
