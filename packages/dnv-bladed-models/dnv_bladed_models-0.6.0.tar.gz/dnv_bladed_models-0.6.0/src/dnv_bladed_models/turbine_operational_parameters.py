...
class TurbineOperationalParameters(BladedModel):
    ...
    PitchAngleWhilstIdling : float, default=1.5707963267948966
        The pitch angle of the blades when the turbine is idling.  The default is 90 degrees.
    
    PitchAngleWhilstParked : float, default=1.5707963267948966
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/TurbineOperationalParameters/TurbineOperationalParameters.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TurbineOperationalParameters):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TurbineOperationalParameters models')
        return TurbineOperationalParameters.parse_obj(data)
    ...
    def _find_unused_containers(self) -> Set[str]:
        ...
        if self.NominalHubWindSpeedVsRotorSpeedAndPitchAngle is not None and len(self.NominalHubWindSpeedVsRotorSpeedAndPitchAngle) == 0: #type: ignore
            unused_containers.add('NominalHubWindSpeedVsRotorSpeedAndPitchAngle')
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = TurbineOperationalParameters.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = TurbineOperationalParameters.from_json('{ ... }')
        """
