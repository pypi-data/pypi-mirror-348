...
class ExternalModule(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('common/ExternalModule.json')
    ...
    def _factory(cls, data):
        if isinstance(data, ExternalModule):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ExternalModule models')
        return ExternalModule.parse_obj(data)
