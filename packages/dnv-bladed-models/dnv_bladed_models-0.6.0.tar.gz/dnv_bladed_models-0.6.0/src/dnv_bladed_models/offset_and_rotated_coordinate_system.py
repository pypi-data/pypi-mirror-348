...
class OffsetAndRotatedCoordinateSystem(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/CoordinateSystems/OffsetAndRotatedCoordinateSystem/OffsetAndRotatedCoordinateSystem.json')
    ...
    def _factory(cls, data):
        if isinstance(data, OffsetAndRotatedCoordinateSystem):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define OffsetAndRotatedCoordinateSystem models')
        return OffsetAndRotatedCoordinateSystem.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Returns
        -------
        OffsetAndRotatedCoordinateSystem
            The model object.
        ...
        Examples
        --------
        >>> model = OffsetAndRotatedCoordinateSystem.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = OffsetAndRotatedCoordinateSystem.from_json('{ ... }')
        """
