...
class LidarMountingPosition(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Lidar/LidarBeam/LidarMountingPosition/LidarMountingPosition.json')
    ...
    def _factory(cls, data):
        if isinstance(data, LidarMountingPosition):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LidarMountingPosition models')
        return LidarMountingPosition.parse_obj(data)
