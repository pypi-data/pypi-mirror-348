...
class DimensionlessRange(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/DimensionlessRange/DimensionlessRange.json')
    ...
    def _factory(cls, data):
        if isinstance(data, DimensionlessRange):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define DimensionlessRange models')
        return DimensionlessRange.parse_obj(data)
