...
class SuperelementConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Superelement/SuperelementConnectableNodes/SuperelementConnectableNodes.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SuperelementConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SuperelementConnectableNodes models')
        return SuperelementConnectableNodes.parse_obj(data)


    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, SuperelementConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = SuperelementConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = SuperelementConnectableNodes.from_json('{ ... }')
        """
...
SuperelementConnectableNodes.update_forward_refs()
SuperelementConnectableNodes.__CustomEntries__.update_forward_refs()
