...
class TimeVsVoltageChange(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Event/TimeVsVoltageChange/TimeVsVoltageChange.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TimeVsVoltageChange):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TimeVsVoltageChange models')
        return TimeVsVoltageChange.parse_obj(data)
