...
class AerodynamicProperties(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/AerodynamicProperties/AerodynamicProperties.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AerodynamicProperties):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AerodynamicProperties models')
        return AerodynamicProperties.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = AerodynamicProperties.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = AerodynamicProperties.from_json('{ ... }')
        """
