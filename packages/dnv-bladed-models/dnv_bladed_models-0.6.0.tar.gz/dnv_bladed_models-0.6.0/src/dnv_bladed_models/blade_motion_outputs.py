...
class BladeMotionOutputs(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/BladeOutputGroupLibrary/BladeOutputGroup/BladeMotionOutputs/BladeMotionOutputs.json')
    ...
    def _factory(cls, data):
        if isinstance(data, BladeMotionOutputs):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeMotionOutputs models')
        return BladeMotionOutputs.parse_obj(data)
