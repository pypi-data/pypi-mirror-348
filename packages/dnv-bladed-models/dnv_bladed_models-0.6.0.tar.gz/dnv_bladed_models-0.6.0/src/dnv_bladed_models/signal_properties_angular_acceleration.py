...
class SignalPropertiesAngularAcceleration(SignalProperties):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesAngularAcceleration/SignalPropertiesAngularAcceleration.json')
    ...
    TransducerFaults: TransducerFaultsAngularAcceleration = Field(alias="TransducerFaults", default=None) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, SignalPropertiesAngularAcceleration):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SignalPropertiesAngularAcceleration models')
        return SignalPropertiesAngularAcceleration.parse_obj(data)
