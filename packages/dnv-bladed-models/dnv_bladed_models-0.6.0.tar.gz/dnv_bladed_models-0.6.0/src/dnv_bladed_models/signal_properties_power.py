...
class SignalPropertiesPower(SignalProperties):
    ...
    TransducerFaults: TransducerFaultsPower = Field(alias="TransducerFaults", default=None) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, SignalPropertiesPower):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SignalPropertiesPower models')
        return SignalPropertiesPower.parse_obj(data)
