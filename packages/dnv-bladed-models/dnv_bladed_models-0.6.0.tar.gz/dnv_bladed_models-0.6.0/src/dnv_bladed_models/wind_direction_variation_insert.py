...
class WindDirectionVariationInsert(CommonRoot):
    r"""
    A WindDirectionVariation is to be inserted from an external resource. The exact type of WindDirectionVariation is not currently known.
    
    Attributes
    ----------
    DirectionVariationType : Literal['__insert__'], default='__insert__'
    ...
    DirectionVariationType: Literal['__insert__'] = Field(alias="DirectionVariationType", default='__insert__', allow_mutation=False, const=True)
...
WindDirectionVariationInsert.update_forward_refs()
