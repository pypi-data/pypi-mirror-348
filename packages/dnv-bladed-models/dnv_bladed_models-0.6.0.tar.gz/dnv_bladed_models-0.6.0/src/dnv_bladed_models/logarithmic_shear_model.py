...
class LogarithmicShearModel(WindShear):
    ...
    """
    _relative_schema_path: str = PrivateAttr('common/LogarithmicShearModel.json')

    WindShearType: Literal['LogarithmicShearModel'] = Field(alias="WindShearType", default='LogarithmicShearModel', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, LogarithmicShearModel):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LogarithmicShearModel models')
        return LogarithmicShearModel.parse_obj(data)
