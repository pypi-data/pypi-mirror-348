...
class TowerCanPropertiesByMaterial(TowerCanCrossSectionProperties):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/TowerCanPropertiesByMaterial/TowerCanPropertiesByMaterial.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerCanPropertiesByMaterial):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerCanPropertiesByMaterial models')
        return TowerCanPropertiesByMaterial.parse_obj(data)
