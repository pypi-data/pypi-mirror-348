...
class CurrentMeanSpeedVariation(BladedModel, ABC):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/CurrentMeanSpeedVariation/common/CurrentMeanSpeedVariation.json')
