...
class HydrodynamicCalculation(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/HydrodynamicCalculation/HydrodynamicCalculation.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HydrodynamicCalculation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HydrodynamicCalculation models')
        return HydrodynamicCalculation.parse_obj(data)
