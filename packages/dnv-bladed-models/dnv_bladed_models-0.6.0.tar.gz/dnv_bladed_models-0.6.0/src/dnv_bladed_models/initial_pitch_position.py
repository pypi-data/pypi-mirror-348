...
class InitialPitchPosition(InitialPosition):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/InitialCondition/InitialPitchPosition.json')

    InitialConditionType: Literal['InitialPitchPosition'] = Field(alias="InitialConditionType", default='InitialPitchPosition', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, InitialPitchPosition):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define InitialPitchPosition models')
        return InitialPitchPosition.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialPitchPosition.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialPitchPosition.from_json('{ ... }')
        """
