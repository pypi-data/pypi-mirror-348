...
class SteadyWakeDeficitInsert(CommonRoot):
    r"""
    A SteadyWakeDeficit is to be inserted from an external resource. The exact type of SteadyWakeDeficit is not currently known.
    
    Attributes
    ----------
    SteadyWakeDeficitType : Literal['__insert__'], default='__insert__'
    ...
    SteadyWakeDeficitType: Literal['__insert__'] = Field(alias="SteadyWakeDeficitType", default='__insert__', allow_mutation=False, const=True)
...
SteadyWakeDeficitInsert.update_forward_refs()
