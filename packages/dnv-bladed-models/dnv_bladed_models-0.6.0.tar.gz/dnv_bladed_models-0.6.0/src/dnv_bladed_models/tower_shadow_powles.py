...
class TowerShadowPowles(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerAerodynamicProperties/FlowObstruction/TowerShadowPowles/TowerShadowPowles.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerShadowPowles):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerShadowPowles models')
        return TowerShadowPowles.parse_obj(data)
