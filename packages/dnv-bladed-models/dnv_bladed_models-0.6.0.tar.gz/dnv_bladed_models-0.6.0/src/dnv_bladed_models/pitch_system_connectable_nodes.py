...
class PitchSystemConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchSystemConnectableNodes/PitchSystemConnectableNodes.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchSystemConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchSystemConnectableNodes models')
        return PitchSystemConnectableNodes.parse_obj(data)


    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, PitchSystemConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = PitchSystemConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = PitchSystemConnectableNodes.from_json('{ ... }')
        """
...
PitchSystemConnectableNodes.update_forward_refs()
PitchSystemConnectableNodes.__CustomEntries__.update_forward_refs()
