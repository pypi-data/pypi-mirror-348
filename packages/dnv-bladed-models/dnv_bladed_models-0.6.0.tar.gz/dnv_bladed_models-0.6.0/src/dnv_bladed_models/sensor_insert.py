...
class SensorInsert(CommonRoot):
    r"""
    A Sensor is to be inserted from an external resource. The exact type of Sensor is not currently known.
    
    Attributes
    ----------
    SensorType : Literal['__insert__'], default='__insert__'
    ...
    SensorType: Literal['__insert__'] = Field(alias="SensorType", default='__insert__', allow_mutation=False, const=True)
...
SensorInsert.update_forward_refs()
