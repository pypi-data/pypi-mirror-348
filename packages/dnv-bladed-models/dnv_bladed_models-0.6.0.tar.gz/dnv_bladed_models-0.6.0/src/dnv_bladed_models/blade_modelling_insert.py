...
class BladeModellingInsert(CommonRoot):
    r"""
    A BladeModelling is to be inserted from an external resource. The exact type of BladeModelling is not currently known.
    
    Attributes
    ----------
    BladeModellingType : Literal['__insert__'], default='__insert__'
    ...
    BladeModellingType: Literal['__insert__'] = Field(alias="BladeModellingType", default='__insert__', allow_mutation=False, const=True)
...
BladeModellingInsert.update_forward_refs()
