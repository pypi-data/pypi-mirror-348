...
class NearSurfaceCurrent(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/NearSurfaceCurrent/NearSurfaceCurrent.json')
    ...
    def _factory(cls, data):
        if isinstance(data, NearSurfaceCurrent):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NearSurfaceCurrent models')
        return NearSurfaceCurrent.parse_obj(data)
