...
class HubConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Hub/HubConnectableNodes/HubConnectableNodes.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HubConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HubConnectableNodes models')
        return HubConnectableNodes.parse_obj(data)


    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, HubConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = HubConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = HubConnectableNodes.from_json('{ ... }')
        """
...
HubConnectableNodes.update_forward_refs()
HubConnectableNodes.__CustomEntries__.update_forward_refs()
