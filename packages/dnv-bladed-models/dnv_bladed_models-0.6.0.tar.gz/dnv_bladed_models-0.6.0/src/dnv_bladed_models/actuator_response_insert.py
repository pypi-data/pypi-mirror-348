...
class ActuatorResponseInsert(CommonRoot):
    r"""
    A ActuatorResponse is to be inserted from an external resource. The exact type of ActuatorResponse is not currently known.
    
    Attributes
    ----------
    ActuatorResponseType : Literal['__insert__'], default='__insert__'
    ...
    ActuatorResponseType: Literal['__insert__'] = Field(alias="ActuatorResponseType", default='__insert__', allow_mutation=False, const=True)
...
ActuatorResponseInsert.update_forward_refs()
