...
class EvolvingTurbulenceKristensen(EvolvingTurbulence):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/EvolvingTurbulence/EvolvingTurbulenceKristensen.json')

    EvolvingTurbulenceType: Literal['EvolvingTurbulenceKristensen'] = Field(alias="EvolvingTurbulenceType", default='EvolvingTurbulenceKristensen', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, EvolvingTurbulenceKristensen):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define EvolvingTurbulenceKristensen models')
        return EvolvingTurbulenceKristensen.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = EvolvingTurbulenceKristensen.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = EvolvingTurbulenceKristensen.from_json('{ ... }')
        """
