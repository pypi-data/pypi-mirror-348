...
class PitchBearingFrictionXYMomentRelationship(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/Friction/PitchBearingKineticFriction/PitchBearingFrictionXYMomentRelationship/PitchBearingFrictionXYMomentRelationship.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchBearingFrictionXYMomentRelationship):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchBearingFrictionXYMomentRelationship models')
        return PitchBearingFrictionXYMomentRelationship.parse_obj(data)
    ...
    def _find_unused_containers(self) -> Set[str]:
        ...
        if self.AppliedMomentVsFrictionTorque is not None and len(self.AppliedMomentVsFrictionTorque) == 0: #type: ignore
            unused_containers.add('AppliedMomentVsFrictionTorque')
