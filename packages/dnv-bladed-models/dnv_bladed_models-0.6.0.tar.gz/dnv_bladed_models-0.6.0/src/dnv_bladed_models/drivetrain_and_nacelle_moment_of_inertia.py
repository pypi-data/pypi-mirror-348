...
class DrivetrainAndNacelleMomentOfInertia(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/DrivetrainAndNacelleMassProperties/DrivetrainAndNacelleMomentOfInertia/DrivetrainAndNacelleMomentOfInertia.json')
    ...
    def _factory(cls, data):
        if isinstance(data, DrivetrainAndNacelleMomentOfInertia):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define DrivetrainAndNacelleMomentOfInertia models')
        return DrivetrainAndNacelleMomentOfInertia.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Returns
        -------
        DrivetrainAndNacelleMomentOfInertia
            The model object.
        ...
        Examples
        --------
        >>> model = DrivetrainAndNacelleMomentOfInertia.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = DrivetrainAndNacelleMomentOfInertia.from_json('{ ... }')
        """
