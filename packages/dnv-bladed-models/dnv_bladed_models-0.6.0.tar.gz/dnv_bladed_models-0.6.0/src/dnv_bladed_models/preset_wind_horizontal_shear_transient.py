...
class PresetWindHorizontalShearTransient(WindHorizontalShearVariation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/WindHorizontalShearVariation/PresetWindHorizontalShearTransient.json')

    HorizontalShearVariationType: Literal['PresetTransient'] = Field(alias="HorizontalShearVariationType", default='PresetTransient', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, PresetWindHorizontalShearTransient):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PresetWindHorizontalShearTransient models')
        return PresetWindHorizontalShearTransient.parse_obj(data)
