...
class AirCharacteristics(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Constants/AirCharacteristics/AirCharacteristics.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AirCharacteristics):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AirCharacteristics models')
        return AirCharacteristics.parse_obj(data)
