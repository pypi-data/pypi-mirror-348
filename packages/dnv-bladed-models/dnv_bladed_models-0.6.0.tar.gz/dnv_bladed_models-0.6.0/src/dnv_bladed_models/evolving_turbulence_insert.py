...
class EvolvingTurbulenceInsert(CommonRoot):
    r"""
    A EvolvingTurbulence is to be inserted from an external resource. The exact type of EvolvingTurbulence is not currently known.
    
    Attributes
    ----------
    EvolvingTurbulenceType : Literal['__insert__'], default='__insert__'
    ...
    EvolvingTurbulenceType: Literal['__insert__'] = Field(alias="EvolvingTurbulenceType", default='__insert__', allow_mutation=False, const=True)
...
EvolvingTurbulenceInsert.update_forward_refs()
