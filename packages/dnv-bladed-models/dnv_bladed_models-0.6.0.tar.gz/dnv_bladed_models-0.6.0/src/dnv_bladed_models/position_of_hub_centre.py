...
class PositionOfHubCentre(BladedModel):
    ...
    def _factory(cls, data):
        if isinstance(data, PositionOfHubCentre):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PositionOfHubCentre models')
        return PositionOfHubCentre.parse_obj(data)
