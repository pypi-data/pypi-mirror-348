...
class PitchSystemDemandInsert(CommonRoot):
    r"""
    A PitchSystemDemand is to be inserted from an external resource. The exact type of PitchSystemDemand is not currently known.
    
    Attributes
    ----------
    PitchSystemDemandType : Literal['__insert__'], default='__insert__'
    ...
    PitchSystemDemandType: Literal['__insert__'] = Field(alias="PitchSystemDemandType", default='__insert__', allow_mutation=False, const=True)
...
PitchSystemDemandInsert.update_forward_refs()
