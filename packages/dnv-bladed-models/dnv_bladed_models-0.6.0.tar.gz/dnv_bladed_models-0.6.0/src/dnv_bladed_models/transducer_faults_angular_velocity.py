...
class TransducerFaultsAngularVelocity(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesAngularVelocity/TransducerFaultsAngularVelocity/TransducerFaultsAngularVelocity.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsAngularVelocity):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsAngularVelocity models')
        return TransducerFaultsAngularVelocity.parse_obj(data)
