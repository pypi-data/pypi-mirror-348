...
class PendulumDamperMountingPosition(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Damper/PendulumDamperMountingPosition/PendulumDamperMountingPosition.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PendulumDamperMountingPosition):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PendulumDamperMountingPosition models')
        return PendulumDamperMountingPosition.parse_obj(data)
