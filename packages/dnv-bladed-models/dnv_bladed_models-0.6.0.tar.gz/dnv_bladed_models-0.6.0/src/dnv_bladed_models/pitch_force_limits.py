...
class PitchForceLimits(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchActuator/PitchForceLimits/PitchForceLimits.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchForceLimits):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchForceLimits models')
        return PitchForceLimits.parse_obj(data)
