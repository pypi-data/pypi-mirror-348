...
class Accelerometer(Sensor):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/common/Accelerometer.json')

    SensorType: Literal['Accelerometer'] = Field(alias="SensorType", default='Accelerometer', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        ...
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Accelerometer models')
        return Accelerometer.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = Accelerometer.from_file('/path/to/file')
        """
