...
class ProportionalIntegralDeriviative(ResponseToDemand):
    ...
    ResponseToDemandType: Literal['ProportionalIntegralDeriviative'] = Field(alias="ResponseToDemandType", default='ProportionalIntegralDeriviative', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, ProportionalIntegralDeriviative):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ProportionalIntegralDeriviative models')
        return ProportionalIntegralDeriviative.parse_obj(data)
