...
class ExtensionPieces(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Hub/ExtensionPieces/ExtensionPieces.json')
    ...
    def _factory(cls, data):
        if isinstance(data, ExtensionPieces):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ExtensionPieces models')
        return ExtensionPieces.parse_obj(data)
