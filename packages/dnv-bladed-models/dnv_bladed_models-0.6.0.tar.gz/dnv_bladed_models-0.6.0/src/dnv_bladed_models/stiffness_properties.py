...
class StiffnessProperties(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/StiffnessProperties/StiffnessProperties.json')
    ...
    def _factory(cls, data):
        if isinstance(data, StiffnessProperties):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define StiffnessProperties models')
        return StiffnessProperties.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = StiffnessProperties.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = StiffnessProperties.from_json('{ ... }')
        """
