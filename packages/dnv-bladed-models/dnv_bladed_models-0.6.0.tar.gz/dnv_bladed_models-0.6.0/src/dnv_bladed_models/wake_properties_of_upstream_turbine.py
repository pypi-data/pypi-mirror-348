...
class WakePropertiesOfUpstreamTurbine(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/DynamicUpstreamWake/WakePropertiesOfUpstreamTurbine/WakePropertiesOfUpstreamTurbine.json')
    ...
    def _factory(cls, data):
        if isinstance(data, WakePropertiesOfUpstreamTurbine):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define WakePropertiesOfUpstreamTurbine models')
        return WakePropertiesOfUpstreamTurbine.parse_obj(data)
