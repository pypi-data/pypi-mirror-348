...
class StructuralModellingInsert(CommonRoot):
    r"""
    A StructuralModelling is to be inserted from an external resource. The exact type of StructuralModelling is not currently known.
    
    Attributes
    ----------
    StructuralModellingType : Literal['__insert__'], default='__insert__'
    ...
    StructuralModellingType: Literal['__insert__'] = Field(alias="StructuralModellingType", default='__insert__', allow_mutation=False, const=True)
...
StructuralModellingInsert.update_forward_refs()
