...
class AppliedMomentVsFrictionTorque(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/Friction/PitchBearingKineticFriction/PitchBearingFrictionXYMomentRelationship/AppliedMomentVsFrictionTorque/AppliedMomentVsFrictionTorque.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AppliedMomentVsFrictionTorque):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AppliedMomentVsFrictionTorque models')
        return AppliedMomentVsFrictionTorque.parse_obj(data)
