...
class WavesInsert(CommonRoot):
    ...
    WavesType: Literal['__insert__'] = Field(alias="WavesType", default='__insert__', allow_mutation=False, const=True)
