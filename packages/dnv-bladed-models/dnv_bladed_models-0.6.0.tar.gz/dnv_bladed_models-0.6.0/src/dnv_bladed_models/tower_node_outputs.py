...
class TowerNodeOutputs(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerOutputGroupLibrary/TowerOutputGroup/TowerNodeOutputs/TowerNodeOutputs.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerNodeOutputs):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerNodeOutputs models')
        return TowerNodeOutputs.parse_obj(data)
