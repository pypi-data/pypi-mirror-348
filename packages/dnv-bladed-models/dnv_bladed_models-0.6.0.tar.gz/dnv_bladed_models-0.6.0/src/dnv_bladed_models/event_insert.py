...
class EventInsert(CommonRoot):
    r"""
    A Event is to be inserted from an external resource. The exact type of Event is not currently known.
    
    Attributes
    ----------
    EventType : Literal['__insert__'], default='__insert__'
    ...
    EventType: Literal['__insert__'] = Field(alias="EventType", default='__insert__', allow_mutation=False, const=True)
...
EventInsert.update_forward_refs()
