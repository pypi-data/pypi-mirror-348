...
class CurrentInsert(CommonRoot):
    r"""
    A Current is to be inserted from an external resource. The exact type of Current is not currently known.
    
    Attributes
    ----------
    CurrentType : Literal['__insert__'], default='__insert__'
    ...
    CurrentType: Literal['__insert__'] = Field(alias="CurrentType", default='__insert__', allow_mutation=False, const=True)
...
CurrentInsert.update_forward_refs()
