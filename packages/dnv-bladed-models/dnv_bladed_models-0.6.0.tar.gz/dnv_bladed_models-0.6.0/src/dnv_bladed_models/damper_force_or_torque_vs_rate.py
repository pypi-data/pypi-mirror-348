...
class DamperForceOrTorqueVsRate(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchController/PitchSafetySystem/DamperForceOrTorqueVsRate/DamperForceOrTorqueVsRate.json')
    ...
    def _factory(cls, data):
        if isinstance(data, DamperForceOrTorqueVsRate):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define DamperForceOrTorqueVsRate models')
        return DamperForceOrTorqueVsRate.parse_obj(data)
