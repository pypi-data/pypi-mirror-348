...
class TimeVsCurrentDirection(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/CurrentDirectionVariation/TimeVsCurrentDirection/TimeVsCurrentDirection.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TimeVsCurrentDirection):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TimeVsCurrentDirection models')
        return TimeVsCurrentDirection.parse_obj(data)
