...
class NominalHubWindSpeedVsRotorSpeedAndPitchAngle(BladedModel):
    ...
    def _factory(cls, data):
        if isinstance(data, NominalHubWindSpeedVsRotorSpeedAndPitchAngle):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NominalHubWindSpeedVsRotorSpeedAndPitchAngle models')
        return NominalHubWindSpeedVsRotorSpeedAndPitchAngle.parse_obj(data)
