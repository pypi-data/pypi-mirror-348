...
class PitchActuatorInsert(CommonRoot):
    r"""
    A PitchActuator is to be inserted from an external resource. The exact type of PitchActuator is not currently known.
    
    Attributes
    ----------
    ActuatorDriveType : Literal['__insert__'], default='__insert__'
    ...
    ActuatorDriveType: Literal['__insert__'] = Field(alias="ActuatorDriveType", default='__insert__', allow_mutation=False, const=True)
...
PitchActuatorInsert.update_forward_refs()
