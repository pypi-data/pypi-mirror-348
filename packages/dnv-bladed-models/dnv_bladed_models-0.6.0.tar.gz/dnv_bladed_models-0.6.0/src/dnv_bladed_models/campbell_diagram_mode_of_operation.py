...
class CampbellDiagramModeOfOperation(BladedModel, ABC):
    ...
    This class is an abstraction, with the following concrete implementations:
        ...
        - CampbellDiagramModeOfOperationInsert
    ...
    CampbellDiagramModeOfOperationType: CampbellDiagramModeOfOperation_CampbellDiagramModeOfOperationTypeEnum = Field(alias="CampbellDiagramModeOfOperationType", default=None) # Not supported yet
