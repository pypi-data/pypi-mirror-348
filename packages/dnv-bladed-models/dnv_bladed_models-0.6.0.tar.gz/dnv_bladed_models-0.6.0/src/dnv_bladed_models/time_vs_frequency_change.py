...
class TimeVsFrequencyChange(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Event/TimeVsFrequencyChange/TimeVsFrequencyChange.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TimeVsFrequencyChange):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TimeVsFrequencyChange models')
        return TimeVsFrequencyChange.parse_obj(data)
