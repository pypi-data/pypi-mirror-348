...
class IntegratorInsert(CommonRoot):
    r"""
    A Integrator is to be inserted from an external resource. The exact type of Integrator is not currently known.
    
    Attributes
    ----------
    IntegratorType : Literal['__insert__'], default='__insert__'
    ...
    IntegratorType: Literal['__insert__'] = Field(alias="IntegratorType", default='__insert__', allow_mutation=False, const=True)
...
IntegratorInsert.update_forward_refs()
