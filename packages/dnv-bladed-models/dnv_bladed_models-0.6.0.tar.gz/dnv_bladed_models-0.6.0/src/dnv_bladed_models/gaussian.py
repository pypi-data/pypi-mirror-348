...
class Gaussian(SteadyWakeDeficit):
    ...
    SteadyWakeDeficitType: Literal['Gaussian'] = Field(alias="SteadyWakeDeficitType", default='Gaussian', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        ...
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Gaussian models')
        return Gaussian.parse_obj(data)
