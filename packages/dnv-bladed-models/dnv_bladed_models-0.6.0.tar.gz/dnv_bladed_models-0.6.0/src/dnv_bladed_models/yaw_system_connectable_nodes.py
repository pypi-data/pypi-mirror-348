...
class YawSystemConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/YawSystem/YawSystemConnectableNodes/YawSystemConnectableNodes.json')
    ...
    def _factory(cls, data):
        if isinstance(data, YawSystemConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define YawSystemConnectableNodes models')
        return YawSystemConnectableNodes.parse_obj(data)


    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, YawSystemConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = YawSystemConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = YawSystemConnectableNodes.from_json('{ ... }')
        """
...
YawSystemConnectableNodes.update_forward_refs()
YawSystemConnectableNodes.__CustomEntries__.update_forward_refs()
