...
class NominalHubWindSpeedVsMinimumSteadyStatePitchAngle(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/TurbineOperationalParameters/VariableSpeedPitchRegulatedControlModel/NominalHubWindSpeedVsMinimumSteadyStatePitchAngle/NominalHubWindSpeedVsMinimumSteadyStatePitchAngle.json')
    ...
    def _factory(cls, data):
        if isinstance(data, NominalHubWindSpeedVsMinimumSteadyStatePitchAngle):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NominalHubWindSpeedVsMinimumSteadyStatePitchAngle models')
        return NominalHubWindSpeedVsMinimumSteadyStatePitchAngle.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = NominalHubWindSpeedVsMinimumSteadyStatePitchAngle.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = NominalHubWindSpeedVsMinimumSteadyStatePitchAngle.from_json('{ ... }')
        """
