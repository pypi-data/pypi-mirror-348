...
class DrivetrainConnectableNodes(BladedModel):
    r"""
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/DrivetrainConnectableNodes/DrivetrainConnectableNodes.json')
    ...
    def _factory(cls, data):
        if isinstance(data, DrivetrainConnectableNodes):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define DrivetrainConnectableNodes models')
        return DrivetrainConnectableNodes.parse_obj(data)


    @classmethod
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        return custom_entries_parser(cls, obj, dict, DrivetrainConnectableNodes.__CustomEntries__)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = DrivetrainConnectableNodes.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = DrivetrainConnectableNodes.from_json('{ ... }')
        """
...
DrivetrainConnectableNodes.update_forward_refs()
DrivetrainConnectableNodes.__CustomEntries__.update_forward_refs()
