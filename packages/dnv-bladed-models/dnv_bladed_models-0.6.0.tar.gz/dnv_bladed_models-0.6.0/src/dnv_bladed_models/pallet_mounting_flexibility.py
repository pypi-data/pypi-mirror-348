...
class PalletMountingFlexibility(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/PalletMountingFlexibility/PalletMountingFlexibility.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PalletMountingFlexibility):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PalletMountingFlexibility models')
        return PalletMountingFlexibility.parse_obj(data)
