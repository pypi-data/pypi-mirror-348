...
class DrivetrainAndNacelleMassProperties(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/DrivetrainAndNacelleMassProperties/DrivetrainAndNacelleMassProperties.json')
    ...
    def _factory(cls, data):
        if isinstance(data, DrivetrainAndNacelleMassProperties):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define DrivetrainAndNacelleMassProperties models')
        return DrivetrainAndNacelleMassProperties.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Returns
        -------
        DrivetrainAndNacelleMassProperties
            The model object.
        ...
        Examples
        --------
        >>> model = DrivetrainAndNacelleMassProperties.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = DrivetrainAndNacelleMassProperties.from_json('{ ... }')
        """
