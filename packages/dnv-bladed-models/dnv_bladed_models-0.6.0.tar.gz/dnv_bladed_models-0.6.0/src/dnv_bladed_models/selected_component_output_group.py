...
class SelectedComponentOutputGroup(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('common/SelectedComponentOutputGroup.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SelectedComponentOutputGroup):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SelectedComponentOutputGroup models')
        return SelectedComponentOutputGroup.parse_obj(data)
