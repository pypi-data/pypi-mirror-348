...
class SlippingClutch(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/SlippingClutch/SlippingClutch.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SlippingClutch):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SlippingClutch models')
        return SlippingClutch.parse_obj(data)
