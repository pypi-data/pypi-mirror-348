...
class TowerCanPropertiesExplicitWhereDifferent(TowerCanCrossSectionPropertiesWhereDifferent):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/TowerCanPropertiesExplicitWhereDifferent/TowerCanPropertiesExplicitWhereDifferent.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerCanPropertiesExplicitWhereDifferent):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerCanPropertiesExplicitWhereDifferent models')
        return TowerCanPropertiesExplicitWhereDifferent.parse_obj(data)
