...
class GeneratorOutputGroup(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Generator/GeneratorOutputGroupLibrary/GeneratorOutputGroup/GeneratorOutputGroup.json')
    ...
    def _factory(cls, data):
        if isinstance(data, GeneratorOutputGroup):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define GeneratorOutputGroup models')
        return GeneratorOutputGroup.parse_obj(data)
