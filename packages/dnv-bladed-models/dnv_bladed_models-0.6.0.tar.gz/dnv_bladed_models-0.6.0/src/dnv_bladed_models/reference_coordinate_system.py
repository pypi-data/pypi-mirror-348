...
class ReferenceCoordinateSystem(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/CoordinateSystems/ReferenceCoordinateSystem/ReferenceCoordinateSystem.json')
    ...
    def _factory(cls, data):
        if isinstance(data, ReferenceCoordinateSystem):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ReferenceCoordinateSystem models')
        return ReferenceCoordinateSystem.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = ReferenceCoordinateSystem.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = ReferenceCoordinateSystem.from_json('{ ... }')
        """
