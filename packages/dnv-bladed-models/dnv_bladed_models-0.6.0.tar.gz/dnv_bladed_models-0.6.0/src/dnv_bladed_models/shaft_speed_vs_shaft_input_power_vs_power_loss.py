...
class ShaftSpeedVsShaftInputPowerVsPowerLoss(BladedModel):
    ...
    def _factory(cls, data):
        if isinstance(data, ShaftSpeedVsShaftInputPowerVsPowerLoss):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ShaftSpeedVsShaftInputPowerVsPowerLoss models')
        return ShaftSpeedVsShaftInputPowerVsPowerLoss.parse_obj(data)
