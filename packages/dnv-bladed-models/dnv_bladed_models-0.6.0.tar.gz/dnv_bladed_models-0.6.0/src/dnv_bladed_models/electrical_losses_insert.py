...
class ElectricalLossesInsert(CommonRoot):
    r"""
    A ElectricalLosses is to be inserted from an external resource. The exact type of ElectricalLosses is not currently known.
    
    Attributes
    ----------
    ElectricalLossesType : Literal['__insert__'], default='__insert__'
    ...
    ElectricalLossesType: Literal['__insert__'] = Field(alias="ElectricalLossesType", default='__insert__', allow_mutation=False, const=True)
...
ElectricalLossesInsert.update_forward_refs()
