...
class PalletNodding(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/PalletMountingFlexibility/PalletNodding/PalletNodding.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PalletNodding):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PalletNodding models')
        return PalletNodding.parse_obj(data)
