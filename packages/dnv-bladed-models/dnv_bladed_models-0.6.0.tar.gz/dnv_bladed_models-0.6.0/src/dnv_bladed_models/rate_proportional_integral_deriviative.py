...
class RateProportionalIntegralDeriviative(TransducerBehaviour):
    ...
    TransducerBehaviourType: Literal['RateProportionalIntegralDeriviative'] = Field(alias="TransducerBehaviourType", default='RateProportionalIntegralDeriviative', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, RateProportionalIntegralDeriviative):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define RateProportionalIntegralDeriviative models')
        return RateProportionalIntegralDeriviative.parse_obj(data)
