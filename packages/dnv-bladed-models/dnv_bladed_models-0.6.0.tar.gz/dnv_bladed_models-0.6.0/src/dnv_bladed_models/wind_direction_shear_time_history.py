...
class WindDirectionShearTimeHistory(WindDirectionShearVariation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/WindDirectionShearVariation/WindDirectionShearTimeHistory.json')

    DirectionShearVariationType: Literal['TimeHistory'] = Field(alias="DirectionShearVariationType", default='TimeHistory', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, WindDirectionShearTimeHistory):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define WindDirectionShearTimeHistory models')
        return WindDirectionShearTimeHistory.parse_obj(data)
