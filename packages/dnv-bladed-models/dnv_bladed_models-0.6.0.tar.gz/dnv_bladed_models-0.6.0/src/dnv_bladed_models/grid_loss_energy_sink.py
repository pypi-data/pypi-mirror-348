...
class GridLossEnergySink(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/ElectricalGrid/GridLossEnergySink/GridLossEnergySink.json')
    ...
    def _factory(cls, data):
        if isinstance(data, GridLossEnergySink):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define GridLossEnergySink models')
        return GridLossEnergySink.parse_obj(data)
