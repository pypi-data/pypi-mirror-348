...
class ComponentInsert(CommonRoot):
    r"""
    A Component is to be inserted from an external resource. The exact type of Component is not currently known.
    
    Attributes
    ----------
    ComponentType : Literal['__insert__'], default='__insert__'
    ...
    ComponentType: Literal['__insert__'] = Field(alias="ComponentType", default='__insert__', allow_mutation=False, const=True)
...
ComponentInsert.update_forward_refs()
