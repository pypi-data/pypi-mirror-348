...
class Earthquake(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Earthquake/Earthquake.json')
    ...
    def _factory(cls, data):
        if isinstance(data, Earthquake):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Earthquake models')
        return Earthquake.parse_obj(data)
