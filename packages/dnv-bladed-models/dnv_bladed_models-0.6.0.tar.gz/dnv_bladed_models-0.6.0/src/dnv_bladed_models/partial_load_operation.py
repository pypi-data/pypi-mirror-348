...
class PartialLoadOperation(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/TurbineOperationalParameters/VariableSpeedPitchRegulatedControlModel/PartialLoadOperation/PartialLoadOperation.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PartialLoadOperation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PartialLoadOperation models')
        return PartialLoadOperation.parse_obj(data)
    ...
    def _find_unused_containers(self) -> Set[str]:
        ...
        if self.GeneratorSpeedVsGeneratorTorque is not None and len(self.GeneratorSpeedVsGeneratorTorque) == 0: #type: ignore
            unused_containers.add('GeneratorSpeedVsGeneratorTorque')
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = PartialLoadOperation.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = PartialLoadOperation.from_json('{ ... }')
        """
