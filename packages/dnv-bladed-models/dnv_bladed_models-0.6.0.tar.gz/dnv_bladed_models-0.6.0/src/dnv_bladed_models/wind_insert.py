...
class WindInsert(CommonRoot):
    r"""
    A Wind is to be inserted from an external resource. The exact type of Wind is not currently known.
    
    Attributes
    ----------
    WindType : Literal['__insert__'], default='__insert__'
    ...
    WindType: Literal['__insert__'] = Field(alias="WindType", default='__insert__', allow_mutation=False, const=True)
...
WindInsert.update_forward_refs()
