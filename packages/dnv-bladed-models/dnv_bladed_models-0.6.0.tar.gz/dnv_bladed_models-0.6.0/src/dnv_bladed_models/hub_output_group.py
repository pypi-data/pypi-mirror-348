...
class HubOutputGroup(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Hub/HubOutputGroupLibrary/HubOutputGroup/HubOutputGroup.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HubOutputGroup):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HubOutputGroup models')
        return HubOutputGroup.parse_obj(data)
