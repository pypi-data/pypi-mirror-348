...
class PitchBearingKineticFriction(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/Friction/PitchBearingKineticFriction/PitchBearingKineticFriction.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchBearingKineticFriction):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchBearingKineticFriction models')
        return PitchBearingKineticFriction.parse_obj(data)
