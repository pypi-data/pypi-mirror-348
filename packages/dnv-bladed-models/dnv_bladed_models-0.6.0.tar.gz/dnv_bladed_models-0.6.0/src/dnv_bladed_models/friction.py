...
class Friction(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/Friction/Friction.json')
    ...
    def _factory(cls, data):
        if isinstance(data, Friction):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Friction models')
        return Friction.parse_obj(data)
