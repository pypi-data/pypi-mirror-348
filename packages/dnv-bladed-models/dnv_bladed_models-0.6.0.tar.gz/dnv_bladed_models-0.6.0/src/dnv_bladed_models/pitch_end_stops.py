...
class PitchEndStops(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchEndStops/PitchEndStops.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchEndStops):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchEndStops models')
        return PitchEndStops.parse_obj(data)
