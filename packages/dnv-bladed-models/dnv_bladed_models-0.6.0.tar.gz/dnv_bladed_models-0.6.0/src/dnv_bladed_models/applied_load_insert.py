...
class AppliedLoadInsert(CommonRoot):
    r"""
    A AppliedLoad is to be inserted from an external resource. The exact type of AppliedLoad is not currently known.
    
    Attributes
    ----------
    AppliedLoadType : Literal['__insert__'], default='__insert__'
    ...
    AppliedLoadType: Literal['__insert__'] = Field(alias="AppliedLoadType", default='__insert__', allow_mutation=False, const=True)
...
AppliedLoadInsert.update_forward_refs()
