...
class AerodynamicModelInsert(CommonRoot):
    r"""
    A AerodynamicModel is to be inserted from an external resource. The exact type of AerodynamicModel is not currently known.
    
    Attributes
    ----------
    AerodynamicModelType : Literal['__insert__'], default='__insert__'
    ...
    AerodynamicModelType: Literal['__insert__'] = Field(alias="AerodynamicModelType", default='__insert__', allow_mutation=False, const=True)
...
AerodynamicModelInsert.update_forward_refs()
