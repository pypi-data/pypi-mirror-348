...
class MassProperties(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/MassProperties/MassProperties.json')
    ...
    def _factory(cls, data):
        if isinstance(data, MassProperties):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define MassProperties models')
        return MassProperties.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = MassProperties.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = MassProperties.from_json('{ ... }')
        """
