...
TBladeStabilityAnalysisModeOfOperationOptions = TypeVar('TBladeStabilityAnalysisModeOfOperationOptions', BladeStabilityAnalysisIdling, BladeStabilityAnalysisParked, BladeStabilityAnalysisModeOfOperationInsert, BladeStabilityAnalysisModeOfOperation, )
...
class BladeStabilityAnalysis(BladeStabilityAnalysisCalculation):
    ...
    ModeOfOperation : Union[BladeStabilityAnalysisIdling, BladeStabilityAnalysisParked, BladeStabilityAnalysisModeOfOperationInsert], Not supported yet
    
    Notes
    -----
    This model is not supported yet by the Bladed calculation engine.
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/BladeStabilityAnalysis.json')

    SteadyCalculationType: Literal['BladeStabilityAnalysis'] = Field(alias="SteadyCalculationType", default='BladeStabilityAnalysis', allow_mutation=False, const=True) # Not supported yet
    ModeOfOperation: Union[BladeStabilityAnalysisIdling, BladeStabilityAnalysisParked, BladeStabilityAnalysisModeOfOperationInsert] = Field(alias="ModeOfOperation", default=None, discriminator='BladeStabilityAnalysisModeOfOperationType') # Not supported yet
    ...
    def parse_obj(cls: Type['Model'], obj: Any) -> 'Model':
        discriminated_props = [
            ('ModeOfOperation', 'BladeStabilityAnalysisModeOfOperationType'),
        ]
    ...
    def _factory(cls, data):
        if isinstance(data, BladeStabilityAnalysis):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeStabilityAnalysis models')
        return BladeStabilityAnalysis.parse_obj(data)
    ...
    def ModeOfOperation_as(self, cls: Type[TBladeStabilityAnalysisModeOfOperationOptions])-> TBladeStabilityAnalysisModeOfOperationOptions:
        ...
        Parameters
        ----------
        cls: Type[Union[BladeStabilityAnalysisIdling, BladeStabilityAnalysisParked, BladeStabilityAnalysisModeOfOperationInsert]]
