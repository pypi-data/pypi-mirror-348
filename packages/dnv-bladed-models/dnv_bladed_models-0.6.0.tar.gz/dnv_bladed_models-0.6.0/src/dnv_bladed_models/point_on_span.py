...
class PointOnSpan(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/CoordinateSystems/ReferenceCoordinateSystem/PointOnSpan/PointOnSpan.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PointOnSpan):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PointOnSpan models')
        return PointOnSpan.parse_obj(data)
