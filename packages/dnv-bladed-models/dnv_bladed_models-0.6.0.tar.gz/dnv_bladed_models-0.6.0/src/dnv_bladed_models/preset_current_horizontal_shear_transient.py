...
class PresetCurrentHorizontalShearTransient(CurrentHorizontalShearVariation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/CurrentHorizontalShearVariation/PresetCurrentHorizontalShearTransient.json')

    HorizontalShearVariationType: Literal['PresetTransient'] = Field(alias="HorizontalShearVariationType", default='PresetTransient', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, PresetCurrentHorizontalShearTransient):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PresetCurrentHorizontalShearTransient models')
        return PresetCurrentHorizontalShearTransient.parse_obj(data)
