...
class MeanderingWake(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/DynamicUpstreamWake/MeanderingWake/MeanderingWake.json')
    ...
    def _factory(cls, data):
        if isinstance(data, MeanderingWake):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define MeanderingWake models')
        return MeanderingWake.parse_obj(data)
