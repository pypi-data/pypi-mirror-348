...
class PitchPositionVsMinimumAndMaximumMoment(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchActuator/common/PitchPositionVsMinimumAndMaximumMoment.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchPositionVsMinimumAndMaximumMoment):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchPositionVsMinimumAndMaximumMoment models')
        return PitchPositionVsMinimumAndMaximumMoment.parse_obj(data)
