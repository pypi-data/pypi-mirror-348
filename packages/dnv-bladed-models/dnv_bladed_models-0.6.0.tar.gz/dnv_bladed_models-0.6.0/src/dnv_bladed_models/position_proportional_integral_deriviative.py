...
class PositionProportionalIntegralDeriviative_DifferentialGainActionEnum(str, Enum):
    ERROR = "Error"
    FEEDBACK = "Feedback"
    SETPOINT = "Setpoint"
...
class PositionProportionalIntegralDeriviative(TransducerBehaviour):
    r"""
    ...
    Attributes
    ----------
    TransducerBehaviourType : Literal['PositionProportionalIntegralDeriviative'], default='PositionProportionalIntegralDeriviative', Not supported yet
    ...
    DifferentialGainAction : PositionProportionalIntegralDeriviative_DifferentialGainActionEnum, default='Feedback', Not supported yet
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/common/PositionProportionalIntegralDeriviative.json')

    TransducerBehaviourType: Literal['PositionProportionalIntegralDeriviative'] = Field(alias="TransducerBehaviourType", default='PositionProportionalIntegralDeriviative', allow_mutation=False, const=True) # Not supported yet
    ...
    DifferentialGainAction: PositionProportionalIntegralDeriviative_DifferentialGainActionEnum = Field(alias="DifferentialGainAction", default=None) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, PositionProportionalIntegralDeriviative):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PositionProportionalIntegralDeriviative models')
        return PositionProportionalIntegralDeriviative.parse_obj(data)
    ...
    def _is_unused(self) -> bool:
        ...
        """
        candidate_fields = [x[1] for x in self.__dict__.items() if x[0] != 'TransducerBehaviourType']
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = PositionProportionalIntegralDeriviative.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = PositionProportionalIntegralDeriviative.from_json('{ ... }')
        """
...
PositionProportionalIntegralDeriviative.update_forward_refs()
