...
class CurrentHorizontalShearVariation(BladedModel, ABC):
    ...
    This class is an abstraction, with the following concrete implementations:
        ...
        - CurrentHorizontalShearVariationInsert
    ...
    HorizontalShearVariationType: CurrentHorizontalShearVariation_HorizontalShearVariationTypeEnum = Field(alias="HorizontalShearVariationType", default=None) # Not supported yet
