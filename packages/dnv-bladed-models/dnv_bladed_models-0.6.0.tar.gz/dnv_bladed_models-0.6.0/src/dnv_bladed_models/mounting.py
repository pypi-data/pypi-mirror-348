...
class Mounting(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/Mounting/Mounting.json')
    ...
    def _factory(cls, data):
        if isinstance(data, Mounting):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Mounting models')
        return Mounting.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = Mounting.from_file('/path/to/file')
        """
