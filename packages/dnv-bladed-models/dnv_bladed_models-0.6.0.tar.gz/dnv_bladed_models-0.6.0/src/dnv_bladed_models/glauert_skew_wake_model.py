...
class GlauertSkewWakeModel(SkewWakeModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/AerodynamicSettings/AerodynamicModel/MomentumTheoryCorrections/GlauertSkewWakeModel/GlauertSkewWakeModel.json')
    ...
    def _factory(cls, data):
        if isinstance(data, GlauertSkewWakeModel):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define GlauertSkewWakeModel models')
        return GlauertSkewWakeModel.parse_obj(data)
