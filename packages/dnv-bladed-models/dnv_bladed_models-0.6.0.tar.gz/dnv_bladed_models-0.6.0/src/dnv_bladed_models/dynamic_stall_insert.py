...
class DynamicStallInsert(CommonRoot):
    r"""
    A DynamicStall is to be inserted from an external resource. The exact type of DynamicStall is not currently known.
    
    Attributes
    ----------
    DynamicStallType : Literal['__insert__'], default='__insert__'
    ...
    DynamicStallType: Literal['__insert__'] = Field(alias="DynamicStallType", default='__insert__', allow_mutation=False, const=True)
...
DynamicStallInsert.update_forward_refs()
