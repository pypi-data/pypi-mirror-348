...
class HardwareTracking(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/ExternallySteppedSimulation/HardwareTracking/HardwareTracking.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HardwareTracking):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HardwareTracking models')
        return HardwareTracking.parse_obj(data)
