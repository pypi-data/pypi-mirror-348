...
class CurrentMeanSpeedVariationInsert(CommonRoot):
    r"""
    A CurrentMeanSpeedVariation is to be inserted from an external resource. The exact type of CurrentMeanSpeedVariation is not currently known.
    
    Attributes
    ----------
    MeanSpeedVariationType : Literal['__insert__'], default='__insert__'
    ...
    MeanSpeedVariationType: Literal['__insert__'] = Field(alias="MeanSpeedVariationType", default='__insert__', allow_mutation=False, const=True)
...
CurrentMeanSpeedVariationInsert.update_forward_refs()
