...
class HubMassProperties(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Hub/HubMassProperties/HubMassProperties.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HubMassProperties):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HubMassProperties models')
        return HubMassProperties.parse_obj(data)
