...
class NearShoreCurrent(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/NearShoreCurrent/NearShoreCurrent.json')
    ...
    def _factory(cls, data):
        if isinstance(data, NearShoreCurrent):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NearShoreCurrent models')
        return NearShoreCurrent.parse_obj(data)
