...
class BladeOutputsForCrossSection(BladeOutputsForLocation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/BladeOutputGroupLibrary/BladeOutputGroup/BladeOutputsForLocation/BladeOutputsForCrossSection.json')

    BladeOutputsForLocationType: Literal['OutputsForCrossSection'] = Field(alias="BladeOutputsForLocationType", default='OutputsForCrossSection', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, BladeOutputsForCrossSection):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeOutputsForCrossSection models')
        return BladeOutputsForCrossSection.parse_obj(data)
    ...
    def _is_unused(self) -> bool:
        ...
        """
        candidate_fields = [x[1] for x in self.__dict__.items() if x[0] != 'BladeOutputsForLocationType']
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = BladeOutputsForCrossSection.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = BladeOutputsForCrossSection.from_json('{ ... }')
        """
