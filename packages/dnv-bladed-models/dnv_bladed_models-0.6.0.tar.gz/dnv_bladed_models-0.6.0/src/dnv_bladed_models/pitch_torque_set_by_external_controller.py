...
class PitchTorqueSetByExternalController(PitchControllerTorqueSafetySystem):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchController/PitchSafetySystem/PitchTorqueSetByExternalController.json')

    PitchSafetySystemType: Literal['TorqueSetByExternalController'] = Field(alias="PitchSafetySystemType", default='TorqueSetByExternalController', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, PitchTorqueSetByExternalController):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchTorqueSetByExternalController models')
        return PitchTorqueSetByExternalController.parse_obj(data)
