...
class TransducerFaultsMoment(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesMoment/TransducerFaultsMoment/TransducerFaultsMoment.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsMoment):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsMoment models')
        return TransducerFaultsMoment.parse_obj(data)
