...
class AerodynamicInformationCalculation(SteadyCalculation):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/AerodynamicInformationCalculation.json')

    SteadyCalculationType: Literal['AerodynamicInformation'] = Field(alias="SteadyCalculationType", default='AerodynamicInformation', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, AerodynamicInformationCalculation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AerodynamicInformationCalculation models')
        return AerodynamicInformationCalculation.parse_obj(data)
