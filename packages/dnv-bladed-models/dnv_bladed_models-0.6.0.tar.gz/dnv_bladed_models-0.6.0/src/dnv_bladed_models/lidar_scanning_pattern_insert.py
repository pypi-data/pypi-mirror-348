...
class LidarScanningPatternInsert(CommonRoot):
    r"""
    ...
    Attributes
    ----------
    ScanningPatternType : Literal['__insert__'], default='__insert__'
    ...
    ScanningPatternType: Literal['__insert__'] = Field(alias="ScanningPatternType", default='__insert__', allow_mutation=False, const=True)
