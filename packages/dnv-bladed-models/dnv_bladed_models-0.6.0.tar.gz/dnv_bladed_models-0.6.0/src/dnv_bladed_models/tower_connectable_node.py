...
class TowerConnectableNode(ConnectableNode):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerConnectableNodes/TowerConnectableNode/TowerConnectableNode.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerConnectableNode):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerConnectableNode models')
        return TowerConnectableNode.parse_obj(data)
