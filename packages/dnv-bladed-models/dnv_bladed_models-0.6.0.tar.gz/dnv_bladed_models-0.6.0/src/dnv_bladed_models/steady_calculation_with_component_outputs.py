...
class SteadyCalculationWithComponentOutputs(Outputs):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/SteadyCalculationWithComponentOutputs/SteadyCalculationWithComponentOutputs.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SteadyCalculationWithComponentOutputs):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SteadyCalculationWithComponentOutputs models')
        return SteadyCalculationWithComponentOutputs.parse_obj(data)
