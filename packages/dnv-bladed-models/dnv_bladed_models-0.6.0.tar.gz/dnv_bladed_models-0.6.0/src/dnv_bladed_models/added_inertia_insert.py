...
class AddedInertiaInsert(CommonRoot):
    r"""
    A AddedInertia is to be inserted from an external resource. The exact type of AddedInertia is not currently known.
    
    Attributes
    ----------
    AddedInertiaType : Literal['__insert__'], default='__insert__'
    ...
    AddedInertiaType: Literal['__insert__'] = Field(alias="AddedInertiaType", default='__insert__', allow_mutation=False, const=True)
...
AddedInertiaInsert.update_forward_refs()
