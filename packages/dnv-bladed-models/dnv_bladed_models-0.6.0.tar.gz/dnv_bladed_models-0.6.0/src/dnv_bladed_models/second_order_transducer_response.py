...
class SecondOrderTransducerResponse(TransducerBehaviour):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/common/SecondOrderTransducerResponse.json')

    TransducerBehaviourType: Literal['SecondOrderTransducerResponse'] = Field(alias="TransducerBehaviourType", default='SecondOrderTransducerResponse', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, SecondOrderTransducerResponse):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SecondOrderTransducerResponse models')
        return SecondOrderTransducerResponse.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = SecondOrderTransducerResponse.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = SecondOrderTransducerResponse.from_json('{ ... }')
        """
