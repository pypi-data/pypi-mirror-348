...
class GeneratorOverpower(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/SafetySystem/GeneratorOverpower/GeneratorOverpower.json')
    ...
    def _factory(cls, data):
        if isinstance(data, GeneratorOverpower):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define GeneratorOverpower models')
        return GeneratorOverpower.parse_obj(data)
