...
class HeightVsShearFactor(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('common/HeightVsShearFactor.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HeightVsShearFactor):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HeightVsShearFactor models')
        return HeightVsShearFactor.parse_obj(data)
