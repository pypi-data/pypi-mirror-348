...
class ResponseToDemandInsert(CommonRoot):
    r"""
    A ResponseToDemand is to be inserted from an external resource. The exact type of ResponseToDemand is not currently known.
    
    Attributes
    ----------
    ResponseToDemandType : Literal['__insert__'], default='__insert__'
    ...
    ResponseToDemandType: Literal['__insert__'] = Field(alias="ResponseToDemandType", default='__insert__', allow_mutation=False, const=True)
...
ResponseToDemandInsert.update_forward_refs()
