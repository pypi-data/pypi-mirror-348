...
class TowerOutputGroup(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerOutputGroupLibrary/TowerOutputGroup/TowerOutputGroup.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerOutputGroup):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerOutputGroup models')
        return TowerOutputGroup.parse_obj(data)
    ...
    def _find_unused_containers(self) -> Set[str]:
        ...
        if self.NodesAtHeights._is_unused():
            unused_containers.add('NodesAtHeights')
