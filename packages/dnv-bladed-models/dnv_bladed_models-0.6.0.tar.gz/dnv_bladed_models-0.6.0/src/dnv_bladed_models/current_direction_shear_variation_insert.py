...
class CurrentDirectionShearVariationInsert(CommonRoot):
    r"""
    A CurrentDirectionShearVariation is to be inserted from an external resource. The exact type of CurrentDirectionShearVariation is not currently known.
...
CurrentDirectionShearVariationInsert.update_forward_refs()
