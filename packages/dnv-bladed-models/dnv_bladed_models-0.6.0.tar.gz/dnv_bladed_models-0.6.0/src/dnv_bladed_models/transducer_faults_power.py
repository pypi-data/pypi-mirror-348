...
class TransducerFaultsPower(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesPower/TransducerFaultsPower/TransducerFaultsPower.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsPower):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsPower models')
        return TransducerFaultsPower.parse_obj(data)
