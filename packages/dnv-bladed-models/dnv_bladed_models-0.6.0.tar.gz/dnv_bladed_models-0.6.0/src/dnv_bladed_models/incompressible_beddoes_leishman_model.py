...
class IncompressibleBeddoesLeishmanModel(BeddoesLeishmanModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/AerodynamicSettings/DynamicStall/IncompressibleBeddoesLeishmanModel.json')

    DynamicStallType: Literal['IncompressibleBeddoesLeishmanModel'] = Field(alias="DynamicStallType", default='IncompressibleBeddoesLeishmanModel', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, IncompressibleBeddoesLeishmanModel):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define IncompressibleBeddoesLeishmanModel models')
        return IncompressibleBeddoesLeishmanModel.parse_obj(data)
