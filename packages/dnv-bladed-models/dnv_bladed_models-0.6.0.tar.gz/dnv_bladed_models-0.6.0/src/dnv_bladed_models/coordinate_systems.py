...
class CoordinateSystems(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/CoordinateSystems/CoordinateSystems.json')
    ...
    def _factory(cls, data):
        if isinstance(data, CoordinateSystems):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define CoordinateSystems models')
        return CoordinateSystems.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = CoordinateSystems.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = CoordinateSystems.from_json('{ ... }')
        """
