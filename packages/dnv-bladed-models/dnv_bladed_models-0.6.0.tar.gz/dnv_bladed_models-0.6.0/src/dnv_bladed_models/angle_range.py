...
class AngleRange(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('SteadyCalculation/AngleRange/AngleRange.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AngleRange):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AngleRange models')
        return AngleRange.parse_obj(data)
