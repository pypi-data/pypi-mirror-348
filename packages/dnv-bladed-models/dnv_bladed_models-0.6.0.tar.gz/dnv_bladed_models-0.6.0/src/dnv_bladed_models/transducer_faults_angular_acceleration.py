...
class TransducerFaultsAngularAcceleration(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesAngularAcceleration/TransducerFaultsAngularAcceleration/TransducerFaultsAngularAcceleration.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsAngularAcceleration):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsAngularAcceleration models')
        return TransducerFaultsAngularAcceleration.parse_obj(data)
