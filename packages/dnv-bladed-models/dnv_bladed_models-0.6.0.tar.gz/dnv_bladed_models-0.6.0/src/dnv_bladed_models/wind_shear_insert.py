...
class WindShearInsert(CommonRoot):
    r"""
    A WindShear is to be inserted from an external resource. The exact type of WindShear is not currently known.
    
    Attributes
    ----------
    WindShearType : Literal['__insert__'], default='__insert__'
    ...
    WindShearType: Literal['__insert__'] = Field(alias="WindShearType", default='__insert__', allow_mutation=False, const=True)
...
WindShearInsert.update_forward_refs()
