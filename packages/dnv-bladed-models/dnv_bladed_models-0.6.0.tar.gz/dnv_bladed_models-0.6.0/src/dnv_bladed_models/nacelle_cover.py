...
class NacelleCover(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/NacelleCover/NacelleCover.json')
    ...
    def _factory(cls, data):
        if isinstance(data, NacelleCover):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NacelleCover models')
        return NacelleCover.parse_obj(data)
