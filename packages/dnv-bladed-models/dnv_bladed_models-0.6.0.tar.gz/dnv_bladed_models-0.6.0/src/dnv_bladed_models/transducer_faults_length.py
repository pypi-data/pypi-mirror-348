...
class TransducerFaultsLength(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesLength/TransducerFaultsLength/TransducerFaultsLength.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsLength):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsLength models')
        return TransducerFaultsLength.parse_obj(data)
