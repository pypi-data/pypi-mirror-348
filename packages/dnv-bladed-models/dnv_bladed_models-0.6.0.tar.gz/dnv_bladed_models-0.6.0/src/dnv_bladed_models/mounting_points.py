...
class MountingPoints(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Hub/MountingPoints/MountingPoints.json')
    ...
    def _factory(cls, data):
        if isinstance(data, MountingPoints):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define MountingPoints models')
        return MountingPoints.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = MountingPoints.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = MountingPoints.from_json('{ ... }')
        """
