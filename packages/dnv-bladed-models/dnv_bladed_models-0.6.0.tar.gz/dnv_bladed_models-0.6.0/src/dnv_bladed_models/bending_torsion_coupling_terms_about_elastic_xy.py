...
class BendingTorsionCouplingTermsAboutElasticXY(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/CrossSection/StiffnessProperties/BendingTorsionCouplingTermsAboutElasticXY/BendingTorsionCouplingTermsAboutElasticXY.json')
    ...
    def _factory(cls, data):
        if isinstance(data, BendingTorsionCouplingTermsAboutElasticXY):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BendingTorsionCouplingTermsAboutElasticXY models')
        return BendingTorsionCouplingTermsAboutElasticXY.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Returns
        -------
        BendingTorsionCouplingTermsAboutElasticXY
            The model object.
        ...
        Examples
        --------
        >>> model = BendingTorsionCouplingTermsAboutElasticXY.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = BendingTorsionCouplingTermsAboutElasticXY.from_json('{ ... }')
        """
...
BendingTorsionCouplingTermsAboutElasticXY.update_forward_refs()
