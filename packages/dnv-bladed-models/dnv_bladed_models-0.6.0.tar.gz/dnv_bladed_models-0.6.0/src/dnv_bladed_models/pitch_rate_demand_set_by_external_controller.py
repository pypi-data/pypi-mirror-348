...
class PitchRateDemandSetByExternalController(PitchControllerRateSafetySystem):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchController/PitchSafetySystem/PitchRateDemandSetByExternalController.json')

    PitchSafetySystemType: Literal['RateDemandSetByExternalController'] = Field(alias="PitchSafetySystemType", default='RateDemandSetByExternalController', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, PitchRateDemandSetByExternalController):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchRateDemandSetByExternalController models')
        return PitchRateDemandSetByExternalController.parse_obj(data)
