...
class ShortCircuit(Fault):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Event/ShortCircuit.json')

    EventType: Literal['ShortCircuit'] = Field(alias="EventType", default='ShortCircuit', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        ...
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ShortCircuit models')
        return ShortCircuit.parse_obj(data)
