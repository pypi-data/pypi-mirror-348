...
class EquilibriumStateSolverSettings(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Settings/SolverSettings/EquilibriumStateSolverSettings/EquilibriumStateSolverSettings.json')
    ...
    def _factory(cls, data):
        if isinstance(data, EquilibriumStateSolverSettings):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define EquilibriumStateSolverSettings models')
        return EquilibriumStateSolverSettings.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Returns
        -------
        EquilibriumStateSolverSettings
            The model object.
        ...
        Examples
        --------
        >>> model = EquilibriumStateSolverSettings.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = EquilibriumStateSolverSettings.from_json('{ ... }')
        """
