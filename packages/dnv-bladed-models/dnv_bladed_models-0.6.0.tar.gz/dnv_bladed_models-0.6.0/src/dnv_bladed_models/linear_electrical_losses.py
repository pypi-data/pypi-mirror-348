...
class LinearElectricalLosses(ElectricalLosses):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Generator/ElectricalLosses/LinearElectricalLosses.json')

    ElectricalLossesType: Literal['LinearElectricalLosses'] = Field(alias="ElectricalLossesType", default='LinearElectricalLosses', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, LinearElectricalLosses):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LinearElectricalLosses models')
        return LinearElectricalLosses.parse_obj(data)
