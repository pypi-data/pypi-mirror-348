...
class LinearSpringDamper(FlexibleJoint):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchActuator/LinearSpringDamper/LinearSpringDamper.json')
    ...
    def _factory(cls, data):
        if isinstance(data, LinearSpringDamper):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LinearSpringDamper models')
        return LinearSpringDamper.parse_obj(data)
