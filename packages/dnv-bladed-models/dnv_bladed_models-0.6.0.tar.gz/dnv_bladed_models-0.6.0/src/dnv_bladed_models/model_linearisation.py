...
class ModelLinearisation(LinearisationCalculation):
    ...
    SteadyCalculationType: Literal['ModelLinearisation'] = Field(alias="SteadyCalculationType", default='ModelLinearisation', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, ModelLinearisation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ModelLinearisation models')
        return ModelLinearisation.parse_obj(data)
