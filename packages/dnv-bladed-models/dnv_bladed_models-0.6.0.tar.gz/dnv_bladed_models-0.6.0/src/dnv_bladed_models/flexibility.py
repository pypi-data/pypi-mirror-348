...
class Flexibility(Component):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Flexibility.json')

    ComponentType: Literal['Flexibility'] = Field(alias="ComponentType", default='Flexibility', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, Flexibility):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Flexibility models')
        return Flexibility.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = Flexibility.from_file('/path/to/file')
        """
