...
class GeneralisedAlphaFixedStep(FixedStepIntegrator):
    ...
    IntegratorType: Literal['GeneralisedAlphaFixedStep'] = Field(alias="IntegratorType", default='GeneralisedAlphaFixedStep', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, GeneralisedAlphaFixedStep):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define GeneralisedAlphaFixedStep models')
        return GeneralisedAlphaFixedStep.parse_obj(data)
