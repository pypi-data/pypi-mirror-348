...
class StructuralMode(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/common/StructuralMode.json')
    ...
    def _factory(cls, data):
        if isinstance(data, StructuralMode):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define StructuralMode models')
        return StructuralMode.parse_obj(data)
