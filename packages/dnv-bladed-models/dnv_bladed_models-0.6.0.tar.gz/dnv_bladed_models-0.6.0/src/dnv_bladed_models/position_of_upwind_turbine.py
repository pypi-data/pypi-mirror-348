...
class PositionOfUpwindTurbine(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/Wind/DynamicUpstreamWake/PositionOfUpwindTurbine/PositionOfUpwindTurbine.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PositionOfUpwindTurbine):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PositionOfUpwindTurbine models')
        return PositionOfUpwindTurbine.parse_obj(data)
