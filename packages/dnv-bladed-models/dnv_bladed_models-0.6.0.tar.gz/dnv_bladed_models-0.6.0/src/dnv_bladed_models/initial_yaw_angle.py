...
class InitialYawAngle(InitialPosition):
    ...
    InitialConditionType: Literal['InitialYawAngle'] = Field(alias="InitialConditionType", default='InitialYawAngle', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, InitialYawAngle):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define InitialYawAngle models')
        return InitialYawAngle.parse_obj(data)
