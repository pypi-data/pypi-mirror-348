...
class ShaftInputPowerVsPowerLoss(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/DrivetrainAndNacelle/MechanicalLosses/common/ShaftInputPowerVsPowerLoss.json')
    ...
    def _factory(cls, data):
        if isinstance(data, ShaftInputPowerVsPowerLoss):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define ShaftInputPowerVsPowerLoss models')
        return ShaftInputPowerVsPowerLoss.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = ShaftInputPowerVsPowerLoss.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = ShaftInputPowerVsPowerLoss.from_json('{ ... }')
        """
