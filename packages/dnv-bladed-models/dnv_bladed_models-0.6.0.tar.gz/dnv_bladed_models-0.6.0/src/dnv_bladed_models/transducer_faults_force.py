...
class TransducerFaultsForce(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesForce/TransducerFaultsForce/TransducerFaultsForce.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsForce):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsForce models')
        return TransducerFaultsForce.parse_obj(data)
