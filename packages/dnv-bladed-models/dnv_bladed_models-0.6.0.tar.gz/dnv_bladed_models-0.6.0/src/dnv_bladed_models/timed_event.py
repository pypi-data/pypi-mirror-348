...
class TimedEvent(Event, ABC):
    ...
    Attributes
    ----------
    TimeOccurs : float, Not supported yet
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Event/common/TimedEvent.json')

    TimeOccurs: float = Field(alias="TimeOccurs", default=None) # Not supported yet
