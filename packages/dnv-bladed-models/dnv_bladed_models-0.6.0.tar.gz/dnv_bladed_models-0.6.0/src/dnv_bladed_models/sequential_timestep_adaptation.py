...
class SequentialTimestepAdaptation(BladedModel):
    ...
    def _factory(cls, data):
        if isinstance(data, SequentialTimestepAdaptation):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SequentialTimestepAdaptation models')
        return SequentialTimestepAdaptation.parse_obj(data)
