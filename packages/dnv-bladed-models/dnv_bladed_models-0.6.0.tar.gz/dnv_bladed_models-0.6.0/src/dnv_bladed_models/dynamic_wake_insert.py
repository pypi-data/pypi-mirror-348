...
class DynamicWakeInsert(CommonRoot):
    r"""
    A DynamicWake is to be inserted from an external resource. The exact type of DynamicWake is not currently known.
    
    Attributes
    ----------
    DynamicWakeType : Literal['__insert__'], default='__insert__'
    ...
    DynamicWakeType: Literal['__insert__'] = Field(alias="DynamicWakeType", default='__insert__', allow_mutation=False, const=True)
...
DynamicWakeInsert.update_forward_refs()
