...
class TransducerBehaviourInsert(CommonRoot):
    r"""
    A TransducerBehaviour is to be inserted from an external resource. The exact type of TransducerBehaviour is not currently known.
    
    Attributes
    ----------
    TransducerBehaviourType : Literal['__insert__'], default='__insert__'
    ...
    TransducerBehaviourType: Literal['__insert__'] = Field(alias="TransducerBehaviourType", default='__insert__', allow_mutation=False, const=True)
...
TransducerBehaviourInsert.update_forward_refs()
