...
class HeightUpTowerVsCdCm(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerHydrodynamicProperties/HeightUpTowerVsCdCm/HeightUpTowerVsCdCm.json')
    ...
    def _factory(cls, data):
        if isinstance(data, HeightUpTowerVsCdCm):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define HeightUpTowerVsCdCm models')
        return HeightUpTowerVsCdCm.parse_obj(data)
