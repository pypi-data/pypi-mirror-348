...
class BladeStabilityAnalysisIdling(BladeStabilityAnalysisModeOfOperation):
    r"""
    ...
    Attributes
    ----------
    BladeStabilityAnalysisModeOfOperationType : Literal['Idling'], default='Idling', Not supported yet
    ...
    BladeStabilityAnalysisModeOfOperationType: Literal['Idling'] = Field(alias="BladeStabilityAnalysisModeOfOperationType", default='Idling', allow_mutation=False, const=True) # Not supported yet
    TorqueSpeedGain: float = Field(alias="TorqueSpeedGain", default=None) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, BladeStabilityAnalysisIdling):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define BladeStabilityAnalysisIdling models')
        return BladeStabilityAnalysisIdling.parse_obj(data)
    ...
    def _is_unused(self) -> bool:
        ...
        """
        candidate_fields = [x[1] for x in self.__dict__.items() if x[0] != 'BladeStabilityAnalysisModeOfOperationType']
