...
class InitialFloatingPosition(InitialPosition):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/InitialCondition/InitialFloatingPosition.json')

    InitialConditionType: Literal['InitialFloatingPosition'] = Field(alias="InitialConditionType", default='InitialFloatingPosition', allow_mutation=False, const=True) # Not supported yet
    ...
    def _factory(cls, data):
        if isinstance(data, InitialFloatingPosition):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define InitialFloatingPosition models')
        return InitialFloatingPosition.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialFloatingPosition.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialFloatingPosition.from_json('{ ... }')
        """
