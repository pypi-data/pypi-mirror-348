...
class TowerCanPropertiesByMaterialWhereDifferent(TowerCanCrossSectionPropertiesWhereDifferent):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/TowerCanPropertiesByMaterialWhereDifferent/TowerCanPropertiesByMaterialWhereDifferent.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerCanPropertiesByMaterialWhereDifferent):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerCanPropertiesByMaterialWhereDifferent models')
        return TowerCanPropertiesByMaterialWhereDifferent.parse_obj(data)
