...
class LookUpTableElement(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Lidar/LookUpTableElement/LookUpTableElement.json')
    ...
    def _factory(cls, data):
        if isinstance(data, LookUpTableElement):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LookUpTableElement models')
        return LookUpTableElement.parse_obj(data)
