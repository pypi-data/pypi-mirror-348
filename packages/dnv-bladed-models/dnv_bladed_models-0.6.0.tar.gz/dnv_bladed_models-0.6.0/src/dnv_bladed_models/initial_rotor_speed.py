...
class InitialRotorSpeed(InitialCondition):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/InitialCondition/InitialRotorSpeed.json')

    InitialConditionType: Literal['InitialRotorSpeed'] = Field(alias="InitialConditionType", default='InitialRotorSpeed', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, InitialRotorSpeed):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define InitialRotorSpeed models')
        return InitialRotorSpeed.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialRotorSpeed.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = InitialRotorSpeed.from_json('{ ... }')
        """
