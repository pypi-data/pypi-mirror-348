...
class AlphaLine(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/AerofoilLibrary/Aerofoil/AlphaLine/AlphaLine.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AlphaLine):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AlphaLine models')
        return AlphaLine.parse_obj(data)
