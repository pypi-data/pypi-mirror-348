...
class TransducerFaultsAcceleration(TransducerFaults):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/MeasuredSignalProperties/SignalPropertiesAcceleration/TransducerFaultsAcceleration/TransducerFaultsAcceleration.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TransducerFaultsAcceleration):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TransducerFaultsAcceleration models')
        return TransducerFaultsAcceleration.parse_obj(data)
