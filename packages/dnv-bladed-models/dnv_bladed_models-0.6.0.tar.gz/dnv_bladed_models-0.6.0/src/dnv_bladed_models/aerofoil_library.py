...
class AerofoilLibrary(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Blade/AerofoilLibrary/AerofoilLibrary.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AerofoilLibrary):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AerofoilLibrary models')
        return AerofoilLibrary.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = AerofoilLibrary.from_file('/path/to/file')
        """
    ...
    def from_json(cls: Type['Model'], b: StrBytes) -> 'Model':
        ...
        Examples
        --------
        >>> model = AerofoilLibrary.from_json('{ ... }')
        """
