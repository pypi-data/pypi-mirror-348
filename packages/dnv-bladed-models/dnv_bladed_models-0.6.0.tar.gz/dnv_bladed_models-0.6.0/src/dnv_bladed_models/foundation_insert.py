...
class FoundationInsert(CommonRoot):
    r"""
    A Foundation is to be inserted from an external resource. The exact type of Foundation is not currently known.
    
    Attributes
    ----------
    FoundationType : Literal['__insert__'], default='__insert__'
    ...
    FoundationType: Literal['__insert__'] = Field(alias="FoundationType", default='__insert__', allow_mutation=False, const=True)
...
FoundationInsert.update_forward_refs()
