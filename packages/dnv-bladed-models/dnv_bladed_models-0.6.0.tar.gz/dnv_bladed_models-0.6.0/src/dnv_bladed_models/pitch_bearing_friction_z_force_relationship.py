...
class PitchBearingFrictionZForceRelationship(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/Friction/PitchBearingKineticFriction/PitchBearingFrictionZForceRelationship/PitchBearingFrictionZForceRelationship.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchBearingFrictionZForceRelationship):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchBearingFrictionZForceRelationship models')
        return PitchBearingFrictionZForceRelationship.parse_obj(data)
