...
class TowerCanInsert(CommonRoot):
    r"""
    A TowerCan is to be inserted from an external resource. The exact type of TowerCan is not currently known.
    
    Attributes
    ----------
    TowerCanType : Literal['__insert__'], default='__insert__'
    ...
    TowerCanType: Literal['__insert__'] = Field(alias="TowerCanType", default='__insert__', allow_mutation=False, const=True)
...
TowerCanInsert.update_forward_refs()
