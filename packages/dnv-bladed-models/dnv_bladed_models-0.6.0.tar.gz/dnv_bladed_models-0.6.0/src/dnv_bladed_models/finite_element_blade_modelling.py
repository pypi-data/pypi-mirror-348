...
class FiniteElementBladeModelling(BladeModelling):
    ...
    BladeModellingType: Literal['FiniteElementBladeModelling'] = Field(alias="BladeModellingType", default='FiniteElementBladeModelling', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, FiniteElementBladeModelling):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define FiniteElementBladeModelling models')
        return FiniteElementBladeModelling.parse_obj(data)
