...
class PitchLimitSwitches(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/PitchSystem/PitchLimitSwitches/PitchLimitSwitches.json')
    ...
    def _factory(cls, data):
        if isinstance(data, PitchLimitSwitches):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define PitchLimitSwitches models')
        return PitchLimitSwitches.parse_obj(data)
