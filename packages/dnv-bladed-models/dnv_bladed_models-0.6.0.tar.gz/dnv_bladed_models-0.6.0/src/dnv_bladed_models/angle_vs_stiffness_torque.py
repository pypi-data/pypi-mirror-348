...
class AngleVsStiffnessTorque(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Damper/AngleVsStiffnessTorque/AngleVsStiffnessTorque.json')
    ...
    def _factory(cls, data):
        if isinstance(data, AngleVsStiffnessTorque):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define AngleVsStiffnessTorque models')
        return AngleVsStiffnessTorque.parse_obj(data)
