...
class NacelleVibration(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/SafetySystem/NacelleVibration/NacelleVibration.json')
    ...
    def _factory(cls, data):
        if isinstance(data, NacelleVibration):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define NacelleVibration models')
        return NacelleVibration.parse_obj(data)
