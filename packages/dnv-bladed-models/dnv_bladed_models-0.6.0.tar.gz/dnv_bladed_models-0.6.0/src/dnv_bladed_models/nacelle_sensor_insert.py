...
class NacelleSensorInsert(CommonRoot):
    r"""
    A NacelleSensor is to be inserted from an external resource. The exact type of NacelleSensor is not currently known.
    
    Attributes
    ----------
    NacelleSensorType : Literal['__insert__'], default='__insert__'
    ...
    NacelleSensorType: Literal['__insert__'] = Field(alias="NacelleSensorType", default='__insert__', allow_mutation=False, const=True)
...
NacelleSensorInsert.update_forward_refs()
