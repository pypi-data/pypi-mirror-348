...
class LoadSensor(Sensor):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/common/LoadSensor.json')

    SensorType: Literal['LoadSensor'] = Field(alias="SensorType", default='LoadSensor', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        if isinstance(data, LoadSensor):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define LoadSensor models')
        return LoadSensor.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = LoadSensor.from_file('/path/to/file')
        """
