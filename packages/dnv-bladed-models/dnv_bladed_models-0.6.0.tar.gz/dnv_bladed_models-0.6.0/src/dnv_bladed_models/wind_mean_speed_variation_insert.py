...
class WindMeanSpeedVariationInsert(CommonRoot):
    r"""
    A WindMeanSpeedVariation is to be inserted from an external resource. The exact type of WindMeanSpeedVariation is not currently known.
...
WindMeanSpeedVariationInsert.update_forward_refs()
