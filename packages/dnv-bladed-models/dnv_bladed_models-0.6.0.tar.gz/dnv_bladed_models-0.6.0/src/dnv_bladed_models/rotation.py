...
class Rotation(Component):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Rotation.json')

    ComponentType: Literal['Rotation'] = Field(alias="ComponentType", default='Rotation', allow_mutation=False, const=True)
    ...
    def _factory(cls, data):
        ...
        if not isinstance(data, dict):
            raise TypeError('An object is required to define Rotation models')
        return Rotation.parse_obj(data)
    ...
    def from_file(cls: Type['Model'], path: Union[str, Path]) -> 'Model':
        ...
        Examples
        --------
        >>> model = Rotation.from_file('/path/to/file')
        """
