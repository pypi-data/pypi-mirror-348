...
class SafetySystemCircuit(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Turbine/BladedControl/SafetySystem/SafetyCircuitLibrary/SafetySystemCircuit/SafetySystemCircuit.json')
    ...
    def _factory(cls, data):
        if isinstance(data, SafetySystemCircuit):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define SafetySystemCircuit models')
        return SafetySystemCircuit.parse_obj(data)
