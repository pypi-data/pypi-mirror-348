...
class TowerCanModelling(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('Components/Tower/TowerCan/TowerCanModelling/TowerCanModelling.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TowerCanModelling):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TowerCanModelling models')
        return TowerCanModelling.parse_obj(data)
