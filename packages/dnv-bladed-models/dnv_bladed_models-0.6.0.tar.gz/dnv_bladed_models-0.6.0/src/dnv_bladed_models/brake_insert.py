...
class BrakeInsert(CommonRoot):
    r"""
    A Brake is to be inserted from an external resource. The exact type of Brake is not currently known.
    
    Attributes
    ----------
    BrakeType : Literal['__insert__'], default='__insert__'
    ...
    BrakeType: Literal['__insert__'] = Field(alias="BrakeType", default='__insert__', allow_mutation=False, const=True)
...
BrakeInsert.update_forward_refs()
