...
class TimeVsCurrentDirectionShear(BladedModel):
    ...
    """
    _relative_schema_path: str = PrivateAttr('TimeDomainSimulation/Environment/SeaState/Current/CurrentDirectionShearVariation/TimeVsCurrentDirectionShear/TimeVsCurrentDirectionShear.json')
    ...
    def _factory(cls, data):
        if isinstance(data, TimeVsCurrentDirectionShear):
            return data
        if not isinstance(data, dict):
            raise TypeError('An object is required to define TimeVsCurrentDirectionShear models')
        return TimeVsCurrentDirectionShear.parse_obj(data)
