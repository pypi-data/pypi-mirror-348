...
# Basic method==========================================================================================================
    ...
    def parse(self, parse_id: bool = True) -> Union[Protein, Nucleotide]:  # return Nucleotide generator
...
# File format conversion method=========================================================================================
    def merge_sequence(self, parse_id: bool = False) -> Union[Protein, Nucleotide]:
...
# Other method==========================================================================================================
    ...
    def filter_n(self, max_num=1) -> Union[Protein, Nucleotide]:
