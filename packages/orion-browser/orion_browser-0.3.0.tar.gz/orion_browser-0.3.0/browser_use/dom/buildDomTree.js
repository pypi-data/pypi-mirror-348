        ...
        if (node.nodeType === Node.ELEMENT_NODE) {
            ...
            if (nodeData.isVisible) {
                ...
                if (nodeData.isTopElement) {
                    ...
                    nodeData.desc = interactive?.domOperationInfo?.interaction?.click?.effect || interactive?.domOperationInfo?.interaction?.scroll?.effect || interactive?.domOperationInfo?.description || interactive?.description || undefined;
