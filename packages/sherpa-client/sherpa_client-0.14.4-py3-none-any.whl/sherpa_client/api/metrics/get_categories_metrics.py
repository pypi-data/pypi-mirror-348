...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CategoryMetrics]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CategoryMetrics]:
    return Response(
