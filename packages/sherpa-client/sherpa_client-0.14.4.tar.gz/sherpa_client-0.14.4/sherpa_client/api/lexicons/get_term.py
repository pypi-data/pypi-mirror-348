...
def _get_kwargs(
    ...
    *,
    ...
    term_only: Union[Unset, None, bool] = False,
) -> Dict[str, Any]:
    url = "{}/projects/{projectName}/lexicons/{lexiconName}/_get_term".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[GetTermResponse200]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetTermResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_name (str):
        lexicon_name (str):
        term_only (Union[Unset, None, bool]):
        json_body (TermIdentifier):
