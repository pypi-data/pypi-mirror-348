...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ModelsMetrics]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ModelsMetrics]:
    return Response(
