...
from connecteam_api_sdk import ConnecteamAPISDK, AsyncConnecteamAPISDK, APIResponseValidationError
from connecteam_api_sdk._types import Omit
from connecteam_api_sdk._models import BaseModel, FinalRequestOptions
from connecteam_api_sdk._constants import RAW_RESPONSE_HEADER
from connecteam_api_sdk._exceptions import (
    APIStatusError,
    APITimeoutError,
    ConnecteamApisdkError,
    APIResponseValidationError,
)
from connecteam_api_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: ConnecteamAPISDK | AsyncConnecteamAPISDK) -> int:
...
class TestConnecteamApisdk:
    client = ConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "connecteam_api_sdk/_legacy_response.py",
                        "connecteam_api_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "connecteam_api_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ConnecteamApisdkError):
            with update_env(**{"CONNECTEAM_API_SDK_API_KEY": Omit()}):
                client2 = ConnecteamAPISDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: ConnecteamAPISDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(CONNECTEAM_API_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = ConnecteamAPISDK(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: ConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: ConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: ConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = ConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = ConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("connecteam_api_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: ConnecteamAPISDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncConnecteamApisdk:
    client = AsyncConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ConnecteamApisdkError):
            with update_env(**{"CONNECTEAM_API_SDK_API_KEY": Omit()}):
                client2 = AsyncConnecteamAPISDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncConnecteamAPISDK) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CONNECTEAM_API_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncConnecteamAPISDK(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncConnecteamAPISDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncConnecteamAPISDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncConnecteamAPISDK,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncConnecteamAPISDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from connecteam_api_sdk._utils import asyncify
        from connecteam_api_sdk._base_client import get_platform
