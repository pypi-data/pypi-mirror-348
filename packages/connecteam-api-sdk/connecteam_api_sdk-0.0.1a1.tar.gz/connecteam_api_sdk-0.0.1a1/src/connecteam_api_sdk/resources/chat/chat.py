...
class ChatResourceWithRawResponse:
    ...
    def v1(self) -> V1ResourceWithRawResponse:
        return V1ResourceWithRawResponse(self._chat.v1)
...
class AsyncChatResourceWithRawResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithRawResponse:
        return AsyncV1ResourceWithRawResponse(self._chat.v1)
...
class ChatResourceWithStreamingResponse:
    ...
    def v1(self) -> V1ResourceWithStreamingResponse:
        return V1ResourceWithStreamingResponse(self._chat.v1)
...
class AsyncChatResourceWithStreamingResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithStreamingResponse:
        return AsyncV1ResourceWithStreamingResponse(self._chat.v1)
