...
IMPORTANT: Do not repeat or summarize responses you get back from remote agents through the send_task function. The user will already see those responses directly. When a task is completed successfully, simply acknowledge completion and ask what the user needs help with next.
