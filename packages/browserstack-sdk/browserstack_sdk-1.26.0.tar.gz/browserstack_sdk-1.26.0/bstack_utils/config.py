...
conf = {
    bstack11ll111_opy_ (u"ࠫࡦࡶࡰࡠࡣࡸࡸࡴࡳࡡࡵࡧࠪᙾ"): False,
    bstack11ll111_opy_ (u"ࠬࡨࡳࡵࡣࡦ࡯ࡤࡹࡥࡴࡵ࡬ࡳࡳ࠭ᙿ"): True,
    bstack11ll111_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬ "): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll1llll1l_opy_ = conf
    @classmethod
    def bstack11l11l1l11_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1llll11_opy_=None):
        return self._11ll1llll1l_opy_.get(property_name, bstack11ll1llll11_opy_)
    def bstack1l1lllll11_opy_(self, property_name, bstack11ll1lll1ll_opy_):
        self._11ll1llll1l_opy_[property_name] = bstack11ll1lll1ll_opy_
    def bstack11l1ll1l1_opy_(self, val):
        self._11ll1llll1l_opy_[bstack11ll111_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᚁ")] = bool(val)
    def bstack1111lll1ll_opy_(self):
        return self._11ll1llll1l_opy_.get(bstack11ll111_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᚂ"), False)