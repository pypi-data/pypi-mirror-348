...
long_description = (this_directory / "fastapi_j2s_readme.md").read_text(encoding='utf-8')
...
setup(
    ...
    description = 'Control Fast Api With Dictionary',   # Give a short description about your library
    ...
    keywords = ['Kimin', 'Modul-Wrapper', 'J2S', 'FastApi-J2S'],   # Keywords that define your package best
