...
load_dotenv()
print(f"DEBUG: Current working directory for server.py: {os.getcwd()}")
print(f"DEBUG: ESA_TOKEN from os.getenv after load_dotenv: {os.getenv('ESA_TOKEN')}")
print(f"DEBUG: ESA_TEAM_NAME from os.getenv after load_dotenv: {os.getenv('ESA_TEAM_NAME')}")
