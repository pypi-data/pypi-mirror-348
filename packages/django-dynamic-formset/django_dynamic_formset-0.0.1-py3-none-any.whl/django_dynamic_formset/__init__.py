...
Purpose:
This package intentionally uses a name similar to a standard Python module  
to study how often such packages are unintentionally downloaded from PyPI by users or automated tools.
