...
def register_tools():
    ...
    # Contact management
    mcp.register_tool(manage_contact)
    
    # List management
    mcp.register_tool(manage_list)
    
    # Campaign management
    mcp.register_tool(manage_campaign)
    
    # Template management
    mcp.register_tool(manage_template)
    
    # Email tools
    mcp.register_tool(send_email)
    mcp.register_tool(track_email)
    
    # SMS tools
    mcp.register_tool(manage_sms)
    
    # Analytics tools
    mcp.register_tool(get_analytics)
    
    # Account tools
    mcp.register_tool(get_account_info)
