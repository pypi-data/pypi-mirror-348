...
T = TypeVar("T", bound="ProfileInfoResponseGuiderSettingsGuideChartRightAscensionColor")


@_attrs_define
class ProfileInfoResponseGuiderSettingsGuideChartRightAscensionColor:
    """
    Attributes:
        a (Union[Unset, int]):
        r (Union[Unset, int]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_info_response_guider_settings_guide_chart_right_ascension_color = cls(
            a=a,
            r=r,
            g=g,
            b=b,
        ...
        profile_info_response_guider_settings_guide_chart_right_ascension_color.additional_properties = d
        return profile_info_response_guider_settings_guide_chart_right_ascension_color
