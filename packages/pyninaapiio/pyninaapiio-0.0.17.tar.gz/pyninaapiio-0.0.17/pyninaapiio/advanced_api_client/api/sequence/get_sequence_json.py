...
def sync_detailed(
    *,
    ...
    """JSON
     ...
     Get sequence as json. For this to work, there needs to be a deep sky object container present and
    the sequencer view has to be initalized! This endpoint is generally advised to use over state since
