...
from masterai_pptx2md.utils import image2png, check_image_size
...
class Parse:
    ...
    def upload_image(self, image_id: str, image_bytes: bytes, suffix: str) -> str:
    ...
    def process_picture(self, shape: Picture, slide_idx: int) -> None:
        ...
        if not check_image_size(self.config.min_image_width, self.config.min_image_height, image_data=image_bytes):
            return
