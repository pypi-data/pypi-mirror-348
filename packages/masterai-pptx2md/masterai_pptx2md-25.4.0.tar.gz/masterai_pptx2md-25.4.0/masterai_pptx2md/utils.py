...
def check_image_size(min_image_width: int, min_image_height: int, image_file_path: Optional[str] = None, image_data: Optional[bytes] = None) -> bool:
    ...
    if min_image_width and min_image_width >= image.width:
        return False
    
    if min_image_height and min_image_height >= image.height:
        return False
