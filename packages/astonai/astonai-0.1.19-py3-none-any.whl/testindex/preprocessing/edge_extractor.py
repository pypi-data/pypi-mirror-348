...
from testindex.preprocessing.ast_tools import extract_imports, extract_calls
...
class EdgeExtractor:
    ...
    def __init__(self, config: Optional[ConfigModel] = None, repo_path: Optional[Union[str, Path]] = None):
    ...
    def extract_edges(self, 
        ...
        for i, chunk in enumerate(chunks):
            ...
            # Skip test files and standalone code
            if 'test_' in source_file.lower() or '/test/' in source_file:
                continue
