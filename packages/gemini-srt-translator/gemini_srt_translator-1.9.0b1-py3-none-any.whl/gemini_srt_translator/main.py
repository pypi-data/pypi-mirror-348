...
class GeminiSRTTranslator:
    ...
    def _get_config(self):
        ...
        return types.GenerateContentConfig(
            ...
            system_instruction=get_instruction(self.target_language, self.description),
            ...
            while i < total or len(batch) > 0:
                ...
                try:
                    ...
                    if "quota" in e_str:
                        ...
                        if self.disable_streaming or last_chunk_size == 0:
        ...
        while done == False:
            ...
            if self.disable_streaming:
                ...
                if not response.text:
                    ...
                    warning_with_progress("Sending last batch again...", isSending=True)
                    continue
