...
""" Runner for onefile program tests of HxHGoN.
...
# Find Gon package relative to us. The replacement is for POSIX python
...
from Gon.tools.testing.RuntimeTracing import (
