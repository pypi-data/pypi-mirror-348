...
""" Runner for program tests of HxHGoN.
...
def main():
    ...
    extra_options = os.environ.get("HUNTER_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["HUNTER_EXTRA_OPTIONS"] = (
            ...
            os.environ["HUNTER_EXTRA_OPTIONS"] = extra_options
