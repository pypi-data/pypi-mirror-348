...
# Gon-project: --include-package=package
# Gon-project: --follow-imports
# Gon-project-if: {Commercial} is not None:
#  Gon-project: --embed-data-files-runtime-pattern=*
#  Gon-project: --include-package-data=package
