...
from Gon.build.DataComposerInterface import getConstantBlobFilename
from Gon.ModuleRegistry import getImportedModuleNames
from Gon.PythonFlavors import isSelfCompiledPythonUninstalled
from Gon.PythonVersions import getTargetPythonDLLPath, python_version
from Gon.Tracing import postprocessing_logger
from Gon.utils.Execution import wrapCommandForDebuggerForExec
...
from Gon.utils.Images import convertImageToIconFormat
from Gon.utils.Importing import importFromInlineCopy
from Gon.utils.MacOSApp import createPlistInfoFile
...
from Gon.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from Gon.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by HxHGoN to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set PYTHONHOME=%(python_home)s
set HUNTER_PYTHONPATH=%(python_path)s
...
export PYTHONHOME
HUNTER_PYTHONPATH="%(python_path)s"
export HUNTER_PYTHONPATH
...
def _createModulePyiFile():
    ...
    contents = """\
# This file was generated by HxHGoN
"""
