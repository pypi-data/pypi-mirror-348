...
#ifndef __HUNTER_COMPILED_GENERATOR_H__
#define __HUNTER_COMPILED_GENERATOR_H__
...
// The HxHGoN_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct HxHGoN_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct HxHGoN_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject HxHGoN_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct HxHGoN_GeneratorObject *, PyObject *);

extern PyObject *HxHGoN_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *HxHGoN_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct HxHGoN_CellObject **closure,
...
extern PyObject *HxHGoN_Generator_qiter(PyThreadState *tstate, struct HxHGoN_GeneratorObject *generator,
                                        bool *finished);

static inline bool HxHGoN_Generator_Check(PyObject *object) { return Py_TYPE(object) == &HxHGoN_Generator_Type; }

static inline PyObject *HxHGoN_Generator_GetName(PyObject *object) {
    return ((struct HxHGoN_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct HxHGoN_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct HxHGoN_GeneratorObject *generator) {
...
extern void HxHGoN_PreserveHeap(void *dest, ...);
extern void HxHGoN_RestoreHeap(void *source, ...);

HUNTER_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
HUNTER_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct HxHGoN_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_HxHGoN_Generator_Type;
extern int count_allocated_HxHGoN_Generator_Type;
extern int count_released_HxHGoN_Generator_Type;
#endif
