...
#ifndef __HUNTER_HELPER_RANGEOBJECTS_H__
#define __HUNTER_HELPER_RANGEOBJECTS_H__
...
HUNTER_MAY_BE_UNUSED static PyObject *PyRange_Start(PyObject *range) { return ((struct _rangeobject3 *)range)->start; }

HUNTER_MAY_BE_UNUSED static PyObject *PyRange_Stop(PyObject *range) { return ((struct _rangeobject3 *)range)->stop; }

HUNTER_MAY_BE_UNUSED static PyObject *PyRange_Step(PyObject *range) { return ((struct _rangeobject3 *)range)->step; }
