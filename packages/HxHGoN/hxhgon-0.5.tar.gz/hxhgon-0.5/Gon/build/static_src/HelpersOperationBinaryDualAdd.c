 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(Gon_ilong *result, Gon_ilong *operand1, Gon_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(Gon_ilong *result, Gon_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
#pragma warning(pop)
    ...
    exit_result_ok_clong:
        ...
        HUNTER_CANNOT_GET_HERE("cannot happen with types NILONG DIGIT");
        return false;
    }
}
