...
bool HxHGoN_Type_IsSubtype(PyTypeObject *a, PyTypeObject *b) {
    CHECK_OBJECT(a);
    CHECK_OBJECT(b);
...
// TODO: We cannot really do this, until HxHGoN_TypeLookup (_PyType_Lookup) is
...
#if 0
int HxHGoN_Object_IsSubclass(PyThreadState *tstate, PyObject *derived, PyObject *cls)
{
    ...
    if (PyTuple_Check(cls)) {
        ...
        for (Py_ssize_t i = 0; i < n; ++i) {
            ...
            r = HxHGoN_Object_IsSubclass(tstate, derived, item);
    ...
    PyObject *checker = HxHGoN_TypeLookup((PyTypeObject *)cls, const_str_plain___subclasscheck__);
...
void HxHGoN_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
    ...
    HUNTER_MAY_BE_UNUSED int res = PyType_Ready(type);
    assert(res >= 0);
}
...
PyObject *MAKE_TYPE_ALIAS(PyObject *name, PyObject *type_params, PyObject *value, PyObject *module_name) {
    ...
    typealiasobject *ta = HxHGoN_GC_New(getTypeAliasType());
...
static typevarobject *_HxHGoN_typevar_alloc(PyThreadState *tstate, PyObject *name, PyObject *bound,
    ...
    typevarobject *result = HxHGoN_GC_New(tp);
...
PyObject *MAKE_TYPE_VAR(PyThreadState *tstate, PyObject *name) {
    ...
    return (PyObject *)_HxHGoN_typevar_alloc(tstate, name, NULL, NULL, NULL, NULL, false, false, true, NULL);
}
...
static PyObject *_HxHGoN_unpack_typevartuples(PyObject *params) {
...
PyObject *MAKE_TYPE_GENERIC(PyThreadState *tstate, PyObject *params) {
    CHECK_OBJECT(params);
    PyObject *unpacked_params = _HxHGoN_unpack_typevartuples(params);
