...
from Gon import Options, Tracing, TreeXML
from Gon.__past__ import iterItems
from Gon.Errors import HxHGoNNodeError
from Gon.PythonVersions import python_version
from Gon.SourceCodeReferences import SourceCodeReference
...
from Gon.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise HxHGoNNodeError("Problem cloning node", self, e)
