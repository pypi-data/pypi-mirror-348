...
""" Directories and paths to for output of HxHGoN.
...
from Gon.utils.SharedLibraries import getDllSuffix
from Gon.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".Gon-pgo"
