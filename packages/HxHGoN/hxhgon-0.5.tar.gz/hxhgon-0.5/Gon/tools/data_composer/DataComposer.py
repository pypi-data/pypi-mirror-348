...
from Gon.__past__ import BytesIO, long, to_byte, unicode, xrange
from Gon.build.DataComposerInterface import deriveModuleConstantsBlobName
from Gon.Builtins import builtin_exception_values_list, builtin_named_values
...
from Gon.Tracing import data_composer_logger
from Gon.utils.FileOperations import getFileSize, listDir, syncFileOutput
from Gon.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.getenv("HUNTER_DATA_COMPOSER_VERBOSE", "0") != "1"
    )

    # Internal tool, most simple command line handling. This is the build directory
    # where main HxHGoN put the .const files.
