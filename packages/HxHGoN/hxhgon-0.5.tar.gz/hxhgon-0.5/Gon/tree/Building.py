...
In the "Gon.tree.TreeHelpers" module, the dispatching is happening. One function
...
from Gon import ModuleRegistry, OutputDirectories, SourceCodeReferences
from Gon.__past__ import long, unicode
from Gon.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from Gon.Bytecodes import loadCodeObjectData
from Gon.containers.OrderedSets import OrderedSet
from Gon.Errors import CodeTooComplexCode
from Gon.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from Gon.importing import Importing
from Gon.importing.ImportCache import addImportedModule
from Gon.importing.PreloadedPackages import getPthImportedPackages
...
from Gon.nodes.BuiltinRefNodes import quick_names
from Gon.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from Gon.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from Gon.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from Gon.nodes.ExceptionNodes import StatementRaiseException
from Gon.nodes.FutureSpecs import FutureSpec
from Gon.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from Gon.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from Gon.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from Gon.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from Gon.nodes.ModuleNodes import (
...
from Gon.nodes.OperatorNodes import makeBinaryOperationNode
from Gon.nodes.OperatorNodesUnary import makeExpressionOperationUnary
from Gon.nodes.ReturnNodes import makeStatementReturn
from Gon.nodes.SliceNodes import makeExpressionBuiltinSlice
from Gon.nodes.StatementNodes import StatementExpressionOnly
from Gon.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from Gon.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from Gon.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from Gon.pgo.PGO import decideCompilationFromPGO
...
from Gon.utils import MemoryUsage
from Gon.utils.ModuleNames import ModuleName
from Gon.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_Gon"):
                    raise
