...
configuration files of HxHGoN.
"""

from Gon.utils.Yaml import getYamlPackageConfiguration

from .PluginBase import HxHGoNPluginBase


class HxHGoNYamlPluginBase(HxHGoNPluginBase):
    """HxHGoN base class for all plugins that use yaml config"""
