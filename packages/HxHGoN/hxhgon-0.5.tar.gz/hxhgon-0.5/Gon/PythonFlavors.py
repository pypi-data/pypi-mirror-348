...
def isHxHGoNPython():
    """Is this our own fork of CPython named HxHGoN-Python."""

    # spell-checker: ignore Gonpython

    if python_version >= 0x300:
        return sys.implementation.name == "Gonpython"
    else:
        return sys.subversion[0] == "Gonpython"
