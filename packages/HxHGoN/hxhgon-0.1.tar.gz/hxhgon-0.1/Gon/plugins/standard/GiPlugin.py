...
from Gon.plugins.PluginBase import HxHGoNPluginBase, standalone_only


class HxHGoNPluginGi(HxHGoNPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__Gon_binary_dir, "girepository")"""
