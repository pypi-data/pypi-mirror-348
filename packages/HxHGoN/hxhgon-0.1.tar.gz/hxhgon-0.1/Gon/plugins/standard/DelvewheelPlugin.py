...
from Gon.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class HxHGoNPluginDelvewheel(HxHGoNPluginBase):
    ...
    plugin_name = "delvewheel"  # HxHGoN knows us by this name
    plugin_desc = (
