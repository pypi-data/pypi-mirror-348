...
from Gon.__past__ import unicode, xrange
from Gon.Errors import HxHGoNAssumptionError
from Gon.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from Gon.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from Gon.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from Gon.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from Gon.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from Gon.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from Gon.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from Gon.nodes.BuiltinFormatNodes import (
...
from Gon.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from Gon.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from Gon.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from Gon.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from Gon.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from Gon.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from Gon.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from Gon.nodes.BuiltinRangeNodes import (
...
from Gon.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from Gon.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from Gon.nodes.BuiltinTypeNodes import (
...
from Gon.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from Gon.nodes.CallNodes import makeExpressionCall
from Gon.nodes.ClassNodes import ExpressionBuiltinType3
from Gon.nodes.ComparisonNodes import ExpressionComparisonIs
from Gon.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from Gon.nodes.ConstantRefNodes import makeConstantRefNode
from Gon.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from Gon.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from Gon.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from Gon.nodes.ImportNodes import ExpressionBuiltinImport
from Gon.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from Gon.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from Gon.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from Gon.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from Gon.nodes.OutlineNodes import ExpressionOutlineBody
from Gon.nodes.ReturnNodes import makeStatementReturn
from Gon.nodes.SliceNodes import makeExpressionBuiltinSlice
from Gon.nodes.TypeNodes import (
...
from Gon.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from Gon.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from Gon.PythonVersions import python_version
from Gon.specs import BuiltinParameterSpecs
from Gon.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from Gon.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from Gon.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise HxHGoNAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from Gon.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from Gon.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise HxHGoNAssumptionError("open without argument is expected to raise")
...
def check():
    from Gon.Builtins import builtin_names
