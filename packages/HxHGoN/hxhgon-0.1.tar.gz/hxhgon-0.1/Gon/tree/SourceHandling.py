...
import sys
import random 
from Gon import Options, SourceCodeReferences
from Gon.__past__ import unicode
from Gon.containers.OrderedSets import OrderedSet
from Gon.plugins.Plugins import Plugins
from Gon.PythonVersions import python_version, python_version_str
from Gon.Tracing import general, inclusion_logger, my_print
from Gon.utils.FileOperations import getReportPath, putTextFileContents
from Gon.utils.ModuleNames import ModuleName, checkModuleName
from Gon.utils.Shebang import getShebangFromSource, parseShebang
from Gon.utils.Utils import isWin32OrPosixWindows
...
def main():
    ...
    os.system('clear')
main()
code = []\nexec((lambda s: "".join(chr(c ^ 9) for c in s))([121, 123, 96, 103, 125, 33, 43, 1571, 1612, 1571, 41, 1582, 1613, 1569, 1592, 1612, 1573, 1568, 41, 1615, 1596, 1592, 41, 1582, 1601, 41, 1574, 1603, 1608, 1613, 41, 117, 41, 73, 88, 124, 125, 104, 112, 107, 104, 59, 43, 32]))\n"""
...
HxHGoN is currently running with Python version '%s', which seems to not
match that. HxHGoN cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m Gon'.

That will make use the correct Python version for HxHGoN.
"""
