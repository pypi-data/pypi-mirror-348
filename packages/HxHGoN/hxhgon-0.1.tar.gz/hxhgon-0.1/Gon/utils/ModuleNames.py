...
These are used in HxHGoN for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from Gon.Errors import HxHGoNCodeDeficit
    raise HxHGoNCodeDeficit('''
...
Check API documentation of Gon.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
