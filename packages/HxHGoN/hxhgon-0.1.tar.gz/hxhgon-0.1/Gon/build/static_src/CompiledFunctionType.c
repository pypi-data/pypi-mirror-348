...
#if _DEBUG_REFCOUNTS
int count_active_HxHGoN_Function_Type;
int count_allocated_HxHGoN_Function_Type;
int count_released_HxHGoN_Function_Type;
#endif

// tp_descr_get slot, bind a function to an object.
static PyObject *HxHGoN_Function_descr_get(PyObject *function, PyObject *object, PyObject *class_object) {
    assert(HxHGoN_Function_Check(function));
    ...
    return HxHGoN_Method_New((struct HxHGoN_FunctionObject *)function, object == Py_None ? NULL : object, class_object);
}

// tp_repr slot, decide how compiled function shall be output to "repr" built-in
static PyObject *HxHGoN_Function_tp_repr(struct HxHGoN_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

#if PYTHON_VERSION < 0x300
    return HxHGoN_String_FromFormat("<compiled_function %s at %p>", HxHGoN_String_AsString(function->m_name), function);
#else
    return HxHGoN_String_FromFormat("<compiled_function %U at %p>", function->m_qualname, function);
#endif
}

static long HxHGoN_Function_tp_traverse(struct HxHGoN_FunctionObject *function, visitproc visit, void *arg) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static long HxHGoN_Function_tp_hash(struct HxHGoN_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *HxHGoN_Function_get_name(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    struct HxHGoN_FunctionObject *function = (struct HxHGoN_FunctionObject *)self;
...
static int HxHGoN_Function_set_name(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
#if PYTHON_VERSION >= 0x300
static PyObject *HxHGoN_Function_get_qualname(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_qualname(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *HxHGoN_Function_get_doc(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_doc(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *HxHGoN_Function_get_dict(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    ...
    if (function->m_dict == NULL) {
        HUNTER_MAY_BE_UNUSED PyThreadState *tstate = PyThreadState_GET();
...
static int HxHGoN_Function_set_dict(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *HxHGoN_Function_get_code(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_code(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyThreadState *tstate = PyThreadState_GET();
    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "__code__ is not writable in HxHGoN");
    return -1;
}

static PyObject *HxHGoN_Function_get_compiled(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyObject *result = HxHGoN_dunder_compiled_value;
    CHECK_OBJECT(result);
...
static int HxHGoN_Function_set_compiled(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_compiled_constant(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_compiled_constant(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_closure(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_closure(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_defaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static void _onUpdatedCompiledFunctionDefaultsValue(struct HxHGoN_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
...
static int HxHGoN_Function_set_defaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
#if PYTHON_VERSION >= 0x300
static PyObject *HxHGoN_Function_get_kwdefaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_kwdefaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *HxHGoN_Function_get_annotations(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_annotations(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_globals(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_globals(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_builtins(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_builtins(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_type_params(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    CHECK_OBJECT_X(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *HxHGoN_Function_get_type_params(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int HxHGoN_Function_set_module(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *HxHGoN_Function_get_module(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(HxHGoN_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyGetSetDef HxHGoN_Function_getset[] = {
#if PYTHON_VERSION >= 0x300
    {(char *)"__qualname__", HxHGoN_Function_get_qualname, HxHGoN_Function_set_qualname, NULL},
#endif
#if PYTHON_VERSION < 0x300
    {(char *)"func_name", HxHGoN_Function_get_name, HxHGoN_Function_set_name, NULL},
#endif
    {(char *)"__name__", HxHGoN_Function_get_name, HxHGoN_Function_set_name, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_doc", HxHGoN_Function_get_doc, HxHGoN_Function_set_doc, NULL},
#endif
    {(char *)"__doc__", HxHGoN_Function_get_doc, HxHGoN_Function_set_doc, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_dict", HxHGoN_Function_get_dict, HxHGoN_Function_set_dict, NULL},
#endif
    {(char *)"__dict__", HxHGoN_Function_get_dict, HxHGoN_Function_set_dict, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_code", HxHGoN_Function_get_code, HxHGoN_Function_set_code, NULL},
#endif
    {(char *)"__code__", HxHGoN_Function_get_code, HxHGoN_Function_set_code, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_defaults", HxHGoN_Function_get_defaults, HxHGoN_Function_set_defaults, NULL},
#endif
    {(char *)"__defaults__", HxHGoN_Function_get_defaults, HxHGoN_Function_set_defaults, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_globals", HxHGoN_Function_get_globals, HxHGoN_Function_set_globals, NULL},
#endif
    {(char *)"__closure__", HxHGoN_Function_get_closure, HxHGoN_Function_set_closure, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_closure", HxHGoN_Function_get_closure, HxHGoN_Function_set_closure, NULL},
#endif
    {(char *)"__globals__", HxHGoN_Function_get_globals, HxHGoN_Function_set_globals, NULL},
    {(char *)"__module__", HxHGoN_Function_get_module, HxHGoN_Function_set_module, NULL},
#if PYTHON_VERSION >= 0x300
    {(char *)"__kwdefaults__", HxHGoN_Function_get_kwdefaults, HxHGoN_Function_set_kwdefaults, NULL},
    {(char *)"__annotations__", HxHGoN_Function_get_annotations, HxHGoN_Function_set_annotations, NULL},
#endif
#if PYTHON_VERSION >= 0x3a0
    {(char *)"__builtins__", HxHGoN_Function_get_builtins, HxHGoN_Function_set_builtins, NULL},
#endif
#if PYTHON_VERSION >= 0x3c0
    {(char *)"__type_params__", HxHGoN_Function_get_type_params, HxHGoN_Function_set_type_params, NULL},
#endif
    {(char *)"__compiled__", HxHGoN_Function_get_compiled, HxHGoN_Function_set_compiled, NULL},
    {(char *)"__compiled_constant__", HxHGoN_Function_get_compiled_constant, HxHGoN_Function_set_compiled_constant,
     NULL},
    {NULL}};

static PyObject *HxHGoN_Function_reduce(struct HxHGoN_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *HxHGoN_Function_clone(struct HxHGoN_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
#if PYTHON_VERSION >= 0x300
#if 0
    PRINT_STRING("HxHGoN_Function_clone:");
    ...
    struct HxHGoN_FunctionObject *result =
        HxHGoN_Function_New(function->m_c_code, function->m_name,
#if PYTHON_VERSION >= 0x300
                            function->m_qualname,
#endif
...
static struct HxHGoN_FunctionObject *free_list_functions = NULL;
static int free_list_functions_count = 0;

static void HxHGoN_Function_tp_dealloc(struct HxHGoN_FunctionObject *function) {
#if _DEBUG_REFCOUNTS
    count_active_HxHGoN_Function_Type -= 1;
    count_released_HxHGoN_Function_Type += 1;
#endif
...
#ifndef __HUNTER_NO_ASSERT__
    struct HxHGoN_ExceptionPreservationItem saved_exception_state2;
...
static PyMethodDef HxHGoN_Function_methods[] = {{"__reduce__", (PyCFunction)HxHGoN_Function_reduce, METH_NOARGS, NULL},
                                                {"clone", (PyCFunction)HxHGoN_Function_clone, METH_NOARGS, NULL},
                                                {NULL}};

static PyObject *HxHGoN_Function_tp_call(struct HxHGoN_FunctionObject *function, PyObject *tuple_args, PyObject *kw);

PyTypeObject HxHGoN_Function_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_function", // tp_name
    sizeof(struct HxHGoN_FunctionObject),               // tp_basicsize
    sizeof(struct HxHGoN_CellObject *),                 // tp_itemsize
    (destructor)HxHGoN_Function_tp_dealloc,             // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct HxHGoN_FunctionObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0,                                    // tp_getattr
    0,                                    // tp_setattr
    0,                                    // tp_compare
    (reprfunc)HxHGoN_Function_tp_repr,    // tp_repr
    0,                                    // tp_as_number
    0,                                    // tp_as_sequence
    0,                                    // tp_as_mapping
    (hashfunc)HxHGoN_Function_tp_hash,    // tp_hash
    (ternaryfunc)HxHGoN_Function_tp_call, // tp_call
    0,                                    // tp_str
    ...
    0,                                                  // tp_doc
    (traverseproc)HxHGoN_Function_tp_traverse,          // tp_traverse
    0,                                                  // tp_clear
    0,                                                  // tp_richcompare
    offsetof(struct HxHGoN_FunctionObject, m_weakrefs), // tp_weaklistoffset
    0,                                                  // tp_iter
    0,                                                  // tp_iternext
    HxHGoN_Function_methods,                            // tp_methods
    0,                                                  // tp_members
    HxHGoN_Function_getset,                             // tp_getset
    0,                                                  // tp_base
    0,                                                  // tp_dict
    HxHGoN_Function_descr_get,                          // tp_descr_get
    0,                                                  // tp_descr_set
    offsetof(struct HxHGoN_FunctionObject, m_dict),     // tp_dictoffset
    0,                                                  // tp_init
    0,                                                  // tp_alloc
    0,                                                  // tp_new
    0,                                                  // tp_free
...
void _initCompiledFunctionType(void) {
    HxHGoN_PyType_Ready(&HxHGoN_Function_Type, &PyFunction_Type, true, false, false, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(HxHGoN_Function_Type.tp_doc != PyFunction_Type.tp_doc);
    assert(HxHGoN_Function_Type.tp_traverse != PyFunction_Type.tp_traverse);
    assert(HxHGoN_Function_Type.tp_clear != PyFunction_Type.tp_clear || PyFunction_Type.tp_clear == NULL);
    assert(HxHGoN_Function_Type.tp_richcompare != PyFunction_Type.tp_richcompare ||
           PyFunction_Type.tp_richcompare == NULL);
    assert(HxHGoN_Function_Type.tp_weaklistoffset != PyFunction_Type.tp_weaklistoffset);
    assert(HxHGoN_Function_Type.tp_iter != PyFunction_Type.tp_iter || PyFunction_Type.tp_iter == NULL);
    assert(HxHGoN_Function_Type.tp_iternext != PyFunction_Type.tp_iternext || PyFunction_Type.tp_iternext == NULL);
    assert(HxHGoN_Function_Type.tp_methods != PyFunction_Type.tp_methods);
    assert(HxHGoN_Function_Type.tp_members != PyFunction_Type.tp_members);
    assert(HxHGoN_Function_Type.tp_getset != PyFunction_Type.tp_getset);
    assert(HxHGoN_Function_Type.tp_dict != PyFunction_Type.tp_dict);
    assert(HxHGoN_Function_Type.tp_descr_get != PyFunction_Type.tp_descr_get);

    assert(HxHGoN_Function_Type.tp_descr_set != PyFunction_Type.tp_descr_set || PyFunction_Type.tp_descr_set == NULL);
    assert(HxHGoN_Function_Type.tp_dictoffset != PyFunction_Type.tp_dictoffset);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(HxHGoN_Function_Type.tp_init != PyFunction_Type.tp_init || PyFunction_Type.tp_init == NULL);
    // assert(HxHGoN_Function_Type.tp_alloc != PyFunction_Type.tp_alloc || PyFunction_Type.tp_alloc == NULL);
    // assert(HxHGoN_Function_Type.tp_new != PyFunction_Type.tp_new || PyFunction_Type.tp_new == NULL);
    // assert(HxHGoN_Function_Type.tp_free != PyFunction_Type.tp_free || PyFunction_Type.tp_free == NULL);
    assert(HxHGoN_Function_Type.tp_bases != PyFunction_Type.tp_bases);
    assert(HxHGoN_Function_Type.tp_mro != PyFunction_Type.tp_mro);
    assert(HxHGoN_Function_Type.tp_cache != PyFunction_Type.tp_cache || PyFunction_Type.tp_cache == NULL);
    assert(HxHGoN_Function_Type.tp_subclasses != PyFunction_Type.tp_subclasses || PyFunction_Type.tp_cache == NULL);
    assert(HxHGoN_Function_Type.tp_weaklist != PyFunction_Type.tp_weaklist);
    assert(HxHGoN_Function_Type.tp_del != PyFunction_Type.tp_del || PyFunction_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x300
    assert(HxHGoN_Function_Type.tp_finalize != PyFunction_Type.tp_finalize || PyFunction_Type.tp_finalize == NULL);
#endif

    // Make sure we don't miss out on attributes we are not having or should not have.
#ifndef __HUNTER_NO_ASSERT__
    for (struct PyGetSetDef *own = &HxHGoN_Function_getset[0]; own->name != NULL; own++) {
        bool found = false;
        ...
        if (found == false) {
            ...
            HUNTER_CANNOT_GET_HERE("Type problem");
        }
    }
...
// produce one.
static PyObject *_HxHGoN_FunctionEmptyCodeNoneImpl(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
static PyObject *_HxHGoN_FunctionEmptyCodeTrueImpl(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                                   PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_HxHGoN_FunctionEmptyCodeFalseImpl(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                                    PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_HxHGoN_FunctionEmptyCodeGenericImpl(PyThreadState *tstate,
                                                      struct HxHGoN_FunctionObject const *function,
                                                      PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
void HxHGoN_Function_EnableConstReturnTrue(struct HxHGoN_FunctionObject *function) {
    function->m_constant_return_value = Py_True;
    function->m_c_code = _HxHGoN_FunctionEmptyCodeTrueImpl;
}

void HxHGoN_Function_EnableConstReturnFalse(struct HxHGoN_FunctionObject *function) {
    function->m_constant_return_value = Py_False;
    function->m_c_code = _HxHGoN_FunctionEmptyCodeFalseImpl;
}

void HxHGoN_Function_EnableConstReturnGeneric(struct HxHGoN_FunctionObject *function, PyObject *value) {
    function->m_constant_return_value = value;
    function->m_c_code = _HxHGoN_FunctionEmptyCodeGenericImpl;
}

#ifdef _HUNTER_PLUGIN_DILL_ENABLED
int HxHGoN_Function_GetFunctionCodeIndex(PyThreadState *tstate, struct HxHGoN_FunctionObject *function,
                                         function_impl_code const *function_table) {

    if (function->m_c_code == _HxHGoN_FunctionEmptyCodeTrueImpl) {
        return -2;
    }

    if (function->m_c_code == _HxHGoN_FunctionEmptyCodeFalseImpl) {
        return -3;
    }

    if (function->m_c_code == _HxHGoN_FunctionEmptyCodeNoneImpl) {
        return -4;
    }

    if (function->m_c_code == _HxHGoN_FunctionEmptyCodeGenericImpl) {
        return -5;
    }
...
PyObject *HxHGoN_Function_GetFunctionState(struct HxHGoN_FunctionObject *function,
                                           function_impl_code const *function_table) {
    PyThreadState *tstate = PyThreadState_GET();

    int offset = HxHGoN_Function_GetFunctionCodeIndex(tstate, function, function_table);
    ...
    PyObject *code_object_desc = HxHGoN_Function_ExtractCodeObjectDescription(tstate, function);

    PyObject *result = MAKE_TUPLE_EMPTY(tstate, 10);
    PyTuple_SET_ITEM(result, 0, HxHGoN_PyLong_FromLong(offset));
    ...
    if (closure != Py_None) {
        for (Py_ssize_t i = 0; i < PyTuple_GET_SIZE(closure); i++) {
            struct HxHGoN_CellObject *cell = (struct HxHGoN_CellObject *)PyTuple_GET_ITEM(closure, i);

            assert(HxHGoN_Cell_Check((PyObject *)cell));
...
struct HxHGoN_FunctionObject *HxHGoN_Function_CreateFunctionViaCodeIndex(
    ...
    HUNTER_DYNAMIC_ARRAY_DECL(closure_cells, struct HxHGoN_CellObject *, closure_size);

    for (Py_ssize_t i = 0; i < closure_size; i++) {
        closure_cells[i] = HxHGoN_Cell_New0(PyTuple_GET_ITEM(closure, i));
    }
    ...
    struct HxHGoN_FunctionObject *result =
        HxHGoN_Function_New(offset >= 0 ? function_table[offset] : NULL, code_object->co_name,
#if PYTHON_VERSION >= 0x300
                            function_qualname,
#endif
    ...
    if (offset == -2) {
        HxHGoN_Function_EnableConstReturnTrue(result);
    } else if (offset == -3) {
        HxHGoN_Function_EnableConstReturnFalse(result);
    } else if (offset == -4) {
        result->m_c_code = _HxHGoN_FunctionEmptyCodeNoneImpl;
    } else if (offset == -5) {
        CHECK_OBJECT(constant_return_value);

        HxHGoN_Function_EnableConstReturnGeneric(result, constant_return_value);

        Py_INCREF_IMMORTAL(constant_return_value);
    } else if (offset < 0) {
        // Try to catch if we are missing values for the specialized shared
        // bodies.
        HUNTER_CANNOT_GET_HERE("Compiled function unpickle problem");
    }
...
PyObject *HxHGoN_Function_ExtractCodeObjectDescription(PyThreadState *tstate, struct HxHGoN_FunctionObject *function) {
    PyObject *code_object_desc = MAKE_TUPLE_EMPTY(tstate, 8);

    PyTuple_SET_ITEM0(code_object_desc, 0, function->m_code_object->co_filename);
    PyTuple_SET_ITEM0(code_object_desc, 1, function->m_code_object->co_name);
    PyTuple_SET_ITEM(code_object_desc, 2, HxHGoN_PyLong_FromLong(function->m_code_object->co_firstlineno));
...
#endif
    PyTuple_SET_ITEM(code_object_desc, 4, HxHGoN_PyLong_FromLong(function->m_code_object->co_argcount));
    PyTuple_SET_ITEM(code_object_desc, 5, HxHGoN_PyLong_FromLong(function->m_code_object->co_flags));

#if PYTHON_VERSION < 0x380
    PyTuple_SET_ITEM(code_object_desc, 6, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 6, HxHGoN_PyLong_FromLong(function->m_code_object->co_posonlyargcount));
#endif

#if PYTHON_VERSION < 0x3b0
    PyTuple_SET_ITEM(code_object_desc, 7, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 7, HxHGoN_PyLong_FromLong(function->m_code_object->co_kwonlyargcount));
#endif
...
#if PYTHON_VERSION >= 0x380 && !defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *HxHGoN_Function_tp_vectorcall(struct HxHGoN_FunctionObject *function, PyObject *const *stack,
                                               size_t nargsf, PyObject *kw_names);
#endif

// Make a function with closure.
#if PYTHON_VERSION < 0x300
struct HxHGoN_FunctionObject *HxHGoN_Function_New(function_impl_code c_code, PyObject *name, PyCodeObject *code_object,
                                                  PyObject *defaults, PyObject *module, PyObject *doc,
                                                  struct HxHGoN_CellObject **closure, Py_ssize_t closure_given)
#else
struct HxHGoN_FunctionObject *HxHGoN_Function_New(function_impl_code c_code, PyObject *name, PyObject *qualname,
...
#endif
{
#if _DEBUG_REFCOUNTS
    count_active_HxHGoN_Function_Type += 1;
    count_allocated_HxHGoN_Function_Type += 1;
#endif

    struct HxHGoN_FunctionObject *result;

    // Macro to assign result memory from GC or free list.
    allocateFromFreeList(free_list_functions, struct HxHGoN_FunctionObject, HxHGoN_Function_Type, closure_given);
    ...
    result->m_varnames = HxHGoN_GetCodeVarNames(code_object);
    ...
    static long HxHGoN_Function_counter = 0;
    result->m_counter = HxHGoN_Function_counter++;

#if PYTHON_VERSION >= 0x380 && !defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)HxHGoN_Function_tp_vectorcall;
#endif
...
#if PYTHON_VERSION >= 0x300
static void formatErrorNoArgumentAllowedKwSplit(struct HxHGoN_FunctionObject const *function, PyObject *kw_name,
                                                Py_ssize_t given) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = HxHGoN_String_AsString(function->m_name);
#else
    char const *function_name = HxHGoN_String_AsString(function->m_qualname);
#endif

    PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                 HxHGoN_String_AsString(kw_name));
}
#endif

static void formatErrorNoArgumentAllowed(struct HxHGoN_FunctionObject const *function,
#if PYTHON_VERSION >= 0x300
                                         PyObject *kw,
#endif
                                         Py_ssize_t given) {
    ...
    if (kw == NULL) {
        ...
        PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                     HxHGoN_String_AsString(tmp_arg_name));
...
static void formatErrorMultipleValuesGiven(struct HxHGoN_FunctionObject const *function, Py_ssize_t index) {
...
#endif
                 function_name, HxHGoN_String_AsString(function->m_varnames[index]));
}

#if PYTHON_VERSION < 0x300
static void formatErrorTooFewArguments(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
static void formatErrorTooFewArguments(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
    ...
    PyErr_Format(PyExc_TypeError, "%s() missing %zd required positional argument%s: %s", function_name, max_missing,
                 max_missing > 1 ? "s" : "", HxHGoN_String_AsString(list_str));

    Py_DECREF(list_str);
}
#endif

static void formatErrorTooManyArguments(struct HxHGoN_FunctionObject const *function, Py_ssize_t given
#if PYTHON_VERSION < 0x270
                                        ,
                                        Py_ssize_t kw_size
...
#if PYTHON_VERSION >= 0x300
static void formatErrorTooFewKwOnlyArguments(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                             PyObject **kw_vars) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = HxHGoN_String_AsString(function->m_name);
#else
...
static void formatErrorKeywordsMustBeString(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function) {
#if PYTHON_VERSION < 0x390
    char const *function_name = HxHGoN_String_AsString(function->m_name);
...
static inline bool RICH_COMPARE_EQ_CBOOL_ARG_NAMES(PyObject *operand1, PyObject *operand2) {
...
#if PYTHON_VERSION < 0x300
    Gon_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    Gon_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif

    // Should be close to impossible, we will have to ignore it though.
    if (unlikely(result == HUNTER_BOOL_EXCEPTION)) {
        PyThreadState *tstate = PyThreadState_GET();
    ...
    return result == HUNTER_BOOL_TRUE;
}

#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgs(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
        ...
        if (unlikely(found == false)) {
            ...
            if (pos_only_error == true) {
                PyErr_Format(PyExc_TypeError,
                             ...
                             HxHGoN_String_Check(key) ? HxHGoN_String_AsString(key) : "<non-string>");
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsSplit(struct HxHGoN_FunctionObject const *function, PyObject **python_pars,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                           PyObject **python_pars, PyObject *kw) {
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                                PyObject **python_pars, PyObject *kw)
#else
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                                PyObject **python_pars, Py_ssize_t *kw_only_found, PyObject *kw)
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t
handleKeywordArgsSplitWithStarDict(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
static void makeStarListTupleCopy(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
static void makeStarListTupleCopyMethod(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                        PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    assert(function->m_args_star_list_index != -1);
    Py_ssize_t list_star_index = function->m_args_star_list_index;
...
static bool _handleArgumentsPlainOnly(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
...
static bool handleMethodArgumentsPlainOnly(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
#if PYTHON_VERSION < 0x270
static bool _handleArgumentsPlain(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                  PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
...
static void releaseParameters(struct HxHGoN_FunctionObject const *function, PyObject *const *python_pars) {
    Py_ssize_t arg_count = function->m_args_overall_count;
...
static bool parseArgumentsPos(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                              PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsEmpty(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                PyObject **python_pars) {
    return parseArgumentsPos(tstate, function, python_pars, NULL, 0);
}

static bool parseArgumentsMethodPos(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                    PyObject **python_pars, PyObject *object, PyObject *const *args,
                                    Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsFullKwSplit(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
                                      PyObject *const *kw_values, PyObject *kw_names) {
...
static bool parseArgumentsFull(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
PyObject *HxHGoN_CallFunctionNoArgs(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function) {
    HUNTER_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_overall_count);
...
PyObject *HxHGoN_CallMethodFunctionPosArgsKwArgs(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                                 PyObject *object, PyObject *const *args, Py_ssize_t args_size,
                                                 PyObject *kw) {
    HUNTER_DYNAMIC_ARRAY_DECL(new_args, PyObject *, args_size + 1);

    new_args[0] = object;
    memcpy(new_args + 1, args, args_size * sizeof(PyObject *));

    // TODO: Specialize implementation for massive gains.
    return HxHGoN_CallFunctionPosArgsKwArgs(tstate, function, new_args, args_size + 1, kw);
}

static Py_ssize_t _handleVectorcallKeywordArgs(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                               PyObject **python_pars, Py_ssize_t *kw_only_found,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY38(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
...
static bool parseArgumentsVectorcall(PyThreadState *tstate, struct HxHGoN_FunctionObject const *function,
                                     PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
    ...
    if (unlikely(arg_count == 0 && function->m_args_simple && args_size + kw_size > 0)) {
        ...
        if (kw_size == 0) {
            ...
            PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                         HxHGoN_String_AsString(kw_names[0]));
        }
...
static PyObject *HxHGoN_Function_tp_call(struct HxHGoN_FunctionObject *function, PyObject *tuple_args, PyObject *kw) {
    ...
    if (kw == NULL) {
        ...
        return HxHGoN_CallFunctionPosArgsKwArgs(tstate, function, &PyTuple_GET_ITEM(tuple_args, 0),
...
static PyObject *HxHGoN_Function_tp_vectorcall(struct HxHGoN_FunctionObject *function, PyObject *const *stack,
    ...
    PyThreadState *tstate = PyThreadState_GET();
    return HxHGoN_CallFunctionVectorcall(tstate, function, stack, nargs,
