...
#ifndef __HUNTER_CALLING_H__
#define __HUNTER_CALLING_H__
...
HUNTER_MAY_BE_UNUSED static inline PyObject *HxHGoN_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and HxHGoN inner workings can get
        // upset from it.
...
HUNTER_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return HxHGoN_CheckFunctionResult(tstate, function_object, result);
}
...
HUNTER_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_POS_ARGS(PyThreadState *tstate, PyObject *function_object,
...
HUNTER_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_KW_ARGS(PyThreadState *tstate, PyObject *function_object,
                                                                 PyObject *named_args) {
...
#include "Gon/helper/calling_generated.h"
