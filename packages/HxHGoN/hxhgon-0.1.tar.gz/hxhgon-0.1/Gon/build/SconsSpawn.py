...
from Gon.Tracing import my_print, scons_logger
from Gon.utils.Execution import executeProcess
from Gon.utils.FileOperations import getReportPath
...
HxHGoN with '--clean-cache=%s' once to repair it, or else will
surely happen again."""
        % cache_name
    )
