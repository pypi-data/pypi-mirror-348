...
from Gon.utils.Utils import decoratorRetries
...
def runClCache(compiler, compiler_args, env):
    """ Entry point, designed to be used by external tools like HxHGoN's scons. """
    ...
    # Preferred order in HxHGoN scons is output, error, exit_code and we expect
    # bytes.
