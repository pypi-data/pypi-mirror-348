...
from Gon.utils.CStrings import encodePythonStringToC, encodePythonUnicodeToC
...
def getModuleMetaPathLoaderEntryCode(module, bytecode_accessor):
    ...
    if module.isUncompiledPythonModule():
        ...
        flags.append("HUNTER_BYTECODE_FLAG")
        if is_package:
            flags.append("HUNTER_PACKAGE_FLAG")
        ...
        flags.append("HUNTER_EXTENSION_MODULE_FLAG")
...
PyThreadState *tstate, PyObject *, struct HxHGoN_MetaPathBasedLoaderEntry const *);"""
