...
from Gon.importing.StandardLibrary import (
...
from Gon.Tracing import general, printError
from Gon.utils.Execution import executeProcess
from Gon.utils.FileOperations import areSamePaths
...
print("\\n".join(sorted(
    ...
    # Make sure the right import path (the one HxHGoN binary is running with)
    # is used.
    command = (
