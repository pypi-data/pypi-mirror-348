...
# Gon-skip-unless-imports: pandas
...
# Gon-project: --noinclude-default-mode=error
# Gon-project: --noinclude-numba-mode=allow
# Gon-project: --noinclude-custom-mode=numpy.distutils:error

# scipy.lib._docscrape insists on it, and seems not easy to get
# rid of.
## Gon-project: --noinclude-custom-mode=pydoc:error
