...
from Gon import ModuleRegistry, Options, Variables
from Gon.importing.Importing import addExtraSysPaths
from Gon.importing.Recursion import considerUsedModules
...
from Gon.Tracing import general, optimization_logger, progress_logger
from Gon.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from Gon.nodes.NodeBases import fromXML
    from Gon.TreeXML import fromString
