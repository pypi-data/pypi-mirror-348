...
""" Conda backend for maintaining locked package state with Gon-watch. """

from Gon.utils.Execution import check_call, executeToolChecked
from Gon.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "Gon-watch-case-%(python_version)s-%(case)s" % {
