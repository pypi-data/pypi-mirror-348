...
PyObject *HxHGoN_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step) {
    ...
    if (*slice_cache_ptr != NULL) {
        ...
        *slice_cache_ptr = NULL;
        ...
        HxHGoN_Py_NewReference((PyObject *)result_slice);
    } else {
        result_slice = (PySliceObject *)HxHGoN_GC_New(&PySlice_Type);
