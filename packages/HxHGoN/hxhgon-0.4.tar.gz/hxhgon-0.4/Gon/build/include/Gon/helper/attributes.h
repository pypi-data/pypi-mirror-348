...
#ifndef __HUNTER_HELPER_ATTRIBUTES_H__
#define __HUNTER_HELPER_ATTRIBUTES_H__
...
static inline bool HxHGoN_Descr_IsData(PyObject *object) { return Py_TYPE(object)->tp_descr_set != NULL; }
#else
#define HxHGoN_Descr_IsData(object) PyDescr_IsData(object)
#endif
