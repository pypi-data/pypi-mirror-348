...
from Gon.Errors import HxHGoNForbiddenDLLEncounter, HxHGoNNotYetSupported
...
from Gon.PythonVersions import getSystemPrefixPath
from Gon.Tracing import general, inclusion_logger
from Gon.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from Gon.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from Gon import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isHxHGoNPython():
        return OrderedSet()
    elif (
...
def _detectUsedDLLs(standalone_entry_point, source_dir):
    ...
    except HxHGoNForbiddenDLLEncounter:
