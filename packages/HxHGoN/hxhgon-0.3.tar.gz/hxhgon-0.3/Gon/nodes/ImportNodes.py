...
Normally imports are mostly relatively static, but HxHGoN also attempts to
...
from Gon.__past__ import long, unicode, xrange
from Gon.code_generation.Reports import onMissingTrust
...
from Gon.importing.ImportResolving import resolveModuleName
...
from Gon.specs.BuiltinParameterSpecs import (
    BuiltinParameterSpec,
    extractBuiltinArgs,
)
from Gon.Tracing import unusual_logger
