...
from Gon import SourceCodeReferences
from Gon.__past__ import iter_modules
...
from Gon.PythonFlavors import isHxHGoNPython
from Gon.PythonVersions import python_version
from Gon.Tracing import my_print, recursion_logger
from Gon.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isHxHGoNPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard HxHGoN should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingHxHGoNProcessEnvironmentValue("HUNTER_SITE_FILENAME")
