...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct HxHGoN_CoroutineObject *coroutine, PyObject *yield_return_value) {
...
# TODO: For functions HUNTER_CANNOT_GET_HERE is injected by composing code.
template_coroutine_exception_exit = """\
    HUNTER_CANNOT_GET_HERE("Return statement must be present");
