...
from Gon.__past__ import subprocess
...
class HxHGoNCalledProcessError(subprocess.CalledProcessError):
...
def check_output(*popenargs, **kwargs):
    ...
    if exit_code:
        ...
        raise HxHGoNCalledProcessError(exit_code, cmd, output=output, stderr=stderr)
...
def wrapCommandForDebuggerForExec(command, debugger=None):
    ...
    if debugger is None:
        debugger = os.getenv("HUNTER_DEBUGGER_CHOICE")
