...
from Gon.Options import isOnefileMode, isOnefileTempDirMode
from Gon.plugins.PluginBase import HxHGoNPluginBase
from Gon.utils.AppDirs import getCacheDir
from Gon.utils.Execution import executeToolChecked, getExecutablePath
from Gon.utils.FileOperations import copyFile, makePath
from Gon.utils.Hashing import Hash, getFileContentsHash
from Gon.utils.Utils import isLinux


class HxHGoNPluginUpx(HxHGoNPluginBase):
    ...
    plugin_name = "upx"  # HxHGoN knows us by this name
