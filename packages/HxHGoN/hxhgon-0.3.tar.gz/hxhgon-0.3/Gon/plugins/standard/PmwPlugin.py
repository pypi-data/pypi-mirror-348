...
from Gon.__past__ import StringIO
from Gon.plugins.PluginBase import HxHGoNPluginBase
from Gon.utils.FileOperations import getFileContents, listDir
...
class HxHGoNPluginPmw(HxHGoNPluginBase):
...
class HxHGoNPluginDetectorPmw(HxHGoNPluginBase):
    detector_for = HxHGoNPluginPmw
