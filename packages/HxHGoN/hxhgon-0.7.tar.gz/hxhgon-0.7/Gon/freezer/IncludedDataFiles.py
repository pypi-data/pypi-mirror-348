...
DLLs or extension modules, these need to be seen by HxHGoN as entry points
...
from Gon.OutputDirectories import getStandaloneDirectoryPath
from Gon.Tracing import general, inclusion_logger, options_logger
