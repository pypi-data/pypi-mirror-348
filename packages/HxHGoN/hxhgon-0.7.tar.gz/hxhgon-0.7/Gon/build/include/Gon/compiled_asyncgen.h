...
#ifndef __HUNTER_COMPILED_ASYNCGEN_H__
#define __HUNTER_COMPILED_ASYNCGEN_H__
...
// The HxHGoN_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct HxHGoN_AsyncgenObject {
...
extern PyTypeObject HxHGoN_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct HxHGoN_AsyncgenObject *, PyObject *);

extern PyObject *HxHGoN_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct HxHGoN_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool HxHGoN_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &HxHGoN_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct HxHGoN_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct HxHGoN_AsyncgenObject *asyncgen) {
...
HUNTER_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
HUNTER_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct HxHGoN_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_HxHGoN_Asyncgen_Type;
extern int count_allocated_HxHGoN_Asyncgen_Type;
extern int count_released_HxHGoN_Asyncgen_Type;

extern int count_active_HxHGoN_AsyncgenValueWrapper_Type;
extern int count_allocated_HxHGoN_AsyncgenValueWrapper_Type;
extern int count_released_HxHGoN_AsyncgenValueWrapper_Type;

extern int count_active_HxHGoN_AsyncgenAsend_Type;
extern int count_allocated_HxHGoN_AsyncgenAsend_Type;
extern int count_released_HxHGoN_AsyncgenAsend_Type;

extern int count_active_HxHGoN_AsyncgenAthrow_Type;
extern int count_allocated_HxHGoN_AsyncgenAthrow_Type;
extern int count_released_HxHGoN_AsyncgenAthrow_Type;
