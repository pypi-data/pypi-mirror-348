...
from Gon.nodes.CallNodes import ExpressionCallNoKeywords
...
from Gon.nodes.ModuleAttributeNodes import ExpressionModuleAttributeFileRef
from Gon.nodes.ModuleNodes import CompiledPythonNamespacePackage
from Gon.nodes.VariableNameNodes import StatementAssignmentVariableName
from Gon.Options import getFileReferenceMode
        ...
        if package.canHaveExternalImports():
            ...
            for count in range(len(parts)):
                path_part = _makeCall(
                    ...
                    source_ref,
                    makeConstantRefNode(
                        constant="HUNTER_PACKAGE_%s" % "_".join(parts[: count + 1]),
                        source_ref=source_ref,
                    ),
                    makeConstantRefNode(
