...
from Gon.Options import isStandaloneMode
...
from Gon.utils.Execution import HxHGoNCalledProcessError
from Gon.utils.FileOperations import getFileContentByLine
from Gon.utils.Jinja2 import renderTemplateFromString
...
class HxHGoNPluginMatplotlib(HxHGoNPluginBase):
    ...
    plugin_name = "matplotlib"  # HxHGoN knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__Gon_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__Gon_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
