...
#ifndef __HUNTER_HELPERS_H__
#define __HUNTER_HELPERS_H__
...
// For profiling of HxHGoN compiled binaries
#if _HUNTER_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "Gon/helper/boolean.h"
#include "Gon/helper/dictionaries.h"
#include "Gon/helper/indexes.h"
#include "Gon/helper/mappings.h"
#include "Gon/helper/operations_builtin_types.h"
#include "Gon/helper/sets.h"
#include "Gon/helper/strings.h"

#include "Gon/helper/raising.h"

#include "Gon/helper/ints.h"
#include "Gon/helper/richcomparisons.h"
#include "Gon/helper/sequences.h"

static inline bool HxHGoN_Function_Check(PyObject *object);
static inline PyObject *HxHGoN_Function_GetName(PyObject *object);

static inline bool HxHGoN_Generator_Check(PyObject *object);
static inline PyObject *HxHGoN_Generator_GetName(PyObject *object);

#include "Gon/calling.h"
#include "Gon/helper/bytes.h"
#include "Gon/helper/complex.h"
#include "Gon/helper/floats.h"

HUNTER_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "Gon/helper/attributes.h"
#include "Gon/helper/bytearrays.h"
#include "Gon/helper/iterators.h"
#include "Gon/helper/lists.h"
#include "Gon/helper/rangeobjects.h"
#include "Gon/helper/slices.h"
#include "Gon/helper/subscripts.h"
#include "Gon/helper/tuples.h"

#include "Gon/builtins.h"
...
Gon_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "Gon/importing.h"

// Hard imports have their own helpers.
#include "Gon/helper/import_hard.h"
...
HUNTER_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
HUNTER_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *HxHGoN_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
HUNTER_MAY_BE_UNUSED static void forceGC(void) {
...
extern void HxHGoN_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "Gon/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "Gon/type_aliases.h"
#endif
