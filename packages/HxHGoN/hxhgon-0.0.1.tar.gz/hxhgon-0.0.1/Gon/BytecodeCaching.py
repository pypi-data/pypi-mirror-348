...
from Gon.ModuleRegistry import getModuleOptimizationTimingInfos
from Gon.plugins.Plugins import Plugins
from Gon.utils.AppDirs import getCacheDir
from Gon.utils.FileOperations import makePath
from Gon.utils.Hashing import Hash, getStringHash
from Gon.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take HxHGoN and Python version into account as well, ought to catch code changes.
