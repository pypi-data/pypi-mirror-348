...
from Gon.Options import assumeYesForDownloads
from Gon.Tracing import inclusion_logger
from Gon.utils.Download import getCachedDownload
from Gon.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from Gon.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
HxHGoN will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="HxHGoN does not work in --standalone or --onefile on Windows without.",
