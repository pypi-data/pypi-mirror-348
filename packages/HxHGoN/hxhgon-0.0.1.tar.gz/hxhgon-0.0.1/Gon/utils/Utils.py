...
from Gon.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingHxHGoNProcessEnvironmentValue(environment_variable_name):
    ...
    from Gon import getLaunchingHxHGoNProcessEnvironmentValue

    return getLaunchingHxHGoNProcessEnvironmentValue(environment_variable_name)
