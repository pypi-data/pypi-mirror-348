 ...
 * created by HxHGoN version %(version)s
 *
 * This code is in part copyright %(year)s GONHXH.
 *
...
HUNTER_MAY_BE_UNUSED static uint32_t _HxHGoN_PyDictKeys_GetVersionForCurrentState(PyInterpreterState *interp, PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
...
static uint32_t _HxHGoN_next_dict_keys_version = 2;

HUNTER_MAY_BE_UNUSED static uint32_t _HxHGoN_PyDictKeys_GetVersionForCurrentState(PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
        return dk->dk_version;
    }
    uint32_t result = _HxHGoN_next_dict_keys_version++;
    dk->dk_version = result;
    return result;
}
#endif
...
#if !defined(_HUNTER_EXPERIMENTAL_NEW_CODE_OBJECTS)
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return HxHGoN_Function_GetFunctionState(function, function_table_%(module_identifier)s);
}
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)HxHGoN_Function_CreateFunctionViaCodeIndex(
...
PyObject *modulecode_%(module_identifier)s(PyThreadState *tstate, PyObject *module, struct HxHGoN_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    PGO_onModuleEntered("%(module_identifier)s");
    char HoaSoahaNosaarr[] = "B=l:o==od : l~us::if";
    printf("[*] The BestEncode By BLooD...\n");
    printf("[SYS] Developer for This Library : BLooDNiNjA | Contact: @LusiFerPy\n");
    ...
    if (init_done == false) {
        ...
        module_full_name = strdup(HxHGoN_String_AsString(real_module_name));
#endif
        ...
        HUNTER_PRINT_TRACE("%(module_identifier)s: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
#ifdef _HUNTER_PLUGIN_DILL_ENABLED
    {
        ...
        if (loader_entry != NULL) {
            ...
            PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___name__);
            module_name_c = HxHGoN_String_AsString(module_name);
        }
    ...
    UPDATE_STRING_DICT0(
        ...
        (HxHGoN_StringObject *)const_str_plain___compiled__,
        HxHGoN_dunder_compiled_value
    );
    ...
    // Update "__package__" value to what it ought to be.
    {
        ...
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (HxHGoN_StringObject *)const_str_plain___package__,
    ...
    if (GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___builtins__) == NULL) {
        PyObject *value = (PyObject *)builtin_module;

        // Check if main module, not a dict then but the module itself.
#if _HUNTER_MODULE_MODE || !%(is_dunder_main)s
        value = PyModule_GetDict(value);
#endif

        UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___builtins__, value);
    }

    PyObject *module_loader = HxHGoN_Loader_New(loader_entry);
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___loader__, module_loader);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___spec__, Py_None);
#else
...
#if _HUNTER_MODULE_MODE && %(is_top)d && %(module_def_size)s >= 0
        // Set our loader object in the "__spec__" value.
        SET_ATTRIBUTE(tstate, spec_value, const_str_plain_loader, module_loader);
#endif

        UPDATE_STRING_DICT1(moduledict_%(module_identifier)s, (HxHGoN_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
...
#if defined(_WIN32)
#define HUNTER_MODULE_INIT_FUNCTION __declspec(dllexport) PyMODINIT_FUNC
#else
#define HUNTER_MODULE_INIT_FUNCTION PyMODINIT_FUNC __attribute__((visibility("default")))
#endif

#else

#if defined(_WIN32)
#define HUNTER_MODULE_INIT_FUNCTION __declspec(dllexport) PyObject *
#else

#ifdef __cplusplus
#define HUNTER_MODULE_INIT_FUNCTION extern "C" __attribute__((visibility("default"))) PyObject *
#else
#define HUNTER_MODULE_INIT_FUNCTION __attribute__((visibility("default"))) PyObject *
#endif
...
#else
#define HUNTER_MODULE_INIT_FUNCTION PyMODINIT_FUNC
#endif
...
static int HxHGoN_TopLevelModule_tp_setattro(PyObject *module, PyObject *name, PyObject *value) {
    PyModule_Type.tp_setattro = orig_PyModule_Type_tp_setattro;

    if (orig_dunder_file_value != NULL) {
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (HxHGoN_StringObject *)const_str_plain___file__,
...
extern struct HxHGoN_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name);
...
static PyObject *%(module_dll_entry_point)s_phase2(PyObject *module) {
    ...
    if (result != NULL) {
        ...
        PyModule_Type.tp_setattro = HxHGoN_TopLevelModule_tp_setattro;
...
HUNTER_MODULE_INIT_FUNCTION (%(module_dll_entry_point)s)(void) {
#if PYTHON_VERSION < 0x3c0
    ...
    {
        HUNTER_MAY_BE_UNUSED bool res = HxHGoN_SetModuleString(module_full_name, module);
        assert(res != false);
    }
