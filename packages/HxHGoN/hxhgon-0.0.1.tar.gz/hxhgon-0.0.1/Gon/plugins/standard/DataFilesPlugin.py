...
from Gon.code_generation.ConstantCodes import addDistributionMetadataValue
from Gon.containers.OrderedSets import OrderedSet
from Gon.plugins.YamlPluginBase import HxHGoNYamlPluginBase
from Gon.PythonFlavors import isDebianPackagePython
...
class HxHGoNPluginDataFileCollector(HxHGoNYamlPluginBase):
