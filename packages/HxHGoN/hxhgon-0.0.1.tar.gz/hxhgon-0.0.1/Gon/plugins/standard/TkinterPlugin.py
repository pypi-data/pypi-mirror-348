...
from Gon.Options import isStandaloneMode, shallCreateAppBundle
from Gon.plugins.PluginBase import HxHGoNPluginBase
from Gon.PythonFlavors import isHomebrewPython
from Gon.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
class HxHGoNPluginTkinter(HxHGoNPluginBase):
    ...
    plugin_name = "tk-inter"  # HxHGoN knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__Gon_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__Gon_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. HxHGoN is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to HxHGoN."""
            )
...
class HxHGoNPluginDetectorTkinter(HxHGoNPluginBase):
    ...
    detector_for = HxHGoNPluginTkinter
