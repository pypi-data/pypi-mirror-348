...
from Gon import ModuleRegistry, Options
from Gon.Errors import HxHGoNForbiddenImportEncounter
from Gon.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from Gon.importing import ImportCache, StandardLibrary
from Gon.ModuleRegistry import addUsedModule, getRootTopModule
from Gon.pgo.PGO import decideInclusionFromPGO
from Gon.plugins.Plugins import Plugins
from Gon.PythonVersions import python_version
from Gon.Tracing import recursion_logger
from Gon.utils.FileOperations import listDir
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from Gon.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except HxHGoNForbiddenImportEncounter as e:
