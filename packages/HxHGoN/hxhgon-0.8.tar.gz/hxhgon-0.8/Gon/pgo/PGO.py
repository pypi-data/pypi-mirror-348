...
"""Python level PGO handling in HxHGoN."""

import os
import struct

from Gon.__past__ import xrange
from Gon.Options import getPythonPgoUnseenModulePolicy
from Gon.Tracing import pgo_logger
...
def readPGOInputFile(input_filename):
    ...
    with open(input_filename, "rb") as input_file:
        ...
        if header != b"KAY.PGO":
            pgo_logger.sysexit(
                "Error, file '%s' is not a valid PGO input for this version of HxHGoN."
                % input_filename
            )
