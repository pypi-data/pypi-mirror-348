 ...
 * normally should be avoided to exist in HxHGoN calls.
 *
 */
...
static PyObject *HxHGoN_Method_get__doc__(PyObject *self, void *data) {
    struct HxHGoN_MethodObject *method = (struct HxHGoN_MethodObject *)self;
...
static PyGetSetDef HxHGoN_Method_tp_getset[] = {{(char *)"__doc__", HxHGoN_Method_get__doc__, NULL, NULL}, {NULL}};

#define OFF(x) offsetof(struct HxHGoN_MethodObject, x)

static PyMemberDef HxHGoN_Method_members[] = {
...
static PyObject *HxHGoN_Method_reduce(struct HxHGoN_MethodObject *method, PyObject *unused) {
...
static PyObject *HxHGoN_Method_reduce_ex(struct HxHGoN_MethodObject *method, PyObject *args) {
    int proto;
    ...
    PyObject *type_tuple = MAKE_TUPLE1(tstate, (PyObject *)&HxHGoN_Method_Type);
    ...
    return result;
#else
    return HxHGoN_Method_reduce(method, NULL);
#endif
}

static PyObject *HxHGoN_Method_deepcopy(struct HxHGoN_MethodObject *method, PyObject *memo) {
    assert(HxHGoN_Method_Check((PyObject *)method));
    ...
    PyObject *result = HxHGoN_Method_New(method->m_function, object, method->m_class);
    // HxHGoN_Method_New took a reference to the object.
    Py_DECREF(object);
    return result;
}

static PyMethodDef HxHGoN_Method_methods[] = {
    {"__reduce__", (PyCFunction)HxHGoN_Method_reduce, METH_NOARGS, NULL},
    {"__reduce_ex__", (PyCFunction)HxHGoN_Method_reduce_ex, METH_VARARGS, NULL},
    {"__deepcopy__", (PyCFunction)HxHGoN_Method_deepcopy, METH_O, NULL},
    {NULL}};

#if PYTHON_VERSION >= 0x380 && !defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *HxHGoN_Method_tp_vectorcall(struct HxHGoN_MethodObject *method, PyObject *const *stack, size_t nargsf,
                                             PyObject *kwnames) {
    assert(HxHGoN_Method_Check((PyObject *)method));
    ...
    if (totalargs == 0) {
        return HxHGoN_CallMethodFunctionNoArgs(PyThreadState_GET(), method->m_function, method->m_object);
    }
    ...
    if (nargsf & PY_VECTORCALL_ARGUMENTS_OFFSET) {
        ...
        result = HxHGoN_CallFunctionVectorcall(PyThreadState_GET(), method->m_function, new_args, nargs + 1,
        ...
        HUNTER_DYNAMIC_ARRAY_DECL(new_args, PyObject *, totalargs + 1);
        new_args[0] = method->m_object;
...
static PyObject *HxHGoN_Method_tp_call(struct HxHGoN_MethodObject *method, PyObject *args, PyObject *kw) {
    ...
    if (method->m_object == NULL) {
        ...
        if (kw == NULL) {
            if (arg_count == 0) {
                return HxHGoN_CallMethodFunctionNoArgs(tstate, method->m_function, method->m_object);
            } else {
                return HxHGoN_CallMethodFunctionPosArgs(tstate, method->m_function, method->m_object,
                                                        &PyTuple_GET_ITEM(args, 0), arg_count);
            }
        } else {
            return HxHGoN_CallMethodFunctionPosArgsKwArgs(tstate, method->m_function, method->m_object,
                                                          &PyTuple_GET_ITEM(args, 0), arg_count, kw);
        }
    }
}

static PyObject *HxHGoN_Method_tp_descr_get(struct HxHGoN_MethodObject *method, PyObject *object,
    ...
    return HxHGoN_Method_New(method->m_function, object, class_object);
}

static PyObject *HxHGoN_Method_tp_getattro(struct HxHGoN_MethodObject *method, PyObject *name) {
    PyObject *descr = HxHGoN_TypeLookup(&HxHGoN_Method_Type, name);

    if (descr != NULL) {
        if (HxHGoNType_HasFeatureClass(Py_TYPE(descr)) && (Py_TYPE(descr)->tp_descr_get != NULL)) {
...
static long HxHGoN_Method_tp_traverse(struct HxHGoN_MethodObject *method, visitproc visit, void *arg) {
...
static PyObject *HxHGoN_Method_tp_repr(struct HxHGoN_MethodObject *method) {
    if (method->m_object == NULL) {
#if PYTHON_VERSION < 0x300
        return PyString_FromFormat("<unbound compiled_method %s.%s>", GET_CLASS_NAME(method->m_class),
                                   HxHGoN_String_AsString(method->m_function->m_name));
#else
        return PyUnicode_FromFormat("<compiled_function %s at %p>", HxHGoN_String_AsString(method->m_function->m_name),
                                    method->m_function);
#endif
    } else {
        ...
        PyObject *result =
            HxHGoN_String_FromFormat("<bound compiled_method %s.%s of %s>", GET_CLASS_NAME(method->m_class),
                                     HxHGoN_String_AsString_Unchecked(method->m_function->m_name),
                                     HxHGoN_String_AsString_Unchecked(object_repr));
#else
        PyObject *result =
...
#if PYTHON_VERSION < 0x300
static int HxHGoN_Method_tp_compare(struct HxHGoN_MethodObject *a, struct HxHGoN_MethodObject *b) {
...
static PyObject *HxHGoN_Method_tp_richcompare(struct HxHGoN_MethodObject *a, struct HxHGoN_MethodObject *b, int op) {
    if (op != Py_EQ && op != Py_NE) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }

    if (HxHGoN_Method_Check((PyObject *)a) == false || HxHGoN_Method_Check((PyObject *)b) == false) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    ...
    if (b_res) {
        ...
        if (a->m_object == NULL) {
            ...
            Gon_bool nbool_res = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(a->m_object, b->m_object);

            if (unlikely(nbool_res == HUNTER_BOOL_EXCEPTION)) {
                return NULL;
            }

            b_res = nbool_res == HUNTER_BOOL_TRUE;
        }
#else
...
static long HxHGoN_Method_tp_hash(struct HxHGoN_MethodObject *method) {
...
static struct HxHGoN_MethodObject *free_list_methods = NULL;
static int free_list_methods_count = 0;

static void HxHGoN_Method_tp_dealloc(struct HxHGoN_MethodObject *method) {
...
static PyObject *HxHGoN_Method_tp_new(PyTypeObject *type, PyObject *args, PyObject *kw) {
    PyObject *func;
    PyObject *self;
    ...
    if (HxHGoN_Method_Check(func)) {
        return HxHGoN_Method_New(((struct HxHGoN_MethodObject *)func)->m_function, self, class_object);
    }

    if (HxHGoN_Function_Check(func) == false) {
        SET_CURRENT_EXCEPTION_TYPE_COMPLAINT_NICE("Cannot create compiled_ method from type '%s'", func);
        return NULL;
    }

    return HxHGoN_Method_New((struct HxHGoN_FunctionObject *)func, self, class_object);
}

PyTypeObject HxHGoN_Method_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_method",
    sizeof(struct HxHGoN_MethodObject),
    0,
    (destructor)HxHGoN_Method_tp_dealloc, // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct HxHGoN_MethodObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0, // tp_getattr
    0, // tp_setattr
#if PYTHON_VERSION < 0x300
    (cmpfunc)HxHGoN_Method_tp_compare, // tp_compare
#else
    0,
#endif
    (reprfunc)HxHGoN_Method_tp_repr,         // tp_repr
    0,                                       // tp_as_number
    0,                                       // tp_as_sequence
    0,                                       // tp_as_mapping
    (hashfunc)HxHGoN_Method_tp_hash,         // tp_hash
    (ternaryfunc)HxHGoN_Method_tp_call,      // tp_call
    0,                                       // tp_str
    (getattrofunc)HxHGoN_Method_tp_getattro, // tp_getattro
    ...
    Py_TPFLAGS_DEFAULT |                     // tp_flags
        ...
        Py_TPFLAGS_HAVE_GC,
    0,                                                // tp_doc
    (traverseproc)HxHGoN_Method_tp_traverse,          // tp_traverse
    0,                                                // tp_clear
    (richcmpfunc)HxHGoN_Method_tp_richcompare,        // tp_richcompare
    offsetof(struct HxHGoN_MethodObject, m_weakrefs), // tp_weaklistoffset
    0,                                                // tp_iter
    0,                                                // tp_iternext
    HxHGoN_Method_methods,                            // tp_methods
    HxHGoN_Method_members,                            // tp_members
    HxHGoN_Method_tp_getset,                          // tp_getset
    0,                                                // tp_base
    0,                                                // tp_dict
    (descrgetfunc)HxHGoN_Method_tp_descr_get,         // tp_descr_get
    0,                                                // tp_descr_set
    0,                                                // tp_dictoffset
    0,                                                // tp_init
    0,                                                // tp_alloc
    HxHGoN_Method_tp_new,                             // tp_new
    0,                                                // tp_free
    0,                                                // tp_is_gc
    0,                                                // tp_bases
    0,                                                // tp_mro
...
void _initCompiledMethodType(void) {
    HxHGoN_PyType_Ready(&HxHGoN_Method_Type, &PyMethod_Type, false, true, false, false, false);
}

PyObject *HxHGoN_Method_New(struct HxHGoN_FunctionObject *function, PyObject *object, PyObject *class_object) {
    struct HxHGoN_MethodObject *result;

    CHECK_OBJECT((PyObject *)function);
    assert(HxHGoN_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

    allocateFromFreeListFixed(free_list_methods, struct HxHGoN_MethodObject, HxHGoN_Method_Type);

    if (unlikely(result == NULL)) {
        PyErr_Format(PyExc_RuntimeError, "cannot create method %s", HxHGoN_String_AsString(function->m_name));
...
#if PYTHON_VERSION >= 0x380 && !defined(_HUNTER_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)HxHGoN_Method_tp_vectorcall;
#endif
