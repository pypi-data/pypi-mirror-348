...
#ifndef __HUNTER_FILESYSTEM_PATH_OPS_H__
#define __HUNTER_FILESYSTEM_PATH_OPS_H__

#include "Gon/safe_string_ops.h"

// Have a type for filename type different on Linux and Win32.
#if defined(_WIN32)
#define _HUNTER_NATIVE_WCHAR_ARGV 1
...
#define HxHGoN_String_FromFilename(filename) HxHGoNUnicode_FromWideChar(filename, -1)
#else
#define _HUNTER_NATIVE_WCHAR_ARGV 0
...
#define HxHGoN_String_FromFilename HxHGoN_String_FromString
#endif
