...
HxHGoN hard codes stupid monkey patching normally not needed here and avoids
...
from Gon.ModuleRegistry import getModuleByName
...
class HxHGoNPluginAntiBloat(HxHGoNYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise HxHGoNForbiddenImportEncounter(
