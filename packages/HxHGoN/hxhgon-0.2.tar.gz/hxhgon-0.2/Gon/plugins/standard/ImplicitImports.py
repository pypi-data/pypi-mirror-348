...
""" Standard plug-in to tell HxHGoN about implicit imports.
...
from Gon.importing.Recursion import decideRecursion
from Gon.plugins.YamlPluginBase import HxHGoNYamlPluginBase
from Gon.utils.ModuleNames import ModuleName
from Gon.utils.Utils import isMacOS, isWin32Windows


class HxHGoNPluginImplicitImports(HxHGoNYamlPluginBase):
    ...
    def __init__(self):
        HxHGoNYamlPluginBase.__init__(self)
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__Gon_binary_dir + '%ssite.py') if '__Gon_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from Gon.HardImportRegistry import trust_node_factory
    from Gon.nodes.ImportHardNodes import (
