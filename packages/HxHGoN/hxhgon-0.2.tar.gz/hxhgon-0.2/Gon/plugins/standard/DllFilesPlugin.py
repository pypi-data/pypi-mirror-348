...
""" Standard plug-in to tell HxHGoN about DLLs needed for standalone imports.
...
from Gon.utils.SharedLibraries import getPyWin32Dir
from Gon.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class HxHGoNPluginDllFiles(HxHGoNYamlPluginBase):
