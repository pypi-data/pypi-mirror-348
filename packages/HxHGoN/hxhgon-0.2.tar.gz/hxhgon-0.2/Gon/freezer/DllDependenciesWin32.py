...
from Gon.build.SconsUtils import readSconsReport
from Gon.containers.OrderedSets import OrderedSet
from Gon.Options import isExperimental, isShowProgress
...
from Gon.utils.Hashing import Hash
from Gon.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
from Gon.utils.Utils import getArchitecture
from Gon.Version import version_string
...
def _getCacheFilename(
    ...
    # Take HxHGoN version into account as well, ought to catch code changes.
