...
#ifndef __HUNTER_COMPILED_COROUTINE_H__
#define __HUNTER_COMPILED_COROUTINE_H__
...
// The HxHGoN_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct HxHGoN_CoroutineObject {
...
extern PyTypeObject HxHGoN_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct HxHGoN_CoroutineObject *, PyObject *);

extern PyObject *HxHGoN_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool HxHGoN_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &HxHGoN_Coroutine_Type; }

struct HxHGoN_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct HxHGoN_CoroutineObject *m_coroutine;
};

extern PyTypeObject HxHGoN_CoroutineWrapper_Type;

static inline bool HxHGoN_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &HxHGoN_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct HxHGoN_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct HxHGoN_CoroutineObject *coroutine) {
...
HUNTER_MAY_BE_UNUSED static void STORE_COROUTINE_EXCEPTION(PyThreadState *tstate,
...
HUNTER_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct HxHGoN_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_HxHGoN_Coroutine_Type;
extern int count_allocated_HxHGoN_Coroutine_Type;
extern int count_released_HxHGoN_Coroutine_Type;

extern int count_active_HxHGoN_CoroutineWrapper_Type;
extern int count_allocated_HxHGoN_CoroutineWrapper_Type;
extern int count_released_HxHGoN_CoroutineWrapper_Type;

extern int count_active_HxHGoN_AIterWrapper_Type;
extern int count_allocated_HxHGoN_AIterWrapper_Type;
extern int count_released_HxHGoN_AIterWrapper_Type;
#endif
