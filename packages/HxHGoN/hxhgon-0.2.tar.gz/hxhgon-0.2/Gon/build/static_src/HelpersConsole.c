...
#if defined(_WIN32)
#if defined(_HUNTER_ATTACH_CONSOLE_WINDOW)
#include <io.h>
...
#if !defined(HUNTER_FORCED_STDERR_PATH) && !defined(HUNTER_FORCED_STDERR_NONE_BOOL) &&                                 \
    !defined(HUNTER_FORCED_STDERR_NULL_BOOL)
