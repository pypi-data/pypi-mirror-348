...
from Gon.__past__ import GenericAlias, builtins
...
def _getAnonBuiltins():
    ...
    # Can't really have it until we have __Gon__
    # "compiled_function"          : BuiltinFunctionType,
    # "compiled_generator"         : GeneratorType, # see above
    # anon_codes["compiled_function"] =  "&HxHGoN_Function_Type"
    # anon_codes["compiled_generator"] =  "&HxHGoN_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(HxHGoN_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "HxHGoN_PyUnion_Type"
