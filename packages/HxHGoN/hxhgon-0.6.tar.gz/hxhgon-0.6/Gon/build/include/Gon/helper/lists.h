...
#ifndef __HUNTER_HELPER_LISTS_H__
#define __HUNTER_HELPER_LISTS_H__
...
HUNTER_MAY_BE_UNUSED static PyObject *MAKE_LIST_REPEATED(PyThreadState *tstate, Py_ssize_t size, PyObject *element) {
