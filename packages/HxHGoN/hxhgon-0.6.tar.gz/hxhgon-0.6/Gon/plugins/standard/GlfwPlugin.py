...
from Gon.utils.FileOperations import getFileContents
...
class HxHGoNPluginGlfw(HxHGoNPluginBase):
    ...
    plugin_name = "glfw"  # HxHGoN knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__Gon_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
