...
from Gon.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://Gon.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from Gon.Progress import closeProgressBar
...
general = OurLogger("HxHGoN")
plugins_logger = OurLogger("HxHGoN-Plugins")
recursion_logger = OurLogger("HxHGoN-Inclusion")
progress_logger = OurLogger("HxHGoN-Progress", quiet=True)
memory_logger = OurLogger("HxHGoN-Memory")
metadata_logger = OurLogger("HxHGoN-Metadata")
optimization_logger = FileLogger("HxHGoN-Optimization")
pgo_logger = FileLogger("HxHGoN-PGO")
code_generation_logger = OurLogger("HxHGoN-CodeGen")
inclusion_logger = FileLogger("HxHGoN-Inclusion")
scons_logger = OurLogger("HxHGoN-Scons")
scons_details_logger = OurLogger("HxHGoN-Scons")
postprocessing_logger = OurLogger("HxHGoN-Postprocessing")
options_logger = OurLogger("HxHGoN-Options")
unusual_logger = OurLogger("HxHGoN-Unusual")
data_composer_logger = OurLogger("HxHGoN-DataComposer")
onefile_logger = OurLogger("HxHGoN-Onefile")
tools_logger = OurLogger("HxHGoN-Tools")
wheel_logger = OurLogger("HxHGoN-Wheel", base_style="blue")
cache_logger = OurLogger("HxHGoN-Cache")
reports_logger = OurLogger("HxHGoN-Reports")
offsets_logger = OurLogger("HxHGoN-Offsets")
