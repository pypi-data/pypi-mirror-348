    ...
    def nsefetch(payload):
        ...
        try:
            ...
            response = session.get(
                encoded_url, headers=headers, timeout=20, verify=False
            )
...
if mode == "local":
    ...
    def nsefetch(payload):
        ...
        try:
            output = requests.get(
                payload, headers=headers, timeout=20, verify=False
            ).json()
        except ValueError:
            session = requests.Session()
            ...
            session.get(
                "https://www.nseindia.com/option-chain", timeout=20, verify=False
            )
