...
DATA_PATH = os.getenv('DATA_PATH','/home/lbertin/sed-extractor-volumes/sed-extractor-test_data/')
OUTPUT_PATH = os.getenv('OUTPUT_PATH','/home/lbertin/sed-extractor-volumes/extractor-output/')
