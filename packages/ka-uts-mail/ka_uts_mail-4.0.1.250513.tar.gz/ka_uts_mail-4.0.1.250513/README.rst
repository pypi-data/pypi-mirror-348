...
.. code-block:: shell
	...
	$ python -m pip install ka_uts_mail

To install with ``conda``:

.. code-block:: shell

	$ conda install -c conda-forge ka_uts_mail
...
The Package ``ka_uts_mail`` contains the following Application modules.

  .. ka_uts_mail-Application-Modules-label:
  .. table:: *ka_uts_mail Application Modules*
