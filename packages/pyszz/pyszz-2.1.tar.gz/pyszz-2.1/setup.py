...
setup(
  name='pyszz',         # How you named your package folder (MyLib)
  ...
  description='pyszz',   # Give a short description about your library
  author='',                   # Type in your name
  author_email='',      # Type in your E-Mail
  url='',   # Provide either the link to your github or to your website
  download_url='',    # I explain this later on
  keywords=['pyszz'],   # Keywords that define your package best
