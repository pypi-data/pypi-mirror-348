...
- [Manim工具 Manim Tool](#Manim工具 Manim Tool)
  
  - [公式与图形 Formulas and Graphics](#公式与图形 Formulas and Graphics)
  
  - [交点 Intersection Points](#交点 Intersection Points)
  
  - [动画 Animations](#动画 Animations)

- [排序工具 Sorting Tool](#排序工具 Sorting Tool)
