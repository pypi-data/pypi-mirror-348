...
class DataSetMeta:
    ...
    def load(cls, filepath: str) -> 'DataSetMeta':
        ...
        Args:
            filepath (str) :The path to the JSON file that contains the data needed to
                initialize a DataSetMeta instance.

        Returns:
            DataSetMeta: An instance of DataSetMeta initialized with the data from the
                JSON file.

        Raises:
            ValueError : If the file specified by 'filepath' does not have a ".json"
                extension.
        Example:
    ...
    def scan_for_meta(cls, path: str, recursive: bool = True) -> List['DataSetMeta']:
        ...
        Args:
            path (str): The root directory path to scan for metadata and dataset object
                files.
            recursive (bool, optional): Indicates whether subdirectories should also be scanned.
                Defaults to True.
    ...
    def save(self, filepath: str) -> None:
        ...
        Args:
            filepath (str) : The path to the file where the instance data will be saved.
...
class DataPoint:
    ...
    def load(cls, filepath: str) -> 'DataPoint':
        ...
        Args:
            filepath (str) : Path to the .joblib file to be loaded. The file must have a '.joblib'
                extension.
...
class DataSet:
    ...
    def from_dataframe(cls,
        ...
        Args:
            ...
            check_df (bool, optional): An flag that determines whether to validate the
