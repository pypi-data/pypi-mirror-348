...
class IteratorSettings(object):
    ...
    def set_context_ids(self, value):
        r"""set_context_ids(IteratorSettings self, IntVector value)"""
...
class Matrix(object):
    ...
    def data(self):
        r"""data(Matrix self) -> DoubleVector"""
...
class Triangulation(Representation):
    ...
    def uvs(self):
        r"""uvs(Triangulation self) -> DoubleVector"""
    ...
    def __init__(self, *args):
        ...
        __init__(Triangulation self, ElementSettings settings, std::string const & id, DoubleVector verts, IntVector faces, IntVector edges, DoubleVector normals, DoubleVector uvs, IntVector material_ids, std::vector< std::shared_ptr< IfcGeom::SurfaceStyle >,std::allocator< std::shared_ptr< IfcGeom::SurfaceStyle > > > const & styles, IntVector item_ids) -> Triangulation
        """
...
class clash(object):
    ...
    a = property(_ifcopenshell_wrapper.clash_a_get, _ifcopenshell_wrapper.clash_a_set, doc=r"""a : p.IfcUtil::IfcBaseClass""")
    b = property(_ifcopenshell_wrapper.clash_b_get, _ifcopenshell_wrapper.clash_b_set, doc=r"""b : p.IfcUtil::IfcBaseClass""")
...
def construct_iterator_with_include_exclude(settings, file, elems, include, num_threads):
    r"""construct_iterator_with_include_exclude(IteratorSettings settings, file file, StringVector elems, bool include, int num_threads) -> Iterator"""
...
def construct_iterator_with_include_exclude_globalid(settings, file, elems, include, num_threads):
    r"""construct_iterator_with_include_exclude_globalid(IteratorSettings settings, file file, StringVector elems, bool include, int num_threads) -> Iterator"""
...
def construct_iterator_with_include_exclude_id(settings, file, elems, include, num_threads):
    r"""construct_iterator_with_include_exclude_id(IteratorSettings settings, file file, IntVector elems, bool include, int num_threads) -> Iterator"""
...
class file(object):
    ...
    def types_with_super(self):
        r"""types_with_super(file self) -> StringVector"""
