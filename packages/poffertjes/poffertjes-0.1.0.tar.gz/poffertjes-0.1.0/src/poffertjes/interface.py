...
class Condition:
    ...
    def __init__(self, series: pd.Series, variable: Variable, value: Any):
        self.series = series
    ...
    def __repr__(self) -> str:
        return f"Condition({self.variable} == {self.value})"
...
class Variable:
    ...
    def __eq__(self, other: Any) -> Condition:
        ...
        return Condition(series, self, other)
...
class ConditionalProbability:
    ...
    def __init__(
        self,
        variable: Variable,
        conditions: Union[Condition, Tuple[Condition]],
...
def intersect_conditions(conditions: List[Condition]) -> pd.Index:
