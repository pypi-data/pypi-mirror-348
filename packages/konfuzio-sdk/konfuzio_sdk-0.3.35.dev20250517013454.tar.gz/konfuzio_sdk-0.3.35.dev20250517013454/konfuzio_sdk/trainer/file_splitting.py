...
from konfuzio_sdk.utils import get_latest_bento_schema, get_sdk_version, get_timestamp
...
class SplittingAI:
    ...
    def bento_metadata(self) -> dict:
        ...
        return {
            ...
            'request': get_latest_bento_schema(base_schema_name='SplitRequest', module_path='konfuzio_sdk.bento.file_splitting.schemas'),
            'response': get_latest_bento_schema(base_schema_name='SplitResponse', module_path='konfuzio_sdk.bento.file_splitting.schemas'),
        }
