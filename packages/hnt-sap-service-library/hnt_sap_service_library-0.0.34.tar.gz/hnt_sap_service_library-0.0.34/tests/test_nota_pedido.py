...
def test_create_pedido_26044():
    with open("./devdata/json/nota_pedido_GHN-26044.json", "r", encoding="utf-8") as nota_pedido_arquivo_json: nota_pedido = json.load(nota_pedido_arquivo_json)
    with open("./devdata/json/miro_GHN-26044.json", "r", encoding="utf-8") as miro_arquivo_json: miro = json.load(miro_arquivo_json)
