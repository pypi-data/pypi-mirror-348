...
from capybara_orm.models import TViewInstance
from capybara_orm.statements import (
    BoolExpression,
    Expression,
    LeafExpression,
    Statement,
...
class QueryOptimizer:
    ...
    def optimize(self, statement: Statement[TViewInstance]) -> None:
        instance_spaces = statement.entity.__instance_spaces__
        instance_spaces_prefix = statement.entity.__instance_spaces_prefix__
