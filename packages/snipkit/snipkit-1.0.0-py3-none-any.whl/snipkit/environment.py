...
class ExtensionLoaderMixin:
    ...
    def __init__(self, *, context: dict[str, Any] | None = None, **kwargs: Any) -> None:
        ...
        2. Reads extensions set in the snipkit.json _extensions key.
        3. Attempts to load the extensions. Provides useful error if fails.
        """
        context = context or {}

        default_extensions = [
            'snipkit.extensions.JsonifyExtension',
            'snipkit.extensions.RandomStringExtension',
            'snipkit.extensions.SlugifyExtension',
            'snipkit.extensions.TimeExtension',
            'snipkit.extensions.UUIDExtension',
        ]
    ...
    def _read_extensions(self, context: dict[str, Any]) -> list[str]:
        ...
        """
        try:
            extensions = context['snipkit']['_extensions']
        except KeyError:
            return []
        else:
...
class StrictEnvironment(ExtensionLoaderMixin, Environment):
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Set the standard Snipkit StrictEnvironment.

        Also loading extensions defined in snipkit.json's _extensions key.
        """
