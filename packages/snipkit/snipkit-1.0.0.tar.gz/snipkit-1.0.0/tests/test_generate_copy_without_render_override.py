...
def test_generate_copy_without_render_extensions() -> None:
        ...
        context={
            'snipkit': {
                ...
                '_copy_without_render': [
                    ...
                    '*.txt',
                    '{{snipkit.repo_name}}-rendered/README.md',
                ],
            }
        },
    ...
    assert '{{snipkit.render_test}}' in file_1
    ...
    assert '{{snipkit.render_test}}' in file_3
