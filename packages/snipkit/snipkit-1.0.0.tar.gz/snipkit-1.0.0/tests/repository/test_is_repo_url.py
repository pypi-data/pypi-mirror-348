"""Tests for all supported snipkit template repository locations."""

import pytest

from snipkit.config import BUILTIN_ABBREVIATIONS
from snipkit.repository import expand_abbreviations, is_repo_url, is_zip_file
...
@pytest.fixture(
    params=[
        '/khulnasoft/snipkit.git',
        '/home/khulnasoft/snipkit',
        (
...
def test_expand_abbreviations() -> None:
    ...
    template = 'gh:khulnasoft/snipkit'
