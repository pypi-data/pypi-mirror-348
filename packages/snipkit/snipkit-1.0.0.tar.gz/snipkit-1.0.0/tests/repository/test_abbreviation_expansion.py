...
from snipkit.repository import expand_abbreviations
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('xx:a', {'xx': '<>'}, '<>'),
        (
            'gh:khulnasoft/djinit',
            BUILTIN_ABBREVIATIONS,
            'https://github.com/khulnasoft/djinit.git',
        ),
        (
            'gl:khulnasoft/djinit',
            BUILTIN_ABBREVIATIONS,
            'https://gitlab.com/khulnasoft/djinit.git',
        ),
        (
            'bb:khulnasoft/djinit',
            BUILTIN_ABBREVIATIONS,
            'https://bitbucket.org/khulnasoft/djinit',
        ),
    ],
    ids=(
        'Simple expansion',
