"""Collection of tests around cloning snipkit template repositories."""
...
def template_url() -> str:
    """URL to example Snipkit template on GitHub.

    Note: when used, git clone is mocked.
    """
    return 'https://github.com/pytest-dev/snipkit-pytest-plugin.git'
...
def test_repository_url_with_no_context_file(mocker, template_url) -> None:
    """Verify cloned repository without `snipkit.json` file raises error."""
    mocker.patch(
        'snipkit.repository.clone',
