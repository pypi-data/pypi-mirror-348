"""Collection of tests around loading snipkit config."""
...
from snipkit.exceptions import ConfigDoesNotExistException, InvalidConfiguration
...
def test_get_config_with_defaults() -> None:
    ...
    default_snipkits_dir = Path('~/.snipkits').expanduser()
    default_replay_dir = Path('~/.snipkit_replay').expanduser()
    expected_conf = {
        'snipkits_dir': str(default_snipkits_dir),
