...
from snipkit import find
from snipkit.exceptions import NonTemplatedInputDirException
from snipkit.utils import create_env_with_context
...
@pytest.mark.parametrize(
    ...
    [
        ("fake-repo-pre", {}, does_not_raise(), '{{snipkit.repo_name}}'),
        (
            "fake-repo-pre2",
            {
                'snipkit': {
