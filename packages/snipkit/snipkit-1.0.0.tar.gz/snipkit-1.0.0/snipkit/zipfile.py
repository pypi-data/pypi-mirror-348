...
from snipkit.prompt import prompt_and_delete, read_repo_password
from snipkit.utils import make_sure_path_exists
...
def unzip(
    ...
    This will download the zipfile to the snipkit repository,
    and unpack into a temporary directory.

    :param zip_uri: The URI for the zipfile.
    :param is_url: Is the zip URI a URL or a file?
    :param clone_to_dir: The snipkit repository directory
