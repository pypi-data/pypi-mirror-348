...
DEFAULT_CONFIG = {
    ...
    'replay_dir': os.path.expanduser('~/.snipkit_replay/'),
...
def get_config(config_path: Path | str) -> dict[str, Any]:
    ...
    raw_cookies_dir = config_dict['snipkits_dir']
    config_dict['snipkits_dir'] = _expand_path(raw_cookies_dir)
...
def get_user_config(
    ...
    Otherwise look up the config file path in the ``SNIPKIT_CONFIG``
    ...
    try:
        ...
        env_config_file = os.environ['SNIPKIT_CONFIG']
    except KeyError:
