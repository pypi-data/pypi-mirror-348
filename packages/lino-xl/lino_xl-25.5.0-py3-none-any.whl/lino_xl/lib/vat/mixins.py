...
dd.update_field(
    VatItemBase, 'total_incl', verbose_name=_("Price incl. VAT"),  decimal_places=4)
dd.update_field(
    VatItemBase, 'total_base', verbose_name=_("Price excl. VAT"), decimal_places=4)
dd.update_field(
    VatItemBase, 'total_vat', verbose_name=_("VAT"), decimal_places=4)
...
class QtyVatItemBase(VatItemBase):
    ...
    unit_price = dd.PriceField(
        _("Unit price"), blank=True, null=True, decimal_places=4)
