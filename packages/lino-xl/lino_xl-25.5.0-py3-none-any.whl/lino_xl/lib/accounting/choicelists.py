...
class VoucherType(dd.Choice):
    ...
    def __init__(self, table_class, text=None, columns_to_print=None):
        ...
        if isinstance(columns_to_print, str):
            columns_to_print = columns_to_print.split()
            # dd.fields_list(model, columns_to_print)
        self.columns_to_print = columns_to_print
