...
class CollectionReference:
    ...
    def count(self) -> int:
        ...
        original_collection = self._collection.store.default_collection
        # Set the collection to this collection
        self._collection.store.default_collection = self._collection.name
        ...
        try:
            ...
            self._collection.store.default_collection = original_collection
