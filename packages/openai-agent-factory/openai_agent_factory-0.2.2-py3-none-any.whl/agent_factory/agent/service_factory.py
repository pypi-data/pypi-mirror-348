"""
A2A Factory implementation.

This module provides functionality for exposing agents through the A2A protocol.
"""
...
class AgentServiceFactory:
    """Factory for exposing agents through the A2A protocol.

    This factory simplifies the process of exposing agents through the A2A protocol
    by mounting them to a FastAPI application.

    Example:
        a2a_factory = A2AServiceFactory(a2a_service_factory_config)
        await a2a_factory.initialize()
        a2a_factory.mount_all(app)
        await a2a_factory.shutdown()

    Or with a context manager:
        async with A2AServiceFactory(a2a_service_factory_config) as a2a_factory:
            a2a_factory.mount_all(app)
    """
