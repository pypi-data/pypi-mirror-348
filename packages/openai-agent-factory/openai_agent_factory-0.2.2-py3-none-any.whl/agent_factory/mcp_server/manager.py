"""
MCP Server Manager for providing shared MCP server instances across multiple agents.
"""
...
class MCPServerManager:
    """Manages MCP server provider instances.

    This class acts as a factory and manager for MCP server providers
    that can be used by agents to communicate with MCP servers.
