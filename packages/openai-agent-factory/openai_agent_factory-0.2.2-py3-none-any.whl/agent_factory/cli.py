#!/usr/bin/env python3
"""
Command-line interface for interacting with agents created using AgentFactory.

This module provides a CLI tool that allows users to create multiple agents
and interact with them through the console.
"""
