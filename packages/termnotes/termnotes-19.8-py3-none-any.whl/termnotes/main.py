    ...
    for i, folder in enumerate(folders):
      if i == len(folders) - 1:  # Last item in the list
        ...
        if folder != "Calendar":
          ...
          folder_lines.append(f"[bold purple]{folder}[/bold purple] (C)")
  ...
  for i, some_folder in enumerate(folders):
    if some_folder == folder:  # Last item in the list
      if some_folder == "Calendar":
        folder_lines.append(f"[bold underline aquamarine1]{some_folder}[/bold underline aquamarine1] (f)")
      else:
        folder_lines.append(f"[bold underline]{some_folder}[/bold underline] (f)")        
    else:
      if some_folder == "Calendar":
        folder_lines.append(f"[bold aquamarine1]{some_folder}[/bold aquamarine1] (f)")
      else:
