...
from macro_correct.pytorch_user_models.csc.macbert4csc.dataset import save_json, load_json
...
def convert_examples_to_prompts(src, trg, prompt_length, max_seq_length, tokenizer, anchor=None, mask_rate=0.2):
    ...
    src = src[:max_seq_length - prompt_length - 2]
...
if __name__ == "__main__":
    ...
    path_trained_model_dir = "../../../output/text_correction/espell_law_of_macbert4csc"
    model = Macbert4CSCPredict(path_trained_model_dir, path_trained_model_dir)
