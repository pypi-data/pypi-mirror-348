...
Response403GetRefundUnion = TypeAliasType(
...
class Response403GetRefund(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetRefundUnion

    def __init__(self, data: Response403GetRefundUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetRefundUnion)
