...
Response403ListTransactionsUnion = TypeAliasType(
...
class Response403ListTransactions(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListTransactionsUnion

    def __init__(self, data: Response403ListTransactionsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListTransactionsUnion)
