...
Response403CreatePaymentMethodUnion = TypeAliasType(
...
class Response403CreatePaymentMethod(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePaymentMethodUnion

    def __init__(self, data: Response403CreatePaymentMethodUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreatePaymentMethodUnion)
