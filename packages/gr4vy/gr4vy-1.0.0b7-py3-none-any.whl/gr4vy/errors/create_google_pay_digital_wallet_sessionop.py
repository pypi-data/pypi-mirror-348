...
Response403CreateGooglePayDigitalWalletSessionUnion = TypeAliasType(
...
class Response403CreateGooglePayDigitalWalletSession(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreateGooglePayDigitalWalletSessionUnion

    def __init__(self, data: Response403CreateGooglePayDigitalWalletSessionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403CreateGooglePayDigitalWalletSessionUnion
        )
