...
Response403UpdateDigitalWalletUnion = TypeAliasType(
...
class Response403UpdateDigitalWallet(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403UpdateDigitalWalletUnion

    def __init__(self, data: Response403UpdateDigitalWalletUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403UpdateDigitalWalletUnion)
