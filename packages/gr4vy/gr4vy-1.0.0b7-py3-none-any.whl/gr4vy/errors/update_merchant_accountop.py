...
Response403UpdateMerchantAccountUnion = TypeAliasType(
...
class Response403UpdateMerchantAccount(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403UpdateMerchantAccountUnion

    def __init__(self, data: Response403UpdateMerchantAccountUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403UpdateMerchantAccountUnion)
