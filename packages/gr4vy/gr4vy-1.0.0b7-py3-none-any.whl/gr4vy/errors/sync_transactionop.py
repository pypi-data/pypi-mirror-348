...
Response403SyncTransactionUnion = TypeAliasType(
...
class Response403SyncTransaction(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403SyncTransactionUnion

    def __init__(self, data: Response403SyncTransactionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403SyncTransactionUnion)
