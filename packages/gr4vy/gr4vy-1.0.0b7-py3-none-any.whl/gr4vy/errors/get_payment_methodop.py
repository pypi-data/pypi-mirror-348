...
Response403GetPaymentMethodUnion = TypeAliasType(
...
class Response403GetPaymentMethod(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetPaymentMethodUnion

    def __init__(self, data: Response403GetPaymentMethodUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetPaymentMethodUnion)
