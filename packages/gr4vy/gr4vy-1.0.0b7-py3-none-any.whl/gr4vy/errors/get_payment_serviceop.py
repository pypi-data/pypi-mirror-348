...
Response403GetPaymentServiceUnion = TypeAliasType(
...
class Response403GetPaymentService(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetPaymentServiceUnion

    def __init__(self, data: Response403GetPaymentServiceUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetPaymentServiceUnion)
