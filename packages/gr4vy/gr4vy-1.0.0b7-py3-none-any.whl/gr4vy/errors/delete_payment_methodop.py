...
Response403DeletePaymentMethodUnion = TypeAliasType(
...
class Response403DeletePaymentMethod(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403DeletePaymentMethodUnion

    def __init__(self, data: Response403DeletePaymentMethodUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403DeletePaymentMethodUnion)
