...
class Error403ForbiddenData(BaseModel):
...
class Error403Forbidden(Exception):
    data: Error403ForbiddenData

    def __init__(self, data: Error403ForbiddenData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Error403ForbiddenData)
