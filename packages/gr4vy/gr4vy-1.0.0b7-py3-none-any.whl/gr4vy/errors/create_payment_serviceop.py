...
Response403CreatePaymentServiceUnion = TypeAliasType(
...
class Response403CreatePaymentService(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePaymentServiceUnion

    def __init__(self, data: Response403CreatePaymentServiceUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreatePaymentServiceUnion)
