...
Response403ListGiftCardBalancesUnion = TypeAliasType(
...
class Response403ListGiftCardBalances(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListGiftCardBalancesUnion

    def __init__(self, data: Response403ListGiftCardBalancesUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListGiftCardBalancesUnion)
