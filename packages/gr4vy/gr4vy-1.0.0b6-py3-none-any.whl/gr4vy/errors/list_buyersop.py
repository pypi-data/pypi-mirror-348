...
Response403ListBuyersUnion = TypeAliasType(
...
class Response403ListBuyers(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListBuyersUnion

    def __init__(self, data: Response403ListBuyersUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListBuyersUnion)
