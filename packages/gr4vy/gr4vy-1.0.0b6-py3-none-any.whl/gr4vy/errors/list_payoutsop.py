...
Response403ListPayoutsUnion = TypeAliasType(
...
class Response403ListPayouts(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPayoutsUnion

    def __init__(self, data: Response403ListPayoutsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListPayoutsUnion)
