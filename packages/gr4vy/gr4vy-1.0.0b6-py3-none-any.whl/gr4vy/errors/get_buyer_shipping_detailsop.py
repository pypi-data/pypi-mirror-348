...
Response403GetBuyerShippingDetailsUnion = TypeAliasType(
...
class Response403GetBuyerShippingDetails(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetBuyerShippingDetailsUnion

    def __init__(self, data: Response403GetBuyerShippingDetailsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetBuyerShippingDetailsUnion)
