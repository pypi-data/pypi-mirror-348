...
Response403CreatePaymentMethodNetworkTokenCryptogramUnion = TypeAliasType(
...
class Response403CreatePaymentMethodNetworkTokenCryptogram(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePaymentMethodNetworkTokenCryptogramUnion

    def __init__(self, data: Response403CreatePaymentMethodNetworkTokenCryptogramUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403CreatePaymentMethodNetworkTokenCryptogramUnion
        )
