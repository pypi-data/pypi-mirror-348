...
Response403DeleteBuyerUnion = TypeAliasType(
...
class Response403DeleteBuyer(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403DeleteBuyerUnion

    def __init__(self, data: Response403DeleteBuyerUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403DeleteBuyerUnion)
