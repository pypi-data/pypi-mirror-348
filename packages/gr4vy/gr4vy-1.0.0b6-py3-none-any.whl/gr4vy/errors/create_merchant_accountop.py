...
Response403CreateMerchantAccountUnion = TypeAliasType(
...
class Response403CreateMerchantAccount(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreateMerchantAccountUnion

    def __init__(self, data: Response403CreateMerchantAccountUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreateMerchantAccountUnion)
