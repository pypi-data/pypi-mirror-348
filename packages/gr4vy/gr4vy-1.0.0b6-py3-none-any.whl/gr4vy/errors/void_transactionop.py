...
Response403VoidTransactionUnion = TypeAliasType(
...
class Response403VoidTransaction(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403VoidTransactionUnion

    def __init__(self, data: Response403VoidTransactionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403VoidTransactionUnion)
