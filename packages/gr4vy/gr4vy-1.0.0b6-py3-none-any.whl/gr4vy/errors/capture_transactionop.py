...
Response403CaptureTransactionUnion = TypeAliasType(
...
class Response403CaptureTransaction(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CaptureTransactionUnion

    def __init__(self, data: Response403CaptureTransactionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CaptureTransactionUnion)
