...
Response403ListPaymentServiceDefinitionsUnion = TypeAliasType(
...
class Response403ListPaymentServiceDefinitions(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPaymentServiceDefinitionsUnion

    def __init__(self, data: Response403ListPaymentServiceDefinitionsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403ListPaymentServiceDefinitionsUnion
        )
