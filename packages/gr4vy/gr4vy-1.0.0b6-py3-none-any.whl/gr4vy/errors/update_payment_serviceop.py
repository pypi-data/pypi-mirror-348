...
Response403UpdatePaymentServiceUnion = TypeAliasType(
...
class Response403UpdatePaymentService(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403UpdatePaymentServiceUnion

    def __init__(self, data: Response403UpdatePaymentServiceUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403UpdatePaymentServiceUnion)
