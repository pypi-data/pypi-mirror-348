...
Response403DeletePaymentServiceUnion = TypeAliasType(
...
class Response403DeletePaymentService(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403DeletePaymentServiceUnion

    def __init__(self, data: Response403DeletePaymentServiceUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403DeletePaymentServiceUnion)
