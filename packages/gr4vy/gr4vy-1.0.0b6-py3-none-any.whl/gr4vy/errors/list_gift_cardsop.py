...
Response403ListGiftCardsUnion = TypeAliasType(
...
class Response403ListGiftCards(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListGiftCardsUnion

    def __init__(self, data: Response403ListGiftCardsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListGiftCardsUnion)
