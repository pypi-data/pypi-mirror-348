...
Response403ListPaymentOptionsUnion = TypeAliasType(
...
class Response403ListPaymentOptions(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPaymentOptionsUnion

    def __init__(self, data: Response403ListPaymentOptionsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListPaymentOptionsUnion)
