...
class PaymentServiceDefinitions(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.Response403ListPaymentServiceDefinitionsUnion
            )
            raise errors.Response403ListPaymentServiceDefinitions(data=response_data)
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.Response403GetPaymentServiceDefinitionUnion
            )
            raise errors.Response403GetPaymentServiceDefinition(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error404Data)
            raise errors.Error404(data=response_data)
        if utils.match_response(http_res, "405", "application/json"):
    ...
    def session(
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.Response403CreatePaymentServiceDefinitionSessionUnion,
            )
            raise errors.Response403CreatePaymentServiceDefinitionSession(
                data=response_data
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error404Data)
