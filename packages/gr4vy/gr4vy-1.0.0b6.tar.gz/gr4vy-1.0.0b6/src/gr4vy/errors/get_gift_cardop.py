...
Response403GetGiftCardUnion = TypeAliasType(
...
class Response403GetGiftCard(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetGiftCardUnion

    def __init__(self, data: Response403GetGiftCardUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetGiftCardUnion)
