...
Response403ListDigitalWalletsUnion = TypeAliasType(
...
class Response403ListDigitalWallets(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListDigitalWalletsUnion

    def __init__(self, data: Response403ListDigitalWalletsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListDigitalWalletsUnion)
