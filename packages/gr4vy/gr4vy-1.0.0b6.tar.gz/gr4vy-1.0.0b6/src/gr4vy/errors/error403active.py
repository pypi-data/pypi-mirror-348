...
class Error403ActiveData(BaseModel):
    TYPE: Annotated[
...
class Error403Active(Exception):
    data: Error403ActiveData

    def __init__(self, data: Error403ActiveData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Error403ActiveData)
