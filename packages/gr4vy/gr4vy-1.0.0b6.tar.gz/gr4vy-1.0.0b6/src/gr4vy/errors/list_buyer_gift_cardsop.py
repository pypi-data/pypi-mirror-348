...
Response403ListBuyerGiftCardsUnion = TypeAliasType(
...
class Response403ListBuyerGiftCards(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListBuyerGiftCardsUnion

    def __init__(self, data: Response403ListBuyerGiftCardsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListBuyerGiftCardsUnion)
