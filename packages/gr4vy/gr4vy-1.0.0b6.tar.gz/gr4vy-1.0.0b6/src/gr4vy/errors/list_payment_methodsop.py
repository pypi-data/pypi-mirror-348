...
Response403ListPaymentMethodsUnion = TypeAliasType(
...
class Response403ListPaymentMethods(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPaymentMethodsUnion

    def __init__(self, data: Response403ListPaymentMethodsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListPaymentMethodsUnion)
