...
Response403ListPaymentServicesUnion = TypeAliasType(
...
class Response403ListPaymentServices(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPaymentServicesUnion

    def __init__(self, data: Response403ListPaymentServicesUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListPaymentServicesUnion)
