...
Response403GetTransactionSummaryUnion = TypeAliasType(
...
class Response403GetTransactionSummary(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetTransactionSummaryUnion

    def __init__(self, data: Response403GetTransactionSummaryUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetTransactionSummaryUnion)
