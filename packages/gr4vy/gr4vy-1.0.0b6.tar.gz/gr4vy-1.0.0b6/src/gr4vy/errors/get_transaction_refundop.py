...
Response403GetTransactionRefundUnion = TypeAliasType(
...
class Response403GetTransactionRefund(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetTransactionRefundUnion

    def __init__(self, data: Response403GetTransactionRefundUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetTransactionRefundUnion)
