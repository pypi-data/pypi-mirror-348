...
Response403UpdateBuyerUnion = TypeAliasType(
...
class Response403UpdateBuyer(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403UpdateBuyerUnion

    def __init__(self, data: Response403UpdateBuyerUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403UpdateBuyerUnion)
