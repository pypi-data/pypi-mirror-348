...
Response403AddBuyerUnion = TypeAliasType(
...
class Response403AddBuyer(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403AddBuyerUnion

    def __init__(self, data: Response403AddBuyerUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403AddBuyerUnion)
