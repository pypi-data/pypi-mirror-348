...
Response403GetPaymentServiceDefinitionUnion = TypeAliasType(
...
class Response403GetPaymentServiceDefinition(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetPaymentServiceDefinitionUnion

    def __init__(self, data: Response403GetPaymentServiceDefinitionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403GetPaymentServiceDefinitionUnion
        )
