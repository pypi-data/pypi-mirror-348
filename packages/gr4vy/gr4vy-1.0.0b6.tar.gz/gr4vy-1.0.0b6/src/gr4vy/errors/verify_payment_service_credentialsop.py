...
Response403VerifyPaymentServiceCredentialsUnion = TypeAliasType(
...
class Response403VerifyPaymentServiceCredentials(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403VerifyPaymentServiceCredentialsUnion

    def __init__(self, data: Response403VerifyPaymentServiceCredentialsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403VerifyPaymentServiceCredentialsUnion
        )
