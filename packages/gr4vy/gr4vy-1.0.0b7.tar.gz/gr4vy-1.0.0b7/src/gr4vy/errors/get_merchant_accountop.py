...
Response403GetMerchantAccountUnion = TypeAliasType(
...
class Response403GetMerchantAccount(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetMerchantAccountUnion

    def __init__(self, data: Response403GetMerchantAccountUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetMerchantAccountUnion)
