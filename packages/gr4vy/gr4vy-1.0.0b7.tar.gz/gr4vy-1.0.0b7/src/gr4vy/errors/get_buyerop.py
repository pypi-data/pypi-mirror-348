...
Response403GetBuyerUnion = TypeAliasType(
...
class Response403GetBuyer(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetBuyerUnion

    def __init__(self, data: Response403GetBuyerUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetBuyerUnion)
