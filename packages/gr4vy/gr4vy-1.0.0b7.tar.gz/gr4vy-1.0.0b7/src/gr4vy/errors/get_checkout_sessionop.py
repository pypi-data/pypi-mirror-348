...
Response403GetCheckoutSessionUnion = TypeAliasType(
...
class Response403GetCheckoutSession(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetCheckoutSessionUnion

    def __init__(self, data: Response403GetCheckoutSessionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetCheckoutSessionUnion)
