...
Response403CreatePayoutUnion = TypeAliasType(
...
class Response403CreatePayout(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePayoutUnion

    def __init__(self, data: Response403CreatePayoutUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreatePayoutUnion)
