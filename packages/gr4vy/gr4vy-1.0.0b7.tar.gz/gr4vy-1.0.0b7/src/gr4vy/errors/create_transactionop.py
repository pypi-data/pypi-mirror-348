...
Response403CreateTransactionUnion = TypeAliasType(
...
class Response403CreateTransaction(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreateTransactionUnion

    def __init__(self, data: Response403CreateTransactionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreateTransactionUnion)
