...
Response403GetTransactionUnion = TypeAliasType(
...
class Response403GetTransaction(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetTransactionUnion

    def __init__(self, data: Response403GetTransactionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetTransactionUnion)
