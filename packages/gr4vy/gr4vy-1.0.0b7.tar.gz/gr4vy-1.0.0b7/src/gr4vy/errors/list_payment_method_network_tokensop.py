...
Response403ListPaymentMethodNetworkTokensUnion = TypeAliasType(
...
class Response403ListPaymentMethodNetworkTokens(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListPaymentMethodNetworkTokensUnion

    def __init__(self, data: Response403ListPaymentMethodNetworkTokensUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403ListPaymentMethodNetworkTokensUnion
        )
