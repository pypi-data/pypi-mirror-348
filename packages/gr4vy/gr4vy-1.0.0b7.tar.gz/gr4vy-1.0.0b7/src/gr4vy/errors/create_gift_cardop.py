...
Response403CreateGiftCardUnion = TypeAliasType(
...
class Response403CreateGiftCard(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreateGiftCardUnion

    def __init__(self, data: Response403CreateGiftCardUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403CreateGiftCardUnion)
