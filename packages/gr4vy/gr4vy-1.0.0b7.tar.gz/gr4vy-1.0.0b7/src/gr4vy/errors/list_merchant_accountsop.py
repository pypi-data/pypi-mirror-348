...
Response403ListMerchantAccountsUnion = TypeAliasType(
...
class Response403ListMerchantAccounts(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403ListMerchantAccountsUnion

    def __init__(self, data: Response403ListMerchantAccountsUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403ListMerchantAccountsUnion)
