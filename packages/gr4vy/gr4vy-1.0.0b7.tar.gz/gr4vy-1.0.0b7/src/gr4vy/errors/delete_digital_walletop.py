...
Response403DeleteDigitalWalletUnion = TypeAliasType(
...
class Response403DeleteDigitalWallet(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403DeleteDigitalWalletUnion

    def __init__(self, data: Response403DeleteDigitalWalletUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403DeleteDigitalWalletUnion)
