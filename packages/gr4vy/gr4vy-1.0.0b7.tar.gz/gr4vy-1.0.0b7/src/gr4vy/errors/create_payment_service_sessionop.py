...
Response403CreatePaymentServiceSessionUnion = TypeAliasType(
...
class Response403CreatePaymentServiceSession(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePaymentServiceSessionUnion

    def __init__(self, data: Response403CreatePaymentServiceSessionUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403CreatePaymentServiceSessionUnion
        )
