...
Response403DeleteGiftCardUnion = TypeAliasType(
...
class Response403DeleteGiftCard(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403DeleteGiftCardUnion

    def __init__(self, data: Response403DeleteGiftCardUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403DeleteGiftCardUnion)
