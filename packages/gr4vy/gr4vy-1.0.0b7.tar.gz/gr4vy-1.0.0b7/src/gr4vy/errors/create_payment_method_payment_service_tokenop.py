...
Response403CreatePaymentMethodPaymentServiceTokenUnion = TypeAliasType(
...
class Response403CreatePaymentMethodPaymentServiceToken(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403CreatePaymentMethodPaymentServiceTokenUnion

    def __init__(self, data: Response403CreatePaymentMethodPaymentServiceTokenUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, Response403CreatePaymentMethodPaymentServiceTokenUnion
        )
