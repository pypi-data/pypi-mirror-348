...
Response403GetDigitalWalletUnion = TypeAliasType(
...
class Response403GetDigitalWallet(Exception):
    r"""The credentials were invalid or the caller did not have permission to act on the resource."""

    data: Response403GetDigitalWalletUnion

    def __init__(self, data: Response403GetDigitalWalletUnion):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, Response403GetDigitalWalletUnion)
