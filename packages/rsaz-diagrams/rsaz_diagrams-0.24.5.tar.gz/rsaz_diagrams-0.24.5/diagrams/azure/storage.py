...
class DataBox1(_Storage):
    _icon = "data-box-1.png"
...
class StorageAccounts1(_Storage):
    _icon = "storage-accounts-1.png"


class StorageAccountsClassic1(_Storage):
    _icon = "storage-accounts-classic-1.png"
...
class StorageExplorer1(_Storage):
    _icon = "storage-explorer-1.png"
...
class StorageSyncServices1(_Storage):
    _icon = "storage-sync-services-1.png"
...
class StorsimpleDataManagers1(_Storage):
    _icon = "storsimple-data-managers-1.png"
...
class StorsimpleDeviceManagers1(_Storage):
