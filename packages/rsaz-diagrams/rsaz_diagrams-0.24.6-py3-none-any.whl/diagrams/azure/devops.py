...
class ApplicationInsights1(_Devops):
    _icon = "application-insights-1.png"
...
class DevtestLabs1(_Devops):
    _icon = "devtest-labs-1.png"
...
class LabServices1(_Devops):
    _icon = "lab-services-1.png"
