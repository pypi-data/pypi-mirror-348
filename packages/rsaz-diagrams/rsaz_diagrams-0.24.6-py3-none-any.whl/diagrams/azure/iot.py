...
class DeviceProvisioningServices1(_Iot):
    _icon = "device-provisioning-services-1.png"
...
class DigitalTwins1(_Iot):
    _icon = "digital-twins-1.png"
...
class IotCentralApplications1(_Iot):
    _icon = "iot-central-applications-1.png"
...
class TimeSeriesInsightsEnvironments1(_Iot):
    _icon = "time-series-insights-environments-1.png"
