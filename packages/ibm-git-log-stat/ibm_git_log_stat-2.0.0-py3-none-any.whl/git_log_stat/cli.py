...
from git_log_stat.jira_exporter.jira_exporter import JiraExporter
...
def main():
    ...
    try:
        ...
        if check_jira and args.output_format:
            ...
            jira_count = jira_exporter.main(jira_url, jira_token, author, jira_file_name, start_date=since, end_date=until)
