...
class BaseResultSchemas:
    ...
    class Metadata(BaseModel):
        field_expansion:Optional[Union[str, Dict[str, BaseGeneralSchemas.FieldExpansionMetadata]]] = Field(None, description="Field expansion metadata")
    ...
    class Base(BaseModel):
        ...
        metadata:Optional[BaseResultSchemas.Metadata] = Field(None, description="Optional metadata")
