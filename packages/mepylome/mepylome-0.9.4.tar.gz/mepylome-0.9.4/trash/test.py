...
GENES = pkg_resources.resource_filename("mepylome", "data/gene_loci_epicv2.tsv.gz")
...
t0 = time.time()
x = idat_basepaths(
    "/mnt/storage/epidip_IDAT/",
    only_valid=True,
)
print("Time used:", time.time() - t0)


# 204514985	204556281	+	MDM4	chr1

# Start	204,516,379 bp[1]
# End	204,558,120 bp[1]



self = Annotation(array_type="epic")
self.detail.df[self.detail.df.Name=="MDM4"]

from mepylome.dtypes.plots import *
id_ = self.idat_handler.id_to_path[self.cnv_id].name
bins, detail, segments = read_cnv_data_from_disk(
    self.cnv_dir, id_
)

detail[detail.Name=="MDM4"]
