...
from registration_shared_service.models import RegistrationServicesLinkages
from transfer.endpoints_utils import get_land_admin_ingestion_parcels, get_parcel_invoices_status, \
    registration_property_details, survey_details
from .snitch import snitch_func
from .transaction_configs import CONFIGURATIONS
...
class TransactableParcel(UsefulFunctionsClass):
    def __init__(self, parcel_number, context, configurations=None, **kwargs):
        ...
        self.configs = configurations if bool(configurations) else CONFIGURATIONS.copy()
