...
class TaxParty4(object):

    """Implementation of the 'Tax Party4' model.

    Box 6, If other than TRANSFEROR, name, address and tin of corporation
    ...
    def __init__(self,
        ...
        """Constructor for the TaxParty4 class"""
