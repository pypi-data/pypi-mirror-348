...
class TelephoneNumberPlusExtension1(object):

    """Implementation of the 'Telephone Number Plus Extension1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TelephoneNumberPlusExtension1 class"""
