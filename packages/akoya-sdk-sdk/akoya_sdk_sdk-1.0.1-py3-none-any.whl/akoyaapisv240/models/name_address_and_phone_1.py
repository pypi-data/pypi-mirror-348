...
class NameAddressAndPhone1(object):

    """Implementation of the 'Name, Address and Phone1' model.

    Acquirer's information contact name, street address, city or town, state
    ...
    def __init__(self,
        ...
        """Constructor for the NameAddressAndPhone1 class"""
