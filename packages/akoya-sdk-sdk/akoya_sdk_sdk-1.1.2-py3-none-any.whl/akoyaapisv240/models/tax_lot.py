...
class TaxLot(object):
    ...
    """Implementation of the 'TaxLot' model.
    ...
    Attributes:
        ...
        postion_type (PostionTypeEnum): LONG, SHORT.
    ...
    def __init__(self,
                 ...
                 postion_type=APIHelper.SKIP,
                 purchased_price=APIHelper.SKIP,
                 quantity=APIHelper.SKIP):
        """Constructor for the TaxLot class"""
        ...
        if postion_type is not APIHelper.SKIP:
            self.postion_type = postion_type 
    ...
    def from_dictionary(cls,
        ...
        postion_type = dictionary.get("postionType") if dictionary.get("postionType") else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'postion_type={(self.postion_type if hasattr(self, "postion_type") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'postion_type={(self.postion_type if hasattr(self, "postion_type") else None)!s}, '
