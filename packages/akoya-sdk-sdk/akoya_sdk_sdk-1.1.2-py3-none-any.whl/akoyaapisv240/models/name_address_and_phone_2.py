...
from akoyaapisv240.models.telephone_number_plus_extension_1 import TelephoneNumberPlusExtension1


class NameAddressAndPhone2(object):

    """Implementation of the 'Name, Address and Phone2' model.

    Issuer's information contact name, street address, city or town, state or
    province, country, ZIP or foreign postal code, and telephone no. (if
    ...
    Attributes:
        ...
        phone (TelephoneNumberPlusExtension1): Phone number
    ...
    def __init__(self,
        ...
        """Constructor for the NameAddressAndPhone2 class"""
    ...
    def from_dictionary(cls,
        ...
        phone = TelephoneNumberPlusExtension1.from_dictionary(dictionary.get('phone')) if 'phone' in dictionary.keys() else APIHelper.SKIP
