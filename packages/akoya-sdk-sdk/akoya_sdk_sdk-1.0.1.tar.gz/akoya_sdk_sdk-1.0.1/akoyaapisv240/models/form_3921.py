...
from akoyaapisv240.models.tax_party_4 import TaxParty4
...
class Form3921(object):
    ...
    Exercise of an Incentive Stock Option Under Section 422(b), from
    TRANSFEROR (1st-2nd boxes as issuer) to EMPLOYEE (3rd-4th boxes as
    recipient)
    ...
    Attributes:
        ...
        corporation (TaxParty4): Box 6, If other than TRANSFEROR, name,
            address and tin of corporation whose stock is being transferred
    ...
    def from_dictionary(cls,
        ...
        corporation = TaxParty4.from_dictionary(dictionary.get('corporation')) if 'corporation' in dictionary.keys() else APIHelper.SKIP
