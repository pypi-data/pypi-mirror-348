...
from akoyaapisv240.models.tax_lot_2 import TaxLot2


class Holding1(object):

    """Implementation of the 'Holding1' model.

    Attributes:
        holding_id (str): The model property of type str.
        security_id (str): The model property of type str.
        security_id_type (str): The model property of type str.
        tax_lots (List[TaxLot2]): The model property of type List[TaxLot2].
    ...
    def __init__(self,
        ...
        """Constructor for the Holding1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('taxLots') is not None:
            tax_lots = [TaxLot2.from_dictionary(x) for x in dictionary.get('taxLots')]
        else:
            tax_lots = APIHelper.SKIP
