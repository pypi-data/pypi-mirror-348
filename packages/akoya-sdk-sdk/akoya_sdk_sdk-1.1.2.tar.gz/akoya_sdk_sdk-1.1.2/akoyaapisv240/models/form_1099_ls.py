...
from akoyaapisv240.models.name_address_and_phone_1 import NameAddressAndPhone1
...
class Form1099LS(object):
    ...
    Reportable Life Insurance Sale, from ACQUIRER (1st-2nd boxes as issuer) to
    PAYMENT RECIPIENT (3rd-4th boxes)
    ...
    Attributes:
        ...
        contact_name_address (NameAddressAndPhone1): Acquirer's information
    ...
    def from_dictionary(cls,
        ...
        contact_name_address = NameAddressAndPhone1.from_dictionary(dictionary.get('contactNameAddress')) if 'contactNameAddress' in dictionary.keys() else APIHelper.SKIP
