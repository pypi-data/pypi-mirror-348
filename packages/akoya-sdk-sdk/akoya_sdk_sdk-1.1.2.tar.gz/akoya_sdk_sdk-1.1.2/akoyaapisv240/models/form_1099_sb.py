...
from akoyaapisv240.models.name_address_and_phone_2 import NameAddressAndPhone2
...
class Form1099SB(object):
    ...
    Seller's Investment in Life Insurance Contract, from ISSUER (1st-2nd
    boxes) to SELLER (3rd-4th boxes as recipient)
    ...
    Attributes:
        ...
        contact_name_address (NameAddressAndPhone2): Issuer's information
    ...
    def from_dictionary(cls,
        ...
        contact_name_address = NameAddressAndPhone2.from_dictionary(dictionary.get('contactNameAddress')) if 'contactNameAddress' in dictionary.keys() else APIHelper.SKIP
