...
class TelephoneNumberPlusExtension4(object):

    """Implementation of the 'Telephone Number Plus Extension4' model.
    ...
    def __init__(self,
        ...
        """Constructor for the TelephoneNumberPlusExtension4 class"""
