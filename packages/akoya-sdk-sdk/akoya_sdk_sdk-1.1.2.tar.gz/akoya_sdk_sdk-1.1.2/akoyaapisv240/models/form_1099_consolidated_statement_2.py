...
class Form1099ConsolidatedStatement2(object):

    """Implementation of the 'Form 1099 Consolidated Statement2' model.
    ...
    def __init__(self,
        ...
        """Constructor for the Form1099ConsolidatedStatement2 class"""
