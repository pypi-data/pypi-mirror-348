...
from wowool.document.document_interface import DocumentInterface, DataType, DT_TEXT_UTF8
...
class AnalysisDocument(DocumentInterface):
    ...
    def text(self) -> str:
        ...
        :rtype: ``str``
        """
        if self.input_document.data_type == DT_TEXT_UTF8:
            return self.input_document.data
        else:
            raise ValueError(f"The input Document is not a text document, but a [{self.input_document.data_type}]")
    ...
    def data_type(self) -> DataType:
        ...
        :rtype: 'DataType'
        """
        return AnalysisDocument.DATA_TYPE
    ...
    def to_json(self) -> dict:
        ...
        document = {
            WJ_ID: self.id,
            WJ_DATA_TYPE: AnalysisInputProvider.DATA_TYPE,
            WJ_DATA: self.data,
    ...
    def __repr__(self):
        ...
        return f"<AnalysisDocument id={self.id} data_type={self.data_type}  size={sz} text={text} >"
