...
from wowool.document.document_interface import DocumentInterface, DataType, DT_ANALYSIS_JSON
...
class AnalysisInputProvider(DocumentInterface):
    DATA_TYPE = DT_ANALYSIS_JSON

    def __init__(self, data: str, id: str, metadata: dict | None = None) -> None:
        self._id = id
