...
class UserFactory:
    ...
    def create_updated_user(user: User, user_update_info: UserUpdateInfo) -> User:
        ...
        user_copy.name = user_update_info.name or user.name
        user_copy.email = user_update_info.email or user.email
        user_copy.phone_number = user_update_info.phone_number or user.phone_number
        user_copy.photo_url = user_update_info.photo_url or user.photo_url
        user_copy.notifications = user_update_info.notifications or user.notifications
        user_copy.auto_assign_chats = user_update_info.auto_assign_chats or user.auto_assign_chats
        return user_copy
