...
def get_exchange_url_from_jtp_symbol(self, symbol: str) -> str:
    exchange = get_exchange_from_jtp_symbol(symbol)
    coin, quote_ccy = get_coin_and_quote_ccy_from_jtp_symbol(symbol)
