...
def trigger_reload(plugins_dir: Path):
    # touching any file under plugins_dir is enough:
    (plugins_dir / ".reload-trigger").write_text("reload\n")

def init_plugins_if_needed(plugins_dir: str, enabled_plugins: list):
