...
class HalESession:
    ...
    def insert_text(self, element_id: str, text: str, field: str):
        ...
        """
        path_element = self.get_element_by_id(element_id)
    ...
    def send_prompt_with_input(self, path_element_id: str, prompt_input: str):
        """
        ...
        dict
            The bot's answer.
        """
        path_element = self.get_element_by_id(path_element_id)
        ...
        card_update = {
            "id": card_id,
            "type_specific": {"prompt_input": prompt_input}
        }
        self.board.update_card(card_update)
        self.board.push()
    ...
    def _execute_action(self, card_id: str):
        ...
        self.board = apply_board_action(
            ...
            card_id=card_id,
            action="run",
            board_path=self.board.file_path.relative_to("/home/jovyan").as_posix()
        )
    ...
    def __repr__(self):
        ...
        return (f"HalESession(hale=HalE(name='{hale_name}'), session_path: {session_path}, "
