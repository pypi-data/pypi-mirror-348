...
class AmiClient(commands.Bot):
        ...
        async def custom_command(ctx_command):
            ...
            try:
                ...
                if match:
                    ...
                    result = "❌ devolvió un error inesperado en el codigo."
    ...
    async def on_typing(self, channel, user, when):
        utils.ContextAmisynth((channel, user, when))
    ...
    async def on_member_update(self, before, after):
        utils.ContextAmisynth((before, after))
        await self.ejecutar_eventos("$onUserEdit", ctx_user_edit=(before, after))
