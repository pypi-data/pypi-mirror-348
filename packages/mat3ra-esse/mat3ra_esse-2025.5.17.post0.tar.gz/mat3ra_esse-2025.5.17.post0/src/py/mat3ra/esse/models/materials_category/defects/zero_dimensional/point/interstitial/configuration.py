...
#   filename:  materials_category/defects/zero_dimensional/point/interstitial/configuration.json
#   version:   0.28.5
...
class InterstitialPointDefectConfigurationSchema(BaseModel):
    type: Literal["interstitial"]
    """
