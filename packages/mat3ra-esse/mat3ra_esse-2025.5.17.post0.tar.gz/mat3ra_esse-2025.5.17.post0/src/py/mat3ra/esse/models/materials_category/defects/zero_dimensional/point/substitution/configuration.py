...
#   filename:  materials_category/defects/zero_dimensional/point/substitution/configuration.json
#   version:   0.28.5
...
class SubstitutionPointDefectConfigurationSchema(BaseModel):
