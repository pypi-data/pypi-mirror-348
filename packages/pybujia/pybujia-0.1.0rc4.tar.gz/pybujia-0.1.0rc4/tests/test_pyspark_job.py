...
class TestPysparkJob:
    ...
    def test_spark_method_transformation(self) -> None:
        ...
        result_expected = "my_db.my_table__expected"
        spark_method_test(spark_job._transformation, fixtures, input_args, result_expected)
    ...
    def test_spark_method_transformation_multi_return(self) -> None:
        ...
        result_expected: list[Union[str, Literal]] = ["my_db.my_table__expected", Literal(10.0)]
        spark_method_test(spark_job._transformation_multi_return, fixtures, input_args, result_expected)
