...
class PyBujia:
    ...
    def _parse_fixture_blocks(content: str) -> Iterator[tuple[str, list[str]]]:
        """
        Lazily parse raw fixture file content into named table blocks.
        ...
        for table_name, lines in table_blocks:
            ...
            if table_schema_id and not schemas_fetcher:
                raise SchemaNotFoundError(
                    f"Table id '{table_name}' has the table schema id: '{table_schema_id}' but no schema fetcher was provided"
                )
