...
from evrmore.core import (
    ...
    # number of satoshis per evrmore
    COIN,
...
def make_txout(amount=None, address=None, counter=None):
    ...
    if not amount:
        ...
        maxsatoshis = (21 * 1000 * 1000) * (100 * 1000 * 1000)
...
class FakeEvrmoreProxy(object):
    ...
    def _call(self, rpc_method_name, *args, **kwargs):
        ...
        python-evrmorelib does not parse.
        """
    ...
    def getblock(self, blockhash, *args, **kwargs):
        ...
        # Note that the actual "getblock" evrmored RPC call from
        # python-evrmorelib returns a CBlock object, not a dictionary.
    ...
    def fundrawtransaction(self, given_transaction, *args, **kwargs):
        ...
        vintxid = lx(
            "99264749804159db1e342a0c8aa3279f6ef4031872051a1e52fb302e51061bef")
    ...
    def _batch(self, batch_request_entries):
        ...
        feature found in python-evrmorelib and evrmored RPC.
        """
        ...
        for (idx, request) in enumerate(batch_request_entries):
            ...
            if isinstance(request["params"], list):
                ...
                # matches error message received through python-evrmorerpc
