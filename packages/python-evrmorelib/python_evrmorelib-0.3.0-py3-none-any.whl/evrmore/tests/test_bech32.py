...
from evrmore.segwit_addr import encode, decode
from evrmore.bech32 import *
from evrmore.core.script import CScript, OP_0, OP_1, OP_16
...
class Test_CBech32Data(unittest.TestCase):
    def test_from_data(self):
        b = CBech32Data.from_bytes(0, unhexlify(
