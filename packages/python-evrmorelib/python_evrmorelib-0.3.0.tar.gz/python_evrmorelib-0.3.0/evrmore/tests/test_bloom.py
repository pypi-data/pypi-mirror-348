...
import evrmore.core
from evrmore.core import x
from evrmore.bloom import *
...
class Test_CBloomFilter(unittest.TestCase):
    def test_create_insert_serialize(self):
        ...
        self.assertTrue(deserialized.contains(
            x('99108ad8ed9bb6274d3980bab5a85c048f0950c8')))
        self.assertFalse(deserialized.contains(
    ...
    def test_bloom_create_insert_key(self):
        ...
        pubkeyhash = evrmore.core.Hash160(pubkey)
