...
from flowjson.utils.img import base64ToBytes, bytesToImage, getImgExt, pathToBase64, pathToBytes, toBytes, uriToBytes
...
from src.utils.formatOcrTextWithLayout import formatOcrTextWithLayout
...
async def bootstrap():
    ...
    # s = "https://lf3-static.bytednsdoc.com/obj/eden-cn/ukj_jtk/ljhwZthlaukjlkulzlp/2025_05_16_11_23_48_384"
    # s = await pathToBase64('/Users/bytedance/fe/pyautogui-extend/src/common/images/vcode/1-tc-code.png')
    # # 54G6
