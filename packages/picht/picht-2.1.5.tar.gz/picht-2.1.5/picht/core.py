...
class MagneticField:
   ...
   def __init__(self, electron_optics):
       ...
       Parameters:
           electron_optics (ElectronOptics): The parent electron optics system containing
...
class Export:
    ...
    Attributes:
        system: Reference to the electron optics system
        field: Electric field
        magnetic_lenses: Magnetic field
    """
    def __init__(self, electron_optics):
        """
        Creates the export handler by initializing/pulling from the ElectronOptics.
