...
class ShakeAdditionalMovement(PositionAdditionalMovement):
    ...
    the position it is.
    """
    def __init__(self, shake_speed: int = 4):
        self.shake_speed = 4 if shake_speed is None else shake_speed
...
class CirclesAdditionalmovement(PositionAdditionalMovement):
    ...
    """
    def __init__(self, time_per_circle: float = 1, radius: int = 200):
        self.time_per_circle = 1 if time_per_circle is None else time_per_circle
        self.radius = 200 if radius is None else radius
