...
class Coordinate(BaseCoordinate):
    ...
    def __init__(self, x: float, y: float, is_normalized: bool = False, engine: Union[VideoEngine, str] = VideoEngine.MOVIEPY, scene_size: tuple = DEFAULT_SCENE_SIZE):
    ...
    def update_scene_size(self, scene_size: tuple = DEFAULT_SCENE_SIZE):
        """
    ...
    def on_scene_size(self, scene_size: tuple = DEFAULT_SCENE_SIZE):
        """
    ...
    @staticmethod
    def to_moviepy_upper_left_corner_tuple(coordinate: Union[tuple, 'Coordinate'], video_size: Union[tuple, 'Coordinate'], scene_size: Union[tuple, 'Coordinate'] = DEFAULT_SCENE_SIZE):
        """
