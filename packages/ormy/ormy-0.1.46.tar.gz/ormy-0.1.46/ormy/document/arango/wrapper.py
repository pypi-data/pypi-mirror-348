...
class ArangoBase(SyncDocumentABC):
    ...
    def find_many_projection(
        ...
        """
        Find multiple documents in the collection matching the query and fields
...
class ArangoBaseGraph(AbstractABC):
    ...
    def traverse_with_count(
        ...
        """
        Traverse a graph and count the results
