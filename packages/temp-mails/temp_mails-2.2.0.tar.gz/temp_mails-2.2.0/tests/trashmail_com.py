...
from temp_mails import Trashmail_com as Mail
from send_email import send_email_sync

name, domain = "".join(choices(ascii_lowercase, k=6)), "trash-mail.com" # not choice(Mail.get_valid_domains()) bc some domains are down atm
