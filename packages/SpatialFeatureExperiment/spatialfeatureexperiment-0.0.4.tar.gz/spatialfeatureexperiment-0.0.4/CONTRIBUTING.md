...
Welcome to `SpatialFeatureExperiment` contributor's guide.
...
If you experience bugs or general issues with `SpatialFeatureExperiment`, please have a look
...
You can help improve `SpatialFeatureExperiment` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`SpatialFeatureExperiment` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `SpatialFeatureExperiment`'s files. While this mechanism can
...
```
conda create -n SpatialFeatureExperiment python=3 six virtualenv pytest pytest-cov
conda activate SpatialFeatureExperiment
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/SpatialFeatureExperiment.git
   cd SpatialFeatureExperiment
   ```
...
5. Install [pre-commit]:
   ...
   `SpatialFeatureExperiment` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/SpatialFeatureExperiment
[issue tracker]: https://github.com/<USERNAME>/SpatialFeatureExperiment/issues
