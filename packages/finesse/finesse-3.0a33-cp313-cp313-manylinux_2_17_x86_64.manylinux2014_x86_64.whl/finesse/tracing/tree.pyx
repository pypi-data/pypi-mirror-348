...
def get_tracing_tree(optical_network: nx.DiGraph) -> nx.DiGraph:
    ...
    return nx.subgraph_view(optical_network, filter_edge=edge_filter)
...
cdef class TraceTree:
    ...
    def from_node(
        ...
        tree = nx.bfs_tree(get_tracing_tree(model.optical_network), node.full_name)
        sub_trees = {}
        cdef Py_ssize_t i, j
