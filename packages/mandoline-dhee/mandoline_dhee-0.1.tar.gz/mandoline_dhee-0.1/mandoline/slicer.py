...
slicer_configs = OrderedDict([
    ('Quality', (
        ...
        ('bed_Z_Offset',      float,  0, (-500,600),  "The z coordinate of the center of the bed."),
        ('Start_aux',          bool,    False,None, "this will activate Coaxial"),
        ('End_aux',          bool,    False,None, "this will activate Coaxial"),
        ('Layer_aux',          bool,    False,None, "this will activate Coaxial"),
        ('HEPA_Start_aux',          bool,    False,None, "this will activate Coaxial"),
        ('HEPA_End_aux',          bool,    False,None, "this will activate Coaxial"),
        ('HEPA_Layer_aux',          bool,    False,None, "this will activate Coaxial"),
        ('Chamber_UV_Start_aux',          bool,    False,None, "this will activate Coaxial"),
        ('Chamber_UV_End_aux',          bool,    False,None, "this will activate Coaxial"),
        ('Chamber_UV_Layer_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E0_Crosslinker_Start_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E0_Crosslinker_End_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E0_Crosslinker_Layer_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E1_Crosslinker_Start_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E1_Crosslinker_End_aux',          bool,    False,None, "this will activate Coaxial"),
        ('E1_Crosslinker_Layer_aux',          bool,    False,None, "this will activate Coaxial"),
        ('Tri-axial_ON',         str,    "",None, "this will activate triaxial"),
        ('Co-axial_ON',          str,    "",None, "this will activate Coaxial"),
        ('E1_Crosslinker__Aux_time',          str,    "G4 P200",None, "this will activate Coaxial"),
        ('HEPA_Aux_time',          str,    "G4 P200",None, "this will activate Coaxial"),
        ('Chamber_UV_Aux_time',          str,    "G4 P200",None, "this will activate Coaxial"),
        ('E0_Crosslinker_Aux_time',          str,    "G4 P200",None, "this will activate Coaxial"),
        ('E1_Crosslinker_Aux_time',          str,    "G4 P200",None, "this will activate Coaxial"),
        ('E0_Crosslinker_ON',       str,    "",None, "this will activate Crosslinker_ON"),
        ('E0_Crosslinker_OFF',       str,   "",None, "this will activate Crosslinker_OFF"),
        ('E1_Crosslinker_ON',       str,    "",None, "this will activate Crosslinker_ON"),
        ('E1_Crosslinker_OFF',       str,   "",None, "this will activate Crosslinker_OFF"),
        ('Servo_ON',             str,    "M28 P0 S120",None, "this will activate servo"),
        ('temperature_ON',        str,    "M104 T0 S0",None, "this will activate servo"),
        ('temperature_OFF',       str,    "M104 T0 S0",None, "this will activate servo"),
        ('bed_temperature_OFF',       str,    "M140 T0 S0",None, "this will activate servo"),
        ('Servo_OFF',             str,    "M28 P0 S0",None, "this will de-activate servo"),
        ('HEPA_OFF',             str,    "",None, "this will de-activate Hepa"), 
        ('HEPA_ON',             str,    "",None, "this will activate Hepa"), 
        ('Chamber_OFF',             str,    "M28 P0 S0",None, "this will de-activate Chamber uv"), 
        ('Chamber_ON',             str,    "M28 P0 S0",None, "this will activate Chamber uv"), 
        ('pressure',             str,    "M28 P0 S0",None, "this will de-activate servo"), 
        ('Activate_Extruder',     str,    " ",None, "this will de-activate servo"),      
        ('Co-axial_OFF',          str,    "",None, "this will de-activate Coaxial"),
        ('Tri-axial_OFF',         str,    "",None, "this will de-activate triaxial"),
        ('perimeter',         int,      1, (0, 1), "Enable or disable perimeter."),
        ('shell_count',       int,      2, (0, 10),     "Number of outer shells to print."),
        ...
        ('Bed_X_offset',     int,      0, (0, 500),     "set x offset from the home to origin"),
        ('Bed_Y_offset',     int,      0, (0, 500),     "set Y offset from the home to origin"),
        ('infill_type',       list, 'Grid', ['Lines', 'Triangles', 'Grid', 'Rhombus', 'Gyroid', 'Cubic', 'TriHexagonal','Spiral','Concentric_square','Honeycomb','Archimedean','Hilbert','Cross_Hatch','Lighting','Concentric'], "Pattern that the infill will be printed in."),
        ('infill_density',    float,  30., (0., 200.),  "Infill density in percent."),
        ('selected_extruder',   list,  '0', ['1','2','3','4','5'], "selected of list of extruder for dual and multiple print"),
        ('infill_overlap',    float, 0.15, (0.0, 1.0),  "Amount, in mm that infill will overlap with perimeter extrusions."),
        ('feed_rate',         int,     60, (1, 1000),    "Speed while extruding. (mm/s)"),
        ('travel_rate_xy',    int,    10, (1, 300),    "Travel motion speed (mm/s)"),
        ('E1_offset',    str,    "",None,    "Travel motion speed (mm/s)"),
        ('E2_offset',    str,    "",None,    "Travel motion speed (mm/s)"),
        ('E3_offset',    str,    "",None,    "Travel motion speed (mm/s)"),
        ('E4_offset',    str,    "",None,    "Travel motion speed (mm/s)"),
        ('E5_offset',    str,    "",None,    "Travel motion speed (mm/s)"),
        ('Extrusion_Multiplier',    int,    1, (1, 300),    "Travel motion speed (mm/s)"),
        ('travel_rate_z',     float,   3., (0.1, 30.),  "Z-axis  motion speed (mm/s)"),
    )),
    ('Support', (
    ...
    ('Retraction', (
        ...
        ('retract_lift',      float,   5.0, (0., 10.),  "Distance to lift the extruder head during retracted moves. (mm)"),
    )),
    ('Materials', (
    ...
    ('Machine', (
        ...
        ('bed_size_x',        float,  154, (0,1000),    "The X-axis size of the build platform bed."),
        ('bed_size_y',        float,  114, (0,1000),    "The Y-axis size of the build platform bed."),
        ('bed_center_x',      float,  100, (-500,600),  "The X coordinate of the center of the bed."),
        ('bed_center_y',      float,  100, (-500,600),  "The Y coordinate of the center of the bed."),
        ('bed_temp',          int,     0, (0, 150),    "The temperature to set the heated bed to."),
        ...
        ('nozzle_0_temp',      int,    0, (150, 250),  "The temperature of the nozzle for extruder 0. (C)"),
        ...
        ('nozzle_1_temp',      int,    0, (150, 250),  "The temperature of the nozzle for extruder 1. (C)"),
        ...
        ('nozzle_2_temp',      int,    0, (150, 250),  "The temperature of the nozzle for extruder 2. (C)"),
        ...
        ('nozzle_3_temp',      int,    0, (150, 250),  "The temperature of the nozzle for extruder 3. (C)"),
...
class Slicer(object):
    ...
    def set_config(self, key, valstr):
        ...
        # Check if the key exists in the config metadata
        if key not in self.conf_metadata:
            print("Ignoring unknown config option: {}".format(key))
            return

        # Fetch the type and range from metadata
        ...
        # Handle string type (for user-defined G-code)
        elif typ is str:
            typestr = "string "
    ...
    def _slicer_task_support(self):
        try:
            ...
            self.thermo.clear()
        except Exception as Supporterror:
            print("support error",Supporterror)
    ...
    def _slicer_task_fill(self):
        ...
        for layer in range(self.layers):
            ...
            if density > 0.0:
                ...
                elif infill_type == "Rhombus":
                    base_ang = 120 * (layer % 3)  # Alternate orientation for each layer
                    lines = geom.make_infill_hexagons(bounds, base_ang, density, self.infill_width)
                elif infill_type == "Gyroid":
                    # Gyroid Pattern
                    lines = geom.make_infill_gyroid(bounds, 0, density, self.infill_width)
                elif infill_type == "Lighting":
                    # Gyroid Pattern
                    lines = geom.make_infill_lighting(bounds, 0, density, self.infill_width)
                elif infill_type == "Concentric":
                    # Gyroid Pattern
                    lines = geom.make_infill_Concentric(bounds, 0, density, self.infill_width)
                elif infill_type == "Spiral":
                    # Gyroid Pattern
                    lines = geom.make_infill_spiral(bounds, 0, density, self.infill_width)
                elif infill_type == "Concentric_square":
                    # Gyroid Pattern
                    lines = geom.make_infill_concentric_square(bounds, 0, density, self.infill_width)
                elif infill_type == "Cubic":
                    # Cubic Pattern
                    lines = geom.make_infill_cubic(bounds, 0, density, self.infill_width)
                elif infill_type == "TriHexagonal":
                    # Tri-Hexagonal Pattern
                    lines = geom.make_infill_trihex(bounds, 0, density, self.infill_width)
                # elif infill_type == "Honeycomb":
                #     infill = geom.make_infill_honeycomb(bounds, 0, density, self.infill_width)
                # elif infill_type == "Hilbert":
                #     infill = geom.make_infill_hilbert(bounds, 0, density, self.infill_width)
                # elif infill_type == "Archimedean":
                #     infill = geom.make_infill_archimedean(bounds, 0, density, self.infill_width)
                # elif infill_type == "Cross_Hatch":
                #     infill = geom.make_infill_cross_hatch(bounds, 0, density, self.infill_width)
                else:
                    lines = []
    ...
    def _slicer_task_gcode(self, filename):
        ...
        with open(filename, "w") as f:
            ...
            f.write("G1 Z15 F400:rise extruder\n")
            f.write("G92 E0 ;Zero extruder\n")
            f.write("M117 Printing...\n")
            # f.write(";LAYER_COUNT:{}\n".format(total_layers))
            Z_offset = self.conf['bed_Z_Offset']
            Co_mode = self.conf['Co-axial_ON']
            Tri_mode = self.conf['Tri-axial_ON']
            self.Servo_on = self.conf['Servo_ON']
            temp_on = self.conf['temperature_ON']
            Activate_Ex = self.conf['Activate_Extruder']
            Bed_X_offset = self.conf['Bed_X_offset']
            Bed_Y_offset = self.conf['Bed_Y_offset']
            bed_center_x = self.conf['bed_center_x']
            self.bed_x = bed_center_x
            bed_center_y = self.conf['bed_center_y']
            self.bed_y = bed_center_y
            print("bcy",bed_center_y)
            print("bcx",bed_center_x)
            print("box",Bed_X_offset)
            print("boy",Bed_Y_offset)
            feed_rate = self.conf['feed_rate']
            # f.write(f"G0 X{Bed_X_offset+bed_center_x} Y{Bed_Y_offset+bed_center_y} F{feed_rate} ")
            f.write(f"G0 X{Bed_X_offset} Y{Bed_Y_offset} F{feed_rate} \n")
            # f.write("G92 X0 Y0 \n")
            Activate_Ex = self.conf['Activate_Extruder']
            E1_offset = self.conf['E1_offset']
            E2_offset = self.conf['E2_offset']
            E3_offset = self.conf['E3_offset']
            E4_offset = self.conf['E4_offset']
            E5_offset = self.conf['E5_offset']
            selected_extruder = self.conf['selected_extruder']
            if len(selected_extruder) > 1:
                select_ex = selected_extruder[0]
                if Activate_Ex == 'T1' :
                    E1_x, E1_y = map(int, E1_offset.split(','))
                    E1_x = E1_x + Bed_X_offset
                    f.write(f'G0 X{E1_x} Y{E1_y} F{feed_rate}\n')
                    f.write(f"G92 X{Bed_X_offset} Y{Bed_Y_offset}\n")
                    selected_extruder.pop(0)
                    
                elif Activate_Ex == 'T2' and Activate_Ex in selected_extruder:
                    E2_x, E2_y = map(int, E2_offset.split(','))
                    E2_x = E2_x + Bed_X_offset
                    f.write(f'G0 X{E2_x} Y{E2_y} F{feed_rate}\n')
                    f.write(f"G92 X{Bed_X_offset} Y{Bed_Y_offset}\n")
                    
                elif Activate_Ex == 'T3' and Activate_Ex in selected_extruder:
                    E3_x, E3_y = map(int, E3_offset.split(','))
                    E3_x = E3_x + Bed_X_offset
                    f.write(f'G0 X{E3_x} Y{E3_y} F{feed_rate}\n')
                    f.write(f"G92 X{Bed_X_offset} Y{Bed_Y_offset}\n")
                    
                elif Activate_Ex == 'T4' and Activate_Ex in selected_extruder:
                    E4_x, E4_y = map(int, E4_offset.split(','))
                    E4_x = E4_x + Bed_X_offset
                    f.write(f'G0 X{E4_x} Y{E4_y} F{feed_rate}\n')
                    f.write(f"G92 X{Bed_X_offset} Y{Bed_Y_offset}\n")
                    
                elif Activate_Ex == 'T5' and Activate_Ex in selected_extruder:
                    E5_x, E5_y = map(int, E5_offset.split(','))
                    E5_x = E5_x + Bed_X_offset
                    f.write(f'G0 X{E5_x} Y{E5_y} F{feed_rate}\n')
                    f.write(f"G92 X{Bed_X_offset} Y{Bed_Y_offset}\n")

            # Start_aux = self.conf['Start_aux']
            # End_aux = self.conf['End_aux']
            # Layer_aux = self.conf['Layer_aux']
            HEPA_Start_aux = self.conf['HEPA_Start_aux']
            HEPA_End_aux = self.conf['HEPA_End_aux']
            HEPA_Layer_aux = self.conf['HEPA_Layer_aux']
            E0_Crosslinker_Start_aux = self.conf['E0_Crosslinker_Start_aux']
            E0_Crosslinker_End_aux = self.conf['E0_Crosslinker_End_aux']
            E0_Crosslinker_Layer_aux = self.conf['E0_Crosslinker_Layer_aux']
            E1_Crosslinker_Start_aux = self.conf['E1_Crosslinker_Start_aux']
            E1_Crosslinker_End_aux = self.conf['E1_Crosslinker_End_aux']
            E1_Crosslinker_Layer_aux = self.conf['E1_Crosslinker_Layer_aux']
            Chamber_UV_Start_aux = self.conf['Chamber_UV_Start_aux']
            Chamber_UV_End_aux = self.conf['Chamber_UV_End_aux']
            Chamber_UV_Layer_aux = self.conf['Chamber_UV_Layer_aux']
            # Aux_time = self.conf['Aux_time']
            E0_Crosslinker_ON = self.conf['E0_Crosslinker_ON']
            E0_Crosslinker_OFF = self.conf['E0_Crosslinker_OFF']
            E1_Crosslinker_ON = self.conf['E1_Crosslinker_ON']
            E1_Crosslinker_OFF = self.conf['E1_Crosslinker_OFF']
            Hepa_ON = self.conf['HEPA_ON']
            Hepa_OFF = self.conf['HEPA_OFF']
            Extrusion_Multiplier = self.conf['Extrusion_Multiplier']
            Chamber_OFF = self.conf['Chamber_OFF']
            Chamber_ON = self.conf['Chamber_ON']
            HEPA_Aux_time = self.conf['HEPA_Aux_time']
            Chamber_UV_Aux_time = self.conf['Chamber_UV_Aux_time']
            E0_Crosslinker_Aux_time = self.conf['E0_Crosslinker_Aux_time']
            E1_Crosslinker_Aux_time = self.conf['E1_Crosslinker_Aux_time']
            self.first = True
            f.write("\n")
            f.write("HEADER_END")
            print("slicing start nbil")
            if Co_mode != None:
                f.write(str(Co_mode)+ "\n")
            if Tri_mode != None:
                f.write(str(Tri_mode)+"\n")
            self.thermo.set_target(total_layers)
            if self.Servo_on != None:
                    f.write("M400\n")
                    f.write(str(temp_on)+ "\n")
                    # f.write(str(self.Servo_on)+ "\n")
            ...
            for layer in range(total_layers):
                ...
                # if Start_aux:
                #     if Crosslinker_ON:
                #         f.write(str(Crosslinker_ON)+ "\n")
                #     if Hepa_ON:
                #         f.write(str(Hepa_ON)+ "\n")
                #     f.write(str(Aux_time)+ "\n")
                #     if Crosslinker_OFF:
                #             f.write(str(Crosslinker_OFF)+ "\n")
                #     if Hepa_OFF:
                #         f.write(str(Hepa_OFF)+ "\n")
                for nozl in range(4):
                            ...
                            for line in self._paths_gcode(paths, width, nozl, self.layer_zs[layer]):
                                ...
                                if 'E' in line:
                                    ...
                                    for i, part in enumerate(parts):
                                        if part.startswith('E'):
                                            ...
                                            E_value *= Extrusion_Multiplier
                                            parts[i] = f"E{E_value:.2f}"
                                ...
                                if 'G0 Z' in line:
                                    ...
                                    if HEPA_Start_aux:
                                        if Hepa_ON:
                                            f.write(str(Hepa_ON)+ "\n")
                                        f.write(str(HEPA_Aux_time)+ "\n")
                                        if Hepa_OFF:
                                            f.write(str(Hepa_OFF)+ "\n")
                                    if Chamber_UV_Start_aux:
                                        if Chamber_ON:
                                            f.write(str(Chamber_ON)+ "\n")
                                            f.write(str(Chamber_UV_Aux_time)+ "\n")
                                        if Chamber_OFF:
                                                f.write(str(Chamber_OFF)+ "\n")
                                    if E0_Crosslinker_Start_aux:
                                        if E0_Crosslinker_ON:
                                            f.write(str(E0_Crosslinker_ON)+ "\n")
                                            f.write(str(E0_Crosslinker_Aux_time)+ "\n")
                                        if E0_Crosslinker_OFF:
                                                f.write(str(E0_Crosslinker_OFF)+ "\n")
                                    if E1_Crosslinker_Start_aux:
                                        if E1_Crosslinker_ON:
                                            f.write(str(E1_Crosslinker_ON)+ "\n")
                                            f.write(str(E1_Crosslinker_Aux_time)+ "\n")
                                        if E1_Crosslinker_OFF:
                                                f.write(str(E1_Crosslinker_OFF)+ "\n")
                                        
                                    if HEPA_Layer_aux:
                                        if Hepa_ON:
                                            f.write(str(Hepa_ON)+ "\n")
                                    if E0_Crosslinker_Layer_aux:
                                        if E0_Crosslinker_ON:
                                            f.write(str(E0_Crosslinker_ON)+ "\n")
                                    if Chamber_UV_Layer_aux:
                                        if Chamber_ON:
                                            f.write(str(Chamber_ON)+ "\n")
                                else:
                                    f.write(line)
                ...
                if HEPA_End_aux:
                    ...
                    if Hepa_OFF:
                        f.write(str(Hepa_OFF)+ "\n")
                if E0_Crosslinker_End_aux:
                    if E0_Crosslinker_ON:
                        f.write(str(E0_Crosslinker_ON)+ "\n")
                        f.write(str(E0_Crosslinker_Aux_time)+ "\n")  
                    if E0_Crosslinker_OFF:
                        f.write(str(E0_Crosslinker_OFF)+ "\n")
                if E1_Crosslinker_End_aux:
                    if E1_Crosslinker_ON:
                        f.write(str(E1_Crosslinker_ON)+ "\n")
                        f.write(str(E1_Crosslinker_Aux_time)+ "\n")  
                    if E1_Crosslinker_OFF:
                        f.write(str(E1_Crosslinker_OFF)+ "\n")
                if Chamber_UV_End_aux:
                    if Chamber_ON:
                        f.write(str(Chamber_ON)+ "\n")
                        f.write(str(Chamber_UV_Aux_time)+ "\n")  
                    if Chamber_OFF:
            ...
            Servo_off = self.conf['Servo_OFF']
            temp_off = self.conf['temperature_OFF']
            f.write(self.conf['bed_temperature_OFF'])
            f.write("\n")
            if Servo_off != None:
                f.write(str(temp_off)+ "\n")
                f.write("M400\n")
                f.write(str(Servo_off)+ "\n")
            Co_mode_off = self.conf['Co-axial_OFF']
            Tri_mode_off = self.conf['Tri-axial_OFF']
            if Co_mode != None:
                f.write(str(Co_mode_off)+ "\n")
            if Tri_mode != None:
                f.write(str(Tri_mode_off)+"\n")
            self.thermo.clear()
    ...
    def _paths_gcode(self, paths, ewidth, nozl, z):
        ...
        # Add tool change G-code if applicable
        for line in self._tool_change_gcode(nozl):
            gcode_lines.append(line)

        # Process each path
        for path in paths:
            perimeter = 0  # Initialize perimeter for this path
            ox, oy = path[0][0:2]  # Start point of the path

            # Calculate lift if necessary
            if retract_lift > 0 or self.last_pos[2] != z:
                self.total_build_time += abs(retract_lift) / travel_rate_z
                gcode_lines.append("G0 Z{z:.2f} F{f:g};retract lift\n".format(z=z + retract_lift, f=travel_rate_z * 60.0))

            # Move to the start point
            dist = math.hypot(self.last_pos[1] - oy, self.last_pos[0] - ox)
            self.total_build_time += dist / travel_rate_xy
            if ox >= 0 and oy >= 0 and ox > self.bed_x / 2 and oy > self.bed_y /2:  # Only append if x and y are non-negative
                gcode_lines.append("G0 X{x:.2f} Y{y:.2f} F{f:g}\n".format(x=ox, y=oy, f=travel_rate_xy * 60.0))
                
            if retract_lift > 0:
                self.total_build_time += abs(retract_lift) / travel_rate_z
                gcode_lines.append("G0 Z{z:.2f} F{f:g}\n".format(z=z, f=travel_rate_z * 60.0))
            ...
            # Follow the path and calculate the perimeter
            for i, (x, y) in enumerate(path[1:]):
                dist = math.hypot(y - oy, x - ox)  # Calculate distance between successive points
                perimeter += dist  # Add to perimeter
                fil_dist = dist * xsect / fil_xsect
                speed = min(feed_rate, max_speed) * 60.0
                self.total_build_time += dist / feed_rate
                self.last_e += fil_dist
                
                # Mark the line as a perimeter if it's the first or last point in the path
                if i == 0 or i == len(path[1:]) - 1:
                    if ox >= 0 and oy >= 0 and ox > self.bed_x / 2 and oy > self.bed_y /2:
                        if self.first:
                            Activate_Ex = self.conf['Activate_Extruder']
                            if self.Servo_on != None:
                                gcode_lines.append("M400\n")
                                gcode_lines.append(str(self.Servo_on)+ "\n")
                            gcode_lines.append(Activate_Ex)
                            gcode_lines.append('\n')
                            self.first = False
                        # print("x",ox)
                        gcode_lines.append("G1 X{x:.2f} Y{y:.2f} E{e:.3f} F{f:g} ; perimeter\n".format(x=x, y=y, e=self.last_e, f=feed_rate))
                else:
                    gcode_lines.append("G1 X{x:.2f} Y{y:.2f} E{e:.3f} F{f:g}\n".format(x=x, y=y, e=self.last_e, f=feed_rate))
                self.last_pos = (x, y, z)
                ox, oy = x, y
            ...
            # Output the perimeter for this path
            # print(f"Perimeter of path: {perimeter:.2f}")
