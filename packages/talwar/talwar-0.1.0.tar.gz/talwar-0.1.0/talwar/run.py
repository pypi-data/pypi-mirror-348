...
from . import check_license, LicenseError
...
def print_banner():
    ...
    ║         ╚═╝   ╚═╝  ╚═╝╚══════╝ ╚══╝╚══╝   ╚═╝  ╚═╝╚═╝  ╚═╝           ║
    ║                                                                      ║
    ║           Automated Penetration Testing via Security Agents          ║
    ║                                                                      ║
...
def execute(args):
    ...
    try:
        ...
        print(f"Error: {str(e)}")
        print("\nTo purchase a license, visit: https://talwar.ai/pricing")
        sys.exit(1)
...
def main():
    ...
    try:
        ...
        # This happens when -h/--help is used
        sys.exit(0)
