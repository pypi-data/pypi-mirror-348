...
def setup_scenario_for_cristal(config: ConvergenceConfig):
    mods = {
        ...
        "CRISTAL Controls.use_freight_model": True,
        "CRISTAL Controls.model_b2c_delivery": True,
        "CRISTAL Controls.model_b2b_delivery": True,
        "CRISTAL Controls.synthesize_b2b_demand": True,
...
def setup_scenario_for_normal_iteration(config: ConvergenceConfig, current_iteration: ConvergenceIteration):
    ...
    # Cristal is not run in regular ABM runs
    mods["CRISTAL Controls.use_freight_model"] = False
