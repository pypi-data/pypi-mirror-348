...
NestedFloatList = _reflection.GeneratedProtocolMessageType(
    "NestedFloatList",
    (_message.Message,),
    {
...
RateInput = _reflection.GeneratedProtocolMessageType(
    "RateInput",
    (_message.Message,),
    {
...
RateOutput = _reflection.GeneratedProtocolMessageType(
    "RateOutput",
    (_message.Message,),
    {
...
MixedIntExpInput = _reflection.GeneratedProtocolMessageType(
    "MixedIntExpInput",
    (_message.Message,),
    {
...
MixedIntExpResult = _reflection.GeneratedProtocolMessageType(
    "MixedIntExpResult",
    (_message.Message,),
    {
...
SumConstExpResult = _reflection.GeneratedProtocolMessageType(
    "SumConstExpResult",
    (_message.Message,),
    {
...
SumConstExpInput = _reflection.GeneratedProtocolMessageType(
    "SumConstExpInput",
    (_message.Message,),
    {
...
SumConstInput = _reflection.GeneratedProtocolMessageType(
    "SumConstInput",
    (_message.Message,),
    {
...
SumConstResult = _reflection.GeneratedProtocolMessageType(
    "SumConstResult",
    (_message.Message,),
    {
...
IntInput = _reflection.GeneratedProtocolMessageType(
    "IntInput",
    (_message.Message,),
    {
...
IntResult = _reflection.GeneratedProtocolMessageType(
    "IntResult",
    (_message.Message,),
    {
...
SubmitOutput = _reflection.GeneratedProtocolMessageType(
    "SubmitOutput",
    (_message.Message,),
    {
...
LockMessage = _reflection.GeneratedProtocolMessageType(
    "LockMessage",
    (_message.Message,),
    {
...
StatusOutput = _reflection.GeneratedProtocolMessageType(
    "StatusOutput",
    (_message.Message,),
    {
...
LockOutput = _reflection.GeneratedProtocolMessageType(
    "LockOutput",
    (_message.Message,),
    {
...
VersionOutput = _reflection.GeneratedProtocolMessageType(
    "VersionOutput",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SUMCONSTEXPRESULT._serialized_end = 1424
    _EMPTY._serialized_start = 1426
    _EMPTY._serialized_end = 1433
    _SUMCONSTEXPINPUT._serialized_start = 1436
    _SUMCONSTEXPINPUT._serialized_end = 1759
    _SUMCONSTINPUT._serialized_start = 1762
    _SUMCONSTINPUT._serialized_end = 2043
    _SUMCONSTRESULT._serialized_start = 2046
    _SUMCONSTRESULT._serialized_end = 2362
    _INTINPUT._serialized_start = 2365
    _INTINPUT._serialized_end = 2613
    _INTRESULT._serialized_start = 2616
    _INTRESULT._serialized_end = 2857
    _SUBMITOUTPUT._serialized_start = 2859
    _SUBMITOUTPUT._serialized_end = 2909
    _LOCKMESSAGE._serialized_start = 2911
    _LOCKMESSAGE._serialized_end = 2941
    _STATUSOUTPUT._serialized_start = 2943
    _STATUSOUTPUT._serialized_end = 2999
    _LOCKOUTPUT._serialized_start = 3001
    _LOCKOUTPUT._serialized_end = 3070
    _VERSIONOUTPUT._serialized_start = 3072
    _VERSIONOUTPUT._serialized_end = 3154
    _EQCSERVICE._serialized_start = 3157
    _EQCSERVICE._serialized_end = 3985
