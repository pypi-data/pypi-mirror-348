...
class TestDataManager(BaseManager[TestData]):
    ...
    async def create_test_data(self, name: str, status: Literal['draft', 'ready', 'deleted'] = 'draft', type: Literal['test', 'design', 'run'] = 'test', content: str = None, supporting_data_files: str = None, tags: List[str] = None) -> TestData:
        """
        Create a new test data entity.
    ...
    async def update_test_data(self, id_or_name: str, name: str = None, status: Literal['draft', 'ready', 'deleted'] = None, type: Literal['test', 'design', 'run'] = None, content: str = None, supporting_data_files: str = None, tags: List[str] = None, cached_prompt_details: str = None) -> TestData:
        """
