from relationalai.early_access.dsl.bindings.binding_models import Binding
from relationalai.early_access.dsl.bindings.common import BindableTable
from relationalai.early_access.dsl.ontologies.constraints import Unique
...
class BoundExternalPreferredUC:
    _constraint: Unique
    _table: BindableTable
