...
from relationalai.early_access.metamodel import ir, compiler as c, builtins as bt, types, visitor, typer, helpers, factory as f
    ...
    def _effect_args(self, n: ir.Task) -> Tuple[Tuple[Any], list[ir.Task]]:
        ...
        if isinstance(n, ir.Output):
            ...
            for _, v in n.aliases:
                handled_args.append(self.handle_value(None, v))
        elif isinstance(n, ir.Update):
