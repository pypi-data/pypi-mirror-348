...
probe_on_monolayer_input_datasets = [(0.015,
      '5f8c1a0d-f5fe-449a-83f2-d865fae472fe',
...
project_id = '2020-12-20-sds-on-au-111-probe-and-substrate-conversion-test'

probe_on_monolayer_input_dataset = probe_on_monolayer_input_datasets[0]
...
wfg = ProbeOnSubstrateMergeConversionMinimizationAndEquilibration(
    ...
    files_in_info={
        'substrate_data_file': {
            'query': {'uuid': probe_on_monolayer_input_dataset[1]},
        ...
        'probe_data_file': {
            'query': {'uuid': probe_on_monolayer_input_dataset[2]},
            'file_name': 'default.gro',
    ...
    system = {
        ...
        'surfactant': {
            ...
            'surface_concentration': probe_on_monolayer_input_dataset[0]
        },
        'indenter': {
            'name': 'AUM',
            'resname': 'AUM',
