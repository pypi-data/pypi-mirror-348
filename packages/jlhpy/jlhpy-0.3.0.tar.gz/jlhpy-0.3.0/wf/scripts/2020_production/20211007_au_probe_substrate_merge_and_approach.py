...
parameter_sets = [
    ...
    } for x in np.arange(-50.0, 75.0, 25.0) for y in np.arange(-50, 75.0, 25.0)
]
    ...
    wfg = ProbeOnSubstrateMergeConversionMinimizationEquilibrationAndApproach(
        ...
        step_specific={
            ...
            'equilibration': {
             ...
             'dtool_push': {
                'dtool_target': '/p/project/hfr21/hoermann4/dtool/PRODUCTION/2021-10-07-sds-on-au-111-probe-and-substrate-merge-and-approach/',
                'remote_dataset': None,
            }
        }
    )
...
# So far only queued first 5 workflows
