...
from jlhpy.utilities.wf.probe_on_substrate.chain_wf_probe_on_substrate_insertion import ProbeOnSubstrateMinimizationEquilibrationAndNormalApproach
from jlhpy.utilities.wf.mappings import psfgen_mappings_template_context


project_id = '2020-12-08-sds-on-au-111-probe-and-substrate-minimzation-equilibration-approach-quick-test'

wfg = ProbeOnSubstrateMinimizationEquilibrationAndNormalApproach(
