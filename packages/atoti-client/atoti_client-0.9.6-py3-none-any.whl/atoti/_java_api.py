...
class JavaApi(metaclass=_JavaApiMetaClass):
    ...
    def refresh(self) -> None:
        if get_data_model_transaction_id() is not None:
    ...
    def publish_measures(self, cube_name: str, /) -> None:
        measures_metada_only = get_data_model_transaction_id() is not None
    ...
    def _outside_transaction_api(self) -> Any:
        return self.java_api.outsideTransactionApi(
            get_data_transaction_id() is not None
        )

    def _enterprise_api(self) -> Any:
        return self.java_api.enterpriseApi(get_data_transaction_id() is not None)
    ...
    def delete_rows_from_table(
        ...
        *,
        ...
        def delete_on_store_branch() -> None:
            transaction_id = get_data_transaction_id()
    ...
    def update_hierarchy_dimension(
        ...
        *,
        ...
        self._outside_transaction_api().updateHierarchyCoordinate(
            ...
            HierarchyIdentifier(
                DimensionIdentifier(new_dimension),
    ...
    def _inside_transaction(
        ...
        *,
        ...
        if get_data_transaction_id() is not None or source_key in _REALTIME_SOURCE_KEYS:
            callback()
        else:
            with transact_data(
                allow_nested=True,
    ...
    def get_cube_mask(
        ...
        *,
        ...
        return {
            role: condition_from_disjunctive_normal_form(
                (
                    [
                        HierarchyIsInCondition(
