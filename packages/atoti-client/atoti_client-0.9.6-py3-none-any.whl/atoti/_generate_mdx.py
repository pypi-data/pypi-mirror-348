...
def _generate_rows_axis(
    ...
    *,
    ...
    multi_level_hierarchy_identifiers = {
        HierarchyIdentifier(DimensionIdentifier(dimension.name), hierarchy.name)
    ...
    *,
    ...
    for condition in conditions:
        match condition:
            ...
            case IsInCondition(subject=HierarchyIdentifier()):
                add_hierarchy_filter(
                    _HierarchyFilter(
                        exclusion=condition.operator == "IS_NOT_IN",
            ...
            case IsInCondition(subject=LevelIdentifier()):
