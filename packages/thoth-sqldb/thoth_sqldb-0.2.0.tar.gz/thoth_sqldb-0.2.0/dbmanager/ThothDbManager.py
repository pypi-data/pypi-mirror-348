...
class ThothDbManager(ABC):
    ...
    def __init__(self, db_root_path: str, db_mode: str = "dev", db_type: Optional[str] = None, language:str="English", **kwargs) -> None:
        """
        ...
        """
        self._validate_common_params(db_root_path, db_mode, language)
    ...
    def _validate_common_params(self, db_root_path: str, db_mode: str, language:str) -> None:
        """
