    ...
    def initialize_detector(self, num_features: int, size_laf: int = 19) -> nn.Module:
        class REKDetector(nn.Module):
            def __init__(self, params, device: torch.device) -> None:
                ...
                url = "https://github.com/binarycode11/singular-points/raw/refs/heads/main/trained_models/release_group36_f2_s2_t2.log/best_model.pt"
    ...
    def initialize_detector(self, num_features: int, size_laf: int = 19) -> nn.Module:
        class SingularPointDetector(nn.Module):
            def __init__(self, params, device: torch.device) -> None:
                ...
                url = "https://github.com/binarycode11/singular-points/raw/refs/heads/main/data/models/sp_map_fo_30.pth" # './data/models/sp2_85.pth'
