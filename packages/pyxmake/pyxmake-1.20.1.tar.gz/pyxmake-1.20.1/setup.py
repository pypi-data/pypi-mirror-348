...
extras_require = \
{':python_version == "2.7" or python_version >= "3.5" and python_version < "3.7"': ['pyx-core>1.20'],
 ':python_version >= "3.7" and python_version < "4.0"': ['pyx-core',
                                                         'pyx-webservice>1.20'],
 'all:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>1.20',
                                                                                       'pyc-core>=1.11'],
 'all:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>1.20'],
 'client:python_version >= "3.8" and python_version < "4.0"': ['pyx-client>1.20'],
 'confluence:python_version >= "3.7"': ['atlassian-python-api>=3.14'],
 'devel:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>1.20',
                                                                                         'pyc-core>=1.11'],
 ...
 'lint:python_version >= "3.8" and python_version < "4.0"': ['black>=24.1',
                                                             'black>=24.1'],
 'poetry:python_version == "2.7" or python_version >= "3.5" and python_version < "4.0"': ['pyx-poetry>1.20']}
