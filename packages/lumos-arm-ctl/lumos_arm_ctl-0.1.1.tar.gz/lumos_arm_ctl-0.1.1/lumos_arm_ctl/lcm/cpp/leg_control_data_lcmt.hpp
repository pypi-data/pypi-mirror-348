...
int leg_control_data_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->pos[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->vel[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->knee_pos[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
...
int leg_control_data_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->pos[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->vel[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->knee_pos[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x47c3cf1527ccd48bLL;
