...
public final class simulator_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xc07fa14d3758d2e9L;
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.q = new double[(int) 40];
        for (int a = 0; a < 40; a++) {
            this.q[a] = ins.readDouble();
        }
 
        this.qd = new double[(int) 40];
        for (int a = 0; a < 40; a++) {
            this.qd[a] = ins.readDouble();
        }
 
        this.qdd = new double[(int) 40];
        for (int a = 0; a < 40; a++) {
            this.qdd[a] = ins.readDouble();
        }
 
        this.tau = new double[(int) 40];
        for (int a = 0; a < 40; a++) {
    ...
    public lcmtypes.simulator_lcmt copy()
    {
        ...
        outobj.q = new double[(int) 40];
        System.arraycopy(this.q, 0, outobj.q, 0, 40); 
        outobj.qd = new double[(int) 40];
        System.arraycopy(this.qd, 0, outobj.qd, 0, 40); 
        outobj.qdd = new double[(int) 40];
        System.arraycopy(this.qdd, 0, outobj.qdd, 0, 40); 
        outobj.tau = new double[(int) 40];
        System.arraycopy(this.tau, 0, outobj.tau, 0, 40); 
