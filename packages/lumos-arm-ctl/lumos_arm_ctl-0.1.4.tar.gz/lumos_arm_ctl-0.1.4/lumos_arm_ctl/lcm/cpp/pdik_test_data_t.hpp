...
#ifndef __pdik_test_data_t_hpp__
#define __pdik_test_data_t_hpp__



class pdik_test_data_t
{
    public:
        ...
        float      L_stance_foot[3];

        float      single_L_x[12];

        float      single_L_y[12];

        float      single_L_G_x[12];

        float      single_L_G_y[12];
...
int pdik_test_data_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int pdik_test_data_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int pdik_test_data_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t pdik_test_data_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* pdik_test_data_t::getTypeName()
{
    return "pdik_test_data_t";
}

int pdik_test_data_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->L_stance_foot[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->single_L_x[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->single_L_y[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->single_L_G_x[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->single_L_G_y[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->hr_h0[0], 10);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->det_q[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->l, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->pseudo_com_vx, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->dx0_next, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->dxf_next_goal, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->one_step_max_vel_gain, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int pdik_test_data_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->L_stance_foot[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->single_L_x[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->single_L_y[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->single_L_G_x[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->single_L_G_y[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->hr_h0[0], 10);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->det_q[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->l, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->pseudo_com_vx, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->dx0_next, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->dxf_next_goal, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->one_step_max_vel_gain, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int pdik_test_data_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t pdik_test_data_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xfe65c67b9e67b193LL;
