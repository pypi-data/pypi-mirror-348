...
int state_estimator_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->com_p[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->com_v[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->body_zmp[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int state_estimator_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->com_p[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->com_v[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->body_zmp[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x5a302e5922e1cf0cLL;
