...
public final class spi_data_t implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x8bbfb68d86b7504cL;
    ...
    public lcmtypes.spi_data_t copy()
    {
        ...
        outobj.flags = new int[(int) 12];
        System.arraycopy(this.flags, 0, outobj.flags, 0, 12); 
