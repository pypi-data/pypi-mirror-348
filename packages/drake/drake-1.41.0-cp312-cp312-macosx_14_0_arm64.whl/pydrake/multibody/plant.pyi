...
class DeformableModel(PhysicalModel):
    ...
    def GetBodyIds(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> list[DeformableBodyId]: ...
    ...
    def GetPositions(self, context: pydrake.systems.framework.Context, id: DeformableBodyId) -> numpy.ndarray[numpy.float64[3, n]]: ...
    ...
    @overload
    def RegisterDeformableBody(self, geometry_instance: pydrake.geometry.GeometryInstance, model_instance: pydrake.multibody.tree.ModelInstanceIndex, config: pydrake.multibody.fem.DeformableBodyConfig, resolution_hint: float) -> DeformableBodyId: ...
    def SetPositions(self, context: pydrake.systems.framework.Context, id: DeformableBodyId, q: numpy.ndarray[numpy.float64[3, n], flags.f_contiguous]) -> None: ...
