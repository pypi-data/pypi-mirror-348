...
class IrisParameterizationFunction:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, parameterization: Callable[[numpy.ndarray[numpy.float64[m, 1]]], numpy.ndarray[numpy.float64[m, 1]]], dimension: int) -> None: ...
    def get_parameterization(self) -> Callable[[numpy.ndarray[numpy.float64[m, 1]]], numpy.ndarray[numpy.float64[m, 1]]]: ...
