class GameObject:
    ...
    """
    def __init__(self, x: float, y: float, name: str, parent: 'GameObject | None' = None):
        self._local_x = x
        self._local_y = y
        self._name = name
    ...
    def _mark_transform_dirty(self) -> None:
        ...
        elif not self._is_dirty: # If world transform was already dirty, ensure representation is also marked
             self._is_dirty = True
