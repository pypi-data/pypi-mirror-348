...
# Block 4: JSON to String converter
...
json_converter.add_dependency(ai_extractor)
write_block.add_dependency(json_converter)
...
json_converter.input_map = {"data": (ai_extractor, "extracted_data")}
write_block.input_map = {"content": (json_converter, "json_string")}
