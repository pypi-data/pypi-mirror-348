...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr2im_0v_met_vbf
# Timestamp: 11-04-2025 (14:53:58)
...
ax_xLabel = r'$p_\mathrm{T}^\mathrm{recoil}$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}p_\mathrm{T}^\mathrm{recoil}$ [fb/GeV]'
ax_title  = r'2-$\mu$ region, VBF phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
yLims = (9e-05, 11.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"HEJ", r"BSM+SM No exclusion; expected exclusion was  0\%" ], r""),
}
...
exec(open(prefix+'sr0l_cr2im_0v_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2im_0v_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2im_0v_met_vbf.png'), format='PNG')
