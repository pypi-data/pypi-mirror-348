...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr2ie_0v_met_mono
...
ax_title  = r'2-$e$ region, $\geq 1$ jet phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
...
exec(open(prefix+'sr0l_cr2ie_0v_met_mono__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2ie_0v_met_mono.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2ie_0v_met_mono.png'), format='PNG')
