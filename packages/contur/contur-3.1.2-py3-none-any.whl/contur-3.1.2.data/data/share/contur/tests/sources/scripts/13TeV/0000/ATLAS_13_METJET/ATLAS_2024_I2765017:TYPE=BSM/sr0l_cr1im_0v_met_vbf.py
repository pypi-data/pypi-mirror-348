...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr1im_0v_met_vbf
...
labels = {
    'legend' : ([ r"ATLAS Data", r"HEJ", r"BSM+SM excl. 28\% "+"\n"+r" (15\% expected)" ], r""),
}
...
exec(open(prefix+'sr0l_cr1im_0v_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1im_0v_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1im_0v_met_vbf.png'), format='PNG')
