...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr1ie_0v_mjj_vbf
...
labels = {
    'legend' : ([ r"ATLAS Data", r"HEJ", r"BSM+SM excl.  2\% "+"\n"+r" ( 1\% expected)" ], r""),
}
...
exec(open(prefix+'sr0l_cr1ie_0v_mjj_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_mjj_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_mjj_vbf.png'), format='PNG')
