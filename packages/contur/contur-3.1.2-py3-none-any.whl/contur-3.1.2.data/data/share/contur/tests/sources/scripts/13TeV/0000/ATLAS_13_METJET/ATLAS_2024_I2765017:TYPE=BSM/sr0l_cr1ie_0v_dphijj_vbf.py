...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr1ie_0v_dphijj_vbf
...
exec(open(prefix+'sr0l_cr1ie_0v_dphijj_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_dphijj_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_dphijj_vbf.png'), format='PNG')
