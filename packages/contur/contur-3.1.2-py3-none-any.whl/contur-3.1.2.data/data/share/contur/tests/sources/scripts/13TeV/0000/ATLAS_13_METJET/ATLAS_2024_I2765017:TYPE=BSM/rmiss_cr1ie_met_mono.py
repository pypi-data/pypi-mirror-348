...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/rmiss_cr1ie_met_mono
# Timestamp: 11-04-2025 (14:53:56)
...
ax_yLabel = r'$R_\mathrm{miss}$'
ax_title  = r'0-lepton/1-$e$ region ratio, $\geq 1$ jet phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"MEPS@NLO $\times$ nNLO EW", r"BSM+SM No exclusion; expected exclusion was 24\%" ], r""),
}
...
exec(open(prefix+'rmiss_cr1ie_met_mono__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1ie_met_mono.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1ie_met_mono.png'), format='PNG')
