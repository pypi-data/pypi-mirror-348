...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/rmiss_cr1ie_met_vbf
...
labels = {
    'legend' : ([ r"ATLAS Data", r"MEPS@NLO $\times$ nNLO EW", r"BSM+SM No exclusion; expected exclusion was 12\%" ], r""),
}
...
exec(open(prefix+'rmiss_cr1ie_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1ie_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1ie_met_vbf.png'), format='PNG')
