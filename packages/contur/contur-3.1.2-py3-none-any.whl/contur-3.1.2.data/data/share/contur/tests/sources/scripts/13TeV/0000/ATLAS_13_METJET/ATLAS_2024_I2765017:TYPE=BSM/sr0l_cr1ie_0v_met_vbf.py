...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr1ie_0v_met_vbf
...
ax_title  = r'1-$e$ region, VBF phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"HEJ", r"BSM+SM excl. 22\% "+"\n"+r" (10\% expected)" ], r""),
}
...
exec(open(prefix+'sr0l_cr1ie_0v_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr1ie_0v_met_vbf.png'), format='PNG')
