...
# Analysis object: /ATLAS_2017_I1609448/d01-x01-y01
# Timestamp: 11-04-2025 (14:53:27)
...
ax_xLabel = r'$p_\mathrm{T}^\mathrm{miss}$ [GeV]'
ax_yLabel = r'$R^\mathrm{miss}$'
ax_title  = r'$\geq 1$ jet phase space'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (200.0, 1400.0)
yLims = (0.9, 11.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"SM (Sherpa $\times$ NNLO)", r"BSM+SM excl.  0\% "+"\n"+r" ( 0\% expected)" ], r""),
}
