...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_met_vbf
...
ax_title  = r'0-lepton region, VBF phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"MEPS@NLO $\times$ nNLO EW", r"BSM+SM No exclusion; expected exclusion was  0\%" ], r""),
}
...
exec(open(prefix+'sr0l_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_met_vbf.png'), format='PNG')
