...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/rmiss_cr2ie_dphijj_vbf
...
ax_title  = r'0-lepton/2-$e$ region ratio, VBF phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (-1.0, 1.0)
...
exec(open(prefix+'rmiss_cr2ie_dphijj_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr2ie_dphijj_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr2ie_dphijj_vbf.png'), format='PNG')
