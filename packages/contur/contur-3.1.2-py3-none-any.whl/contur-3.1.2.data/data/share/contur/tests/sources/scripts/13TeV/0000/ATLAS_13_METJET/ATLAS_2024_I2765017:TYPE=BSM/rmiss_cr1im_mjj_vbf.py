...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/rmiss_cr1im_mjj_vbf
...
exec(open(prefix+'rmiss_cr1im_mjj_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1im_mjj_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'rmiss_cr1im_mjj_vbf.png'), format='PNG')
