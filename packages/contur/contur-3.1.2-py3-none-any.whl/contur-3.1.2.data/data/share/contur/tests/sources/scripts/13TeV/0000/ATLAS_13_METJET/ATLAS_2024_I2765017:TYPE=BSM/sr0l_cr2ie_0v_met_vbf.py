...
# Analysis object: /ATLAS_2024_I2765017:TYPE=BSM/sr0l_cr2ie_0v_met_vbf
...
ax_title  = r'2-$e$ region, VBF phase space'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (200.0, 2600.0)
yLims = (9e-05, 11.0)
...
exec(open(prefix+'sr0l_cr2ie_0v_met_vbf__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2ie_0v_met_vbf.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'sr0l_cr2ie_0v_met_vbf.png'), format='PNG')
