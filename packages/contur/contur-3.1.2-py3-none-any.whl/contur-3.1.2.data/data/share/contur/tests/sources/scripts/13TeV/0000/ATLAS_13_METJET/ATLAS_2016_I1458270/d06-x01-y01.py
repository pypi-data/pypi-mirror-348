...
# Analysis object: /ATLAS_2016_I1458270/d06-x01-y01
# Timestamp: 11-04-2025 (14:53:26)
...
ax_xLabel = r'$m_\mathrm{eff} \mathrm{~(incl.)}$ [GeV]'
ax_yLabel = r'$\mathrm{Events~per~bin}$'
ax_title  = r''
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (800.0, 3600.0)
...
labels = {
    'legend' : ([ r"ATLAS Data", r"Expected SM events", r"BSM+SM No exclusion; expected exclusion was  0\%" ], r""),
}
