...
class MLSelectorBase(BaseEstimator, SelectorMixin,TransformerMixin):
    """Base class providing API and common functions for all multi-label
    Feature Selection Methods.
    Implements base functionality for ML selectors, especially the get/set params for
    ...
    def __init__(self):
        super(MLSelectorBase, self).__init__()
    ...
    def fit(self, X, y):
        """Abstract method to fit feature selection method with training data
        ...
        raise NotImplementedError("MLSelectorBase::fit()")
    ...
    def transform(self, X):
        ...
        NotImplementedError
            this is just an abstract method
        """
        raise NotImplementedError("MLSelectorBase::transform()")
    def fit_transform(self, X,y):
        ...
        NotImplementedError
            this is just an abstract method
        """
        raise NotImplementedError("MLSelectorBase::fit_transform()")
