...
class Commands(FrameExecutor):
    ...
    def BlePeriph_DefineService(self) -> BlePeriph_DefineService:
        ...
        **This method may only be called when BLE is disabled, i.e. before calling[
        BlePeriph.Enable(true)](.#BlePeriph.Enable) or after calling[
        BlePeriph.Enable(false)](.#BlePeriph.Enable) .**
        """
