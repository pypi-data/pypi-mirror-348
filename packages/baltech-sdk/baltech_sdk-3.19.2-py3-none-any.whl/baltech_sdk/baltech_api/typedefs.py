...
class BlePeriph_ErrEnabled(BlePeriphError):
    """
    The command could not be executed because BLE is currently enabled; however,
    the command requires BLE to be [disabled](.#BlePeriph.Enable).
    """
    ErrorCode = 0x00014B01
    URL = "https://docs.baltech.de/refman/cmds/bleperiph/index.html#BlePeriph.ErrEnabled"
