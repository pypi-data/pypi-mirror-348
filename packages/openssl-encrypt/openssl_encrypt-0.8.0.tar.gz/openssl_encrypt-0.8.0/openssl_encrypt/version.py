...
__version__ = "0.8.0"
__git_commit__ = "6bbaf1ed539f9752d426878db6d1af60f67bb882"
...
VERSION_HISTORY = {
    ...
    "0.8.0": "Added new metadata structure in a backward-compatible way. Now allows user defined data encryption when using PQC. Passing all tests and updates docs"
}
