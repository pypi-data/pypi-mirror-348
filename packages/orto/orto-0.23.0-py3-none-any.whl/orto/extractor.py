...
class LoewdinCompositionExtractor(extto.BetweenExtractor):
    ...
    @property
    def data(self) -> tuple[pd.DataFrame, list[float]]: # noqa
        '''
    ...
    @staticmethod
    def _process_block(block: str) -> tuple[pd.DataFrame, list[float]]: # noqa
        '''
        Converts single block into data entries described in self.data
        ...
        return combined_df, occupancies

    @classmethod
    def extract(cls, file_name: str | pathlib.Path) -> list[tuple[pd.DataFrame, list[float]]]: # noqa
        '''
        Convenience method which instantiates class, extracts blocks, and
        returns processed datasets
        ...
        Returns
        -------
        list[tuple[pd.DataFrame, list[float]]]
            Each entry contains processed data, as defined in cls.data
        '''
        _ext = cls()
        _ext(file_name, process=True)
...
class LoewdinOrbitalPopulationExtractor(extto.BetweenExtractor):
    ...
    def _process_block(block: str,
                       spin: str = 'UP') -> tuple[pd.DataFrame, list[float]]:
        '''
        Converts single block into data entries described in self.data
        ...
        block: str
            String block extracted from file
        spin: str
            Spin to extract data for. Options are 'UP' or 'DOWN'.\n
            Default is 'UP'.\n
    ...
    def extract(cls,
                file_name: str | pathlib.Path,
                spin: str = 'UP') -> list[tuple[pd.DataFrame, list[float]]]:
        '''
        Convenience method which instantiates class, extracts blocks, and
        returns processed datasets
...
class LoewdinReducedOrbitalPopulationExtractor(extto.BetweenExtractor):
    ...
    def extract(cls,
                file_name: str | pathlib.Path,
                spin: str = 'UP') -> list[tuple[pd.DataFrame, list[float]]]: # noqa
        '''
        Convenience method which instantiates class, extracts blocks, and
        returns processed datasets
