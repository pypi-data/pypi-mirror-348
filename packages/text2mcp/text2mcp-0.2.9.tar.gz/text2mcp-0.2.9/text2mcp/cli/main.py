...
def get_parser() -> argparse.ArgumentParser:
    ...
    gen_parser.add_argument('-t', '--template', help='Code template file path (legacy mode, same as --code-template)', default='code_template.md')
    ...
    # Add modular template options
    gen_parser.add_argument('--prompt-template', help='Path to prompt template file or content string')
    gen_parser.add_argument('--code-template', help='Path to code template file or content string')
    gen_parser.add_argument('--additional-template', help='Path to additional information template file or content string')
...
async def generate_code(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        # Check if using modular templates
        if args.prompt_template or args.code_template or args.additional_template:
            logger.info("Using modular templates for code generation")
            code = generator.generate_with_modular_templates(
                args.description,
                prompt_template=args.prompt_template,
                code_template=args.code_template,
                additional_template=args.additional_template
            )
        else:
            # Legacy template mode
            logger.info("Using legacy template mode for code generation")
