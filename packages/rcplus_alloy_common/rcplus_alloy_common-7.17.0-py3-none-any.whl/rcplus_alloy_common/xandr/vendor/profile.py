...
class EngagementRateType(int, Enum):
    VIDEO_COMPLETION = 1
    VIEW = 2
    VIEW_OVER_TOTAL = 3
    PREDICTED_IAB_VIDEO_VIEW_RATE = 4
    PREDICTED_IAB_VIDEO_VIEW_RATE_OVER_TOTAL = 5
    PREDICTED_100PV50PD_VIDEO_VIEW_RATE = 6
    PREDICTED_100PV50PD_VIDEO_VIEW_RATE_OVER_TOTAL = 7
    PREDICTED_100PV1S_DISPLAY_VIEW_RATE = 8
    PREDICTED_100PV1S_DISPLAY_VIEW_RATE_OVER_TOTAL = 9
...
class Exp(BaseModel):
    ...
    sbe: Optional[Exp] = Field(None, description="An object containing the sub-expression (the elements of the expression).")
