...
# 🔽 Функция для импорта
def super_resolve(input_image_path, output_image_path, model_path="model.pth"):
    model = SuperResolutionModel(model_path)
    model.process_image(input_image_path, output_image_path)