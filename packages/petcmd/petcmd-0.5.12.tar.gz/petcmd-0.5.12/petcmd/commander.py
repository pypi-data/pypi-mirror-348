...
class Commander:
	...
	def __init__(self, error_handler: Callable[[Exception], None] = None,
		...
		self.__completion_commands = ["setup-shell-completion", "remove-shell-completion",
			"setup-zshrc-for-completion", "help-completion"]
	...
	def __print_commands(self):
		for command in self.__commands[self.__internal_commands:]:
