...
from polars import Expr, Float64, Int64
...
from ..validation.check_base import RowCheckBase, ThresholdType
from ..validation.validation_node import create_validation_rule
...
class ColumnSchema:
    ...
    def _get_clean_stage(
        ...
        elif to == "decimal" or to == "float":
            return CleanNumberColumn(output_format=Float64, data_type="float", **kwargs,)
        elif to == "boolean":
