...
from .error import SchemaValidationError, FileValidationError, StructureValidationError, DataValidationError, UnknownValidationError

__all__ = [
    "ColumnNode", "SourceColDef",
    "ValidationResult", "ProcessingResult", "ProcessingFailure", "ProcessingSuccess",
    "SchemaValidationError", "FileValidationError", "StructureValidationError", "DataValidationError", "UnknownValidationError",
    "ThresholdLevel",
]
...
class ProcessingResult:
    ...
    errors: list[SchemaValidationError]
    success: bool = False
    failed_stage: Literal["normalise", "prepare", "validate"] | None = None


@dataclass(frozen=True)
class ProcessingFailure(ProcessingResult):
    success: False = False
    failed_stage: Literal["normalise", "prepare", "validate"]
