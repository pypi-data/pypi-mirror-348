...
def sanitise_column_name(column:str, join_char="_"):
    ...
    - Appending the prefix back to the string (if any)
    ...
    return prefix + sanitise_scalar_string(col, join_char=join_char)
...
def sanitise_column_headers(lf: pl.LazyFrame, join_char="_") -> pl.LazyFrame:
    ...
    return lf.rename(
        ...
        {col: sanitise_column_name(col, join_char) for col in lf.collect_schema().names()}
    )
