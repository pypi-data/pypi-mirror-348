...
Different from other audio generation tools, like [MMaudio](https://mmaudio.pro/), [AudioX](https://audiox.app/) is revolutionizing audio production with AI technology that transforms any input into professional-quality sound. With true "anything to audio" capabilities, AudioX offers unmatched versatility for creators of all skill levels.
...
- Audio extraction and manipulation utilities for video files
...
setup(
    ...
    version=version,
    description='Transform any inspiration into professional audio in minutes with AudioX, now with audio file processing capabilities.',
    ...
    keywords='audio, ai, music, sound effects, generation, audioX, video, processing, extraction, ffmpeg',
