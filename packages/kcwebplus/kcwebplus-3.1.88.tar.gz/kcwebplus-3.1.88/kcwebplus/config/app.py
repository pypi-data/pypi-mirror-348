...
route['modular']=[{"kcwebapi":"official"},{"docs":"official"},{"bank":"fund"}] #指定访问配置固定模块 （如果匹配了该值，将无法通过改变url访问不同模块）
route['plug']=[{"kcwebapi":"kcwebapi"},{"docs":"docs"},{"bank":"bank"}] #指定访问固定插件 （如果匹配了该值，将无法通过改变url访问不同插件）
