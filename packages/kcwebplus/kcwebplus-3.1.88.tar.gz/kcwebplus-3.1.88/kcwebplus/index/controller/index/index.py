...
system_start.insert_Boot_up(cmd='nohup kcwebplus /index/index/index/inspection --cli > app/runtime/log/inspection.log 2>&1 &',name='智能巡检',types='kcwebplus',icon='https://img.kwebapp.cn/icon/kcweb.png')
