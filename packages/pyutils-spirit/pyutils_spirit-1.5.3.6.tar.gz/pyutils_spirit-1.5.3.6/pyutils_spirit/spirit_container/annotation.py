...
class Component:
    ...
    def __call__(self, component_cls: type) -> type:
...
class Mapper:
    ...
    def __call__(self, mapper_cls: type) -> type:
...
class Service:
    ...
    def __call__(self, service_cls: type) -> type:
...
class Controller:
    ...
    def __call__(self, controller_cls: type) -> type:
