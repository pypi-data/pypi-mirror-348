...
class SmtTermVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _maude.SmtTermVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _maude.SmtTermVector___nonzero__(self)

    def __bool__(self):
        return _maude.SmtTermVector___bool__(self)

    def __len__(self):
        return _maude.SmtTermVector___len__(self)

    def __getslice__(self, i, j):
        return _maude.SmtTermVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _maude.SmtTermVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _maude.SmtTermVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _maude.SmtTermVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _maude.SmtTermVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _maude.SmtTermVector___setitem__(self, *args)

    def pop(self):
        return _maude.SmtTermVector_pop(self)

    def append(self, x):
        return _maude.SmtTermVector_append(self, x)

    def empty(self):
        return _maude.SmtTermVector_empty(self)

    def size(self):
        return _maude.SmtTermVector_size(self)

    def swap(self, v):
        return _maude.SmtTermVector_swap(self, v)

    def begin(self):
        return _maude.SmtTermVector_begin(self)

    def end(self):
        return _maude.SmtTermVector_end(self)

    def rbegin(self):
        return _maude.SmtTermVector_rbegin(self)

    def rend(self):
        return _maude.SmtTermVector_rend(self)

    def clear(self):
        return _maude.SmtTermVector_clear(self)

    def get_allocator(self):
        return _maude.SmtTermVector_get_allocator(self)

    def pop_back(self):
        return _maude.SmtTermVector_pop_back(self)

    def erase(self, *args):
        return _maude.SmtTermVector_erase(self, *args)

    def __init__(self, *args):
        _maude.SmtTermVector_swiginit(self, _maude.new_SmtTermVector(*args))

    def push_back(self, x):
        return _maude.SmtTermVector_push_back(self, x)

    def front(self):
        return _maude.SmtTermVector_front(self)

    def back(self):
        return _maude.SmtTermVector_back(self)

    def assign(self, n, x):
        return _maude.SmtTermVector_assign(self, n, x)

    def resize(self, *args):
        return _maude.SmtTermVector_resize(self, *args)

    def insert(self, *args):
        return _maude.SmtTermVector_insert(self, *args)

    def reserve(self, n):
        return _maude.SmtTermVector_reserve(self, n)

    def capacity(self):
        return _maude.SmtTermVector_capacity(self)
    __swig_destroy__ = _maude.delete_SmtTermVector

# Register SmtTermVector in _maude:
_maude.SmtTermVector_swigregister(SmtTermVector)
class PyDataConatiner(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, data):
        _maude.PyDataConatiner_swiginit(self, _maude.new_PyDataConatiner(data))
    __swig_destroy__ = _maude.delete_PyDataConatiner

    def data(self):
        return _maude.PyDataConatiner_data(self)

# Register PyDataConatiner in _maude:
_maude.PyDataConatiner_swigregister(PyDataConatiner)
class SmtTerm(PyDataConatiner):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
