...
def vision_query(
    ...
    参数:
        prompt: 文本提示
        image_url: 图像URL (与image_base64互斥)
        image_base64: base64编码的图像 (与image_url互斥)
    ...
    if not image_url and not image_base64:
        return "错误: 必须提供image_url或image_base64参数。"
    
    if image_url and image_base64:
        return "错误: image_url和image_base64参数不能同时提供。"
