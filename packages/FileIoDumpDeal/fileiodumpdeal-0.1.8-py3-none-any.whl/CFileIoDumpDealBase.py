...
class CFileIoDumpDealBase(object):
    ...
    def _ProcessTaskResult(self):
        ...
        for sNoExtFN in lsNoExtFN:
            ...
            for sTail in ['_R', '_Q']:
                ...
                iProcessCnt += 1
            PrintAndSleep(5, f'_ProcessTaskResult.sNoExtFN={sNoExtFN}=Wait5s')
    ...
    def LoopFileIoDumpDeal(self, iSleepSeconds):
        ...
        while True:
            ...
            PrintAndSleep(iSleepSecs, f'LoopFileIoDumpDeal.iLoopCnt={iLoopCnt}=iProcessCnt={iProcessCnt},iDumpCnt={iDumpCnt}=')
            iLoopCnt += 1
