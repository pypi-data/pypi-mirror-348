class SendTransshipmentDemurrageFeesResponse:
    """
    This API is used to acknowledge the response from Fasah to the Bonded Area system.
    """
    ...
    def from_dictionary(cls, dictionary: dict):
        ...
        :return: An instance of SendTransshipmentDemurrageFeesResponse or None if the dictionary is invalid.
        """
