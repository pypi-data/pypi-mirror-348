...
class nl:
    @overload
    def sum(self, op1: Union[Iterable[NlExpr], Mapping[_T, NlExpr]]) -> NlExpr: ...
    @overload
    def sum(self, op1: _NlExprLike, op2: _NlExprLike, op3: _NlExprLike) -> NlExpr: ...
    @overload
    def sum(
        self, op1: _NlExprLike, op2: _NlExprLike, op3: _NlExprLike, op4: _NlExprLike
    ) -> NlExpr: ...
    def atan2(self, y: _NlExprLike, x: _NlExprLike) -> NlExpr: ...
    def pow(self, base: _NlExprLike, expo: _NlExprLike) -> NlExpr: ...
    def sqrt(self, expr: _NlExprLike) -> NlExpr: ...
    def exp(self, expr: _NlExprLike) -> NlExpr: ...
    def log(self, expr: _NlExprLike) -> NlExpr: ...
    def log10(self, expr: _NlExprLike) -> NlExpr: ...
    def neg(self, expr: _NlExprLike) -> NlExpr: ...
    def abs(self, expr: _NlExprLike) -> NlExpr: ...
    def floor(self, expr: _NlExprLike) -> NlExpr: ...
    def ceil(self, expr: _NlExprLike) -> NlExpr: ...
    def cos(self, expr: _NlExprLike) -> NlExpr: ...
    def sin(self, expr: _NlExprLike) -> NlExpr: ...
    def tan(self, expr: _NlExprLike) -> NlExpr: ...
    def cosh(self, expr: _NlExprLike) -> NlExpr: ...
    def sinh(self, expr: _NlExprLike) -> NlExpr: ...
    def tanh(self, expr: _NlExprLike) -> NlExpr: ...
    def acos(self, expr: _NlExprLike) -> NlExpr: ...
    def asin(self, expr: _NlExprLike) -> NlExpr: ...
    def atan(self, expr: _NlExprLike) -> NlExpr: ...
    def acosh(self, expr: _NlExprLike) -> NlExpr: ...
    def asinh(self, expr: _NlExprLike) -> NlExpr: ...
    def atanh(self, expr: _NlExprLike) -> NlExpr: ...
