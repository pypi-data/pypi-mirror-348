"use strict";
(self["webpackChunk_jovyanai_labextension"] = self["webpackChunk_jovyanai_labextension"] || []).push([["vendors-node_modules_codemirror_merge_dist_index_js"],{
...
/* harmony export */   acceptChunk: () => (/* binding */ acceptChunk),
/* harmony export */   diff: () => (/* binding */ diff),
/* harmony export */   getChunks: () => (/* binding */ getChunks),
/* harmony export */   getOriginalDoc: () => (/* binding */ getOriginalDoc),
/* harmony export */   goToNextChunk: () => (/* binding */ goToNextChunk),
/* harmony export */   goToPreviousChunk: () => (/* binding */ goToPreviousChunk),
/* harmony export */   originalDocChangeEffect: () => (/* binding */ originalDocChangeEffect),
/* harmony export */   presentableDiff: () => (/* binding */ presentableDiff),
/* harmony export */   rejectChunk: () => (/* binding */ rejectChunk),
/* harmony export */   uncollapseUnchanged: () => (/* binding */ uncollapseUnchanged),
/* harmony export */   unifiedMergeView: () => (/* binding */ unifiedMergeView),
/* harmony export */   updateOriginalDoc: () => (/* binding */ updateOriginalDoc)
/* harmony export */ });
...
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @codemirror/language */ "webpack/sharing/consume/default/@codemirror/language");
...
/* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @lezer/highlight */ "webpack/sharing/consume/default/@lezer/highlight");
/* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_lezer_highlight__WEBPACK_IMPORTED_MODULE_4__);
...
const mergeConfig = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define({
    combine: values => values[0]
});
const setChunks = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.define();
const ChunkField = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    create(state) {
        return null;
    },
    update(current, tr) {
...
let moveByChunk = (dir) => ({ state, dispatch }) => {
    ...
    dispatch(state.update({
        ...
        effects: _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.scrollIntoView(_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorSelection.range(to, from))
    }));
    return true;
};
/**
...
const decorateChunks = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.ViewPlugin.fromClass(class {
    constructor(view) {
...
const changeGutter = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.low(/*@__PURE__*/(0,_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.gutter)({
    class: "cm-changeGutter",
    markers: view => { var _a; return ((_a = view.plugin(decorateChunks)) === null || _a === void 0 ? void 0 : _a.gutter) || _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSet.empty; }
}));
...
const changedLine = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.line({ class: "cm-changedLine" });
const changedText = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.mark({ class: "cm-changedText" });
const inserted = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.mark({ tagName: "ins", class: "cm-insertedLine" });
const deleted = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.mark({ tagName: "del", class: "cm-deletedLine" });
const changedLineGutterMarker = /*@__PURE__*/new class extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.GutterMarker {
    constructor() {
        super(...arguments);
...
function getChunkDeco(view) {
    ...
    let gutterBuilder = markGutter ? new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSetBuilder() : null;
...
class Spacer extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.WidgetType {
    constructor(height) {
        super();
        this.height = height;
    }
...
const adjustSpacers = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.define({
    map: (value, mapping) => value.map(mapping)
});
const Spacers = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    create: () => _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.none,
    update: (spacers, tr) => {
        for (let e of tr.effects)
...
function updateSpacers(a, b, chunks) {
    let buildA = new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSetBuilder(), buildB = new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSetBuilder();
    ...
    for (let chunkI = 0;; chunkI++) {
        ...
        if (posA < endA) {
            ...
            if (diff < -epsilon) {
                offA -= diff;
                buildA.add(posA, posA, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({
                ...
                offB += diff;
                buildB.add(posB, posB, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({
                    widget: new Spacer(diff),
                    block: true,
                    side: -1
                }));
    ...
    if (docDiff < epsilon) {
        buildA.add(a.state.doc.length, a.state.doc.length, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({
        ...
        buildB.add(b.state.doc.length, b.state.doc.length, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({
            widget: new Spacer(docDiff),
            block: true,
            side: 1
        }));
...
*/
const uncollapseUnchanged = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.define({
    map: (value, change) => change.mapPos(value)
});
class CollapseWidget extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.WidgetType {
    constructor(lines) {
        super();
        this.lines = lines;
    }
...
const CollapsedRanges = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    create(state) { return _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.none; },
    update(deco, tr) {
...
function buildCollapsedRanges(state, margin, minLines) {
    ...
    for (let i = 0;; i++) {
        ...
        if (lines >= minLines) {
            builder.add(state.doc.line(collapseFrom).from, state.doc.line(collapseTo).to, _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.replace({
...
const externalTheme = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.styleModule.of(/*@__PURE__*/new style_mod__WEBPACK_IMPORTED_MODULE_2__.StyleModule({
    ".cm-mergeView": {
        overflowY: "auto",
    },
    ".cm-mergeViewEditors": {
...
const collapseCompartment = /*@__PURE__*/new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Compartment, configCompartment = /*@__PURE__*/new _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Compartment;
/**
    ...
    */
    constructor(config) {
        ...
        let sharedExtensions = [
            _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.low(decorateChunks),
            baseTheme,
            externalTheme,
            Spacers,
            _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.updateListener.of(update => {
        ...
        let stateA = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.create({
            doc: config.a.doc,
            selection: config.a.selection,
            extensions: [
                config.a.extensions || [],
                _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.editorAttributes.of({ class: "cm-merge-a" }),
        ...
        let stateB = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.create({
            doc: config.b.doc,
            selection: config.b.selection,
            extensions: [
                config.b.extensions || [],
                _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.editorAttributes.of({ class: "cm-merge-b" }),
        ...
        stateA = stateA.update({ effects: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.appendConfig.of(add) }).state;
        stateB = stateB.update({ effects: _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.appendConfig.of(add) }).state;
        ...
        this.a = new _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView({
            state: stateA,
            parent: wrapA,
            root: config.root,
            dispatchTransactions: trs => this.dispatch(trs, this.a)
        });
        this.b = new _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView({
            state: stateB,
            parent: wrapB,
            root: config.root,
    ...
    dispatch(trs, target) {
        if (trs.some(tr => tr.docChanged)) {
            ...
            let changes = trs.reduce((chs, tr) => chs.compose(tr.changes), _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.ChangeSet.empty(trs[0].startState.doc.length));
...
const deletedChunkGutterMarker = /*@__PURE__*/new class extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.GutterMarker {
    constructor() {
        super(...arguments);
        this.elementClass = "cm-deletedLineGutter";
    }
};
const unifiedChangeGutter = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Prec.low(/*@__PURE__*/(0,_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.gutter)({
    class: "cm-changeGutter",
    markers: view => { var _a; return ((_a = view.plugin(decorateChunks)) === null || _a === void 0 ? void 0 : _a.gutter) || _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.RangeSet.empty; },
...
function unifiedMergeView(config) {
    let orig = typeof config.original == "string" ? _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Text.of(config.original.split(/\r?\n/)) : config.original;
    ...
    return [
        ...
        baseTheme,
        _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.EditorView.editorAttributes.of({ class: "cm-merge-b" }),
        _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.transactionExtender.of(tr => {
...
unified merge view.
*/
const updateOriginalDoc = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.define();
/**
...
const originalDoc = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    create: () => _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.Text.empty,
    update(doc, tr) {
        for (let e of tr.effects)
...
class DeletionWidget extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.WidgetType {
...
function deletionWidget(state, chunk, hideContent) {
    ...
    let buildDOM = (view) => {
        ...
        let lang = syntaxHighlightDeletions && state.facet(_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.language);
        let line = makeLine();
        ...
        if (lang && chunk.toA - chunk.fromA <= syntaxHighlightDeletionsMaxLength) {
            ...
            (0,_lezer_highlight__WEBPACK_IMPORTED_MODULE_4__.highlightTree)(tree, { style: tags => (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.highlightingFor)(state, tags) }, (from, to, cls) => {
                if (from > pos)
                    add(pos, from, "");
                add(from, to, cls);
                pos = to;
    ...
    let deco = _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({
        block: true,
        side: -1,
...
function acceptChunk(view, pos) {
    ...
    let changes = _codemirror_state__WEBPACK_IMPORTED_MODULE_1__.ChangeSet.of({ from: chunk.fromA, to: Math.min(orig.length, chunk.toA), insert }, orig.length);
    view.dispatch({
...
const deletedChunks = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    ...
    abort: if (linesA == linesB && linesA < 10) {
        ...
        for (let ch of chunk.changes) {
            if (ch.fromA < ch.toA) {
                ...
                if (/\n/.test(deleted))
                    break abort;
                deco.push(_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.widget({ widget: new InlineDeletion(deleted), side: -1 }).range(bB + ch.fromB));
            }
            if (ch.fromB < ch.toB) {
...
class InlineDeletion extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.WidgetType {
    constructor(text) {
        super();
        this.text = text;
    }
...
const inlineChangedLineGutterMarker = /*@__PURE__*/new class extends _codemirror_view__WEBPACK_IMPORTED_MODULE_0__.GutterMarker {
    constructor() {
        super(...arguments);
        this.elementClass = "cm-inlineChangedLineGutter";
    }
};
const inlineChangedLine = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.line({ class: "cm-inlineChangedLine" });
...
//# sourceMappingURL=vendors-node_modules_codemirror_merge_dist_index_js.9ec98206895d277e08dd.js.map