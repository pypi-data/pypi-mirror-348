...
class StrucGAP_Preprocess:
    def __init__(self, data_manager, data_dir=None, sample_group_data_dir=None, data_sheet_name=None, branch_list_dir=None):
        if data_dir == None:
        ...
        # data['PeptideSequence+structure_coding+ProteinID'] = data['PeptideSequence'] + '+' + data['structure_coding'] + '+' + data['ProteinID']
        
        # if branch_list_dir == None:
        #     branch_list_dir = input(f"Please enter your branch list data file path (such as: 'D:\doctor\wyq\branch_structures_18_mice uterus.0240401.xlsx'): ")
