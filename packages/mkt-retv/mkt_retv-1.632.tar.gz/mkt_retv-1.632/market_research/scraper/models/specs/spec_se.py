...
class ModelScraperPW(Scraper):
    def __init__(self, export_prefix="sse_model_info_web", intput_folder_path="input", output_folder_path="results",
                 wait_time=1.0, verbose=False):
        Scraper.__init__(self, True, export_prefix, intput_folder_path, output_folder_path)
        self.wait_time = wait_time
        self.verbose = verbose
