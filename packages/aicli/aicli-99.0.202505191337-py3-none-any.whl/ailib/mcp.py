...
@mcp.tool()
def info_validation(cluster: str, _all: bool = False, url: str = "https://api.openshift.com", token: str = None,
                    offlinetoken: str = None, debug: bool = False, ca: str = None, cert: str = None,
                    key: str = None) -> list:
    ...
    for validation in validations:
        for entry in validations[validation]:
            _id = entry['id']
            status = entry['status']
            if not _all and status == 'success':
                continue
...
@mcp.tool()
def list_cluster(subscription: str = None, org: str = None, url: str = "https://api.openshift.com", token: str = None,
                 offlinetoken: str = None, debug: bool = False, ca: str = None, cert: str = None,
                 key: str = None) -> list:
    """List cluster"""
...
@mcp.tool()
def list_infra_env(url: str = "https://api.openshift.com", token: str = None,
                   offlinetoken: str = None, debug: bool = False, ca: str = None, cert: str = None,
                   key: str = None) -> list:
    """List infraenvs"""
    ai = AssistedClient(url, token=token, offlinetoken=offlinetoken, debug=debug, ca=ca, cert=cert, key=key)
