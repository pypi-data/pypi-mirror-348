...
class UpgradeFtdDevicesInput(BaseModel):
    ...
    """ # noqa: E501
    device_uids: Annotated[List[StrictStr], Field(min_length=1, max_length=50)] = Field(description="The list of unique identifiers, represented as UUIDs, of the devices to upgrade in Security Cloud Control. All of the devices in the list have to be compatible with the upgrade package.", alias="deviceUids")
