...
from ..models.create_building_dto_cooling_system_type_0 import (
    CreateBuildingDTOCoolingSystemType0,
    check_create_building_dto_cooling_system_type_0,
)
from ..models.create_building_dto_heating_system_type_0 import (
    CreateBuildingDTOHeatingSystemType0,
    check_create_building_dto_heating_system_type_0,
)
from ..models.create_building_dto_occupancy_type_type_0 import (
    CreateBuildingDTOOccupancyTypeType0,
    check_create_building_dto_occupancy_type_type_0,
)
...
T = TypeVar("T", bound="CreateBuildingDTO")
...
class CreateBuildingDTO:
    ...
    Attributes:
        area (float): Area of the building
            ...
            **Unit:** square feet
        heating_system (Union[CreateBuildingDTOHeatingSystemType0, None]): Heating system used in the building.
        ...
        cooling_system (Union[CreateBuildingDTOCoolingSystemType0, None]): Cooling system used in the building.
        ...
        occupancy_type (Union[CreateBuildingDTOOccupancyTypeType0, None]):
    ...
    area: float
    heating_system: CreateBuildingDTOHeatingSystemType0 | None
    cooling_system: CreateBuildingDTOCoolingSystemType0 | None
    measured_utilities: "InputUtilityMeters"
    occupancy_type: CreateBuildingDTOOccupancyTypeType0 | None
    location: Union["CreateBuildingVersionAddressDTO", "LocationCoordinates"]
    name: str
    notes: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_heating_system(data: object) -> CreateBuildingDTOHeatingSystemType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                heating_system_type_0 = check_create_building_dto_heating_system_type_0(data)

                return heating_system_type_0
            except:  # noqa: E722
                pass
            return cast(CreateBuildingDTOHeatingSystemType0 | None, data)

        heating_system = _parse_heating_system(d.pop("heating_system"))

        def _parse_cooling_system(data: object) -> CreateBuildingDTOCoolingSystemType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                cooling_system_type_0 = check_create_building_dto_cooling_system_type_0(data)

                return cooling_system_type_0
            except:  # noqa: E722
                pass
            return cast(CreateBuildingDTOCoolingSystemType0 | None, data)
        ...
        def _parse_occupancy_type(data: object) -> CreateBuildingDTOOccupancyTypeType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                occupancy_type_type_0 = check_create_building_dto_occupancy_type_type_0(data)

                return occupancy_type_type_0
            except:  # noqa: E722
                pass
            return cast(CreateBuildingDTOOccupancyTypeType0 | None, data)
        ...
        create_building_dto.additional_properties = d
