...
from ..models.user_settings_display_unit import UserSettingsDisplayUnit, check_user_settings_display_unit
...
class UserSettings:
    ...
    These attributes don't affect anything else within other API endpoints, such as returned unit types, etc.
        ...
        Attributes:
            display_unit (UserSettingsDisplayUnit): Preferred display unit.
    ...
    display_unit: UserSettingsDisplayUnit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        display_unit = check_user_settings_display_unit(d.pop("display_unit"))
