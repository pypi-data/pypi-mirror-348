...
T = TypeVar("T", bound="EmissionsIntensities")


@_attrs_define
class EmissionsIntensities:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        emissions_intensities.additional_properties = d
        return emissions_intensities
