...
T = TypeVar("T", bound="CarbonResultStatistic")


@_attrs_define
class CarbonResultStatistic:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        carbon_result_statistic.additional_properties = d
        return carbon_result_statistic
