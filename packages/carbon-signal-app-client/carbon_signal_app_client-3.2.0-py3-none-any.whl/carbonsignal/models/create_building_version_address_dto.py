...
T = TypeVar("T", bound="CreateBuildingVersionAddressDTO")


@_attrs_define
class CreateBuildingVersionAddressDTO:
    """BuildingVersionAddress.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_building_version_address_dto = cls(
            type_=type_,
            address=address,
            city=city,
            state=state,
        ...
        create_building_version_address_dto.additional_properties = d
        return create_building_version_address_dto
