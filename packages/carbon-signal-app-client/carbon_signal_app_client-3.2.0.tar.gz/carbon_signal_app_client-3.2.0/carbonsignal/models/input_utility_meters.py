...
T = TypeVar("T", bound="InputUtilityMeters")


@_attrs_define
class InputUtilityMeters:
    """Ensures that at least one utility meter has some values.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        input_utility_meters.additional_properties = d
        return input_utility_meters
