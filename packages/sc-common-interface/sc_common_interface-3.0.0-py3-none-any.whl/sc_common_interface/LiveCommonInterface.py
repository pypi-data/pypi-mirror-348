...
def send__live_comment(data):
    ...
    if platform.upper() == "INSTAGRAM":
        ...
        if "comment_type"=="comment":
            ...
            body = {"entry": [{"id": page_id, "time": stamp, "changes": [{"value": {"from": {"id": user_id, "name": name}, "post_id": post_id, "created_time": stamp, "item": "reaction", "parent_id": post_id, "reaction_type": "like", "verb": "add"}, "field": "feed"}]}], "object": "page"}
...
def send_comment():
    ...
    contentbody = {"entry": [{"id": page_id, "time": timStamp, "changes": [{"value": {
        ...
        "comment_id": "%s_350%d%d" % (page_id, int(time.time() * 1000),random.randint(4, 1000)), "created_time": timStamp, "item": "comment",
...
if __name__=="__main__":
    # data = {"env":"https://front-service.shoplinestg.com","sales_id":"91371","headers":{"cookie":"viewerLogin_6229a7baea70642a8b65ebda=6998469593053840441"}}
    # res = send_sl_comment(data)
    # print(res)
    pass
