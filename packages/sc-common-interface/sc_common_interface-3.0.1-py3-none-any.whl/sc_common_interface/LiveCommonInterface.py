...
if __name__ == "__main__":
    data = {'headers': {
        ...
        'lang': 'en', 'Content-Type': 'application/json', 'user-agent': 'ShoplineQuality/1.5-python'},
            'activity_id': 10321186, 'env': 'https://front-admin-preview.shoplineapp.com',
            'body': {'businessSource': 'POST', 'duration': 600, 'lotteryMethod': 'ACTIVITY_END',
                     'activityTitle': '接口创建留言抢优惠1747559554', 'businessId': 563929, 'activityType': 'LUCKY_DRAW',
                     'totalWinner': 4,
                     'message': {'winMessage': 'winMessage，联系客服领奖！', 'activityEndComment': '{title}活動結束 ,謝謝大家的熱情參與！',
                                 'winComment': '恭喜 {winner} 中獎，請於直播後與小編聯繫！',
                                 'activityStartComment': '{title} 活動開始 商家截止前留言關鍵字「{keyword}」即可參加抽獎'},
                     'activityInfo': {'tagFriendsNum': 1, 'taskTypes': ['LIKED_POST'],
                                      'keyword': '接口自动化新增关键字1747559554202'}}, 'sales_id': 563929,
            'keyword': '接口自动化新增关键字1747559554202', 'key': '5e3bba98882fc0fb22a0607238bc5b8f'}
    data["keyword"] = "fsfsf"
    data["platform"] = "facebook"
    user_id, name, __ = send__live_comment(data)
