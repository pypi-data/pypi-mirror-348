...
class TColumnType(object):
    ...
    def __init__(self, col_name=None, col_type=None, is_reserved_keyword=None, src_name=None, is_system=None, is_physical=None, col_id=None, default_value=None, comment=None,):
...
class TCopyParams(object):
    ...
    def __init__(self, delimiter=None, null_str=None, has_header=    0, quoted=None, quote=None, escape=None, line_delim=None, array_delim=None, array_begin=None, array_end=None, threads=None, source_type=    0, s3_access_key=None, s3_secret_key=None, s3_region=None, geo_coords_encoding=    6, geo_coords_comp_param=32, geo_coords_type=    18, geo_coords_srid=4326, sanitize_column_names=True, geo_layer_name=None, s3_endpoint=None, geo_assign_render_groups=False, geo_explode_collections=False, source_srid=0, s3_session_token=None, raster_point_type=    1, raster_import_bands=None, raster_scanlines_per_thread=None, raster_point_transform=    1, raster_point_compute_angle=False, raster_import_dimensions=None, odbc_dsn=None, odbc_connection_string=None, odbc_sql_select=None, odbc_sql_order_by=None, odbc_username=None, odbc_password=None, odbc_credential_string=None, add_metadata_columns=None, trim_spaces=True, geo_validate_geometry=False, raster_drop_if_all_null=False,):
        ...
        self.raster_drop_if_all_null = raster_drop_if_all_null
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.raster_drop_if_all_null = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.geo_validate_geometry is not None:
            ...
            oprot.writeFieldEnd()
        if self.raster_drop_if_all_null is not None:
            oprot.writeFieldBegin('raster_drop_if_all_null', TType.BOOL, 43)
            oprot.writeBool(self.raster_drop_if_all_null)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TTableDetails(object):
    ...
    def __init__(self, row_desc=None, fragment_size=None, page_size=None, max_rows=None, view_sql=None, shard_count=None, key_metainfo=None, is_temporary=None, partition_detail=None, table_type=None, refresh_info=None, sharded_column_name=None, comment=None,):
        self.row_desc = row_desc
    ...
    def write(self, oprot):
        ...
        if self.sharded_column_name is not None:
            ...
            oprot.writeFieldEnd()
        if self.comment is not None:
            oprot.writeFieldBegin('comment', TType.STRING, 13)
            oprot.writeString(self.comment.encode('utf-8') if sys.version_info[0] == 2 else self.comment)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TCopyParams.thrift_spec = (
    ...
    (43, TType.BOOL, 'raster_drop_if_all_null', None, False, ),  # 43
)
...
TTableDetails.thrift_spec = (
    ...
    (13, TType.STRING, 'comment', 'UTF8', None, ),  # 13
)
