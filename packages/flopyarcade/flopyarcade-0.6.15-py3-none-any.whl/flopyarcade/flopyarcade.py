...
class FloPyEnv(gym.Env):
    ...
    #     #     self.success = True
    #     # except Exception:
    #     #     _ = self.bmi_return(self.success, self.model_ws, self.MODELNAME)
    ...
    def _handle_0sc_environment(self, action, reward, info, teardownOnFinish):
        ...
        # print('DEBUG self.timeStep', self.timeStep)
    ...
    def _prepare_time_step(self):
        ...
        """
        print('DEBUG dt', self.dt, self.current_time)
        self.mf6.prepare_time_step(self.current_time)
