...
parameters = {
    ...
    "Anion transference number in SEI": 1 - 0.063,  # t_plus is known as 0.063
    "SEI porosity": 0.1,
...
parameters["Negative electrode exchange-current density [A.m-2]"] = 1
parameters["Positive electrode exchange-current density [A.m-2]"] = (
    lambda cₑ, cₚ, cₚ_max, T: (
        6e-7 * cₑ ** αₙₚ * cₚ ** αₚₚ * (cₚ_max - cₚ) ** αₙₚ
    )
)
parameters["Positive electrode exchange-current density [A.m-2]"] = 1
