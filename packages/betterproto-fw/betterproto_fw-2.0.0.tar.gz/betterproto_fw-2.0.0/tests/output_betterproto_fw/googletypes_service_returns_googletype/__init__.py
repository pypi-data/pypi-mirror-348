...
class TestStub(betterproto_fw.ServiceStub):
    ...
    async def get_struct(
        ...
        *,
        ...
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
    ) -> "betterproto_fw_lib_google_protobuf.Struct":
        """ """
    ...
    async def get_list_value(
        ...
        *,
        ...
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
    ) -> "betterproto_fw_lib_google_protobuf.ListValue":
        """ """
    ...
    async def get_value(
        ...
        *,
        ...
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
    ) -> "betterproto_fw_lib_google_protobuf.Value":
        """ """
...
class TestBase(ServiceBase):
    ...
    async def __rpc_get_empty(
        self,
        stream: "grpclib.server.Stream[RequestMessage, betterproto_fw_lib_google_protobuf.Empty]",
    ) -> None:
    ...
    async def __rpc_get_struct(
        self,
        stream: "grpclib.server.Stream[RequestMessage, betterproto_fw_lib_google_protobuf.Struct]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_list_value(
        self,
        stream: "grpclib.server.Stream[RequestMessage, betterproto_fw_lib_google_protobuf.ListValue]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_value(
        self,
        stream: "grpclib.server.Stream[RequestMessage, betterproto_fw_lib_google_protobuf.Value]",
    ) -> None:
        request = await stream.recv_message()
