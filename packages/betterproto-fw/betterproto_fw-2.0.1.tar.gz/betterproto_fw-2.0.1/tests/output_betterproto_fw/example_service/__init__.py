...
class ExampleRequest(betterproto_fw.Message):
    """ """

    example_string: str = betterproto_fw.string_field(1)
    """
    
    """

    example_integer: int = betterproto_fw.int64_field(2)
    """
...
@dataclass(eq=False, repr=False)
class ExampleResponse(betterproto_fw.Message):
    """ """
