...
class RootPackageMessage(betterproto.Message):
    """ """
...
class Test(betterproto.Message):
    ...
    message: "RootPackageMessage" = betterproto.message_field(1)
    """
    
    """

    other_value: "other.OtherPackageMessage" = betterproto.message_field(2)
    """
