...
from pinaxai.aws.context import AwsBuildContext
...
if TYPE_CHECKING:
    ...
    from pinaxai.aws.resource.ecs.container import EcsContainer
...
class AwsApp(InfraApp):
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from pinaxai.aws.resource.ec2.security_group import InboundRule, SecurityGroup
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from pinaxai.aws.resource.ecs.service import EcsService
        from pinaxai.aws.resource.ecs.task_definition import EcsTaskDefinition
        from pinaxai.aws.resource.ecs.volume import EcsVolume
        from pinaxai.aws.resource.elb.listener import Listener
        from pinaxai.aws.resource.elb.load_balancer import LoadBalancer
        from pinaxai.aws.resource.elb.target_group import TargetGroup
