...
def predict(dataroot='./dataset/test', netG='unet_128', name='portpy_test_2', phase='test', model='test', input_nc=8, output_nc=1,
            direction='AtoB', dataset_mode='single', norm='batch', results_dir='./results/'):
