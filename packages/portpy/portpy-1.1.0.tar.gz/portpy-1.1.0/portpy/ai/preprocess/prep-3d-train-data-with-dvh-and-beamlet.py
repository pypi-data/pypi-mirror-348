...
# out_dir = r'\\pisidsmph\NadeemLab\Gourav\datasets\msk-echo-3d-dvh-beamlet-sparse-separate-ptv\test'
out_dir = r'\\pisidsmph\NadeemLab\Gourav\datasets\anonymous\test'
