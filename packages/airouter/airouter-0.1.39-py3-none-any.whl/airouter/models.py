...
class LLM(str, Enum):
  ...
  ANTROPHIC_CLAUDE_V35_SONNET_V2 = "anthropic.claude-3-5-sonnet-20241022-v2:0"
...
if True:
  ...
  map_provider_to_llms = {
    ...
    ProviderName.AWS_BEDROCK_CHAT: [
      ...
      LLM.ANTROPHIC_CLAUDE_V35_SONNET_V2,
    ],
  ...
  map_context_size = {
    ...
    LLM.GPT_4_1: 1_000_000,
    LLM.GPT_4_1_MINI: 1_000_000,
    ...
    LLM.ANTROPHIC_CLAUDE_V35_SONNET_V2: 200_000,
  ...
  map_output_size = {
    ...
    LLM.ANTROPHIC_CLAUDE_V35_SONNET_V2: 8_192,
  }
