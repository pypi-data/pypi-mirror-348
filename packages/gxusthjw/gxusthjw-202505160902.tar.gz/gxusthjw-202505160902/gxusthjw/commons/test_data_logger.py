...
class TestDataLogger(unittest.TestCase):
    ...
    def test_init_OwnerNone_NameNone(self):
        logger = DataLogger()
        self.assertIs(logger._DataLogger__owner, logger)
        self.assertEqual(logger._DataLogger__name, "DataLogger_DataLogger")
    ...
    def test_init_OwnerProvided_NameNone(self):
        ...
        owner = DummyOwner()
        logger = DataLogger(owner=owner)
        self.assertIs(logger._DataLogger__owner, owner)
        self.assertEqual(logger._DataLogger__name, "DummyOwner_DataLogger")
        self.assertTrue(isinstance(logger._DataTable__df, pd.DataFrame))
        self.assertTrue("DataLoggerName" in logger._DataTable__df.columns)
    ...
    def test_init_OwnerNone_NameProvided(self):
        logger = DataLogger(name="CustomLogger")
        self.assertIs(logger._DataLogger__owner, logger)
        self.assertEqual(logger._DataLogger__name, "CustomLogger")
        self.assertTrue(isinstance(logger._DataTable__df, pd.DataFrame))
        self.assertTrue("DataLoggerName" in logger._DataTable__df.columns)
    ...
    def test_init_OwnerProvided_NameProvided(self):
        ...
        owner = DummyOwner()
        logger = DataLogger(owner=owner, name="CustomLogger")
        self.assertIs(logger._DataLogger__owner, owner)
        self.assertEqual(logger._DataLogger__name, "CustomLogger")
        self.assertTrue(isinstance(logger._DataTable__df, pd.DataFrame))
        self.assertTrue("DataLoggerName" in logger._DataTable__df.columns)
