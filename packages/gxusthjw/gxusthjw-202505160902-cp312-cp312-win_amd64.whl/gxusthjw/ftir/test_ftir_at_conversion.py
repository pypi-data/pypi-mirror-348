...
#       Jiwei Huang        0.0.1         2025/04/03     revise
# ------------------------------------------------------------------
# 导包 =============================================================
import unittest
import os
...
from ..commons import read_txt, reverse
from .ftir_at_conversion import (transmittance_to_absorbance,
...
class TestFtirAtConversion(unittest.TestCase):
    ...
    def test_at_convert(self):
        ...
        omnic_absorbance_file0 = os.path.join(this_path,
                                              "{}/{}".format(test_file_folder,
                                                             omnic_absorbance_file_name0))
        omnic_absorbance_file1 = os.path.join(this_path,
                                              "{}/{}".format(test_file_folder,
                                                             omnic_absorbance_file_name1))
        raw_x, raw_y = read_txt(raw_file, sep=',', skiprows=2, res_type='list_numpy')
        omnic_absorbance0_x, omnic_absorbance0_y = read_txt(omnic_absorbance_file0, sep=',',
                                                            res_type='list_numpy')
        omnic_absorbance1_x, omnic_absorbance1_y = read_txt(omnic_absorbance_file1, sep=',',
                                                            res_type='list_numpy')

        absorbance_y = transmittance_to_absorbance(raw_y)
        absorbance_y2 = transmittance_to_absorbance2(raw_y)

        data_dict = {"omnic": reverse(omnic_absorbance1_y),
                     "absorbance_y": absorbance_y,
                     "absorbance_y2": absorbance_y2}
