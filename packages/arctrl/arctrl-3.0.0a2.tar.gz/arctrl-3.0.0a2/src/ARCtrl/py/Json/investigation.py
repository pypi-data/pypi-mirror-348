...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3167(__unit: None=None, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3169(value_1: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3171(value_3: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3173(value_5: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3175(value_7: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3176(osr: OntologySourceReference, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow3177(oa: Publication, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow3178(person: Person, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow3179(assay: ArcAssay, inv: Any=inv) -> IEncodable:
        return encoder_4(assay)

    def _arrow3180(study: ArcStudy, inv: Any=inv) -> IEncodable:
        return encoder_5(study)

    def _arrow3182(value_9: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3183(comment: Comment, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3167()), try_include("Title", _arrow3169, inv.Title), try_include("Description", _arrow3171, inv.Description), try_include("SubmissionDate", _arrow3173, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow3175, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow3176, inv.OntologySourceReferences), try_include_seq("Publications", _arrow3177, inv.Publications), try_include_seq("Contacts", _arrow3178, inv.Contacts), try_include_seq("Assays", _arrow3179, inv.Assays), try_include_seq("Studies", _arrow3180, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow3182, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow3183, inv.Comments)]))
...
def _arrow3198(get: IGetters) -> ArcInvestigation:
    ...
    def _arrow3191(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    return ArcInvestigation(_arrow3186(), _arrow3187(), _arrow3188(), _arrow3189(), _arrow3190(), _arrow3191(), _arrow3192(), _arrow3193(), _arrow3194(), _arrow3195(), None, None, _arrow3196(), _arrow3197())


decoder: Decoder_1[ArcInvestigation] = object(_arrow3198)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3202(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        value: str = inv.Identifier
    ...
    def _arrow3204(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3206(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3208(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3210(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3211(osr: OntologySourceReference, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow3212(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow3213(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow3214(assay: ArcAssay, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, assay)

    def _arrow3215(study: ArcStudy, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, study)

    def _arrow3217(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3218(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3202()), try_include("Title", _arrow3204, inv.Title), try_include("Description", _arrow3206, inv.Description), try_include("SubmissionDate", _arrow3208, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow3210, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow3211, inv.OntologySourceReferences), try_include_seq("Publications", _arrow3212, inv.Publications), try_include_seq("Contacts", _arrow3213, inv.Contacts), try_include_seq("Assays", _arrow3214, inv.Assays), try_include_seq("Studies", _arrow3215, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow3217, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow3218, inv.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow3232(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        def _arrow3220(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow3228(__unit: None=None) -> Array[ArcAssay] | None:
            arg_17: Decoder_1[Array[ArcAssay]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Assays", arg_17)

        def _arrow3229(__unit: None=None) -> Array[ArcStudy] | None:
            arg_19: Decoder_1[Array[ArcStudy]] = resize_array(decoder_compressed_2(string_table, oa_table, cell_table))
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Studies", arg_19)

        def _arrow3230(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredStudyIdentifiers", arg_21)

        def _arrow3231(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_8)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcInvestigation(_arrow3220(), _arrow3221(), _arrow3222(), _arrow3223(), _arrow3224(), _arrow3225(), _arrow3226(), _arrow3227(), _arrow3228(), _arrow3229(), None, None, _arrow3230(), _arrow3231())

    return object(_arrow3232)
...
def ROCrate_encoder(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3236(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3240(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3242(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3244(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3246(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3248(value_9: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3251(__unit: None=None, oa: Any=oa) -> IEncodable:
        def _arrow3249(__unit: None=None) -> str:
            copy_of_struct: Any = today()
            return to_string(copy_of_struct, "yyyy-MM-dd")

        value_12: str = default_arg(oa.PublicReleaseDate, _arrow3249())
    ...
    def _arrow3252(osr: OntologySourceReference, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(osr)

    def _arrow3253(oa_1: Publication, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(oa_1)

    def _arrow3254(oa_2: Person, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(oa_2)

    def _arrow3255(s: ArcStudy, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(None, s)

    def _arrow3256(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3236()), ("@type", ObjectExpr3237()), ("additionalType", ObjectExpr3238()), ("identifier", _arrow3240()), ("filename", _arrow3242()), try_include("title", _arrow3244, oa.Title), try_include("description", _arrow3246, oa.Description), try_include("submissionDate", _arrow3248, oa.SubmissionDate), ("publicReleaseDate", _arrow3251()), try_include_seq("ontologySourceReferences", _arrow3252, oa.OntologySourceReferences), try_include_seq("publications", _arrow3253, oa.Publications), try_include_seq("people", _arrow3254, oa.Contacts), try_include_seq("studies", _arrow3255, oa.Studies), try_include_seq("comments", _arrow3256, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3269(get: IGetters) -> ArcInvestigation:
    identifier: str
    ...
    def _arrow3258(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
    ...
    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow3258(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr3260:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3259(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr3260()))
    ...
    def _arrow3261(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow3265(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    def _arrow3266(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow3267(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow3268(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifier, _arrow3261(), _arrow3262(), _arrow3263(), _arrow3264(), _arrow3265(), _arrow3266(), _arrow3267(), assays, studies, None, None, study_identifiers, _arrow3268())


ROCrate_decoder: Decoder_1[ArcInvestigation] = object(_arrow3269)
...
def ROCrate_encodeRoCrate(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3273(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow3275(value_2: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr3274(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_2)

        return ObjectExpr3274()

    def _arrow3276(oa_1: ArcInvestigation, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow3273, "CreativeWork"), try_include("@id", _arrow3275, "ro-crate-metadata.json"), try_include("about", _arrow3276, oa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue_1)]))
    class ObjectExpr3277(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            def mapping_1(tupled_arg_1: tuple[str, IEncodable]) -> tuple[str, __A_]:
...
def ISAJson_encoder(id_map: Any | None, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3281(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        value: str = ROCrate_genID(inv)
        class ObjectExpr3280(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr3280()

    def _arrow3283(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3285(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3287(value_3: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        class ObjectExpr3286(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_3)

        return ObjectExpr3286()

    def _arrow3289(value_5: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3291(value_7: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3293(value_9: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3294(osr: OntologySourceReference, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_1(id_map, osr)

    def _arrow3295(oa: Publication, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_2(id_map, oa)

    def _arrow3296(person: Person, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_3(id_map, person)

    def _arrow3297(s: ArcStudy, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_4(id_map, None, s)

    def _arrow3298(comment: Comment, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_5(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3281()), ("filename", _arrow3283()), ("identifier", _arrow3285()), try_include("title", _arrow3287, inv.Title), try_include("description", _arrow3289, inv.Description), try_include("submissionDate", _arrow3291, inv.SubmissionDate), try_include("publicReleaseDate", _arrow3293, inv.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow3294, inv.OntologySourceReferences), try_include_seq("publications", _arrow3295, inv.Publications), try_include_seq("people", _arrow3296, inv.Contacts), try_include_seq("studies", _arrow3297, inv.Studies), try_include_seq("comments", _arrow3298, inv.Comments)]))
...
def _arrow3311(get: IGetters) -> ArcInvestigation:
    identifer: str
    match_value: str | None
    object_arg: IOptionalGetter = get.Optional
    match_value = object_arg.Field("identifier", string)
    identifer = create_missing_identifier() if (match_value is None) else match_value
    def _arrow3300(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
        arg_3: Decoder_1[FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]]] = list_1_1(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("studies", arg_3)

    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow3300(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr3302:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3301(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr3302()))
    studies: Array[ArcStudy] = list(studies_raw)
    def mapping(a_1: ArcStudy) -> str:
        return a_1.Identifier

    study_identifiers: Array[str] = list(map_1(mapping, studies_raw))
    def _arrow3303(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("title", string)
    ...
    def _arrow3307(__unit: None=None) -> Array[OntologySourceReference] | None:
        arg_13: Decoder_1[Array[OntologySourceReference]] = resize_array(ISAJson_decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("ontologySourceReferences", arg_13)

    def _arrow3308(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow3309(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ISAJson_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow3310(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifer, _arrow3303(), _arrow3304(), _arrow3305(), _arrow3306(), _arrow3307(), _arrow3308(), _arrow3309(), assays, studies, None, None, study_identifiers, _arrow3310())


ISAJson_decoder: Decoder_1[ArcInvestigation] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3311)
