...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    def _arrow2106(value_23: str, pv: Any=pv) -> IEncodable:
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2112(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2111(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2111(), unit)

    return object(_arrow2112)
