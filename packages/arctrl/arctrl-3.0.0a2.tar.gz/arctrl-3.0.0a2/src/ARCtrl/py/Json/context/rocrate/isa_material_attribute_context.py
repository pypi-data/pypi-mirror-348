...
def _arrow1701(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1695()), ("arc", ObjectExpr1696()), ("MaterialAttribute", ObjectExpr1697()), ("ArcMaterialAttribute", ObjectExpr1698()), ("characteristicType", ObjectExpr1699())])
