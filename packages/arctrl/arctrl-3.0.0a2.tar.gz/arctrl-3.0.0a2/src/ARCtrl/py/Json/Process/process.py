...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> IEncodable:
    ...
    def _arrow2677(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2680(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2681(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(study_name, assay_name, oa.Name, oa_1)

    def _arrow2682(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2684(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2685(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(value_6)

    def _arrow2686(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(value_7)

    def _arrow2687(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2677()), ("@type", list_1_1(singleton(ObjectExpr2678()))), try_include("name", _arrow2680, oa.Name), try_include("executesProtocol", _arrow2681, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ROCrate_encoder_2, oa.ParameterValues), try_include("performer", _arrow2682, oa.Performer), try_include("date", _arrow2684, oa.Date), try_include_list_opt("inputs", _arrow2685, oa.Inputs), try_include_list_opt("outputs", _arrow2686, oa.Outputs), try_include_list_opt("comments", _arrow2687, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2698(get: IGetters) -> Process:
    ...
    def _arrow2691(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2692(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    return Process(_arrow2689(), _arrow2690(), _arrow2691(), _arrow2692(), _arrow2693(), _arrow2694(), None, None, _arrow2695(), _arrow2696(), _arrow2697())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2698)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2702(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2704(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2705(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2706(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2708(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2710(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2711(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2712(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2713(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2714(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2715(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2702, ROCrate_genID(oa_1)), try_include("name", _arrow2704, oa_1.Name), try_include("executesProtocol", _arrow2705, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2706, oa_1.ParameterValues), try_include("performer", _arrow2708, oa_1.Performer), try_include("date", _arrow2710, oa_1.Date), try_include("previousProcess", _arrow2711, oa_1.PreviousProcess), try_include("nextProcess", _arrow2712, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2713, oa_1.Inputs), try_include_list_opt("outputs", _arrow2714, oa_1.Outputs), try_include_list_opt("comments", _arrow2715, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2717(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2717, f, oa, id_map)
...
def _arrow2730(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2729(get: IGetters) -> Process:
            def _arrow2718(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2719(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2720(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2721(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
