...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2551(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2552(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2546()), ("@type", list_1_1(singleton(ObjectExpr2547()))), ("additionalType", ObjectExpr2548()), try_include("name", _arrow2550, oa.Name), try_include("type", _arrow2551, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2552, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2560(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2559(get: IGetters) -> Material:
            ...
            def _arrow2554(__unit: None=None) -> str | None:
            ...
            def _arrow2556(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2557(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2558(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2554(), _arrow2555(), _arrow2556(), _arrow2557(), _arrow2558())

        return object(_arrow2559)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2560()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2564(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2566(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2567(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2568(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2564, ROCrate_genID(oa)), try_include("name", _arrow2566, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2567, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2568, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2570(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2570, f, c, id_map)
...
def _arrow2577(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2576(get: IGetters) -> Material:
            ...
            def _arrow2573(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2574(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2575(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2571(), _arrow2572(), _arrow2573(), _arrow2574(), _arrow2575())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2576)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2577()
