...
def _arrow1844(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1838()), ("bio", ObjectExpr1839()), ("Source", ObjectExpr1840()), ("name", ObjectExpr1841()), ("characteristics", ObjectExpr1842())])
