...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow3015(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow3017(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3019(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3021(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3023(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3024(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3025(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3026(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3027(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow3028(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow3030(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3031(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3015()), try_include("Title", _arrow3017, study.Title), try_include("Description", _arrow3019, study.Description), try_include("SubmissionDate", _arrow3021, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3023, study.PublicReleaseDate), try_include_seq("Publications", _arrow3024, study.Publications), try_include_seq("Contacts", _arrow3025, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3026, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3027, study.Tables), try_include("DataMap", _arrow3028, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3030, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3031, study.Comments)]))
...
def _arrow3045(get: IGetters) -> ArcStudy:
    def _arrow3033(__unit: None=None) -> str:
    ...
    return ArcStudy(_arrow3033(), _arrow3034(), _arrow3035(), _arrow3036(), _arrow3037(), _arrow3038(), _arrow3039(), _arrow3040(), _arrow3041(), _arrow3042(), _arrow3043(), _arrow3044())


decoder: Decoder_1[ArcStudy] = object(_arrow3045)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow3049(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow3051(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3053(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3055(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3057(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3058(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3059(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3060(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3061(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow3062(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow3064(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3065(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3049()), try_include("Title", _arrow3051, study.Title), try_include("Description", _arrow3053, study.Description), try_include("SubmissionDate", _arrow3055, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3057, study.PublicReleaseDate), try_include_seq("Publications", _arrow3058, study.Publications), try_include_seq("Contacts", _arrow3059, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3060, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3061, study.Tables), try_include("DataMap", _arrow3062, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3064, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3065, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow3081(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow3067(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow3068(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)
        ...
        def _arrow3073(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow3074(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow3075(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow3077(__unit: None=None) -> Array[ArcTable] | None:
        ...
        def _arrow3079(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)
        ...
        return ArcStudy(_arrow3067(), _arrow3068(), _arrow3070(), _arrow3071(), _arrow3072(), _arrow3073(), _arrow3074(), _arrow3075(), _arrow3077(), _arrow3078(), _arrow3079(), _arrow3080())

    return object(_arrow3081)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow3085(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3089(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3091(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3093(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3095(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3096(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow3098(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3100(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3101(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow3102(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow3104(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow3103(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow3103

    def _arrow3106(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow3105(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow3105

    def _arrow3107(oa_4: Data, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(oa_4)

    def _arrow3108(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3085()), ("@type", list_1_1(singleton(ObjectExpr3086()))), ("additionalType", ObjectExpr3087()), ("identifier", _arrow3089()), try_include("filename", _arrow3091, file_name), try_include("title", _arrow3093, s.Title), try_include("description", _arrow3095, s.Description), try_include_seq("studyDesignDescriptors", _arrow3096, s.StudyDesignDescriptors), try_include("submissionDate", _arrow3098, s.SubmissionDate), try_include("publicReleaseDate", _arrow3100, s.PublicReleaseDate), try_include_seq("publications", _arrow3101, s.Publications), try_include_seq("people", _arrow3102, s.Contacts), try_include_list("processSequence", _arrow3104(), processes), try_include_seq("assays", _arrow3106(), assays_1), try_include_list("dataFiles", _arrow3107, get_data(processes)), try_include_seq("comments", _arrow3108, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3120(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3110(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow3110()), create_missing_identifier())
    ...
    def _arrow3114(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow3119(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow3112(), _arrow3113(), _arrow3114(), _arrow3115(), _arrow3116(), _arrow3117(), _arrow3118(), tables, None, assay_identifiers, _arrow3119()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3120)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3121(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3121, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3123(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3122(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3122

        encoded_protocols = try_include_list("protocols", _arrow3123(), value_5)
        ...
        def _arrow3127(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3130(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3132(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3134(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3136(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3138(value_15: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr3137(IEncodable):
                def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_6.encode_string(value_15)

            return ObjectExpr3137()

        def _arrow3139(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3140(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3141(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3143(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3142(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow3142

        def _arrow3146(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow3145(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow3145

        def _arrow3147(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3127()), ("filename", ObjectExpr3128()), ("identifier", _arrow3130()), try_include("title", _arrow3132, study.Title), try_include("description", _arrow3134, study.Description), try_include("submissionDate", _arrow3136, study.SubmissionDate), try_include("publicReleaseDate", _arrow3138, study.PublicReleaseDate), try_include_seq("publications", _arrow3139, study.Publications), try_include_seq("people", _arrow3140, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3141, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3143(), processes), try_include_seq("assays", _arrow3146(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3147, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3150(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3150, f, s, id_map)
...
def _arrow3162(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3152()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3151(), def_thunk)
    ...
    def _arrow3155(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow3161(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow3155(), _arrow3156(), _arrow3157(), _arrow3158(), _arrow3159(), None if (len(persons) == 0) else persons, _arrow3160(), tables, None, assay_identifiers, _arrow3161()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3162)
