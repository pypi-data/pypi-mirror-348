...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow2490(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2493(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2494(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2496(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2498(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2500(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2501(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2490()), ("@type", list_1_1(singleton(ObjectExpr2491()))), try_include("name", _arrow2493, oa.Name), try_include("protocolType", _arrow2494, oa.ProtocolType), try_include("description", _arrow2496, oa.Description), try_include("uri", _arrow2498, oa.Uri), try_include("version", _arrow2500, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2501, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2514(get: IGetters) -> Protocol:
    def _arrow2506(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow2503(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow2503(), empty())
        ...
        list_4 = append(default_arg(_arrow2504(), empty()), list_2)
        ...
        return append(default_arg(_arrow2505(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2506())
    ...
    def _arrow2513(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2507(), _arrow2508(), _arrow2509(), _arrow2510(), _arrow2511(), _arrow2512(), None, components, _arrow2513())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2514)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2518(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2520(value_2: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2519(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr2519()

        def _arrow2521(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2523(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2525(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2527(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2528(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return encoder(id_map, value_10)

        def _arrow2529(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, c)

        def _arrow2530(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2518, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2520, oa_1.Name), try_include("protocolType", _arrow2521, oa_1.ProtocolType), try_include("description", _arrow2523, oa_1.Description), try_include("uri", _arrow2525, oa_1.Uri), try_include("version", _arrow2527, oa_1.Version), try_include_list_opt("parameters", _arrow2528, oa_1.Parameters), try_include_list_opt("components", _arrow2529, oa_1.Components), try_include_list_opt("comments", _arrow2530, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2532(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2532, f, oa, id_map)
...
def _arrow2542(get: IGetters) -> Protocol:
    def _arrow2533(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2534(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2535(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2539(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(decoder)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2540(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_1)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2541(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_2)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2533(), _arrow2534(), _arrow2535(), _arrow2536(), _arrow2537(), _arrow2538(), _arrow2539(), _arrow2540(), _arrow2541())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2542)
