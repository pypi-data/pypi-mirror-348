...
def ISAJson_encoder(id_map: Any | None, c: Component) -> IEncodable:
    ...
    def _arrow2468(value: str, id_map: Any=id_map, c: Any=c) -> IEncodable:
    ...
    def _arrow2469(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> IEncodable:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("componentName", _arrow2468, Component__get_ComponentName(c)), try_include("componentType", _arrow2469, c.ComponentType)]))
...
def _arrow2472(get: IGetters) -> Component:
    name: str | None
    ...
    def _arrow2471(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("componentType", OntologyAnnotation_ISAJson_decoder)

    return Component(pattern_input_1[0], pattern_input_1[1], _arrow2471())


ISAJson_decoder: Decoder_1[Component] = object(_arrow2472)
