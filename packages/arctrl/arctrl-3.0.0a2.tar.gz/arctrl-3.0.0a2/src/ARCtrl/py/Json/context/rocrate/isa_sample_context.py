...
def _arrow1836(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1830()), ("bio", ObjectExpr1831()), ("Sample", ObjectExpr1832()), ("name", ObjectExpr1833()), ("additionalProperties", ObjectExpr1834())])
