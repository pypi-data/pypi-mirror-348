...
def _arrow1863(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1859())])
...
conforms_to_jsonvalue: IEncodable = _arrow1863()
...
def _arrow1875(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1865()), ("arc", ObjectExpr1867()), ("CreativeWork", ObjectExpr1868()), ("about", ObjectExpr1869()), ("conformsTo", ObjectExpr1872())])
