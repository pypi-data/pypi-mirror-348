...
def encoder(assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2891(__unit: None=None, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2893(value_1: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2895(value_3: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2896(oa: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2897(oa_1: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2898(oa_2: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2899(dm: DataMap, assay: Any=assay) -> IEncodable:
        return encoder_4(dm)

    def _arrow2900(table: ArcTable, assay: Any=assay) -> IEncodable:
        return encoder_5(table)

    def _arrow2901(person: Person, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2902(comment: Comment, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2891()), try_include("Title", _arrow2893, assay.Title), try_include("Description", _arrow2895, assay.Description), try_include("MeasurementType", _arrow2896, assay.MeasurementType), try_include("TechnologyType", _arrow2897, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2898, assay.TechnologyPlatform), try_include("DataMap", _arrow2899, assay.DataMap), try_include_seq("Tables", _arrow2900, assay.Tables), try_include_seq("Performers", _arrow2901, assay.Performers), try_include_seq("Comments", _arrow2902, assay.Comments)]))
...
def _arrow2914(get: IGetters) -> ArcAssay:
    def _arrow2904(__unit: None=None) -> str:
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2918(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        value: str = assay.Identifier
    ...
    def _arrow2920(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2922(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2923(oa: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2924(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2925(oa_2: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2926(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2927(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2928(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2929(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2918()), try_include("Title", _arrow2920, assay.Title), try_include("Description", _arrow2922, assay.Description), try_include("MeasurementType", _arrow2923, assay.MeasurementType), try_include("TechnologyType", _arrow2924, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2925, assay.TechnologyPlatform), try_include_seq("Tables", _arrow2926, assay.Tables), try_include("DataMap", _arrow2927, assay.DataMap), try_include_seq("Performers", _arrow2928, assay.Performers), try_include_seq("Comments", _arrow2929, assay.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcAssay]:
    def _arrow2941(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcAssay:
        def _arrow2931(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow2932(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)

        def _arrow2933(__unit: None=None) -> str | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("Description", string)
        ...
        return ArcAssay.create(_arrow2931(), _arrow2932(), _arrow2933(), _arrow2934(), _arrow2935(), _arrow2936(), _arrow2937(), _arrow2938(), _arrow2939(), _arrow2940())

    return object(_arrow2941)
...
def ROCrate_encoder(study_name: str | None, a: ArcAssay) -> IEncodable:
    ...
    def _arrow2945(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2949(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    class ObjectExpr2950(IEncodable):
    ...
    def _arrow2952(value_5: str, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2954(value_7: str, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2955(oa: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderPropertyValue(oa)

    def _arrow2956(oa_1: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2957(oa_2: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_2)

    def _arrow2958(oa_3: Person, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_1(oa_3)

    def _arrow2959(oa_4: Data, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_2(oa_4)

    def _arrow2961(__unit: None=None, study_name: Any=study_name, a: Any=a) -> Callable[[Process], IEncodable]:
        assay_name: str | None = a.Identifier
        def _arrow2960(oa_5: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, assay_name, oa_5)

        return _arrow2960

    def _arrow2962(comment: Comment, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_4(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2945()), ("@type", list_1_1(singleton(ObjectExpr2946()))), ("additionalType", ObjectExpr2947()), ("identifier", _arrow2949()), ("filename", ObjectExpr2950()), try_include("title", _arrow2952, a.Title), try_include("description", _arrow2954, a.Description), try_include("measurementType", _arrow2955, a.MeasurementType), try_include("technologyType", _arrow2956, a.TechnologyType), try_include("technologyPlatform", _arrow2957, a.TechnologyPlatform), try_include_seq("performers", _arrow2958, a.Performers), try_include_list("dataFiles", _arrow2959, data_files), try_include_list("processSequence", _arrow2961(), processes), try_include_seq("comments", _arrow2962, a.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2973(get: IGetters) -> ArcAssay:
    def _arrow2964(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    identifier: str = default_arg(_arrow2964(), create_missing_identifier())
...
def ISAJson_encoder(study_name: str | None, id_map: Any | None, a: ArcAssay) -> IEncodable:
    def f(a_1: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> IEncodable:
        ...
        def _arrow2974(ps: FSharpList[Process], a_1: Any=a_1) -> IEncodable:
            return encoder_9(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2974, Option_fromValueWithDefault(empty(), processes))
        ...
        def _arrow2977(__unit: None=None, a_1: Any=a_1) -> IEnumerable_1[Comment]:
            def _arrow2976(__unit: None=None) -> IEnumerable_1[Comment]:
                def _arrow2975(__unit: None=None) -> IEnumerable_1[Comment]:
                    return singleton_1(Comment.create("description", value_9(a_1.Description))) if (a_1.Description is not None) else empty_1()

                return append(singleton_1(Comment.create("title", value_9(a_1.Title))) if (a_1.Title is not None) else empty_1(), delay(_arrow2975))

            return append(a_1.Comments if (len(a_1.Comments) > 0) else empty_1(), delay(_arrow2976))

        comments: FSharpList[Comment] = to_list(delay(_arrow2977))
        ...
        def _arrow2981(value_5: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2982(oa_2: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2983(oa_3: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2985(value_7: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2987(__unit: None=None, a_1: Any=a_1) -> Callable[[Process], IEncodable]:
            assay_name: str | None = a_1.Identifier
            def _arrow2986(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_2(study_name, assay_name, id_map, oa_4)

            return _arrow2986

        def _arrow2988(comment: Comment, a_1: Any=a_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("filename", ObjectExpr2979()), try_include("@id", _arrow2981, ROCrate_genID(a_1)), try_include("measurementType", _arrow2982, a_1.MeasurementType), try_include("technologyType", _arrow2983, a_1.TechnologyType), try_include("technologyPlatform", _arrow2985, map(mapping, a_1.TechnologyPlatform)), encoced_data_files, encoded_materials, encoded_characteristics, encoded_units, try_include_list("processSequence", _arrow2987(), processes), try_include_seq("comments", _arrow2988, comments)]))
    ...
    if id_map is not None:
        def _arrow2990(a_2: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> str:
            return ROCrate_genID(a_2)

        return encode(_arrow2990, f, a, id_map)
...
def _arrow2996(get: IGetters) -> ArcAssay:
    def _arrow2991(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Assay_tryIdentifierFromFileName, _arrow2991()), create_missing_identifier())
    def mapping(arg_4: FSharpList[Process]) -> Array[ArcTable]:
        a: ArcTables = ARCtrl_ArcTables__ArcTables_fromProcesses_Static_62A3309D(arg_4)
        return a.Tables

    def _arrow2992(__unit: None=None) -> FSharpList[Process] | None:
        arg_3: Decoder_1[FSharpList[Process]] = list_1_2(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("processSequence", arg_3)

    tables: Array[ArcTable] | None = map(mapping, _arrow2992())
    ...
    def _arrow2993(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("measurementType", OntologyAnnotation_ISAJson_decoder)

    def _arrow2994(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("technologyType", OntologyAnnotation_ISAJson_decoder)

    def _arrow2995(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return ArcAssay(identifier, title, description, _arrow2993(), _arrow2994(), _arrow2995(), tables, None, None, comments_1)


ISAJson_decoder: Decoder_1[ArcAssay] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2996)
