...
def _arrow1871(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1846()), ("Study", ObjectExpr1847()), ("identifier", ObjectExpr1848()), ("title", ObjectExpr1849()), ("additionalType", ObjectExpr1850()), ("description", ObjectExpr1851()), ("submissionDate", ObjectExpr1852()), ("publicReleaseDate", ObjectExpr1853()), ("publications", ObjectExpr1854()), ("people", ObjectExpr1855()), ("assays", ObjectExpr1857()), ("dataFiles", ObjectExpr1858()), ("filename", ObjectExpr1860()), ("comments", ObjectExpr1861()), ("processSequence", ObjectExpr1864()), ("studyDesignDescriptors", ObjectExpr1866())])
