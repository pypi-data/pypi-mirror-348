...
def encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1973(value: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1975(value_2: str, comment: Any=comment) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("name", _arrow1973, comment.Name), try_include("value", _arrow1975, comment.Value)]))
...
def _arrow1979(get: IGetters) -> Comment:
    def _arrow1977(__unit: None=None) -> str | None:
    ...
    return Comment(_arrow1977(), _arrow1978())


decoder: Decoder_1[Comment] = object(_arrow1979)
...
def ROCrate_encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1983(__unit: None=None, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1986(value_2: str, comment: Any=comment) -> IEncodable:
        class ObjectExpr1985(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_2)

        return ObjectExpr1985()

    def _arrow1988(value_4: str, comment: Any=comment) -> IEncodable:
        class ObjectExpr1987(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_4)

        return ObjectExpr1987()

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1983()), ("@type", ObjectExpr1984()), try_include("name", _arrow1986, comment.Name), try_include("value", _arrow1988, comment.Value), ("@context", context_jsonvalue)]))
...
def _arrow1992(get: IGetters) -> Comment:
    ...
    return Comment(_arrow1990(), _arrow1991())


ROCrate_decoder: Decoder_1[Comment] = object(_arrow1992)
...
def ISAJson_encoder(id_map: Any | None, comment: Comment) -> IEncodable:
    def f(comment_1: Comment, id_map: Any=id_map, comment: Any=comment) -> IEncodable:
        ...
        def _arrow1997(value: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        def _arrow1999(value_2: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        def _arrow2001(value_4: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1997, ROCrate_genID(comment_1)), try_include("name", _arrow1999, comment_1.Name), try_include("value", _arrow2001, comment_1.Value)]))
    ...
    if id_map is None:
        ...
        def _arrow2003(c: Comment, id_map: Any=id_map, comment: Any=comment) -> str:
            return ROCrate_genID(c)

        return encode(_arrow2003, f, comment, id_map)
