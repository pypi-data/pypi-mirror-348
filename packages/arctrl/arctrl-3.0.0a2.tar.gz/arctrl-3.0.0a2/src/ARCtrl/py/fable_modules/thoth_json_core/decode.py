...
class ObjectExpr78(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow76(__unit: None=None) -> uint8:
                return out_arg

            def _arrow77(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow76, _arrow77)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr78()

class ObjectExpr81(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow79(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow80(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow79, _arrow80)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr81()

class ObjectExpr84(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow82(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow83(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow82, _arrow83)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr84()
...
class ObjectExpr87(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow85, _arrow86)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr87()

class ObjectExpr90(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow88(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow89(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow88, _arrow89)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr90()

class ObjectExpr93(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow91(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow92(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow91, _arrow92)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr93()

class ObjectExpr96(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow94(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow95(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow94, _arrow95)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr96()
