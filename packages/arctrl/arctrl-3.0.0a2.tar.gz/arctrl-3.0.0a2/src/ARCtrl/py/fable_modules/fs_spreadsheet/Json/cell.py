...
def encode_rows(cell: FsCell) -> IEncodable:
    def _arrow287(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("column", _arrow287()), ("value", encode(cell.Value))])
...
def decode_rows(row_number: int | None=None) -> Decoder_1[FsCell]:
    def _arrow293(builder: IGetters, row_number: Any=row_number) -> FsCell:
        ...
        c: int = default_arg(_arrow292(), 0) or 0
...
def encode_cols(cell: FsCell) -> IEncodable:
    def _arrow295(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("row", _arrow295()), ("value", encode(cell.Value))])
