...
def _arrow3350(value_1: YAMLElement) -> OutputBinding:
    def getter(get: IGetters) -> OutputBinding:
        def _arrow3349(__unit: None=None, get: Any=get) -> str | None:
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("glob", string)

        return OutputBinding(_arrow3349())

    return object(getter, value_1)


Decode_outputBindingGlobDecoder: Callable[[YAMLElement], OutputBinding] = _arrow3350

def _arrow3351(value: YAMLElement) -> OutputBinding | None:
...
Decode_outputBindingDecoder: Callable[[YAMLElement], OutputBinding | None] = _arrow3351

def _arrow3355(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        def _arrow3352(__unit: None=None, get: Any=get) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("entry", Decode_decodeStringOrExpression)

        def _arrow3353(__unit: None=None, get: Any=get) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("entryname", Decode_decodeStringOrExpression)

        def _arrow3354(__unit: None=None, get: Any=get) -> bool | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("writable", bool_1)

        return CWLType(2, DirentInstance(_arrow3352(), _arrow3353(), _arrow3354()))

    return object(getter, value_1)


Decode_direntDecoder: Callable[[YAMLElement], CWLType] = _arrow3355

def _arrow3357(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        items: str
        object_arg: IRequiredGetter = get.Required
        ...
        if items == "File":
            ...
            def _arrow3356(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("listing", Decode_direntDecoder)

            return CWLType(11, _arrow3356())
...
Decode_cwlArrayTypeDecoder: Callable[[YAMLElement], CWLType] = _arrow3357
...
def Decode_cwlTypeStringMatcher(t: str, get: IGetters) -> tuple[CWLType, bool]:
    ...
    def _arrow3358(__unit: None=None, t: Any=t, get: Any=get) -> CWLType:
        object_arg: IRequiredGetter = get.Required
...
def _arrow3362(value_1: YAMLElement) -> tuple[CWLType, bool]:
    def getter(get: IGetters) -> tuple[CWLType, bool]:
        ...
        if cwl_type is None:
            def _arrow3361(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("type", Decode_cwlArrayTypeDecoder)

            return (_arrow3361(), False)
...
Decode_cwlTypeDecoder: Callable[[YAMLElement], tuple[CWLType, bool]] = _arrow3362

def _arrow3369(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3368(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow3367(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow3366(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    ...
                    def _arrow3365(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr3364() if (output_source is not None) else empty_1(), delay(_arrow3365))

                return append(_expr3363() if (output_binding is not None) else empty_1(), delay(_arrow3366))

            return collect(_arrow3367, dict_1.keys())

        return list(to_array(delay(_arrow3368)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow3369

def _arrow3370(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow3370

def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    def _arrow3371(__unit: None=None, get: Any=get) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("dockerPull", string)

    def _arrow3373(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow3372(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow3372, value_1)

        return object_arg_1.Field("dockerFile", arg_3)

    def _arrow3374(__unit: None=None, get: Any=get) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("dockerImageId", string)

    return DockerRequirement(_arrow3371(), _arrow3373(), _arrow3374())
    ...
    def arg_1(value_3: YAMLElement, get: Any=get) -> Array[EnvironmentDef]:
        def decoder(value_2: YAMLElement, value_3: Any=value_3) -> EnvironmentDef:
            def getter(get2: IGetters, value_2: Any=value_2) -> EnvironmentDef:
                def _arrow3375(__unit: None=None, get2: Any=get2) -> str:
                ...
                return EnvironmentDef(_arrow3375(), _arrow3376())
    ...
    def arg_1(value_6: YAMLElement, get: Any=get) -> Array[SoftwarePackage]:
        def decoder(value_5: YAMLElement, value_6: Any=value_6) -> SoftwarePackage:
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                ...
                def _arrow3379(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_2: IOptionalGetter = get2.Optional
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        def _arrow3378(value_2: YAMLElement, value_1: Any=value_1) -> str:
                            return string(value_2)

                        return resizearray(_arrow3378, value_1)

                    return object_arg_2.Field("version", arg_5)

                def _arrow3381(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_3: IOptionalGetter = get2.Optional
                    def arg_7(value_3: YAMLElement) -> Array[str]:
                        def _arrow3380(value_4: YAMLElement, value_3: Any=value_3) -> str:
                            return string(value_4)

                        return resizearray(_arrow3380, value_3)

                    return object_arg_3.Field("specs", arg_7)

                return SoftwarePackage(_arrow3377(), _arrow3379(), _arrow3381())
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    def _arrow3382(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow3382()), some(_arrow3383()), some(_arrow3384()), some(_arrow3385()), some(_arrow3386()), some(_arrow3387()), some(_arrow3388()), some(_arrow3389()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow3391(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow3390(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow3390, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow3391())
...
def _arrow3392(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow3392

def _arrow3393(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow3393
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow3394

def _arrow3399(value_5: YAMLElement) -> InputBinding | None:
...
Decode_inputBindingDecoder: Callable[[YAMLElement], InputBinding | None] = _arrow3399

def _arrow3406(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3405(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
            def _arrow3404(key: str) -> IEnumerable_1[CWLInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                ...
                def _arrow3403(__unit: None=None) -> IEnumerable_1[CWLInput]:
                    ...
                    def _arrow3402(__unit: None=None) -> IEnumerable_1[CWLInput]:
                        return singleton(input)

                    return append(_expr3401() if pattern_input[1] else empty_1(), delay(_arrow3402))

                return append(_expr3400() if (input_binding is not None) else empty_1(), delay(_arrow3403))

            return collect(_arrow3404, dict_1.keys())

        return list(to_array(delay(_arrow3405)))

    return object(getter, value_1)


Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow3406

def _arrow3407(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow3407

def _arrow3409(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        object_arg: IOptionalGetter = get.Optional
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow3408(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow3408, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow3409

def _arrow3410(value_1: YAMLElement) -> str:
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow3410

def _arrow3411(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow3411

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow3412(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow3413(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow3417(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3416(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow3415(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow3414(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow3414(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))
...
Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow3417

def _arrow3419(value_2: YAMLElement) -> Array[str]:
    def getter(get: IGetters) -> Array[str]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow3418(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow3418, value)
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow3419

def _arrow3427(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3426(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow3425(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow3420(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow3420, value)
                ...
                def _arrow3424(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr3422():
                        wf_step.Hints = hints
                        return empty_1()

                    def _arrow3423(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                        return singleton(wf_step)

                    return append(_expr3422() if (hints is not None) else empty_1(), delay(_arrow3423))

                return append(_expr3421() if (requirements is not None) else empty_1(), delay(_arrow3424))

            return collect(_arrow3425, dict_1.keys())

        return list(to_array(delay(_arrow3426)))

    return object(getter, value_1)


Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3427

def _arrow3428(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3428
