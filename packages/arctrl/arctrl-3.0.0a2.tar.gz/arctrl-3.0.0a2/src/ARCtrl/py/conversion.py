...
def DateTime_tryFromString(s: str) -> Any | None:
    try: 
        def _arrow3663(__unit: None=None) -> Any:
...
def ColumnIndex_tryInt(str_1: str) -> int | None:
    ...
    out_arg: int = 0
    def _arrow3664(__unit: None=None, str_1: Any=str_1) -> int:
        return out_arg

    def _arrow3665(v: int, str_1: Any=str_1) -> None:
        nonlocal out_arg
        out_arg = v or 0

    match_value = (try_parse(str_1, 511, False, 32, FSharpRef(_arrow3664, _arrow3665)), out_arg)
    if match_value[0]:
...
BaseTypes_reflection = _expr3666
...
ProcessConversion_reflection = _expr3667
...
def ProcessConversion_tryComponentGetter(general_i: int, value_i: int, value_header: CompositeHeader) -> Callable[[Any, int], LDNode] | None:
    if value_header.tag == 0:
        def Value(matrix: Any, general_i: Any=general_i, value_i: Any=value_i, value_header: Any=value_header) -> Callable[[int], LDNode]:
            def _arrow3668(i: int, matrix: Any=matrix) -> LDNode:
...
def ProcessConversion_tryGetProtocolREFGetter(general_i: int, header: CompositeHeader) -> Callable[[Any, int], str] | None:
    if header.tag == 8:
        def Value(matrix: Any, general_i: Any=general_i, header: Any=header) -> Callable[[int], str]:
            def _arrow3673(i: int, matrix: Any=matrix) -> str:
...
def ProcessConversion_getProcessGetter(process_name_root: str, headers: IEnumerable_1[CompositeHeader]) -> Callable[[Any, int], LDNode]:
    ...
    if match_value is None:
        def _arrow3682(matrix_1: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3681(i_1: int) -> Array[LDNode]:
        ...
        def _arrow3684(matrix_2: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3683(i_2: int) -> Array[LDNode]:
                return []

            return _arrow3683

        input_getter_1 = _arrow3682 if (length(char_getters) != 0) else _arrow3684

    else: 
        input_getter: Callable[[Any, int], LDNode] = match_value
        def _arrow3686(matrix: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3685(i: int) -> Array[LDNode]:
    ...
    if match_value_1 is None:
        def _arrow3688(matrix_4: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3687(i_4: int) -> Array[LDNode]:
        ...
        def _arrow3690(matrix_5: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3689(i_5: int) -> Array[LDNode]:
                return []

            return _arrow3689

        output_getter_1 = _arrow3688 if (length(factor_value_getters) != 0) else _arrow3690

    else: 
        output_getter: Callable[[Any, int], LDNode] = match_value_1
        def _arrow3692(matrix_3: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], Array[LDNode]]:
            def _arrow3691(i_3: int) -> Array[LDNode]:
        ...
        output_getter_1 = _arrow3692

    def _arrow3695(matrix_6: Any, process_name_root: Any=process_name_root, headers: Any=headers) -> Callable[[int], LDNode]:
        def _arrow3694(i_6: int) -> LDNode:
            def mapping_4(tuple_1: tuple[int, int]) -> int:
                return tuple_1[1]

            class ObjectExpr3693:
                @property
                def Compare(self) -> Callable[[int, int], int]:
                    return compare_primitives

            pn: str = process_name_root if ((1 + max(map_1(mapping_4, matrix_6.keys()), ObjectExpr3693())) == 1) else ProcessConversion_composeProcessName(process_name_root, i_6)
...
def ProcessConversion_groupProcesses_Z27F0B586(processes: FSharpList[LDNode], graph: LDGraph | None=None, context: LDContext | None=None) -> FSharpList[tuple[str, FSharpList[LDNode]]]:
    def projection(p: LDNode, processes: Any=processes, graph: Any=graph, context: Any=context) -> str:
        ...
        if match_value is not None:
            if ProcessConversion_decomposeProcessName_Z721C83C5(match_value)[1] is not None:
                ...
                def _arrow3696(__unit: None=None, p: Any=p) -> bool:
    ...
    class ObjectExpr3701:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3700(x: str, y: str) -> bool:
                return x == y
    ...
    return List_groupBy(projection, processes, ObjectExpr3701())
...
def ProcessConversion_processToRows_Z6839B9E8(p: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> Array[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
    ...
    if match_value_1 is None:
        ...
        def _arrow3710(__unit: None=None, p: Any=p, graph: Any=graph, context: Any=context) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
            def _arrow3702(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
            ...
            def _arrow3709(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                ...
                def _arrow3708(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                    ...
                    def _arrow3707(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        ...
                        return append(_arrow3705(), delay(_arrow3706))

                    return append(_arrow3704(), delay(_arrow3707))

                return append(_arrow3703(), delay(_arrow3708))

            return append(_arrow3702(), delay(_arrow3709))

        prot_vals = to_list(delay(_arrow3710))
    ...
    def _arrow3711(Value: LDNode, p: Any=p, graph: Any=graph, context: Any=context) -> LDNode | None:
        return Value

    def _arrow3712(Value_1: LDNode, p: Any=p, graph: Any=graph, context: Any=context) -> LDNode | None:
        return Value_1

    def _arrow3713(Value_2: LDNode, p: Any=p, graph: Any=graph, context: Any=context) -> LDNode | None:
        return Value_2

    def _arrow3714(Value_3: LDNode, p: Any=p, graph: Any=graph, context: Any=context) -> LDNode | None:
        return Value_3

    pattern_input: tuple[Array[LDNode | None], Array[LDNode | None]] = ((ResizeArray_create(len(outputs), None), ResizeArray_map(_arrow3711, outputs))) if ((len(outputs) != 0) if (len(inputs) == 0) else False) else (((ResizeArray_map(_arrow3712, inputs), ResizeArray_create(len(inputs), None))) if ((len(outputs) == 0) if (len(inputs) != 0) else False) else ((ResizeArray_map(_arrow3713, inputs), ResizeArray_map(_arrow3714, outputs))))
    ...
    if (len(outputs_1) == 0) if (len(inputs_1) == 0) else False:
        ...
        def _arrow3716(__unit: None=None, p: Any=p, graph: Any=graph, context: Any=context) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
            def _arrow3715(__unit: None=None) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
                return pvs

            return append(components, delay(_arrow3715))

        class ObjectExpr3717:
            @property
            def Compare(self) -> Callable[[int, int], int]:
                return compare_primitives

        vals: FSharpList[tuple[CompositeHeader, CompositeCell]] = map_2(mapping, sort_by(projection, to_list(delay(_arrow3716)), ObjectExpr3717()))
        def _arrow3720(__unit: None=None, p: Any=p, graph: Any=graph, context: Any=context) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
            def _arrow3719(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                ...
                return append(vals, delay(_arrow3718))

            return append(prot_vals, delay(_arrow3719))

        return ResizeArray_singleton(to_list(delay(_arrow3720)))
        ...
        def f_5(tupled_arg: tuple[LDNode | None, LDNode | None], p: Any=p, graph: Any=graph, context: Any=context) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
            ...
            def _arrow3724(__unit: None=None, tupled_arg: Any=tupled_arg) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
                def _arrow3723(__unit: None=None) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
                    def _arrow3722(__unit: None=None) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
                        def _arrow3721(__unit: None=None) -> IEnumerable_1[tuple[tuple[CompositeHeader, CompositeCell], int | None]]:
                            return factors

                        return append(pvs, delay(_arrow3721))

                    return append(components, delay(_arrow3722))

                return append(chars, delay(_arrow3723))

            class ObjectExpr3725:
                @property
                def Compare(self) -> Callable[[int, int], int]:
                    return compare_primitives

            vals_1: FSharpList[tuple[CompositeHeader, CompositeCell]] = map_2(mapping_1, sort_by(projection_1, to_list(delay(_arrow3724)), ObjectExpr3725()))
            def _arrow3730(__unit: None=None, tupled_arg: Any=tupled_arg) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                def _arrow3729(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow3728(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow3727(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                            def _arrow3726(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                                return singleton(BaseTypes_decomposeProcessOutput_Z2F770004(value_4(o), context)) if (o is not None) else empty_1()

                            return append(comments, delay(_arrow3726))

                        return append(vals_1, delay(_arrow3727))

                    return append(prot_vals, delay(_arrow3728))

                return append(singleton(BaseTypes_decomposeProcessInput_Z2F770004(value_4(i), context)) if (i is not None) else empty_1(), delay(_arrow3729))

            return to_list(delay(_arrow3730))
...
def ARCtrl_ArcTable__ArcTable_GetProtocols(this: ArcTable) -> FSharpList[LDNode]:
    if this.RowCount == 0:
        def _arrow3731(__unit: None=None, this: Any=this) -> LDNode:
        ...
        return singleton_2(_arrow3731())

    else: 
        def _arrow3732(i: int, this: Any=this) -> LDNode:
        ...
        return List_distinct(initialize(this.RowCount, _arrow3732), ObjectExpr3733())
...
def ARCtrl_ArcTable__ArcTable_GetProcesses(this: ArcTable) -> FSharpList[LDNode]:
    if this.RowCount == 0:
        ...
        def _arrow3735(__unit: None=None, this: Any=this) -> IEnumerable_1[LDNode]:
            def _arrow3734(i: int) -> LDNode:
                return getter(this.Values)(i)

            return map_1(_arrow3734, range_big_int(0, 1, this.RowCount - 1))

        return to_list(delay(_arrow3735))
...
DatamapConversion_reflection = _expr3736
...
PersonConversion_reflection = _expr3737
...
def PersonConversion_composeAddress_Z721C83C5(address: str) -> Any:
    try: 
        def _arrow3738(__unit: None=None) -> LDNode:
...
ScholarlyArticleConversion_reflection = _expr3739
...
def ScholarlyArticleConversion_composeScholarlyArticle_D324A6D(publication: Publication) -> LDNode:
    ...
    def _arrow3741(__unit: None=None, publication: Any=publication) -> IEnumerable_1[LDNode]:
        def _arrow3740(__unit: None=None) -> IEnumerable_1[LDNode]:
        ...
        return append(singleton(LDPropertyValue.create_doi(value_4(publication.DOI))) if ((value_4(publication.DOI) != "") if (publication.DOI is not None) else False) else empty_1(), delay(_arrow3740))

    identifiers: Array[LDNode] = list(to_list(delay(_arrow3741)))
...
AssayConversion_reflection = _expr3742
...
def AssayConversion_composeAssay_1501C0F8(assay: ArcAssay) -> LDNode:
    ...
    def _arrow3743(__unit: None=None, assay: Any=assay) -> Array[LDNode] | None:
    ...
    variable_measureds: Array[LDNode] | None = (None if (fragment_descriptors is None) else _arrow3743()) if (variable_measured is None) else (_arrow3744() if (fragment_descriptors is None) else _arrow3745())
...
StudyConversion_reflection = _expr3746

def StudyConversion_composeStudy_1680536E(study: ArcStudy) -> LDNode:
    def _arrow3747(s: str, study: Any=study) -> Any | None:
        return DateTime_tryFromString(s)

    date_created: Any | None = bind(_arrow3747, study.SubmissionDate)
    def _arrow3748(s_1: str, study: Any=study) -> Any | None:
        return DateTime_tryFromString(s_1)

    date_published: Any | None = bind(_arrow3748, study.PublicReleaseDate)
...
def StudyConversion_decomposeStudy_Z6839B9E8(study: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> ArcStudy:
    def _arrow3749(d: Any, study: Any=study, graph: Any=graph, context: Any=context) -> str:
        return DateTime_toString(d)

    date_created: str | None = map(_arrow3749, LDDataset.try_get_date_created_as_date_time(study, context))
    def _arrow3750(d_1: Any, study: Any=study, graph: Any=graph, context: Any=context) -> str:
        return DateTime_toString(d_1)

    date_published: str | None = map(_arrow3750, LDDataset.try_get_date_published_as_date_time(study, context))
...
InvestigationConversion_reflection = _expr3751
...
def InvestigationConversion_composeInvestigation_Z720BD3FF(investigation: ArcInvestigation) -> LDNode:
    ...
    def _arrow3752(s: str, investigation: Any=investigation) -> Any | None:
        return DateTime_tryFromString(s)

    date_created: Any | None = bind(_arrow3752, investigation.SubmissionDate)
    def _arrow3753(s_1: str, investigation: Any=investigation) -> Any | None:
        return DateTime_tryFromString(s_1)

    date_published: Any = default_arg(bind(_arrow3753, investigation.PublicReleaseDate), now())
    ...
    def _arrow3754(__unit: None=None, investigation: Any=investigation) -> Array[LDNode]:
    ...
    has_parts: Array[LDNode] | None = Option_fromSeq(_arrow3754())
...
def InvestigationConversion_decomposeInvestigation_Z6839B9E8(investigation: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> ArcInvestigation:
    ...
    def _arrow3755(d: Any, investigation: Any=investigation, graph: Any=graph, context: Any=context) -> str:
        return DateTime_toString(d)

    date_created: str | None = map(_arrow3755, LDDataset.try_get_date_created_as_date_time(investigation, context))
    def _arrow3756(d_1: Any, investigation: Any=investigation, graph: Any=graph, context: Any=context) -> str:
        return DateTime_toString(d_1)

    date_published: str | None = map(_arrow3756, LDDataset.try_get_date_published_as_date_time(investigation, context))
