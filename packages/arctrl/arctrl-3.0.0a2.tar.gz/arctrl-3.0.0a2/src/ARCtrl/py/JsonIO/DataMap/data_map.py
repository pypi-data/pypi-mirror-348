...
def encoder(dm: DataMap) -> IEncodable:
    ...
    class ObjectExpr3558(IEncodable):
    ...
    return ObjectExpr3558()


def _arrow3560(get: IGetters) -> DataMap:
    def _arrow3559(__unit: None=None) -> Array[DataContext]:
        arg_1: Decoder_1[Array[DataContext]] = resize_array(decoder_1)
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("dataContexts", arg_1)

    return DataMap__ctor_4E3220A7(_arrow3559())


decoder: Decoder_1[DataMap] = object(_arrow3560)
