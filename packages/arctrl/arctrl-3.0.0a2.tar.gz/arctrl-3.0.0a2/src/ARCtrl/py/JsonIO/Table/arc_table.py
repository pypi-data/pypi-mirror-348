...
def ARCtrl_ArcTable__ArcTable_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcTable], str]:
    def _arrow3547(obj: ArcTable, spaces: Any=spaces) -> str:
...
def ARCtrl_ArcTable__ArcTable_fromCompressedJsonString_Static_Z721C83C5(json_string: str) -> ArcTable:
    def _arrow3549(get: IGetters, json_string: Any=json_string) -> ArcTable:
        ...
        def _arrow3548(__unit: None=None) -> Array[CompositeCell]:
        ...
        arg_7: Decoder_1[ArcTable] = decoder_compressed(string_table, oa_table, _arrow3548())
        object_arg_3: IRequiredGetter = get.Required
        return object_arg_3.Field("table", arg_7)

    match_value: FSharpResult_2[ArcTable, str] = Decode_fromString(object(_arrow3549), json_string)
    if match_value.tag == 1:
        raise Exception(to_text(printf("Error decoding string: %O"))(match_value.fields[0]))
...
def ARCtrl_ArcTable__ArcTable_ToCompressedJsonString_71136F3F(this: ArcTable, spaces: int | None=None) -> str:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3550())
    class ObjectExpr3551:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3551())
    arc_table: IEncodable = encoder_compressed(string_table, oa_table, cell_table, this)
    def _arrow3553(__unit: None=None, this: Any=this, spaces: Any=spaces) -> IEncodable:
        ...
        class ObjectExpr3552(IEncodable):
