...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3539())
    ...
    cell_table: Any = Dictionary([], ObjectExpr3540())
    ...
    class ObjectExpr3541(IEncodable):
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3543(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3542(__unit: None=None) -> Array[CompositeCell]:
