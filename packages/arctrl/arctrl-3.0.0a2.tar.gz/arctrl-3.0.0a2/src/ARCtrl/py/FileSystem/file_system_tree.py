...
class FileSystemTree(Union):
    ...
    def try_get_child_by_name(name: str) -> Callable[[FileSystemTree], FileSystemTree | None]:
        def _arrow451(fst: FileSystemTree) -> FileSystemTree | None:
    ...
    def contains_child_with_name(name: str) -> Callable[[FileSystemTree], bool]:
        def _arrow452(fst: FileSystemTree) -> bool:
    ...
    def AddFile(self, path: str) -> FileSystemTree:
        ...
        def _arrow454(__unit: None=None) -> IEnumerable_1[str]:
            ...
            return append(singleton(path), delay(_arrow453))

        file_paths: Array[str] = to_array(delay(_arrow454))
        return FileSystemTree.from_file_paths(file_paths)

    @staticmethod
    def add_file(path: str) -> Callable[[FileSystemTree], FileSystemTree]:
        def _arrow455(tree: FileSystemTree) -> FileSystemTree:
        ...
        def loop(paths_1: Array[Array[str]], parent: FileSystemTree) -> FileSystemTree:
            ...
            class ObjectExpr457:
                ...
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow456(x_3: str, y_2: str) -> bool:
                        return x_3 == y_2
            ...
            folders: Array[FileSystemTree] = map(mapping_2, Array_groupBy(projection, filter(predicate_1, paths_1), ObjectExpr457()), None)
            if parent.tag == 1:
...
FileSystemTree_reflection = _expr472
