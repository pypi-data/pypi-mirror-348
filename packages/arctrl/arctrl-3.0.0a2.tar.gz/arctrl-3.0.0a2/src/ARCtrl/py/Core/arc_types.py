...
class ArcAssay(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        def _arrow944(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040129: str = _arrow944()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow919(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e, combined, ObjectExpr924()):
                            (combined.append(e))
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1, combined, ObjectExpr925()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr926()):
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr931()):
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        def _arrow935(__unit: None=None) -> bool:
            ...
            def _arrow934(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow933(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow933, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow934))) if (length(a) == length(b)) else False
        ...
        def _arrow938(__unit: None=None) -> bool:
            ...
            def _arrow937(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow936(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow936, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow937))) if (length(a_1) == length(b_1)) else False
...
class ArcRun(ArcTables):
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1017(run: ArcRun) -> ArcRun:
            c: ArcRun = run.Copy()
            c.AddTable(table, index)
            return c
    ...
    def add_tables(tables: IEnumerable_1[ArcTable], index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1018(run: ArcRun) -> ArcRun:
            c: ArcRun = run.Copy()
            c.AddTables(tables, index)
            return c
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcRun], tuple[ArcRun, ArcTable]]:
        def _arrow1019(run: ArcRun) -> tuple[ArcRun, ArcTable]:
            c: ArcRun = run.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table_at(index: int) -> Callable[[ArcRun], ArcTable]:
        def _arrow1021(run: ArcRun) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcRun], ArcTable]:
        def _arrow1022(run: ArcRun) -> ArcTable:
            new_run: ArcRun = run.Copy()
    ...
    def set_table_at(index: int, table: ArcTable) -> Callable[[ArcRun], ArcRun]:
        def _arrow1025(run: ArcRun) -> ArcRun:
            new_run: ArcRun = run.Copy()
...
class ArcInvestigation:
    ...
    def get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1142(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def try_get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun | None]:
        def _arrow1143(inv: ArcInvestigation) -> ArcRun | None:
            copy: ArcInvestigation = inv.Copy()
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr1149())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr1150())
            ...
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1152:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1151(x: str, y: str) -> bool:
                                    return x == y
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr1152()):
    ...
    def deregister_missing_assays(__unit: None=None) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1153(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow1159(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow1154(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow1158(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow1155(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                def _arrow1157(__unit: None=None) -> IEnumerable_1[ArcTable]:
                    def _arrow1156(run: ArcRun) -> IEnumerable_1[ArcTable]:
                        return run.Tables

                    return collect(_arrow1156, this.Runs)

                return append_4(collect(_arrow1155, this.Assays), delay(_arrow1157))

            return append_4(collect(_arrow1154, this.Studies), delay(_arrow1158))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow1159))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow1175(__unit: None=None) -> bool:
            a: IEnumerable_1[Publication] = this.Publications
            b: IEnumerable_1[Publication] = other.Publications
            def folder(acc: bool, e: bool) -> bool:
                if acc:
            ...
            def _arrow1174(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1173(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow1173, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1174))) if (length(a) == length(b)) else False
        ...
        def _arrow1178(__unit: None=None) -> bool:
            ...
            def _arrow1177(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1176(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1176, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1177))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow1181(__unit: None=None) -> bool:
            ...
            def _arrow1180(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1179(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1179, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1180))) if (length(a_2) == length(b_2)) else False
        ...
        def _arrow1184(__unit: None=None) -> bool:
            ...
            def _arrow1183(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1182(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1182, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1183))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow1187(__unit: None=None) -> bool:
            ...
            def _arrow1186(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1185(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow1185, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1186))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow1190(__unit: None=None) -> bool:
            ...
            def _arrow1189(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1188(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1188, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1189))) if (length(a_5) == length(b_5)) else False
        ...
        def _arrow1193(__unit: None=None) -> bool:
            ...
            def _arrow1192(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1191(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow1191, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow1192))) if (length(a_6) == length(b_6)) else False
        ...
        def _arrow1196(__unit: None=None) -> bool:
            ...
            def _arrow1195(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1194(i_8: int) -> bool:
                    return item(i_8, a_7) == item(i_8, b_7)

                return map_1(_arrow1194, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow1195))) if (length(a_7) == length(b_7)) else False
        ...
        def _arrow1199(__unit: None=None) -> bool:
            ...
            def _arrow1198(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1197(i_9: int) -> bool:
                    return equals(item(i_9, a_8), item(i_9, b_8))

                return map_1(_arrow1197, range_big_int(0, 1, length(a_8) - 1))

            return fold(folder_8, True, to_list(delay(_arrow1198))) if (length(a_8) == length(b_8)) else False
        ...
        def _arrow1202(__unit: None=None) -> bool:
            ...
            def _arrow1201(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1200(i_10: int) -> bool:
                    return equals(item(i_10, a_9), item(i_10, b_9))

                return map_1(_arrow1200, range_big_int(0, 1, length(a_9) - 1))

            return fold(folder_9, True, to_list(delay(_arrow1201))) if (length(a_9) == length(b_9)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow1175(), _arrow1178(), _arrow1181(), _arrow1184(), _arrow1187(), _arrow1190(), _arrow1193(), _arrow1196(), _arrow1199(), _arrow1202()]))
...
ArcInvestigation_reflection = _expr1203
...
def ArcWorkflow_addSubWorkflow_Z1C75CB0E(sub_workflow: ArcWorkflow) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1205(workflow: ArcWorkflow, sub_workflow: Any=sub_workflow) -> ArcWorkflow:
...
def ArcWorkflow_initSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], tuple[ArcWorkflow, ArcWorkflow]]:
    def _arrow1208(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> tuple[ArcWorkflow, ArcWorkflow]:
...
def ArcWorkflow__RegisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    class ObjectExpr1210:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1209(x: str, y: str) -> bool:
                return x == y
    ...
    if contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1210()):
...
def ArcWorkflow_registerSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1211(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
        copy: ArcWorkflow = ArcWorkflow__Copy_6FCE9E49(workflow)
...
def ArcWorkflow__DeregisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    ...
    ignore(remove_in_place(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1213()))
...
def ArcWorkflow__GetRegisteredSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> ArcWorkflow:
    ...
    if not contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1216()):
...
def ArcWorkflow_getRegisteredSubWorkflows(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1218(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow_getRegisteredSubWorkflowsOrIdentifier(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1219(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow__StructurallyEquals_Z1C75CB0E(this: ArcWorkflow, other: ArcWorkflow) -> bool:
    ...
    def _arrow1222(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1221(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1220(i_1: int) -> bool:
                return item(i_1, a) == item(i_1, b)

            return map_1(_arrow1220, range_big_int(0, 1, length(a) - 1))

        return fold(folder, True, to_list(delay(_arrow1221))) if (length(a) == length(b)) else False
    ...
    def _arrow1225(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1224(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1223(i_2: int) -> bool:
                return equals(item(i_2, a_1), item(i_2, b_1))

            return map_1(_arrow1223, range_big_int(0, 1, length(a_1) - 1))

        return fold(folder_1, True, to_list(delay(_arrow1224))) if (length(a_1) == length(b_1)) else False
    ...
    def _arrow1228(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1227(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1226(i_3: int) -> bool:
                return equals(item(i_3, a_2), item(i_3, b_2))

            return map_1(_arrow1226, range_big_int(0, 1, length(a_2) - 1))

        return fold(folder_2, True, to_list(delay(_arrow1227))) if (length(a_2) == length(b_2)) else False
    ...
    def _arrow1231(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1230(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1229(i_4: int) -> bool:
                return equals(item(i_4, a_3), item(i_4, b_3))

            return map_1(_arrow1229, range_big_int(0, 1, length(a_3) - 1))

        return fold(folder_3, True, to_list(delay(_arrow1230))) if (length(a_3) == length(b_3)) else False
