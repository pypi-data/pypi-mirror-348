...
class LDSample:
    ...
    def validate_sample(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1538:
            ...
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1537(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Sample", s.AdditionalType, ObjectExpr1538()) if LDSample.validate(s, context) else False
    ...
    def validate_source(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1540:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1539(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Source", s.AdditionalType, ObjectExpr1540()) if LDSample.validate(s, context) else False

    @staticmethod
    def validate_material(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1542:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1541(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Material", s.AdditionalType, ObjectExpr1542()) if LDSample.validate(s, context) else False
