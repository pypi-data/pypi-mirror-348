...
class LabProcess(LDNode):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1568(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1569(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1570(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1571(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1571


LabProcess_reflection = _expr1572
