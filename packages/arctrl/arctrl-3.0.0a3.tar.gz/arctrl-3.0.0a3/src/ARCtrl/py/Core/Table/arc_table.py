...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr699()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr700()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow701(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow703(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow702(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow702, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow703))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        next_values: Any = Dictionary([], ObjectExpr704())
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow705(table: ArcTable) -> CompositeCell | None:
    ...
    def get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell]:
        def _arrow706(table: ArcTable) -> CompositeCell:
    ...
    def iter_columns(action: Callable[[CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow707(table: ArcTable) -> ArcTable:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow708(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def update_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow709(table: ArcTable) -> ArcTable:
    ...
    def update_cells_by(f: Callable[[int, int, CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow711(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def update_cell_by(column_index: int, row_index: int, f: Callable[[CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow712(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def add_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow714(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddColumnFill(self, header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> None:
        this: ArcTable = self
        def _arrow715(_arg: int) -> CompositeCell:
            return cell.Copy()

        cells: Array[CompositeCell] = initialize(this.RowCount, _arrow715, None)
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow722(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_2(_arrow722, index_arr)
        def _arrow723(index_1: int) -> None:
        ...
        iterate_2(_arrow723, sort_descending(index_arr, ObjectExpr724()))
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow727(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow726(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow726, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow727))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow728(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow729(table: ArcTable) -> CompositeColumn | None:
    ...
    def try_get_column_by_header_by(header_predicate: Callable[[CompositeHeader], bool]) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow730(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow733(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow734(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow735(table: ArcTable) -> CompositeColumn:
    ...
    def move_column(start_col: int, end_col: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow736(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow738(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow737(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow737, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow738)) if (cells is None) else value_3(cells)
    ...
    def update_row(row_index: int, cells: Array[CompositeCell]) -> Callable[[ArcTable], ArcTable]:
        def _arrow740(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow741(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow745(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow744(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow744, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow745))
        def _arrow746(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow746, None)
        this.AddRows(rows, index)

    @staticmethod
    def add_rows_empty(row_count: int, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow747(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow749(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_2(_arrow749, index_arr)
        def _arrow750(index_1: int) -> None:
        ...
        iterate_2(_arrow750, sort_descending(index_arr, ObjectExpr751()))

    @staticmethod
    def remove_rows(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow752(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.RemoveColumns(index_arr)
            return new_table
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow754(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow753(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow753, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow754))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow755(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow756(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow758(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr757()), None), None)

        return _arrow758

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow759(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow760(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow764(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow763(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow762(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow761(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow761, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow762))

                return map(_arrow763, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow764))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow773(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow772(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow771(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow770(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow765(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow768(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow767(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow766(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow766, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow767))

                        def _arrow769(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow765, range_big_int(0, 1, 19)), delay(_arrow768)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow769, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow770))

                return append_1(singleton("-------------"), delay(_arrow771))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow772))

        return join("\n", to_list(delay(_arrow773)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr774())
        ...
        def _arrow777(__unit: None=None) -> bool:
            ...
            def _arrow776(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow775(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow775, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow776))) if (length(a) == length(b)) else False

        if _arrow777() if (this.Name == other.Name) else False:
            ...
            def _arrow779(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow778(i_1: int) -> bool:
                    return equals(item(i_1, a_1), item(i_1, b_1))

                return map(_arrow778, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow779))) if (length(a_1) == length(b_1)) else False
