...
class ArcAssay(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        def _arrow939(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040129: str = _arrow939()
            ...
            def predicate(s: ArcStudy) -> bool:
                ...
                class ObjectExpr886:
                    ...
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow885(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(this.Identifier, source, ObjectExpr886())
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow887(assay: ArcAssay) -> ArcAssay:
    ...
    def add_tables(tables: IEnumerable_1[ArcTable], index: int | None=None) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow888(assay: ArcAssay) -> ArcAssay:
            c: ArcAssay = assay.Copy()
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcAssay], tuple[ArcAssay, ArcTable]]:
        def _arrow889(assay: ArcAssay) -> tuple[ArcAssay, ArcTable]:
            c: ArcAssay = assay.Copy()
    ...
    def init_tables(table_names: IEnumerable_1[str], index: int | None=None) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow890(assay: ArcAssay) -> ArcAssay:
            c: ArcAssay = assay.Copy()
    ...
    def get_table_at(index: int) -> Callable[[ArcAssay], ArcTable]:
        def _arrow891(assay: ArcAssay) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcAssay], ArcTable]:
        def _arrow892(assay: ArcAssay) -> ArcTable:
            new_assay: ArcAssay = assay.Copy()
    ...
    def set_table_at(index: int, table: ArcTable) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow895(assay: ArcAssay) -> ArcAssay:
            new_assay: ArcAssay = assay.Copy()
    ...
    def remove_table_at(index: int) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow897(assay: ArcAssay) -> ArcAssay:
            new_assay: ArcAssay = assay.Copy()
    ...
    def remove_table(name: str) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow898(assay: ArcAssay) -> ArcAssay:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow909(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow910(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow918(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow920(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e, combined, ObjectExpr921()):
                            (combined.append(e))
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1, combined, ObjectExpr923()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr924()):
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr925()):
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr926()):
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr927()):
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        def _arrow932(__unit: None=None) -> bool:
            ...
            def _arrow931(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow930(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow930, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow931))) if (length(a) == length(b)) else False

        def _arrow935(__unit: None=None) -> bool:
            ...
            def _arrow934(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow933(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow933, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow934))) if (length(a_1) == length(b_1)) else False
...
class ArcStudy(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, submission_date: str | None=None, public_release_date: str | None=None, publications: Array[Publication] | None=None, contacts: Array[Person] | None=None, study_design_descriptors: Array[OntologyAnnotation] | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, registered_assay_identifiers: Array[str] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        comments_1: Array[Comment] = default_arg(comments, [])
        def _arrow1009(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040579: str = _arrow1009()
        self.investigation: ArcInvestigation | None = None
    ...
    def add_registered_assay(assay: ArcAssay) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow946(study: ArcStudy) -> ArcStudy:
    ...
    def init_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], tuple[ArcStudy, ArcAssay]]:
        def _arrow947(study: ArcStudy) -> tuple[ArcStudy, ArcAssay]:
    ...
    def RegisterAssay(self, assay_identifier: str) -> None:
        ...
        class ObjectExpr949:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow948(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr949()):
    ...
    def register_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow950(study: ArcStudy) -> ArcStudy:
            copy: ArcStudy = study.Copy()
    ...
    def DeregisterAssay(self, assay_identifier: str) -> None:
        ...
        ignore(remove_in_place(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr952()))
    ...
    def GetRegisteredAssay(self, assay_identifier: str) -> ArcAssay:
        ...
        if not contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr955()):
    ...
    def get_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcAssay]:
        def _arrow956(study: ArcStudy) -> ArcAssay:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays_or_identifier(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow958(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def add_tables(tables: IEnumerable_1[ArcTable], index: int | None=None) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow960(study: ArcStudy) -> ArcStudy:
            c: ArcStudy = study.Copy()
            c.AddTables(tables, index)
            return c
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcStudy], tuple[ArcStudy, ArcTable]]:
        def _arrow961(study: ArcStudy) -> tuple[ArcStudy, ArcTable]:
            c: ArcStudy = study.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table(name: str) -> Callable[[ArcStudy], ArcTable]:
        def _arrow964(study: ArcStudy) -> ArcTable:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetTable(name)
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow982(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumn(table_name, column_index)
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow990(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRow(table_name, row_index)
    ...
    def StructurallyEquals(self, other: ArcStudy) -> bool:
        ...
        def _arrow993(__unit: None=None) -> bool:
            ...
            def _arrow992(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow991(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow991, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow992))) if (length(a) == length(b)) else False

        def _arrow996(__unit: None=None) -> bool:
            ...
            def _arrow995(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow994(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow994, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow995))) if (length(a_1) == length(b_1)) else False

        def _arrow999(__unit: None=None) -> bool:
            ...
            def _arrow998(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow997(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow997, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow998))) if (length(a_2) == length(b_2)) else False

        def _arrow1002(__unit: None=None) -> bool:
            ...
            def _arrow1001(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1000(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1000, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1001))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow1005(__unit: None=None) -> bool:
            ...
            def _arrow1004(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1003(i_5: int) -> bool:
                    return item(i_5, a_4) == item(i_5, b_4)

                return map_1(_arrow1003, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1004))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow1008(__unit: None=None) -> bool:
            ...
            def _arrow1007(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1006(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1006, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1007))) if (length(a_5) == length(b_5)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), equals(this.DataMap, other.DataMap), _arrow993(), _arrow996(), _arrow999(), _arrow1002(), _arrow1005(), _arrow1008()]))
...
class ArcWorkflow:
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, workflow_type: OntologyAnnotation | None=None, uri: str | None=None, version: str | None=None, sub_workflow_identifiers: Array[str] | None=None, parameters: Array[ProtocolParameter] | None=None, components: Array[Component] | None=None, datamap: DataMap | None=None, contacts: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        def _arrow1011(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_00401151: str = _arrow1011()
        self.investigation: ArcInvestigation | None = None
...
ArcWorkflow_reflection = _expr1012
...
class ArcRun(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, workflow_identifiers: Array[str] | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        def _arrow1071(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_00401447: str = _arrow1071()
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1013(run: ArcRun) -> ArcRun:
            c: ArcRun = run.Copy()
            c.AddTable(table, index)
            return c
    ...
    def add_tables(tables: IEnumerable_1[ArcTable], index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1014(run: ArcRun) -> ArcRun:
            c: ArcRun = run.Copy()
            c.AddTables(tables, index)
            return c
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcRun], tuple[ArcRun, ArcTable]]:
        def _arrow1015(run: ArcRun) -> tuple[ArcRun, ArcTable]:
            c: ArcRun = run.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def init_tables(table_names: IEnumerable_1[str], index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1016(run: ArcRun) -> ArcRun:
            c: ArcRun = run.Copy()
            c.InitTables(table_names, index)
            return c
    ...
    def get_table_at(index: int) -> Callable[[ArcRun], ArcTable]:
        def _arrow1017(run: ArcRun) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcRun], ArcTable]:
        def _arrow1019(run: ArcRun) -> ArcTable:
            new_run: ArcRun = run.Copy()
    ...
    def set_table_at(index: int, table: ArcTable) -> Callable[[ArcRun], ArcRun]:
        def _arrow1022(run: ArcRun) -> ArcRun:
            new_run: ArcRun = run.Copy()
    ...
    def remove_table_at(index: int) -> Callable[[ArcRun], ArcRun]:
        def _arrow1024(run: ArcRun) -> ArcRun:
            new_run: ArcRun = run.Copy()
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcRun], CompositeColumn]:
        def _arrow1039(run: ArcRun) -> CompositeColumn:
            new_run: ArcRun = run.Copy()
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcRun], CompositeColumn]:
        def _arrow1040(run: ArcRun) -> CompositeColumn:
            new_run: ArcRun = run.Copy()
    ...
    def add_row(table_name: str, cells: Array[CompositeCell] | None=None, row_index: int | None=None) -> Callable[[ArcRun], ArcRun]:
        def _arrow1042(run: ArcRun) -> ArcRun:
            new_run: ArcRun = run.Copy()
    ...
    def remove_row_at(table_index: int, row_index: int) -> Callable[[ArcRun], ArcRun]:
        def _arrow1043(run: ArcRun) -> ArcRun:
            new_run: ArcRun = run.Copy()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcRun], Array[CompositeCell]]:
        def _arrow1047(run: ArcRun) -> Array[CompositeCell]:
            new_run: ArcRun = run.Copy()
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcRun], Array[CompositeCell]]:
        def _arrow1048(run: ArcRun) -> Array[CompositeCell]:
            new_run: ArcRun = run.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1050:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1049(x_1: str, y: str) -> bool:
                                    return x_1 == y
                        ...
                        if not contains_1(e, combined, ObjectExpr1050()):
                            (combined.append(e))
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1052:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1051(x_2: str, y_1: str) -> bool:
                                    return x_2 == y_1
                        ...
                        if not contains_1(e_1, combined, ObjectExpr1052()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr1053()):
                            (combined_1.append(e_2))
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr1054()):
                            (combined_1.append(e_1_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr1055()):
                            (combined_2.append(e_3))
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr1056()):
                            (combined_2.append(e_1_2))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_4.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_4, combined_3, ObjectExpr1057()):
                ...
                try: 
                    while enumerator_1_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_3, combined_3, ObjectExpr1058()):
    ...
    def StructurallyEquals(self, other: ArcRun) -> bool:
        ...
        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.MeasurementType, other.MeasurementType), equals(this.TechnologyType, other.TechnologyType), equals(this.TechnologyPlatform, other.TechnologyPlatform), _arrow1061(), equals(this.DataMap, other.DataMap), _arrow1064(), _arrow1067(), _arrow1070()]))
...
class ArcInvestigation:
    ...
    def UnregisteredAssays(self, __unit: None=None) -> Array[ArcAssay]:
        ...
        def f(a: ArcAssay) -> bool:
            def predicate(s: ArcStudy, a: Any=a) -> bool:
                def _arrow1073(i: str, s: Any=s) -> bool:
                    return i == a.Identifier

                return exists(_arrow1073, s.RegisteredAssayIdentifiers)
    ...
    def add_assay(assay: ArcAssay, register_in: Array[ArcStudy] | None=None) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1074(inv: ArcInvestigation) -> ArcInvestigation:
    ...
    def init_assay(assay_identifier: str, register_in: Array[ArcStudy] | None=None) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1075(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def delete_assay_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1076(inv: ArcInvestigation) -> ArcInvestigation:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def remove_assay_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1078(inv: ArcInvestigation) -> ArcInvestigation:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def GetAssayIndex(self, assay_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1083(a: ArcAssay) -> bool:
            return a.Identifier == assay_identifier

        index: int = find_index(_arrow1083, this.Assays) or 0
        if index == -1:
    ...
    def get_assay_index(assay_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1084(inv: ArcInvestigation) -> int:
    ...
    def get_assay_at(index: int) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1085(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1086(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def TryGetAssay(self, assay_identifier: str) -> ArcAssay | None:
        this: ArcInvestigation = self
        def _arrow1087(a: ArcAssay) -> bool:
            return a.Identifier == assay_identifier

        return try_find(_arrow1087, this.Assays)

    @staticmethod
    def try_get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay | None]:
        def _arrow1088(inv: ArcInvestigation) -> ArcAssay | None:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def contains_assay(assay_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1089(inv: ArcInvestigation) -> bool:
    ...
    def UnregisteredStudies(self, __unit: None=None) -> Array[ArcStudy]:
        ...
        def f(s: ArcStudy) -> bool:
            def _arrow1092(__unit: None=None, s: Any=s) -> bool:
                source: Array[str] = this.RegisteredStudyIdentifiers
                def _arrow1091(__unit: None=None) -> Callable[[str], bool]:
                    x: str = s.Identifier
                    def _arrow1090(y: str) -> bool:
                        return x == y

                    return _arrow1090

                return exists(_arrow1091(), source)

            return not _arrow1092()
    ...
    def add_study(study: ArcStudy) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1093(inv: ArcInvestigation) -> ArcInvestigation:
    ...
    def init_study(study_identifier: str) -> Callable[[ArcInvestigation], tuple[ArcInvestigation, ArcStudy]]:
        def _arrow1094(inv: ArcInvestigation) -> tuple[ArcInvestigation, ArcStudy]:
            copy: ArcInvestigation = inv.Copy()
    ...
    def RegisterStudy(self, study_identifier: str) -> None:
        ...
        class ObjectExpr1096:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1095(x_1: str, y: str) -> bool:
                    return x_1 == y
        ...
        if contains(study_ident_1, this.RegisteredStudyIdentifiers, ObjectExpr1096()):
    ...
    def register_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1097(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def add_registered_study(study: ArcStudy) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1098(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def delete_study_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1099(i: ArcInvestigation) -> ArcInvestigation:
    ...
    def remove_study_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1102(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def remove_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1103(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def rename_study(old_identifier: str, new_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1104(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def GetStudyIndex(self, study_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1107(s: ArcStudy) -> bool:
            return s.Identifier == study_identifier

        index: int = find_index(_arrow1107, this.Studies) or 0
        if index == -1:
    ...
    def get_study_index(study_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1108(inv: ArcInvestigation) -> int:
    ...
    def get_study_at(index: int) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1109(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1110(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def try_get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy | None]:
        def _arrow1111(inv: ArcInvestigation) -> ArcStudy | None:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def contains_study(study_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1112(inv: ArcInvestigation) -> bool:
    ...
    def DeregisterStudy(self, study_identifier: str) -> None:
        ...
        class ObjectExpr1118:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1117(x: str, y: str) -> bool:
                    return x == y
        ...
        ignore(remove_in_place(study_identifier, this.RegisteredStudyIdentifiers, ObjectExpr1118()))

    @staticmethod
    def deregister_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1119(i: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = i.Copy()
    ...
    def GetWorkflowIndex(self, workflow_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1120(w: ArcWorkflow) -> bool:
            return ArcWorkflow__get_Identifier(w) == workflow_identifier

        index: int = find_index(_arrow1120, this.Workflows) or 0
        if index == -1:
    ...
    def get_workflow_index(workflow_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1121(inv: ArcInvestigation) -> int:
    ...
    def add_workflow(workflow: ArcWorkflow) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1122(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def init_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], ArcWorkflow]:
        def _arrow1123(inv: ArcInvestigation) -> ArcWorkflow:
            copy: ArcInvestigation = inv.Copy()
    ...
    def delete_workflow_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1124(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def DeleteWorkflow(self, workflow_identifier: str) -> None:
        this: ArcInvestigation = self
        def _arrow1125(w: ArcWorkflow) -> bool:
            return ArcWorkflow__get_Identifier(w) == workflow_identifier

        index: int = find_index(_arrow1125, this.Workflows) or 0
        this.DeleteWorkflowAt(index)

    @staticmethod
    def delete_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1126(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def get_workflow_at(index: int) -> Callable[[ArcInvestigation], ArcWorkflow]:
        def _arrow1127(inv: ArcInvestigation) -> ArcWorkflow:
            copy: ArcInvestigation = inv.Copy()
    ...
    def get_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], ArcWorkflow]:
        def _arrow1128(inv: ArcInvestigation) -> ArcWorkflow:
            copy: ArcInvestigation = inv.Copy()
    ...
    def try_get_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], ArcWorkflow | None]:
        def _arrow1129(inv: ArcInvestigation) -> ArcWorkflow | None:
            copy: ArcInvestigation = inv.Copy()
    ...
    def contains_workflow(workflow_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1130(inv: ArcInvestigation) -> bool:
    ...
    def set_workflow(workflow_identifier: str, workflow: ArcWorkflow) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1131(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def GetRunIndex(self, run_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1133(r: ArcRun) -> bool:
            return r.Identifier == run_identifier

        index: int = find_index(_arrow1133, this.Runs) or 0
        if index == -1:
    ...
    def get_run_index(run_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1134(inv: ArcInvestigation) -> int:
    ...
    def init_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1136(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def DeleteRun(self, run_identifier: str) -> None:
        this: ArcInvestigation = self
        def _arrow1138(w: ArcRun) -> bool:
            return w.Identifier == run_identifier

        index: int = find_index(_arrow1138, this.Runs) or 0
    ...
    def get_run_at(index: int) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1140(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun]:
        def _arrow1141(inv: ArcInvestigation) -> ArcRun:
            copy: ArcInvestigation = inv.Copy()
    ...
    def try_get_run(run_identifier: str) -> Callable[[ArcInvestigation], ArcRun | None]:
        def _arrow1142(inv: ArcInvestigation) -> ArcRun | None:
            copy: ArcInvestigation = inv.Copy()
    ...
    def contains_run(run_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1143(inv: ArcInvestigation) -> bool:
    ...
    def set_run_at(index: int, run: ArcRun) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1144(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def set_run(run_identifier: str, run: ArcRun) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1145(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr1146())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr1147())
            ...
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1149:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1148(x: str, y: str) -> bool:
                                    return x == y
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr1149()):
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow1156(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow1151(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow1155(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow1152(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                def _arrow1154(__unit: None=None) -> IEnumerable_1[ArcTable]:
                    def _arrow1153(run: ArcRun) -> IEnumerable_1[ArcTable]:
                        return run.Tables

                    return collect(_arrow1153, this.Runs)

                return append_4(collect(_arrow1152, this.Assays), delay(_arrow1154))

            return append_4(collect(_arrow1151, this.Studies), delay(_arrow1155))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow1156))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow1159(__unit: None=None) -> bool:
            a: IEnumerable_1[Publication] = this.Publications
            b: IEnumerable_1[Publication] = other.Publications
            def folder(acc: bool, e: bool) -> bool:
                if acc:
            ...
            def _arrow1158(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1157(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow1157, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1158))) if (length(a) == length(b)) else False

        def _arrow1162(__unit: None=None) -> bool:
            a_1: IEnumerable_1[Person] = this.Contacts
            b_1: IEnumerable_1[Person] = other.Contacts
            def folder_1(acc_1: bool, e_1: bool) -> bool:
                if acc_1:
            ...
            def _arrow1161(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1160(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1160, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1161))) if (length(a_1) == length(b_1)) else False

        def _arrow1165(__unit: None=None) -> bool:
            ...
            def _arrow1164(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1163(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1163, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1164))) if (length(a_2) == length(b_2)) else False

        def _arrow1168(__unit: None=None) -> bool:
            ...
            def _arrow1167(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1166(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1166, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1167))) if (length(a_3) == length(b_3)) else False

        def _arrow1171(__unit: None=None) -> bool:
            ...
            def _arrow1170(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1169(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow1169, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1170))) if (length(a_4) == length(b_4)) else False

        def _arrow1174(__unit: None=None) -> bool:
            ...
            def _arrow1173(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1172(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1172, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1173))) if (length(a_5) == length(b_5)) else False

        def _arrow1177(__unit: None=None) -> bool:
            ...
            def _arrow1176(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1175(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow1175, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow1176))) if (length(a_6) == length(b_6)) else False

        def _arrow1180(__unit: None=None) -> bool:
            ...
            def _arrow1179(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1178(i_8: int) -> bool:
                    return item(i_8, a_7) == item(i_8, b_7)

                return map_1(_arrow1178, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow1179))) if (length(a_7) == length(b_7)) else False

        def _arrow1183(__unit: None=None) -> bool:
            ...
            def _arrow1182(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1181(i_9: int) -> bool:
                    return equals(item(i_9, a_8), item(i_9, b_8))

                return map_1(_arrow1181, range_big_int(0, 1, length(a_8) - 1))

            return fold(folder_8, True, to_list(delay(_arrow1182))) if (length(a_8) == length(b_8)) else False

        def _arrow1186(__unit: None=None) -> bool:
            ...
            def _arrow1185(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1184(i_10: int) -> bool:
                    return equals(item(i_10, a_9), item(i_10, b_9))

                return map_1(_arrow1184, range_big_int(0, 1, length(a_9) - 1))

            return fold(folder_9, True, to_list(delay(_arrow1185))) if (length(a_9) == length(b_9)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow1159(), _arrow1162(), _arrow1165(), _arrow1168(), _arrow1171(), _arrow1174(), _arrow1177(), _arrow1180(), _arrow1183(), _arrow1186()]))
...
ArcInvestigation_reflection = _expr1187
...
def ArcWorkflow_addSubWorkflow_Z1C75CB0E(sub_workflow: ArcWorkflow) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1188(workflow: ArcWorkflow, sub_workflow: Any=sub_workflow) -> ArcWorkflow:
...
def ArcWorkflow_initSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], tuple[ArcWorkflow, ArcWorkflow]]:
    def _arrow1189(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> tuple[ArcWorkflow, ArcWorkflow]:
...
def ArcWorkflow__RegisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    class ObjectExpr1191:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1190(x: str, y: str) -> bool:
                return x == y
    ...
    if contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1191()):
...
def ArcWorkflow_registerSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1192(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
        copy: ArcWorkflow = ArcWorkflow__Copy_6FCE9E49(workflow)
...
def ArcWorkflow__DeregisterSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> None:
    class ObjectExpr1194:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1193(x: str, y: str) -> bool:
                return x == y
    ...
    ignore(remove_in_place(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1194()))


def ArcWorkflow_deregisterSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1195(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
        copy: ArcWorkflow = ArcWorkflow__Copy_6FCE9E49(workflow)
...
def ArcWorkflow__GetRegisteredSubWorkflow_Z721C83C5(this: ArcWorkflow, sub_workflow_identifier: str) -> ArcWorkflow:
    class ObjectExpr1197:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1196(x: str, y: str) -> bool:
                return x == y
    ...
    if not contains(sub_workflow_identifier, ArcWorkflow__get_SubWorkflowIdentifiers(this), ObjectExpr1197()):
...
def ArcWorkflow_getRegisteredSubWorkflow_Z721C83C5(sub_workflow_identifier: str) -> Callable[[ArcWorkflow], ArcWorkflow]:
    def _arrow1198(workflow: ArcWorkflow, sub_workflow_identifier: Any=sub_workflow_identifier) -> ArcWorkflow:
...
def ArcWorkflow_getRegisteredSubWorkflows(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1199(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow_getRegisteredSubWorkflowsOrIdentifier(__unit: None=None) -> Callable[[ArcWorkflow], Array[ArcWorkflow]]:
    def _arrow1200(workflow: ArcWorkflow) -> Array[ArcWorkflow]:
...
def ArcWorkflow__StructurallyEquals_Z1C75CB0E(this: ArcWorkflow, other: ArcWorkflow) -> bool:
    ...
    def _arrow1204(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1203(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1202(i_1: int) -> bool:
                return item(i_1, a) == item(i_1, b)

            return map_1(_arrow1202, range_big_int(0, 1, length(a) - 1))

        return fold(folder, True, to_list(delay(_arrow1203))) if (length(a) == length(b)) else False

    def _arrow1207(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1206(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1205(i_2: int) -> bool:
                return equals(item(i_2, a_1), item(i_2, b_1))

            return map_1(_arrow1205, range_big_int(0, 1, length(a_1) - 1))

        return fold(folder_1, True, to_list(delay(_arrow1206))) if (length(a_1) == length(b_1)) else False

    def _arrow1210(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1209(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1208(i_3: int) -> bool:
                return equals(item(i_3, a_2), item(i_3, b_2))

            return map_1(_arrow1208, range_big_int(0, 1, length(a_2) - 1))

        return fold(folder_2, True, to_list(delay(_arrow1209))) if (length(a_2) == length(b_2)) else False

    def _arrow1213(__unit: None=None, this: Any=this, other: Any=other) -> bool:
        ...
        def _arrow1212(__unit: None=None) -> IEnumerable_1[bool]:
            def _arrow1211(i_4: int) -> bool:
                return equals(item(i_4, a_3), item(i_4, b_3))

            return map_1(_arrow1211, range_big_int(0, 1, length(a_3) - 1))

        return fold(folder_3, True, to_list(delay(_arrow1212))) if (length(a_3) == length(b_3)) else False

    def _arrow1216(__unit: None=None, this: Any=this, other: Any=other) -> bool:
