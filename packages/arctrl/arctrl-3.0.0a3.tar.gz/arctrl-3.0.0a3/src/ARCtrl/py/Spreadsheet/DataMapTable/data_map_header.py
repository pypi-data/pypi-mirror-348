...
def to_fs_cells(comment_keys: FSharpList[str]) -> FSharpList[FsCell]:
    def _arrow1377(__unit: None=None, comment_keys: Any=comment_keys) -> IEnumerable_1[FsCell]:
                    ...
                    def _arrow1373(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1372(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1371(__unit: None=None) -> IEnumerable_1[FsCell]:
                                ...
                                return append(to_enumerable([FsCell("Label")]), delay(_arrow1370))

                            return append(to_enumerable([FsCell("Generated By")]), delay(_arrow1371))

                        return append(to_enumerable([FsCell("Description")]), delay(_arrow1372))

                    return append(to_enumerable([FsCell("Object Type"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1373))

                return append(to_enumerable([FsCell("Unit"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1374))

            return append(to_enumerable([FsCell("Explication"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1375))

        return append(to_enumerable([FsCell("Data"), FsCell("Data Format"), FsCell("Data Selector Format")]), delay(_arrow1376))

    return to_list(delay(_arrow1377))
