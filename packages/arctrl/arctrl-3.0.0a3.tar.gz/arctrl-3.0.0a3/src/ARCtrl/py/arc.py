...
class ARC(ArcInvestigation):
    ...
    def try_load_async(arc_path: str) -> Async[FSharpResult_2[ARC, Array[str]]]:
        def _arrow3774(__unit: None=None) -> Async[FSharpResult_2[ARC, Array[str]]]:
            def _arrow3773(_arg: Array[str]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                arc: ARC = ARC.from_file_paths(to_array(_arg))
                contracts: Array[Contract] = arc.GetReadContracts()
                def _arrow3772(_arg_1: FSharpResult_2[Array[Contract], Array[str]]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                ...
                return singleton.Bind(full_fill_contract_batch_async(arc_path, contracts), _arrow3772)

            return singleton.Bind(get_all_file_paths_async(arc_path), _arrow3773)

        return singleton.Delay(_arrow3774)

    def GetAssayRemoveContracts(self, assay_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3776:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3775(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.AssayIdentifiers, ObjectExpr3776()):
        ...
        def _arrow3779(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3778(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3777(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)), delay(_arrow3777))

            return append(singleton_1(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3778))

        return to_array(delay(_arrow3779))
    ...
    def GetAssayRenameContracts(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3781:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3780(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_assay_identifier, this.AssayIdentifiers, ObjectExpr3781()):
            raise Exception("ARC does not contain assay with given name")
        ...
        def _arrow3783(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3782(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3782))

        return to_array(delay(_arrow3783))
    ...
    def GetStudyRenameContracts(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        this: ARC = self
        class ObjectExpr3785:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3784(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(old_study_identifier, this.StudyIdentifiers, ObjectExpr3785()):
        ...
        renamed_paths: Array[str] = map_1(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow3787(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3786(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3786))

        return to_array(delay(_arrow3787))
    ...
    def WriteAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3789(__unit: None=None) -> Async[None]:
            def _arrow3788(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
            ...
            return singleton.Bind(this.TryWriteAsync(arc_path), _arrow3788)

        return singleton.Delay(_arrow3789)

    def UpdateAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3791(__unit: None=None) -> Async[None]:
            def _arrow3790(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryUpdateAsync(arc_path), _arrow3790)

        return singleton.Delay(_arrow3791)

    def RemoveAssayAsync(self, arc_path: str, assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3793(__unit: None=None) -> Async[None]:
            def _arrow3792(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveAssayAsync(arc_path, assay_identifier), _arrow3792)

        return singleton.Delay(_arrow3793)
    ...
    def RenameAssayAsync(self, arc_path: str, old_assay_identifier: str, new_assay_identifier: str) -> Async[None]:
        ...
        def _arrow3795(__unit: None=None) -> Async[None]:
            ...
            return singleton.Bind(this.TryRenameAssayAsync(arc_path, old_assay_identifier, new_assay_identifier), _arrow3794)
    ...
    def RemoveStudyAsync(self, arc_path: str, study_identifier: str) -> Async[None]:
        ...
        def _arrow3797(__unit: None=None) -> Async[None]:
            ...
            return singleton.Bind(this.TryRemoveStudyAsync(arc_path, study_identifier), _arrow3796)
    ...
    def RenameStudyAsync(self, arc_path: str, old_study_identifier: str, new_study_identifier: str) -> Async[None]:
        ...
        def _arrow3799(__unit: None=None) -> Async[None]:
            ...
            return singleton.Bind(this.TryRenameStudyAsync(arc_path, old_study_identifier, new_study_identifier), _arrow3798)

        return singleton.Delay(_arrow3799)

    @staticmethod
    def load_async(arc_path: str) -> Async[ARC]:
        def _arrow3801(__unit: None=None) -> Async[ARC]:
            def _arrow3800(_arg: FSharpResult_2[ARC, Array[str]]) -> Async[ARC]:
            ...
            return singleton.Bind(ARC.try_load_async(arc_path), _arrow3800)
    ...
    def MakeDataFilesAbsolute(self, __unit: None=None) -> None:
        this: ARC = self
        class ObjectExpr3802:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        files_paths: Any = of_seq(this.FileSystem.Tree.ToFilePaths(), ObjectExpr3802())
        ...
        def update_column_option(data_name_function: Callable[[Data], str], col: CompositeColumn | None=None) -> None:
            ...
            if col is not None:
                def _arrow3803(__unit: None=None, data_name_function: Any=data_name_function, col: Any=col) -> bool:
        ...
        if this.StaticHash == 0:
            ...
            def _arrow3828(__unit: None=None) -> IEnumerable_1[Contract]:
                ...
                def _arrow3827(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    def _arrow3808(s: ArcStudy) -> IEnumerable_1[Contract]:
                        ...
                        def _arrow3807(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value is not None:
                                if DataMap__get_StaticHash(match_value) == 0:
                                    ...
                                    def _arrow3806(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                ...
                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3804))

                            elif pattern_matching_result == 1:
                                def _arrow3805(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3805))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3807))

                    def _arrow3826(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3813(a: ArcAssay) -> IEnumerable_1[Contract]:
                            ...
                            def _arrow3812(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_1 is not None:
                                    if DataMap__get_StaticHash(match_value_1) == 0:
                                        ...
                                        def _arrow3811(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    ...
                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3809))
                                    ...
                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3810))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton_1(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3812))

                        def _arrow3825(__unit: None=None) -> IEnumerable_1[Contract]:
                            def _arrow3818(w: ArcWorkflow) -> IEnumerable_1[Contract]:
                                ...
                                def _arrow3817(__unit: None=None) -> IEnumerable_1[Contract]:
                                    ...
                                    if match_value_2 is not None:
                                        if DataMap__get_StaticHash(match_value_2) == 0:
                                            ...
                                            def _arrow3816(__unit: None=None) -> bool:
                                    ...
                                    if pattern_matching_result_2 == 0:
                                        ...
                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForWorkflow_Z721C83C5(dm_10, ArcWorkflow__get_Identifier(w))), delay(_arrow3814))
                                        ...
                                        return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForWorkflow_Z721C83C5(dm_11, ArcWorkflow__get_Identifier(w))), delay(_arrow3815))

                                    elif pattern_matching_result_2 == 2:
                                        return empty()


                                return append(ARCtrl_ArcWorkflow__ArcWorkflow_ToCreateContract_6FCE9E49(w, True) if (ArcWorkflow__get_StaticHash(w) == 0) else (singleton_1(ARCtrl_ArcWorkflow__ArcWorkflow_ToUpdateContract(w)) if (ArcWorkflow__get_StaticHash(w) != hash_4) else empty()), delay(_arrow3817))

                            def _arrow3824(__unit: None=None) -> IEnumerable_1[Contract]:
                                def _arrow3823(r: ArcRun) -> IEnumerable_1[Contract]:
                                    ...
                                    def _arrow3822(__unit: None=None) -> IEnumerable_1[Contract]:
                                        ...
                                        if match_value_3 is not None:
                                            if DataMap__get_StaticHash(match_value_3) == 0:
                                                ...
                                                def _arrow3821(__unit: None=None) -> bool:
                                        ...
                                        if pattern_matching_result_3 == 0:
                                            ...
                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForRun_Z721C83C5(dm_14, r.Identifier)), delay(_arrow3819))
                                            ...
                                            return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForRun_Z721C83C5(dm_15, r.Identifier)), delay(_arrow3820))

                                        elif pattern_matching_result_3 == 2:
                                            return empty()


                                    return append(ARCtrl_ArcRun__ArcRun_ToCreateContract_6FCE9E49(r, True) if (r.StaticHash == 0) else (singleton_1(ARCtrl_ArcRun__ArcRun_ToUpdateContract(r)) if (r.StaticHash != hash_5) else empty()), delay(_arrow3822))

                                return collect(_arrow3823, this.Runs)

                            return append(collect(_arrow3818, this.Workflows), delay(_arrow3824))

                        return append(collect(_arrow3813, this.Assays), delay(_arrow3825))

                    return append(collect(_arrow3808, this.Studies), delay(_arrow3826))

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(this)) if (this.StaticHash != hash_1) else empty(), delay(_arrow3827))

            return to_array(delay(_arrow3828))
        ...
        def _arrow3832(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3831(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3830(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton_1(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3829))

                return append(singleton_1(gitattributes_contract), delay(_arrow3830))

            return append(singleton_1(Init_createInitContract_6DFDD678(branch)), delay(_arrow3831))

        return to_array(delay(_arrow3832))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_1(s_1: ArcStudy) -> Any:
            ...
            def _arrow3840(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3839(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3838(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3837(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3836(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3835(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3834(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton_1(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3834))

                                return append(singleton_1(text_value), delay(_arrow3835))

                            return collect(_arrow3836, table.Values)

                        return collect(_arrow3837, s_1.Tables)

                    return append(singleton_1(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3838))

                return append(singleton_1(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3839))

            class ObjectExpr3841:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3840)), ObjectExpr3841())

        class ObjectExpr3842:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_2(a: ArcAssay) -> Any:
            ...
            def _arrow3849(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3848(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3847(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3846(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3845(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow3844(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3843(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton_1(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton_1(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3843))

                                return append(singleton_1(text_value_1), delay(_arrow3844))

                            return collect(_arrow3845, table_1.Values)

                        return collect(_arrow3846, a.Tables)

                    return append(singleton_1(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3847))

                return append(singleton_1(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3848))
            ...
            return of_seq(to_list(delay(_arrow3849)), ObjectExpr3850())

        class ObjectExpr3851:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr3852:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3833()), union_many(map_1(mapping_1, registered_studies, None), ObjectExpr3842()), union_many(map_1(mapping_2, registered_assays, None), ObjectExpr3851())]), ObjectExpr3852())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3853(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3853)(tree_1)

            else: 
                return tree_1


        def _arrow3855(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3854(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3854)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3855()), FileSystemTree.from_file_paths([]))
    ...
    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3856())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3857(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3857)(tree_1)

            else: 
                return tree_1


        def _arrow3859(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3858(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3858)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3859()), FileSystemTree.from_file_paths([]))
    ...
    def DefaultContracts() -> Any:
        ...
        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3860())
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3863:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3862(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3863()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3865:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3864(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3865()):
            def predicate(p: str) -> bool:
