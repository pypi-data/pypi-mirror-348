...
def Dictionary_ofSeq(s: IEnumerable_1[tuple[_KEY, _T]]) -> Any:
    ...
    dict_1: Any = Dictionary([], ObjectExpr1427())
...
def Dictionary_tryFind(key: Any, dict_1: Any) -> Any | None:
    ...
    out_arg: _T = None
    def _arrow1428(__unit: None=None, key: Any=key, dict_1: Any=dict_1) -> _T:
        return out_arg

    def _arrow1429(v: _T | None=None, key: Any=key, dict_1: Any=dict_1) -> None:
        nonlocal out_arg
        out_arg = v

    pattern_input = (try_get_value(dict_1, key, FSharpRef(_arrow1428, _arrow1429)), out_arg)
    if pattern_input[0]:
...
class LDContext:
    ...
    def try_find_term(self, term: str) -> str | None:
        ...
        if definition is None:
            ...
            def _arrow1437(__unit: None=None) -> str | None:
                prefix: str = active_pattern_result[0]
                suffix: str = active_pattern_result[1]
            ...
            def _arrow1438(__unit: None=None) -> str | None:
                d: str = definition
                return d

            return _arrow1437() if (active_pattern_result is not None) else _arrow1438()
...
LDContext_reflection = _expr1439
