...
def _arrow3407(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3406(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
        ...
        return list(to_array(delay(_arrow3406)))

    return object(getter, value_1)


Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow3407

def _arrow3408(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow3408

def _arrow3410(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        object_arg: IOptionalGetter = get.Optional
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow3409(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow3409, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow3410
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow3411

def _arrow3412(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow3412

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow3413(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow3414(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow3418(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3417(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow3416(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow3415(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow3415(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))

            return collect(_arrow3416, dict_1.keys())

        return list(to_array(delay(_arrow3417)))

    return object(getter, value_1)


Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow3418

def _arrow3420(value_2: YAMLElement) -> Array[str]:
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow3420

def _arrow3428(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3427(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow3426(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow3421(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow3421, value)
                ...
                def _arrow3425(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr3423():
                        wf_step.Hints = hints
                        return empty_1()
                    ...
                    return append(_expr3423() if (hints is not None) else empty_1(), delay(_arrow3424))

                return append(_expr3422() if (requirements is not None) else empty_1(), delay(_arrow3425))
...
Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3428

def _arrow3429(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3429
