...
def _arrow1813(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1796()), ("bio", ObjectExpr1797()), ("Protocol", ObjectExpr1798()), ("name", ObjectExpr1799()), ("protocolType", ObjectExpr1800()), ("description", ObjectExpr1801()), ("version", ObjectExpr1802()), ("components", ObjectExpr1804()), ("reagents", ObjectExpr1805()), ("computationalTools", ObjectExpr1806()), ("uri", ObjectExpr1807()), ("comments", ObjectExpr1809())])
