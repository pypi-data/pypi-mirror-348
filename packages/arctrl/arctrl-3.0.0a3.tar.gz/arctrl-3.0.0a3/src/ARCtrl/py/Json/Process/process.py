...
def _arrow2699(get: IGetters) -> Process:
    ...
    def _arrow2692(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2693(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2696(__unit: None=None) -> FSharpList[ProcessInput] | None:
        arg_13: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("inputs", arg_13)

    def _arrow2697(__unit: None=None) -> FSharpList[ProcessOutput] | None:
        arg_15: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ROCrate_decoder_4)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("outputs", arg_15)

    def _arrow2698(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2690(), _arrow2691(), _arrow2692(), _arrow2693(), _arrow2694(), _arrow2695(), None, None, _arrow2696(), _arrow2697(), _arrow2698())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2699)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2703(value: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2702(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value)

            return ObjectExpr2702()

        def _arrow2705(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2706(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2707(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2709(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2711(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2712(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2713(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2714(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2715(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2716(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2703, ROCrate_genID(oa_1)), try_include("name", _arrow2705, oa_1.Name), try_include("executesProtocol", _arrow2706, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2707, oa_1.ParameterValues), try_include("performer", _arrow2709, oa_1.Performer), try_include("date", _arrow2711, oa_1.Date), try_include("previousProcess", _arrow2712, oa_1.PreviousProcess), try_include("nextProcess", _arrow2713, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2714, oa_1.Inputs), try_include_list_opt("outputs", _arrow2715, oa_1.Outputs), try_include_list_opt("comments", _arrow2716, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2718(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2718, f, oa, id_map)
...
def _arrow2731(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2730(get: IGetters) -> Process:
            def _arrow2719(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2720(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2721(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2722(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
            ...
            def _arrow2726(__unit: None=None) -> Process | None:
                arg_15: Decoder_1[Process] = decode(None)
                object_arg_7: IOptionalGetter = get.Optional
                return object_arg_7.Field("nextProcess", arg_15)

            def _arrow2727(__unit: None=None) -> FSharpList[ProcessInput] | None:
                arg_17: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ISAJson_decoder_3)
                object_arg_8: IOptionalGetter = get.Optional
                return object_arg_8.Field("inputs", arg_17)

            def _arrow2728(__unit: None=None) -> FSharpList[ProcessOutput] | None:
                arg_19: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ISAJson_decoder_4)
                object_arg_9: IOptionalGetter = get.Optional
                return object_arg_9.Field("outputs", arg_19)

            def _arrow2729(__unit: None=None) -> FSharpList[Comment] | None:
                arg_21: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_5)
                object_arg_10: IOptionalGetter = get.Optional
                return object_arg_10.Field("comments", arg_21)

            return Process(_arrow2719(), _arrow2720(), _arrow2721(), _arrow2722(), _arrow2723(), _arrow2724(), _arrow2725(), _arrow2726(), _arrow2727(), _arrow2728(), _arrow2729())

        return object(_arrow2730)

    return decode(None)


ISAJson_decoder: Decoder_1[Process] = _arrow2731()
