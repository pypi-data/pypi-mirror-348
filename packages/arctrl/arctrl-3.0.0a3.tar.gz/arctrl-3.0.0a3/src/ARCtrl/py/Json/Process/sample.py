...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2618(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2622(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2623(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2618()), ("@type", list_1_2(singleton(ObjectExpr2619()))), ("additionalType", ObjectExpr2620()), try_include("name", _arrow2622, oa.Name), try_include_list("additionalProperties", _arrow2623, additional_properties), ("@context", context_jsonvalue)]))
    class ObjectExpr2624(IEncodable):
    ...
    return ObjectExpr2624()


class ObjectExpr2626(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2625(__unit: None=None) -> str:
        ...
        if (_arrow2625() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2626()

def _arrow2630(get: IGetters) -> Sample:
    ...
    def _arrow2629(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2627(), _arrow2628(), pattern_input[0], pattern_input[1], _arrow2629())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2630)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2636(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2641(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2642(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2643(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2644(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2636, ROCrate_genID(oa_1)), try_include("name", _arrow2641, oa_1.Name), try_include_list_opt("characteristics", _arrow2642, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2643, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2644, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2651(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2651, f, oa, id_map)
...
def _arrow2657(get: IGetters) -> Sample:
    ...
    def _arrow2654(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2655(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2656(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2652(), _arrow2653(), _arrow2654(), _arrow2655(), _arrow2656())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2657)
