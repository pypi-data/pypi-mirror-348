...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3171(value_1: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3173(value_3: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3175(value_5: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3177(value_7: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3178(osr: OntologySourceReference, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow3179(oa: Publication, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow3180(person: Person, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow3181(assay: ArcAssay, inv: Any=inv) -> IEncodable:
        return encoder_4(assay)

    def _arrow3182(study: ArcStudy, inv: Any=inv) -> IEncodable:
        return encoder_5(study)

    def _arrow3184(value_9: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3185(comment: Comment, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3168()), try_include("Title", _arrow3171, inv.Title), try_include("Description", _arrow3173, inv.Description), try_include("SubmissionDate", _arrow3175, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow3177, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow3178, inv.OntologySourceReferences), try_include_seq("Publications", _arrow3179, inv.Publications), try_include_seq("Contacts", _arrow3180, inv.Contacts), try_include_seq("Assays", _arrow3181, inv.Assays), try_include_seq("Studies", _arrow3182, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow3184, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow3185, inv.Comments)]))
...
def _arrow3199(get: IGetters) -> ArcInvestigation:
    def _arrow3187(__unit: None=None) -> str:
    ...
    def _arrow3191(__unit: None=None) -> str | None:
    ...
    return ArcInvestigation(_arrow3187(), _arrow3188(), _arrow3189(), _arrow3190(), _arrow3191(), _arrow3192(), _arrow3193(), _arrow3194(), _arrow3195(), _arrow3196(), None, None, _arrow3197(), _arrow3198())
