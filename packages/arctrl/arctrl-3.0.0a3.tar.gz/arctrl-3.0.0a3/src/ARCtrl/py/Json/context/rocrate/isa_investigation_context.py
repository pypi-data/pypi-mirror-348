...
def _arrow1693(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1678()), ("Investigation", ObjectExpr1679()), ("identifier", ObjectExpr1680()), ("title", ObjectExpr1681()), ("additionalType", ObjectExpr1682()), ("description", ObjectExpr1683()), ("submissionDate", ObjectExpr1684()), ("publicReleaseDate", ObjectExpr1685()), ("publications", ObjectExpr1686()), ("people", ObjectExpr1687()), ("studies", ObjectExpr1688()), ("ontologySourceReferences", ObjectExpr1689()), ("comments", ObjectExpr1690()), ("filename", ObjectExpr1691())])
...
context_jsonvalue: IEncodable = _arrow1693()
