...
def _arrow2842(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2842
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2844(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2846(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2848(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2850(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2844()), ("table", encoder(template.Table)), ("name", _arrow2846()), ("description", _arrow2848()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2850()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2864(get: IGetters) -> Template:
    def _arrow2852(__unit: None=None) -> str:
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("id", guid)

    def _arrow2853(__unit: None=None) -> ArcTable:
    ...
    def _arrow2856(__unit: None=None) -> Organisation:
    ...
    def _arrow2858(__unit: None=None) -> Array[Person] | None:
        arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("authors", arg_13)

    def _arrow2860(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2861(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2862(__unit: None=None) -> Any:
        object_arg_9: IRequiredGetter = get.Required
        return object_arg_9.Field("last_updated", Decode_datetime)

    return Template.create(_arrow2852(), _arrow2853(), _arrow2854(), _arrow2855(), _arrow2856(), _arrow2857(), _arrow2858(), _arrow2860(), _arrow2861(), _arrow2862())


Template_decoder: Decoder_1[Template] = object(_arrow2864)

def Template_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, template: Template) -> IEncodable:
    def _arrow2867(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_1: str
        copy_of_struct: str = template.Id
        value_1 = str(copy_of_struct)
    ...
    def _arrow2869(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_3: str = template.Name
    ...
    def _arrow2871(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_4: str = template.Description
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2867()), ("table", encoder_compressed(string_table, oa_table, cell_table, template.Table)), ("name", _arrow2869()), ("description", _arrow2871()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2873()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", _arrow2875())])
...
def Template_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[Template]:
    def _arrow2887(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> Template:
        def _arrow2877(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("id", guid)

        def _arrow2878(__unit: None=None) -> ArcTable:
        ...
        def _arrow2880(__unit: None=None) -> str:
            object_arg_3: IRequiredGetter = get.Required
            return object_arg_3.Field("description", string)

        def _arrow2881(__unit: None=None) -> Organisation:
            object_arg_4: IRequiredGetter = get.Required
            return object_arg_4.Field("organisation", Template_Organisation_decoder)
        ...
        def _arrow2883(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("authors", arg_13)
        ...
        def _arrow2885(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_17: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("tags", arg_17)

        def _arrow2886(__unit: None=None) -> Any:
            object_arg_9: IRequiredGetter = get.Required
            return object_arg_9.Field("last_updated", datetime_local)

        return Template.create(_arrow2877(), _arrow2878(), _arrow2879(), _arrow2880(), _arrow2881(), _arrow2882(), _arrow2883(), _arrow2884(), _arrow2885(), _arrow2886())

    return object(_arrow2887)
