...
def encoder(assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2892(__unit: None=None, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2894(value_1: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2896(value_3: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2897(oa: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2898(oa_1: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2899(oa_2: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2900(dm: DataMap, assay: Any=assay) -> IEncodable:
        return encoder_4(dm)

    def _arrow2901(table: ArcTable, assay: Any=assay) -> IEncodable:
        return encoder_5(table)

    def _arrow2902(person: Person, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2903(comment: Comment, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2892()), try_include("Title", _arrow2894, assay.Title), try_include("Description", _arrow2896, assay.Description), try_include("MeasurementType", _arrow2897, assay.MeasurementType), try_include("TechnologyType", _arrow2898, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2899, assay.TechnologyPlatform), try_include("DataMap", _arrow2900, assay.DataMap), try_include_seq("Tables", _arrow2901, assay.Tables), try_include_seq("Performers", _arrow2902, assay.Performers), try_include_seq("Comments", _arrow2903, assay.Comments)]))
...
def _arrow2915(get: IGetters) -> ArcAssay:
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2919(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        value: str = assay.Identifier
    ...
    def _arrow2921(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2923(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2924(oa: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2925(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2926(oa_2: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2927(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2928(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2929(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2930(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2919()), try_include("Title", _arrow2921, assay.Title), try_include("Description", _arrow2923, assay.Description), try_include("MeasurementType", _arrow2924, assay.MeasurementType), try_include("TechnologyType", _arrow2925, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2926, assay.TechnologyPlatform), try_include_seq("Tables", _arrow2927, assay.Tables), try_include("DataMap", _arrow2928, assay.DataMap), try_include_seq("Performers", _arrow2929, assay.Performers), try_include_seq("Comments", _arrow2930, assay.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcAssay]:
    def _arrow2942(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcAssay:
        ...
        def _arrow2938(__unit: None=None) -> Array[ArcTable] | None:
            arg_13: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Tables", arg_13)

        def _arrow2939(__unit: None=None) -> DataMap | None:
            arg_15: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("DataMap", arg_15)

        def _arrow2940(__unit: None=None) -> Array[Person] | None:
            arg_17: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Performers", arg_17)

        def _arrow2941(__unit: None=None) -> Array[Comment] | None:
            arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_4)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Comments", arg_19)

        return ArcAssay.create(_arrow2932(), _arrow2933(), _arrow2934(), _arrow2935(), _arrow2936(), _arrow2937(), _arrow2938(), _arrow2939(), _arrow2940(), _arrow2941())

    return object(_arrow2942)
...
def ROCrate_encoder(study_name: str | None, a: ArcAssay) -> IEncodable:
    ...
    def _arrow2946(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2950(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2953(value_5: str, study_name: Any=study_name, a: Any=a) -> IEncodable:
        class ObjectExpr2952(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_5)

        return ObjectExpr2952()

    def _arrow2955(value_7: str, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2956(oa: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderPropertyValue(oa)

    def _arrow2957(oa_1: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2958(oa_2: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_2)

    def _arrow2959(oa_3: Person, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_1(oa_3)

    def _arrow2960(oa_4: Data, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_2(oa_4)

    def _arrow2962(__unit: None=None, study_name: Any=study_name, a: Any=a) -> Callable[[Process], IEncodable]:
        assay_name: str | None = a.Identifier
        def _arrow2961(oa_5: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, assay_name, oa_5)

        return _arrow2961

    def _arrow2963(comment: Comment, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_4(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2946()), ("@type", list_1_1(singleton(ObjectExpr2947()))), ("additionalType", ObjectExpr2948()), ("identifier", _arrow2950()), ("filename", ObjectExpr2951()), try_include("title", _arrow2953, a.Title), try_include("description", _arrow2955, a.Description), try_include("measurementType", _arrow2956, a.MeasurementType), try_include("technologyType", _arrow2957, a.TechnologyType), try_include("technologyPlatform", _arrow2958, a.TechnologyPlatform), try_include_seq("performers", _arrow2959, a.Performers), try_include_list("dataFiles", _arrow2960, data_files), try_include_list("processSequence", _arrow2962(), processes), try_include_seq("comments", _arrow2963, a.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2974(get: IGetters) -> ArcAssay:
    def _arrow2965(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    identifier: str = default_arg(_arrow2965(), create_missing_identifier())
    ...
    def _arrow2971(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("technologyPlatform", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2972(__unit: None=None) -> Array[Person] | None:
        arg_16: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_2)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("performers", arg_16)

    def _arrow2973(__unit: None=None) -> Array[Comment] | None:
        arg_18: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_3)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_18)

    return ArcAssay(identifier, _arrow2967(), _arrow2968(), _arrow2969(), _arrow2970(), _arrow2971(), tables, None, _arrow2972(), _arrow2973())


ROCrate_decoder: Decoder_1[ArcAssay] = object(_arrow2974)
...
def ISAJson_encoder(study_name: str | None, id_map: Any | None, a: ArcAssay) -> IEncodable:
    def f(a_1: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> IEncodable:
        ...
        def _arrow2975(ps: FSharpList[Process], a_1: Any=a_1) -> IEncodable:
            return encoder_9(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2975, Option_fromValueWithDefault(empty(), processes))
        ...
        def _arrow2978(__unit: None=None, a_1: Any=a_1) -> IEnumerable_1[Comment]:
            def _arrow2977(__unit: None=None) -> IEnumerable_1[Comment]:
                ...
                return append(singleton_1(Comment.create("title", value_9(a_1.Title))) if (a_1.Title is not None) else empty_1(), delay(_arrow2976))

            return append(a_1.Comments if (len(a_1.Comments) > 0) else empty_1(), delay(_arrow2977))

        comments: FSharpList[Comment] = to_list(delay(_arrow2978))
        ...
        def _arrow2982(value_5: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2983(oa_2: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2984(oa_3: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2986(value_7: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2988(__unit: None=None, a_1: Any=a_1) -> Callable[[Process], IEncodable]:
            assay_name: str | None = a_1.Identifier
            def _arrow2987(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_2(study_name, assay_name, id_map, oa_4)

            return _arrow2987

        def _arrow2989(comment: Comment, a_1: Any=a_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("filename", ObjectExpr2980()), try_include("@id", _arrow2982, ROCrate_genID(a_1)), try_include("measurementType", _arrow2983, a_1.MeasurementType), try_include("technologyType", _arrow2984, a_1.TechnologyType), try_include("technologyPlatform", _arrow2986, map(mapping, a_1.TechnologyPlatform)), encoced_data_files, encoded_materials, encoded_characteristics, encoded_units, try_include_list("processSequence", _arrow2988(), processes), try_include_seq("comments", _arrow2989, comments)]))
        ...
        return ObjectExpr2990()

    if id_map is not None:
        def _arrow2991(a_2: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> str:
            return ROCrate_genID(a_2)

        return encode(_arrow2991, f, a, id_map)
...
def _arrow2997(get: IGetters) -> ArcAssay:
    def _arrow2992(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Assay_tryIdentifierFromFileName, _arrow2992()), create_missing_identifier())
    def mapping(arg_4: FSharpList[Process]) -> Array[ArcTable]:
        a: ArcTables = ARCtrl_ArcTables__ArcTables_fromProcesses_Static_62A3309D(arg_4)
        return a.Tables

    def _arrow2993(__unit: None=None) -> FSharpList[Process] | None:
        arg_3: Decoder_1[FSharpList[Process]] = list_1_2(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("processSequence", arg_3)

    tables: Array[ArcTable] | None = map(mapping, _arrow2993())
    ...
    def _arrow2996(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return ArcAssay(identifier, title, description, _arrow2994(), _arrow2995(), _arrow2996(), tables, None, None, comments_1)


ISAJson_decoder: Decoder_1[ArcAssay] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2997)
