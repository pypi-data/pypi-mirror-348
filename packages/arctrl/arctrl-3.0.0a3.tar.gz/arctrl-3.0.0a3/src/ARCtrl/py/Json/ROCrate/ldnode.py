...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        def _arrow1922(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow1919(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow1920(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow1921(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow1919, _arrow1920, _arrow1921))

        return list_1(to_list(delay(_arrow1922)))
...
def encoder(obj: LDNode) -> IEncodable:
    def _arrow1935(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow1924(__unit: None=None) -> IEncodable:
            value: str = obj.Id
        ...
        def _arrow1934(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow1926(value_1: str) -> IEncodable:
            ...
            def _arrow1933(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def _arrow1928(value_3: str) -> IEncodable:
                ...
                def _arrow1932(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    def _arrow1929(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    ...
                    def _arrow1931(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                        def _arrow1930(kv: Any) -> IEnumerable_1[tuple[str, IEncodable]]:
                            l: str = kv[0].lower()
                        ...
                        return collect(_arrow1930, obj.GetProperties(True))

                    return append(_arrow1929(), delay(_arrow1931))

                return append(singleton(("additionalType", resize_array_or_singleton(_arrow1928, obj.AdditionalType))) if (len(obj.AdditionalType) != 0) else empty(), delay(_arrow1932))

            return append(singleton(("@type", resize_array_or_singleton(_arrow1926, obj.SchemaType))), delay(_arrow1933))

        return append(singleton(("@id", _arrow1924())), delay(_arrow1934))

    values: FSharpList[tuple[str, IEncodable]] = to_list(delay(_arrow1935))
...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        class ObjectExpr1939(Decoder_1[LDNode]):
        ...
        decode_object: Decoder_1[LDNode] = ObjectExpr1939()
        class ObjectExpr1941(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow1940(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow1940())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr1941()
        if expect_object_1:
            def _arrow1942(value_4: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow1942, decode_object)

        else: 
            def _arrow1944(value_5: LDValue, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow1945(value_6: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow1946(value_7: LDRef, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow1947(value_8: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow1948(value_9: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            def _arrow1949(value_10: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_10

            def _arrow1950(value_11: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_11

            return one_of(of_array([map_1(_arrow1944, decoder_2), map_1(_arrow1945, decode_object), map_1(_arrow1946, decoder_3), map_1(_arrow1947, resize_array), map_1(_arrow1948, string), map_1(_arrow1949, int_1), map_1(_arrow1950, decimal)]))


    return decode(expect_object)


def _arrow1951(value: Any=None) -> LDNode:
    return value


decoder: Decoder_1[LDNode] = map_1(_arrow1951, get_decoder(True))
