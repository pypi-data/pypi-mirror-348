...
def _arrow2634(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2637(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2638(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2639(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2634, ROCrate_decoder_1), map(_arrow2637, ROCrate_decoder_2), map(_arrow2638, ROCrate_decoder_3), map(_arrow2639, ROCrate_decoder_4)]))
...
def _arrow2646(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2647(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2648(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2650(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2646, ISAJson_decoder_1), map(_arrow2647, ISAJson_decoder_2), map(_arrow2648, ISAJson_decoder_3), map(_arrow2650, ISAJson_decoder_4)]))
