...
def directory_exists_async(path: str) -> Async[bool]:
    def _arrow3577(__unit: None=None, path: Any=path) -> Async[bool]:
        return singleton.Return(Path(path).is_dir())

    return singleton.Delay(_arrow3577)


def create_directory_async(path: str) -> Async[None]:
    def _arrow3578(__unit: None=None, path: Any=path) -> Async[None]:
        Path(path).mkdir(parents=True, exist_ok=True)
        return singleton.Zero()

    return singleton.Delay(_arrow3578)


def ensure_directory_async(path: str) -> Async[None]:
    def _arrow3580(__unit: None=None, path: Any=path) -> Async[None]:
        def _arrow3579(_arg: bool) -> Async[None]:
            return singleton.ReturnFrom(create_directory_async(path)) if (not _arg) else singleton.Zero()

        return singleton.Bind(directory_exists_async(path), _arrow3579)

    return singleton.Delay(_arrow3580)


def ensure_directory_of_file_async(file_path: str) -> Async[None]:
    def _arrow3581(__unit: None=None, file_path: Any=file_path) -> Async[None]:
        return singleton.ReturnFrom(ensure_directory_async(Path(file_path).parent))

    return singleton.Delay(_arrow3581)


def file_exists_async(path: str) -> Async[bool]:
    def _arrow3582(__unit: None=None, path: Any=path) -> Async[bool]:
        return singleton.Return(Path(path).is_file())

    return singleton.Delay(_arrow3582)


def read_file_text_async(path: str) -> Async[str]:
    def _arrow3584(__unit: None=None, path: Any=path) -> Async[str]:
        def _arrow3583(__unit: None=None) -> str:
            with open(path, 'r', encoding='utf-8') as f: return f.read()

        return singleton.Return(_arrow3583())

    return singleton.Delay(_arrow3584)


def read_file_binary_async(path: str) -> Async[bytearray]:
    def _arrow3586(__unit: None=None, path: Any=path) -> Async[bytearray]:
        def _arrow3585(__unit: None=None) -> bytearray:
            with open(path, 'rb') as f: return f.read()

        return singleton.Return(_arrow3585())

    return singleton.Delay(_arrow3586)


def read_file_xlsx_async(path: str) -> Async[FsWorkbook]:
    def _arrow3587(__unit: None=None, path: Any=path) -> Async[FsWorkbook]:
        return singleton.Return(FsSpreadsheet_FsWorkbook__FsWorkbook_fromXlsxFile_Static_Z721C83C5(path))

    return singleton.Delay(_arrow3587)


def move_file_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3588(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
...
def delete_file_async(path: str) -> Async[None]:
    def _arrow3589(__unit: None=None, path: Any=path) -> Async[None]:
        try:
            os.remove(path)
...
def delete_directory_async(path: str) -> Async[None]:
    def _arrow3590(__unit: None=None, path: Any=path) -> Async[None]:
...
def write_file_text_async(path: str, text: str) -> Async[None]:
    def _arrow3591(__unit: None=None, path: Any=path, text: Any=text) -> Async[None]:
        with open(path, 'w') as f: f.write(text)
        return singleton.Zero()

    return singleton.Delay(_arrow3591)


def write_file_binary_async(path: str, bytes: bytearray) -> Async[None]:
    def _arrow3592(__unit: None=None, path: Any=path, bytes: Any=bytes) -> Async[None]:
...
def write_file_xlsx_async(path: str, wb: FsWorkbook) -> Async[None]:
    def _arrow3593(__unit: None=None, path: Any=path, wb: Any=wb) -> Async[None]:
        FsSpreadsheet_FsWorkbook__FsWorkbook_toXlsxFile_Static(path, wb)
        return singleton.Zero()

    return singleton.Delay(_arrow3593)
...
def get_sub_directories_async(path: str) -> Async[Array[str]]:
    def _arrow3594(__unit: None=None, path: Any=path) -> Async[Array[str]]:
...
def get_sub_files_async(path: str) -> Async[Array[str]]:
    def _arrow3595(__unit: None=None, path: Any=path) -> Async[Array[str]]:
...
def get_all_file_paths_async(directory_path: str) -> Async[Array[str]]:
    ...
    def _arrow3601(__unit: None=None, directory_path: Any=directory_path) -> Async[Array[str]]:
        def all_files(dirs: IEnumerable_1[str]) -> Async[IEnumerable_1[str]]:
            def _arrow3599(__unit: None=None, dirs: Any=dirs) -> Async[IEnumerable_1[str]]:
                def _arrow3598(_arg: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                    sub_files_1: IEnumerable_1[str] = concat(_arg)
                    def _arrow3597(_arg_1: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                        def _arrow3596(_arg_2: Array[IEnumerable_1[str]]) -> Async[IEnumerable_1[str]]:
                            sub_dir_contents_1: IEnumerable_1[str] = concat(_arg_2)
                            return singleton.Return(append(sub_dir_contents_1, sub_files_1))

                        return singleton.Bind(all(map_1(all_files, _arg_1)), _arrow3596)

                    return singleton.Bind(all(map_1(get_sub_directories_async, dirs)), _arrow3597)

                return singleton.Return(empty()) if is_empty(dirs) else singleton.Bind(all(map_1(get_sub_files_async, dirs)), _arrow3598)

            return singleton.Delay(_arrow3599)

        def _arrow3600(_arg_3: IEnumerable_1[str]) -> Async[Array[str]]:
        ...
        return singleton.Bind(all_files(to_enumerable([directory_path_1])), _arrow3600)

    return singleton.Delay(_arrow3601)


def rename_file_or_directory_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3604(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
        def _arrow3603(_arg: bool) -> Async[None]:
            def _arrow3602(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(old_path), _arrow3602)

        return singleton.Bind(file_exists_async(old_path), _arrow3603)

    return singleton.Delay(_arrow3604)


def delete_file_or_directory_async(path: str) -> Async[None]:
    def _arrow3607(__unit: None=None, path: Any=path) -> Async[None]:
        def _arrow3606(_arg: bool) -> Async[None]:
            def _arrow3605(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(path), _arrow3605)

        return singleton.Bind(file_exists_async(path), _arrow3606)
