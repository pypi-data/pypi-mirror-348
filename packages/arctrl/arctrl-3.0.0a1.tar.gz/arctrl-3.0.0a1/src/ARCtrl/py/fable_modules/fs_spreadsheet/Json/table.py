...
def encode(sheet: FsTable) -> IEncodable:
    def _arrow301(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("name", _arrow301()), ("range", _arrow305())])
...
def _arrow310(builder: IGetters) -> FsTable:
    ...
    return FsTable(_arrow308(), FsRangeAddress__ctor_Z721C83C5(_arrow309()))


decode: Decoder_1[FsTable] = object(_arrow310)
