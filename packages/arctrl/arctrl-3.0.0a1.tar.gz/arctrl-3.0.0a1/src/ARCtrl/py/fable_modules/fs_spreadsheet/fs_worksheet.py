...
class FsWorksheet:
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr216()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr219()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        return max_by(projection, self_1.Rows, ObjectExpr220())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr221())
        ...
        class ObjectExpr223:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow222(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr223()))
...
FsWorksheet_reflection = _expr224
