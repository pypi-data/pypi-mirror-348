...
def _arrow3351(value_1: YAMLElement) -> OutputBinding:
    def getter(get: IGetters) -> OutputBinding:
        def _arrow3350(__unit: None=None, get: Any=get) -> str | None:
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("glob", string)

        return OutputBinding(_arrow3350())

    return object(getter, value_1)


Decode_outputBindingGlobDecoder: Callable[[YAMLElement], OutputBinding] = _arrow3351

def _arrow3352(value: YAMLElement) -> OutputBinding | None:
...
Decode_outputBindingDecoder: Callable[[YAMLElement], OutputBinding | None] = _arrow3352

def _arrow3356(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        def _arrow3353(__unit: None=None, get: Any=get) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("entry", Decode_decodeStringOrExpression)

        def _arrow3354(__unit: None=None, get: Any=get) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("entryname", Decode_decodeStringOrExpression)

        def _arrow3355(__unit: None=None, get: Any=get) -> bool | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("writable", bool_1)

        return CWLType(2, DirentInstance(_arrow3353(), _arrow3354(), _arrow3355()))

    return object(getter, value_1)


Decode_direntDecoder: Callable[[YAMLElement], CWLType] = _arrow3356

def _arrow3358(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        items: str
        object_arg: IRequiredGetter = get.Required
        ...
        if items == "File":
            ...
            def _arrow3357(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("listing", Decode_direntDecoder)

            return CWLType(11, _arrow3357())
...
Decode_cwlArrayTypeDecoder: Callable[[YAMLElement], CWLType] = _arrow3358
...
def _arrow3363(value_1: YAMLElement) -> tuple[CWLType, bool]:
    def getter(get: IGetters) -> tuple[CWLType, bool]:
        ...
        if cwl_type is None:
            def _arrow3362(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("type", Decode_cwlArrayTypeDecoder)

            return (_arrow3362(), False)
...
Decode_cwlTypeDecoder: Callable[[YAMLElement], tuple[CWLType, bool]] = _arrow3363

def _arrow3370(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3369(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow3368(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow3367(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    def _expr3365():
                        set_optional_property("outputSource", output_source, output)
                        return empty_1()

                    def _arrow3366(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr3365() if (output_source is not None) else empty_1(), delay(_arrow3366))

                return append(_expr3364() if (output_binding is not None) else empty_1(), delay(_arrow3367))

            return collect(_arrow3368, dict_1.keys())

        return list(to_array(delay(_arrow3369)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow3370

def _arrow3371(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow3371

def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    def _arrow3372(__unit: None=None, get: Any=get) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("dockerPull", string)

    def _arrow3374(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow3373(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow3373, value_1)

        return object_arg_1.Field("dockerFile", arg_3)

    def _arrow3375(__unit: None=None, get: Any=get) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("dockerImageId", string)

    return DockerRequirement(_arrow3372(), _arrow3374(), _arrow3375())
    ...
    def arg_1(value_6: YAMLElement, get: Any=get) -> Array[SoftwarePackage]:
        def decoder(value_5: YAMLElement, value_6: Any=value_6) -> SoftwarePackage:
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                def _arrow3378(__unit: None=None, get2: Any=get2) -> str:
                    object_arg_1: IRequiredGetter = get2.Required
                    return object_arg_1.Field("package", string)

                def _arrow3380(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_2: IOptionalGetter = get2.Optional
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        def _arrow3379(value_2: YAMLElement, value_1: Any=value_1) -> str:
                            return string(value_2)

                        return resizearray(_arrow3379, value_1)

                    return object_arg_2.Field("version", arg_5)

                def _arrow3382(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_3: IOptionalGetter = get2.Optional
                    def arg_7(value_3: YAMLElement) -> Array[str]:
                        def _arrow3381(value_4: YAMLElement, value_3: Any=value_3) -> str:
                            return string(value_4)

                        return resizearray(_arrow3381, value_3)

                    return object_arg_3.Field("specs", arg_7)

                return SoftwarePackage(_arrow3378(), _arrow3380(), _arrow3382())
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    def _arrow3383(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow3384(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_1: IOptionalGetter = get.Optional
    ...
    def _arrow3385(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow3386(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow3387(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow3388(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow3389(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow3390(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow3383()), some(_arrow3384()), some(_arrow3385()), some(_arrow3386()), some(_arrow3387()), some(_arrow3388()), some(_arrow3389()), some(_arrow3390()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow3392(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow3391(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow3391, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow3392())
...
def _arrow3393(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow3393

def _arrow3394(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow3394

def _arrow3395(value: YAMLElement) -> Array[Requirement] | None:
    def getter(get: IGetters) -> Array[Requirement] | None:
        object_arg: IOptionalGetter = get.Optional
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow3395

def _arrow3400(value_5: YAMLElement) -> InputBinding | None:
...
Decode_inputBindingDecoder: Callable[[YAMLElement], InputBinding | None] = _arrow3400

def _arrow3408(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3407(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
            def _arrow3405(key: str) -> IEnumerable_1[CWLInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                ...
                def _arrow3404(__unit: None=None) -> IEnumerable_1[CWLInput]:
                    def _expr3402():
                        set_optional_property("optional", True, input)
                        return empty_1()

                    def _arrow3403(__unit: None=None) -> IEnumerable_1[CWLInput]:
                        return singleton(input)

                    return append(_expr3402() if pattern_input[1] else empty_1(), delay(_arrow3403))

                return append(_expr3401() if (input_binding is not None) else empty_1(), delay(_arrow3404))

            return collect(_arrow3405, dict_1.keys())

        return list(to_array(delay(_arrow3407)))

    return object(getter, value_1)


Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow3408

def _arrow3409(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow3409

def _arrow3411(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        object_arg: IOptionalGetter = get.Optional
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow3410(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow3410, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow3411

def _arrow3413(value_1: YAMLElement) -> str:
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow3413

def _arrow3414(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow3414

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow3415(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow3416(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow3420(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3419(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow3418(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow3417(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow3417(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))

            return collect(_arrow3418, dict_1.keys())

        return list(to_array(delay(_arrow3419)))

    return object(getter, value_1)


Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow3420

def _arrow3422(value_2: YAMLElement) -> Array[str]:
    def getter(get: IGetters) -> Array[str]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow3421(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow3421, value)
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow3422

def _arrow3430(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow3429(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow3428(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow3423(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow3423, value)
                ...
                def _arrow3427(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr3425():
                        wf_step.Hints = hints
                        return empty_1()

                    def _arrow3426(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                        return singleton(wf_step)

                    return append(_expr3425() if (hints is not None) else empty_1(), delay(_arrow3426))

                return append(_expr3424() if (requirements is not None) else empty_1(), delay(_arrow3427))

            return collect(_arrow3428, dict_1.keys())

        return list(to_array(delay(_arrow3429)))

    return object(getter, value_1)


Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3430

def _arrow3431(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow3431
