...
def Array_ofIndexedSeq(s: IEnumerable_1[tuple[int, str]]) -> Array[str]:
    def _arrow797(tuple: tuple[int, str], s: Any=s) -> int:
        return tuple[0]
    ...
    def _arrow800(i: int, s: Any=s) -> str:
        def _arrow799(arg: tuple[int, str]) -> bool:
            return i == arg[0]

        match_value: tuple[int, str] | None = try_find(_arrow799, s)
    ...
    return initialize(1 + max_by(_arrow797, s, ObjectExpr798())[0], _arrow800, None)
...
def Array_map4(f: Callable[[_A, _B, _C, _D], _T], aa: Array[Any], ba: Array[Any], ca: Array[Any], da: Array[Any]) -> Array[Any]:
    ...
    def _arrow801(i: int, f: Any=f, aa: Any=aa, ba: Any=ba, ca: Any=ca, da: Any=da) -> _T:
        return f(aa[i], ba[i], ca[i], da[i])

    return initialize(len(aa), _arrow801, None)
...
def Dictionary_tryGetValue(k: Any, dict_1: Any) -> Any | None:
    ...
    out_arg: _V = None
    def _arrow802(__unit: None=None, k: Any=k, dict_1: Any=dict_1) -> _V:
        return out_arg

    def _arrow803(v: _V | None=None, k: Any=k, dict_1: Any=dict_1) -> None:
        nonlocal out_arg
        out_arg = v

    pattern_input = (try_get_value(dict_1, k, FSharpRef(_arrow802, _arrow803)), out_arg)
    if pattern_input[0]:
...
def Dictionary_tryGetString(k: Any, dict_1: Any) -> str | None:
    ...
    out_arg: str = None
    def _arrow804(__unit: None=None, k: Any=k, dict_1: Any=dict_1) -> str:
        return out_arg

    def _arrow805(v: str, k: Any=k, dict_1: Any=dict_1) -> None:
        nonlocal out_arg
        out_arg = v

    pattern_input = (try_get_value(dict_1, k, FSharpRef(_arrow804, _arrow805)), out_arg)
