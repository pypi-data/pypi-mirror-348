...
IContext_reflection = _expr1742

def _arrow1747(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1743()), ("Organization", ObjectExpr1744()), ("name", ObjectExpr1745())])
...
context_jsonvalue: IEncodable = _arrow1747()
