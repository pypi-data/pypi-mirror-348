...
IContext_reflection = _expr1626

def _arrow1632(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1627()), ("Comment", ObjectExpr1628()), ("name", ObjectExpr1629()), ("value", ObjectExpr1630())])
...
context_jsonvalue: IEncodable = _arrow1632()
