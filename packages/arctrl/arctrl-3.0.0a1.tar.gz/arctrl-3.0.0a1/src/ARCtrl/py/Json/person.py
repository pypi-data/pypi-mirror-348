...
def _arrow2343(get: IGetters) -> Person:
    ...
    def _arrow2339(__unit: None=None) -> str | None:
    ...
    def _arrow2341(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2342(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2332(), _arrow2333(), _arrow2334(), _arrow2335(), _arrow2336(), _arrow2337(), _arrow2338(), _arrow2339(), _arrow2340(), _arrow2341(), _arrow2342())


decoder: Decoder_1[Person] = object(_arrow2343)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2347(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2345()), ("@id", _arrow2347()), ("name", ObjectExpr2348()), ("@context", context_jsonvalue)])
...
def _arrow2350(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2350)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2354(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2359(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2364(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2368(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2370(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2373(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2376(value_12: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2380(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2354()), ("@type", ObjectExpr2355()), try_include("orcid", _arrow2359, oa.ORCID), try_include("firstName", _arrow2364, oa.FirstName), try_include("lastName", _arrow2368, oa.LastName), try_include("midInitials", _arrow2370, oa.MidInitials), try_include("email", _arrow2373, oa.EMail), try_include("phone", _arrow2376, oa.Phone), try_include("fax", _arrow2380, oa.Fax), try_include("address", _arrow2385, oa.Address), try_include("affiliation", _arrow2386, oa.Affiliation), try_include_seq("roles", _arrow2387, oa.Roles), try_include_seq("comments", _arrow2388, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2405(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2403()), try_include("name", _arrow2405, name), ("@context", context_minimal_json_value)]))
...
def _arrow2409(get: IGetters) -> str:
    def _arrow2408(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2408(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2409)))
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2413(value: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2415(value_2: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2417(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2419(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2421(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2423(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2425(value_12: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2427(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2429(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2430(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2431(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2413, ROCrate_genID(person_2)), try_include("firstName", _arrow2415, person_2.FirstName), try_include("lastName", _arrow2417, person_2.LastName), try_include("midInitials", _arrow2419, person_2.MidInitials), try_include("email", _arrow2421, person_2.EMail), try_include("phone", _arrow2423, person_2.Phone), try_include("fax", _arrow2425, person_2.Fax), try_include("address", _arrow2427, person_2.Address), try_include("affiliation", _arrow2429, person_2.Affiliation), try_include_seq("roles", _arrow2430, person_2.Roles), try_include_seq("comments", _arrow2431, person_2.Comments)]))
    ...
    if id_map is not None:
        def _arrow2433(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return ROCrate_genID(p_1)

        return encode(_arrow2433, f, person, id_map)
...
def _arrow2444(get: IGetters) -> Person:
    ...
    def _arrow2440(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("address", string)

    def _arrow2441(__unit: None=None) -> str | None:
        object_arg_7: IOptionalGetter = get.Optional
    ...
    def _arrow2443(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Person_setOrcidFromComments(Person(None, _arrow2434(), _arrow2435(), _arrow2436(), _arrow2437(), _arrow2438(), _arrow2439(), _arrow2440(), _arrow2441(), _arrow2442(), _arrow2443()))


ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2444)
