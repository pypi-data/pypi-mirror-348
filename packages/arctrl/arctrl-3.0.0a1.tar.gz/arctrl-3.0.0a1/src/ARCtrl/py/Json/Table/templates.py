...
def Template_encoder(template: Template) -> IEncodable:
    ...
    def _arrow2840(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2838()), ("table", encoder(template.Table)), ("name", _arrow2840()), ("description", _arrow2843()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2845()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2865(get: IGetters) -> Template:
    ...
    return Template.create(_arrow2852(), _arrow2853(), _arrow2854(), _arrow2855(), _arrow2857(), _arrow2858(), _arrow2861(), _arrow2862(), _arrow2863(), _arrow2864())
