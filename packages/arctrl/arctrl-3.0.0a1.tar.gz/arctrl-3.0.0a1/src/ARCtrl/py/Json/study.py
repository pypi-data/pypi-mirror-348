...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow3014(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow3016(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3018(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3020(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3022(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3023(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3024(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3025(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3026(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow3027(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3014()), try_include("Title", _arrow3016, study.Title), try_include("Description", _arrow3018, study.Description), try_include("SubmissionDate", _arrow3020, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3022, study.PublicReleaseDate), try_include_seq("Publications", _arrow3023, study.Publications), try_include_seq("Contacts", _arrow3024, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3025, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3026, study.Tables), try_include("DataMap", _arrow3027, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3030, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3031, study.Comments)]))
...
def _arrow3046(get: IGetters) -> ArcStudy:
    ...
    def _arrow3040(__unit: None=None) -> Array[Person] | None:
        arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("Contacts", arg_13)

    def _arrow3041(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return ArcStudy(_arrow3033(), _arrow3034(), _arrow3035(), _arrow3036(), _arrow3037(), _arrow3038(), _arrow3040(), _arrow3041(), _arrow3042(), _arrow3043(), _arrow3044(), _arrow3045())


decoder: Decoder_1[ArcStudy] = object(_arrow3046)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow3050(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow3052(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3054(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3056(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3058(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3059(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3060(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3061(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3062(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow3063(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow3065(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3066(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3050()), try_include("Title", _arrow3052, study.Title), try_include("Description", _arrow3054, study.Description), try_include("SubmissionDate", _arrow3056, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3058, study.PublicReleaseDate), try_include_seq("Publications", _arrow3059, study.Publications), try_include_seq("Contacts", _arrow3060, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3061, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3062, study.Tables), try_include("DataMap", _arrow3063, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3065, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3066, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow3080(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow3068(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow3069(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)
        ...
        return ArcStudy(_arrow3068(), _arrow3069(), _arrow3070(), _arrow3071(), _arrow3072(), _arrow3073(), _arrow3074(), _arrow3075(), _arrow3076(), _arrow3077(), _arrow3078(), _arrow3079())

    return object(_arrow3080)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow3084(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3090(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3092(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3094(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3095(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow3097(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3099(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
        class ObjectExpr3098(IEncodable):
            def Encode(self, helpers_8: IEncoderHelpers_1[Any]) -> Any:
                return helpers_8.encode_string(value_12)

        return ObjectExpr3098()

    def _arrow3100(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow3101(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow3103(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow3102(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow3102

    def _arrow3105(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow3104(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow3104

    def _arrow3106(oa_4: Data, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3084()), ("@type", list_1_1(singleton(ObjectExpr3085()))), ("additionalType", ObjectExpr3086()), ("identifier", _arrow3088()), try_include("filename", _arrow3090, file_name), try_include("title", _arrow3092, s.Title), try_include("description", _arrow3094, s.Description), try_include_seq("studyDesignDescriptors", _arrow3095, s.StudyDesignDescriptors), try_include("submissionDate", _arrow3097, s.SubmissionDate), try_include("publicReleaseDate", _arrow3099, s.PublicReleaseDate), try_include_seq("publications", _arrow3100, s.Publications), try_include_seq("people", _arrow3101, s.Contacts), try_include_list("processSequence", _arrow3103(), processes), try_include_seq("assays", _arrow3105(), assays_1), try_include_list("dataFiles", _arrow3106, get_data(processes)), try_include_seq("comments", _arrow3108, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3121(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def _arrow3120(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow3113(), _arrow3114(), _arrow3115(), _arrow3116(), _arrow3117(), _arrow3118(), _arrow3119(), tables, None, assay_identifiers, _arrow3120()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3121)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3122(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3122, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3124(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3123(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3123

        encoded_protocols = try_include_list("protocols", _arrow3124(), value_5)
        ...
        def _arrow3128(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3133(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3135(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3137(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3139(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3140(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3141(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3142(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3144(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3143(oa_4: Process) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3128()), ("filename", ObjectExpr3129()), ("identifier", _arrow3131()), try_include("title", _arrow3133, study.Title), try_include("description", _arrow3135, study.Description), try_include("submissionDate", _arrow3137, study.SubmissionDate), try_include("publicReleaseDate", _arrow3139, study.PublicReleaseDate), try_include_seq("publications", _arrow3140, study.Publications), try_include_seq("people", _arrow3141, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3142, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3144(), processes), try_include_seq("assays", _arrow3146(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3147, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3149(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3149, f, s, id_map)
...
def _arrow3160(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3151()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3150(), def_thunk)
    ...
    def _arrow3153(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("title", string)

    def _arrow3154(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
    ...
    def _arrow3157(__unit: None=None) -> Array[Publication] | None:
        arg_21: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("publications", arg_21)

    def _arrow3158(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow3159(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow3153(), _arrow3154(), _arrow3155(), _arrow3156(), _arrow3157(), None if (len(persons) == 0) else persons, _arrow3158(), tables, None, assay_identifiers, _arrow3159()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3160)
