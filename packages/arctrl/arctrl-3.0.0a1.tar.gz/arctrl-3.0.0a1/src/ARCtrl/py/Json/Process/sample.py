...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2628(__unit: None=None, oa: Any=oa) -> IEncodable:
        value_2: str = ROCrate_genID(oa)
        class ObjectExpr2627(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value_2)

        return ObjectExpr2627()
    ...
    def _arrow2636(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2637(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2628()), ("@type", list_1_2(singleton(ObjectExpr2629()))), ("additionalType", ObjectExpr2631()), try_include("name", _arrow2636, oa.Name), try_include_list("additionalProperties", _arrow2637, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2644(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2643(__unit: None=None) -> str:
        ...
        if (_arrow2643() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2644()

def _arrow2648(get: IGetters) -> Sample:
    ...
    def _arrow2647(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2645(), _arrow2646(), pattern_input[0], pattern_input[1], _arrow2647())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2648)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2652(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2654(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2655(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2656(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2657(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2652, ROCrate_genID(oa_1)), try_include("name", _arrow2654, oa_1.Name), try_include_list_opt("characteristics", _arrow2655, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2656, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2657, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2659(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2659, f, oa, id_map)
...
def _arrow2665(get: IGetters) -> Sample:
    def _arrow2660(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2661(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2662(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2663(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2664(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2660(), _arrow2661(), _arrow2662(), _arrow2663(), _arrow2664())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2665)
