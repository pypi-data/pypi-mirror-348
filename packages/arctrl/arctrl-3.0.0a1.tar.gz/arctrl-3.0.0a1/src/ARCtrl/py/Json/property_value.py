...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr2076(), None)
            ...
            pattern_input_1 = (ObjectExpr2077(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow2079(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow2081(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow2079, oa_1.Name), map(_arrow2081, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr2082(), None)
    ...
    def _arrow2086(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2089(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2091(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2093(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2095(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2097(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2099(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2100(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow2101(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow2103(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2105(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2086()), ("@type", ObjectExpr2087()), ("additionalType", _arrow2089()), try_include("alternateName", _arrow2091, pv.AlternateName()), try_include("measurementMethod", _arrow2093, pv.MeasurementMethod()), try_include("description", _arrow2095, pv.Description()), try_include("category", _arrow2097, pattern_input[0]), try_include("categoryCode", _arrow2099, pattern_input[1]), try_include("value", _arrow2100, pattern_input_1[0]), try_include("valueCode", _arrow2101, pattern_input_1[1]), try_include("unit", _arrow2103, pattern_input_2[0]), try_include("unitCode", _arrow2105, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2110(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2109(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2109(), unit)

    return object(_arrow2110)
