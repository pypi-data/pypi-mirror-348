...
def _arrow2616(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2617(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2618(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2619(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2616, ROCrate_decoder_1), map(_arrow2617, ROCrate_decoder_2), map(_arrow2618, ROCrate_decoder_3), map(_arrow2619, ROCrate_decoder_4)]))
...
def _arrow2621(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2622(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2623(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2624(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2621, ISAJson_decoder_1), map(_arrow2622, ISAJson_decoder_2), map(_arrow2623, ISAJson_decoder_3), map(_arrow2624, ISAJson_decoder_4)]))
