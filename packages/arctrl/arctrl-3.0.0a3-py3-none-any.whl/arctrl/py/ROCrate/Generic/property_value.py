...
class LDPropertyValue:
    ...
    def validate_component(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1513:
            ...
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1512(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Component", pv.AdditionalType, ObjectExpr1513()) if LDPropertyValue.validate(pv, context) else False

    @staticmethod
    def validate_parameter_value(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1515:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1514(x: str, y: str) -> bool:
                    return x == y
        ...
        class ObjectExpr1517:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1516(x_1: str, y_1: str) -> bool:
                    return x_1 == y_1
        ...
        return (True if contains("ParameterValue", pv.AdditionalType, ObjectExpr1515()) else contains("ProcessParameterValue", pv.AdditionalType, ObjectExpr1517())) if LDPropertyValue.validate(pv, context) else False
    ...
    def validate_characteristic_value(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1519:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1518(x: str, y: str) -> bool:
                    return x == y
        ...
        class ObjectExpr1521:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1520(x_1: str, y_1: str) -> bool:
                    return x_1 == y_1
        ...
        return (True if contains("CharacteristicValue", pv.AdditionalType, ObjectExpr1519()) else contains("MaterialAttributeValue", pv.AdditionalType, ObjectExpr1521())) if LDPropertyValue.validate(pv, context) else False
    ...
    def validate_factor_value(pv: LDNode, context: LDContext | None=None) -> bool:
        ...
        return contains("FactorValue", pv.AdditionalType, ObjectExpr1523()) if LDPropertyValue.validate(pv, context) else False
            ...
            if match_value is not None:
                if match_value_1 is not None:
                    if match_value_2 is not None:
                        def _arrow1524(__unit: None=None) -> bool:
    ...
    def validate_pub_med_id(pv: LDNode, context: LDContext | None=None) -> bool:
        if LDPropertyValue.validate(pv, context):
            ...
            if match_value is not None:
                if match_value_1 is not None:
                    if match_value_2 is not None:
                        def _arrow1525(__unit: None=None) -> bool:
                            value: str = match_value_1
                            id: str = match_value_2
    ...
    def gen_id(name: str, value: str | None=None, property_id: str | None=None, prefix: str | None=None) -> str:
        ...
        def _arrow1526(__unit: None=None) -> str:
            pid_1: str = property_id
            return ((("#" + prefix_1) + "_") + name) + ""

        def _arrow1527(__unit: None=None) -> str:
            value_2: str = value
            return ((((("#" + prefix_1) + "_") + name) + "_") + value_2) + ""

        def _arrow1528(__unit: None=None) -> str:
            pid: str = property_id
            value_1: str = value
            return ((((("#" + prefix_1) + "_") + name) + "_") + value_1) + ""

        return clean((_arrow1526() if (property_id is not None) else (((("#" + prefix_1) + "_") + name) + "")) if (value is None) else (_arrow1527() if (property_id is None) else _arrow1528()))
...
LDPropertyValue_reflection = _expr1529
