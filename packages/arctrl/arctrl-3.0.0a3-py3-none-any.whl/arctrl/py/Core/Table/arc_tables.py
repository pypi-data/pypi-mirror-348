...
def ArcTablesAux_SanityChecks_validateSheetIndex(index: int, allow_append: bool, sheets: Array[ArcTable]) -> None:
    ...
    def _arrow677(__unit: None=None, index: Any=index, allow_append: Any=allow_append, sheets: Any=sheets) -> bool:
        x: int = index or 0
...
def ArcTablesAux_SanityChecks_validateNamesUnique(names: IEnumerable_1[str]) -> None:
    class ObjectExpr679:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow678(x: str, y: str) -> bool:
                return x == y
    ...
    if not (length(names) == length(distinct(names, ObjectExpr679()))):
...
def ArcTablesAux_SanityChecks_validateNewNameUnique(new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow680(x: str, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow680, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNameAtUnique(index: int, new_name: str, existing_names: IEnumerable_1[str]) -> None:
    def _arrow681(x: str, index: Any=index, new_name: Any=new_name, existing_names: Any=existing_names) -> bool:
        return x == new_name

    match_value: int | None = try_find_index(_arrow681, existing_names)
    if match_value is None:
        pass
...
def ArcTablesAux_SanityChecks_validateNewNamesUnique(new_names: IEnumerable_1[str], existing_names: IEnumerable_1[str]) -> None:
    ...
    same: Any = intersect(of_seq(new_names, ObjectExpr682()), of_seq(existing_names, ObjectExpr683()))
...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr697()
    ...
    def TableNames(self, __unit: None=None) -> FSharpList[str]:
        ...
        def _arrow685(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow684(s: ArcTable) -> str:
                return s.Name

            return map_1(_arrow684, this.Tables)

        return to_list(delay(_arrow685))
    ...
    def AddColumnAt(self, table_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None, column_index: int | None=None, force_replace: bool | None=None) -> None:
        this: ArcTables = self
        def _arrow686(table: ArcTable) -> None:
            table.AddColumn(header, cells, column_index, force_replace)

        this.MapTableAt(table_index, _arrow686)
    ...
    def RemoveColumnAt(self, table_index: int, column_index: int) -> None:
        this: ArcTables = self
        def _arrow687(table: ArcTable) -> None:
            table.RemoveColumn(column_index)

        this.MapTableAt(table_index, _arrow687)
    ...
    def UpdateColumnAt(self, table_index: int, column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> None:
        ...
        this.MapTableAt(table_index, _arrow688)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr692())
        def _arrow696(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow693(__unit: None=None) -> Array[ArcTable]:
            ...
            class ObjectExpr695:
                @property
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow694(x_2: str, y_1: str) -> bool:
                        return x_2 == y_1
            ...
            s: Array[ArcTable] = map_3(mapping_4, map_3(mapping_3, Array_groupBy(projection, map_3(mapping_2, _arrow693(), None), ObjectExpr695()), None), None)
        ...
        return ArcTables(list(_arrow696()))
