...
def fullfill_contract_batch_async_by(contract_f: Callable[[str, Contract], Async[FSharpResult_2[Contract, str]]], base_path: str, cs: Array[Contract]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
    def _arrow3628(__unit: None=None, contract_f: Any=contract_f, base_path: Any=base_path, cs: Any=cs) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
        def _arrow3627(_arg: Array[FSharpResult_2[Contract, str]]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
        ...
        return singleton.Bind(start_sequential(curry2(contract_f)(base_path), cs), _arrow3627)
...
def fulfill_write_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3629(__unit: None=None, e_1: Any=e_1) -> str:
            arg_4: str = str(e_1)
            return to_text(printf("Error writing contract %s: %s"))(c.Path)(arg_4)

        return FSharpResult_2(1, _arrow3629())

    def _arrow3639(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3636(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            if match_value is None:
                ...
                def _arrow3631(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path_2, ""), _arrow3630)

                return singleton.Bind(ensure_directory_of_file_async(path_2), _arrow3631)
                ...
                def _arrow3633(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path, t), _arrow3632)

                return singleton.Bind(ensure_directory_of_file_async(path), _arrow3633)

            elif match_value.tag == 0:
                wb: Any = match_value.fields[0]
                path_1: str = combine(base_path, c.Path)
                def _arrow3635(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    def _arrow3634(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                        return singleton.Return(FSharpResult_2(0, c))

                    return singleton.Bind(write_file_xlsx_async(path_1, wb), _arrow3634)

                return singleton.Bind(ensure_directory_of_file_async(path_1), _arrow3635)

            else: 
                return singleton.Return(FSharpResult_2(1, to_text(printf("Contract %s is not an ISA contract"))(c.Path)))


        def _arrow3638(_arg_6: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3637(__unit: None=None) -> str:
                arg_2: str = str(_arg_6)
                return to_text(printf("Error writing contract %s: %s"))(c.Path)(arg_2)

            return singleton.Return(FSharpResult_2(1, _arrow3637()))

        return singleton.TryWith(singleton.Delay(_arrow3636), _arrow3638)

    return catch_with(f, singleton.Delay(_arrow3639))


def fulfill_update_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3640(__unit: None=None, e_1: Any=e_1) -> str:
            arg_4: str = str(e_1)
            return to_text(printf("Error updating contract %s: %s"))(c.Path)(arg_4)

        return FSharpResult_2(1, _arrow3640())

    def _arrow3650(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3647(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            if match_value is None:
                ...
                def _arrow3642(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path_2, ""), _arrow3641)

                return singleton.Bind(ensure_directory_of_file_async(path_2), _arrow3642)
                ...
                def _arrow3644(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path, t), _arrow3643)

                return singleton.Bind(ensure_directory_of_file_async(path), _arrow3644)

            elif match_value.tag == 0:
                wb: Any = match_value.fields[0]
                path_1: str = combine(base_path, c.Path)
                def _arrow3646(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    def _arrow3645(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                        return singleton.Return(FSharpResult_2(0, c))

                    return singleton.Bind(write_file_xlsx_async(path_1, wb), _arrow3645)

                return singleton.Bind(ensure_directory_of_file_async(path_1), _arrow3646)

            else: 
                return singleton.Return(FSharpResult_2(1, to_text(printf("Contract %s is not an ISA contract"))(c.Path)))


        def _arrow3649(_arg_6: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3648(__unit: None=None) -> str:
                arg_2: str = str(_arg_6)
                return to_text(printf("Error updating contract %s: %s"))(c.Path)(arg_2)

            return singleton.Return(FSharpResult_2(1, _arrow3648()))

        return singleton.TryWith(singleton.Delay(_arrow3647), _arrow3649)

    return catch_with(f, singleton.Delay(_arrow3650))


def fullfill_rename_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3651(__unit: None=None, e_1: Any=e_1) -> str:
            arg_5: str = str(e_1)
            return to_text(printf("Error renaming contract %s: %s"))(c.Path)(arg_5)

        return FSharpResult_2(1, _arrow3651())
    ...
    def _arrow3656(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3653(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            if pattern_matching_result == 0:
                ...
                return singleton.Bind(rename_file_or_directory_async(old_path, new_path), _arrow3652)

            elif pattern_matching_result == 2:
                return singleton.Return(FSharpResult_2(1, to_text(printf("Rename Contract %s does not contain new Path"))(c.Path)))


        def _arrow3655(_arg_1: Exception) -> Async[FSharpResult_2[Contract, str]]:
...
def fullfill_delete_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    ...
    def _arrow3662(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3659(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            return singleton.Bind(delete_file_or_directory_async(path), _arrow3658)
...
def full_fill_contract(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3663(__unit: None=None, e: Any=e) -> str:
            arg_2: str = str(e)
            return to_text(printf("Error fulfilling contract %s: %s"))(c.Path)(arg_2)

        return FSharpResult_2(1, _arrow3663())

    def _arrow3664(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
    ...
    return catch_with(f, singleton.Delay(_arrow3664))


def full_fill_contract_batch_async(base_path: str, cs: Array[Contract]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
    def _arrow3665(base_path_1: str, c: Contract, base_path: Any=base_path, cs: Any=cs) -> Async[FSharpResult_2[Contract, str]]:
        return full_fill_contract(base_path_1, c)

    return fullfill_contract_batch_async_by(_arrow3665, base_path, cs)
