...
def _arrow1663(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1655()), ("Factor", ObjectExpr1656()), ("factorName", ObjectExpr1657()), ("annotationValue", ObjectExpr1658()), ("termSource", ObjectExpr1659()), ("termAccession", ObjectExpr1660()), ("comments", ObjectExpr1661())])
...
context_jsonvalue: IEncodable = _arrow1663()
