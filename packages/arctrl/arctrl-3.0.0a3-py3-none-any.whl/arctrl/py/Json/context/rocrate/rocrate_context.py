...
def _arrow1874(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1868()), ("arc", ObjectExpr1869()), ("CreativeWork", ObjectExpr1870()), ("about", ObjectExpr1871()), ("conformsTo", ObjectExpr1872())])
