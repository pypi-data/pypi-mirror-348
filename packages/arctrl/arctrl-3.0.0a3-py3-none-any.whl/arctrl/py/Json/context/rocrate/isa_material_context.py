...
IContext_reflection = _expr1714

def _arrow1722(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1715()), ("bio", ObjectExpr1716()), ("Material", ObjectExpr1717()), ("type", ObjectExpr1718()), ("name", ObjectExpr1719()), ("characteristics", ObjectExpr1720())])
...
context_jsonvalue: IEncodable = _arrow1722()
