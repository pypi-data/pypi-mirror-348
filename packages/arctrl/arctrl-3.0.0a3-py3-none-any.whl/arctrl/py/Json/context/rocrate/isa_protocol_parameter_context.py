...
def _arrow1817(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1808()), ("arc", ObjectExpr1810()), ("ProtocolParameter", ObjectExpr1811()), ("ArcProtocolParameter", ObjectExpr1814()), ("parameterName", ObjectExpr1815())])
