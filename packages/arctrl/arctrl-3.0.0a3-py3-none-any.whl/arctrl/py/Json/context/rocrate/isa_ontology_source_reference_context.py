...
IContext_reflection = _expr1732

def _arrow1741(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1733()), ("OntologySourceReference", ObjectExpr1734()), ("description", ObjectExpr1735()), ("name", ObjectExpr1736()), ("file", ObjectExpr1737()), ("version", ObjectExpr1738()), ("comments", ObjectExpr1739())])
...
context_jsonvalue: IEncodable = _arrow1741()
