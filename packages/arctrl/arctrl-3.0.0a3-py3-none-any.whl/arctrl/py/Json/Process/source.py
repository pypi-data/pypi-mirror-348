...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2582(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2586(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2582()), ("@type", list_1_1(singleton(ObjectExpr2583()))), ("additionalType", ObjectExpr2584()), try_include("name", _arrow2586, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2591(get: IGetters) -> Source:
    ...
    def _arrow2590(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2588(), _arrow2589(), _arrow2590())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2591)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2595(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2597(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2598(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2595, ROCrate_genID(oa_1)), try_include("name", _arrow2597, oa_1.Name), try_include_list_opt("characteristics", _arrow2598, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2600(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2600, f, oa, id_map)
...
def _arrow2604(get: IGetters) -> Source:
    ...
    def _arrow2603(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2601(), _arrow2602(), _arrow2603())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2604)
