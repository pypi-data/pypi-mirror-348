...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow443(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr442(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow443()
        def _arrow445(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr444(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow445()
        def _arrow447(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr446(IMultipleOptionalGetter):
            ...
            return ObjectExpr446()

        self.multiple_optional: IMultipleOptionalGetter = _arrow447()
        def _arrow449(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr448(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow449()
