...
def encode_rows(cell: FsCell) -> IEncodable:
    ...
    class ObjectExpr286(IEncodable):
...
def encode_cols(cell: FsCell) -> IEncodable:
    def _arrow293(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("row", _arrow293()), ("value", encode(cell.Value))])
