...
class RaceData:
    ...
    def read_file(cls, filename: str, folder: Path | None) -> str:
        ...
        from the package‐bundled `data_example/` directory.

        :param filename: one of "start.log", "end.log", "abbreviations.txt"
        :param folder:  optional Path to user’s own data_example folder
        ...
        try:
            ...
            raise FileNotFoundError(f"{filename!r} not found in the specified folder or package data_example")
