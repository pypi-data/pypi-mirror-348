...
def setup_params(args=None):
    ...
    # Set up the project and bucket constants for ODE environment
    if os.getenv("CLUSTER") == "ode":
        params["g_ai_project_name"] = os.getenv("PROJECT_NAME")
        params["g_ai_project_id"] = os.getenv("PROJECT_ID")
        params["doc_ai_bucket_name"] = os.getenv("BUCKET_NAME")
        params["doc_ai_bucket_batch_input"] = os.getenv("INPUT_BUCKET_NAME")
        params["doc_ai_bucket_batch_output"] = os.getenv("OUTPUT_BUCKET_NAME")
