import{E as e,j as o,cO as f,ez as y,eA as v,eB as h,l as r,bW as x,eC as a,r as z,o as w,eD as P}from"./vendor-CToBXdDM.js";import{K as k,M as S}from"./vendor-arizeai-BhbMHqQs.js";import{L,r as j,g as C,h as R,F as I,i as E,P as D,j as A,M as s,k as T,D as F,l as O,E as G,n as M,o as N,p as q,q as V,s as t,t as W,v as _,w as B,x as $,y as K,z as H,B as J,C as Q,G as U,H as X,I as Y,J as Z,K as oo,N as ao,O as lo,Q as ro,U as d,V as m,W as p,X as co,Y as go,Z as eo,_ as bo,$ as no,a0 as io,a1 as so,a2 as to,a3 as mo,a4 as po,a5 as uo,a6 as fo,a7 as yo,a8 as vo,a9 as ho,aa as xo,ab as zo,ac as wo,ad as Po,ae as ko,af as So,ag as Lo,ah as jo,ai as Co,aj as Ro,ak as Io,al as Eo,am as Do,an as Ao,ao as To,ap as Fo,aq as Oo,ar as Go,as as Mo,at as No,au as qo,av as Vo,aw as Wo,ax as _o}from"./pages-jHwPRLA2.js";import{en as Bo,b$ as $o,R as Ko,eo as Ho,ep as Jo}from"./components-DpK7N6zE.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-CeLHFooz.js";import"./vendor-shiki-CPwL2jwA.js";import"./vendor-recharts-PlWJHgM9.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))i(c);new MutationObserver(c=>{for(const g of c)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function u(c){const g={};return c.integrity&&(g.integrity=c.integrity),c.referrerPolicy&&(g.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?g.credentials="include":c.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function i(c){if(c.ep)return;c.ep=!0;const g=u(c);fetch(c.href,g)}})();const Qo=e`
  :root {
...
`;function ga(){const{theme:l="dark"}=k();return o(f,{styles:e(Xo,Uo,l==="dark"?Yo:Zo,oa(l),Qo,aa,la,ra,ca)})}const ea=y(v(r(a,{path:"/",errorElement:o(qo,{}),children:[o(a,{path:"/v1/*",element:o(x,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(L,{})}),o(a,{path:"/reset-password",element:o(C,{}),loader:j}),o(a,{path:"/reset-password-with-token",element:o(R,{})}),o(a,{path:"/forgot-password",element:o(I,{})}),o(a,{element:o(No,{}),loader:E,children:r(a,{element:o(Mo,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(D,{})}),o(a,{index:!0,loader:A}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(M,{}),children:[o(a,{index:!0,element:o(s,{})}),o(a,{element:o(s,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(F,{}),loader:T})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(G,{}),loader:O,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"projects"},element:o(U,{}),children:[o(a,{index:!0,element:o(N,{})}),r(a,{path:":projectId",loader:q,handle:{crumb:l=>l.project.name},element:o(Q,{}),children:[o(a,{index:!0,element:o(V,{})}),r(a,{element:o(J,{}),children:[o(a,{path:"traces",element:o(W,{}),children:o(a,{path:":traceId",element:o(t,{})})}),o(a,{path:"spans",element:o(_,{}),children:o(a,{path:":traceId",element:o(t,{})})}),o(a,{path:"sessions",element:o(K,{}),children:o(a,{path:":sessionId",element:o($,{}),loader:B})}),o(a,{path:"config",element:o(H,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"dashboards"},element:o(lo,{}),children:[o(a,{index:!0,element:o(Y,{}),loader:X}),o(a,{path:"projects/:projectId",element:o(oo,{}),loader:Z,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(ao,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(a,{index:!0,element:o(ro,{})}),r(a,{path:":datasetId",loader:d,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(bo,{}),loader:d,children:[o(a,{index:!0,element:o(p,{}),loader:m}),o(a,{path:"experiments",element:o(p,{}),loader:m}),o(a,{path:"examples",element:o(eo,{}),loader:co,children:o(a,{path:":exampleId",element:o(go,{})})})]}),o(a,{path:"compare",handle:{crumb:()=>"compare"},loader:no,element:o(io,{})})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(so,{})}),o(a,{path:"spans/:spanId",element:o(mo,{}),loader:to,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(a,{index:!0,element:o(uo,{}),loader:po}),r(a,{path:":promptId",loader:fo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(ko,{}),children:[o(a,{index:!0,element:o(yo,{})}),o(a,{path:"versions",loader:vo,element:o(zo,{}),children:o(a,{path:":versionId",loader:ho,element:o(xo,{})})}),o(a,{path:"config",element:o(Po,{}),loader:wo})]}),o(a,{path:"playground",element:o(Lo,{}),loader:So,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(jo,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Co,{}),handle:{crumb:()=>"support"}}),r(a,{path:"/settings",element:o(Go,{}),handle:{crumb:()=>"settings"},children:[o(a,{path:"general",loader:Ro,element:o(Io,{}),handle:{crumb:()=>"general"}}),o(a,{path:"providers",loader:Eo,element:o(Do,{}),handle:{crumb:()=>"providers"}}),o(a,{path:"annotations",loader:Ao,element:o(To,{}),handle:{crumb:()=>"annotations"}}),o(a,{path:"data",element:o(Oo,{}),handle:{crumb:()=>"data retention"},loader:Fo})]})]})})]})),{basename:window.Config.basename});function ba(){return o(h,{router:ea})}function na(){return o(Vo,{children:o(Bo,{children:o(ia,{})})})}function ia(){const{theme:l}=$o();return o(S,{theme:l,mountGlobalStyles:!1,children:r(w.RelayEnvironmentProvider,{environment:Ko,children:[o(ga,{}),o(Wo,{children:o(Ho,{children:o(_o,{children:o(z.Suspense,{children:o(Jo,{children:o(ba,{})})})})})})]})})}const sa=document.getElementById("root"),ta=P.createRoot(sa);ta.render(o(na,{}));
