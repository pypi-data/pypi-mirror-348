import{E as e,j as o,cO as f,ez as y,eA as v,eB as h,l as r,bW as x,eC as l,r as z,o as w,eD as P}from"./vendor-CHbwJtRJ.js";import{K as k,M as S}from"./vendor-arizeai-CGce5406.js";import{L,r as C,g as I,h as R,F as j,i as E,P as A,j as D,M as s,k as T,D as F,l as O,E as M,n as G,o as N,p as q,q as V,s as t,t as W,v as _,w as B,x as K,y as $,z as Z,B as H,C as J,G as Q,H as U,I as X,J as Y,K as d,N as m,O as p,Q as oo,U as lo,V as ao,W as ro,X as co,Y as go,Z as eo,_ as bo,$ as no,a0 as io,a1 as so,a2 as to,a3 as mo,a4 as po,a5 as uo,a6 as fo,a7 as yo,a8 as vo,a9 as ho,aa as xo,ab as zo,ac as wo,ad as Po,ae as ko,af as So,ag as Lo,ah as Co,ai as Io,aj as Ro,ak as jo,al as Eo,am as Ao,an as Do,ao as To,ap as Fo,aq as Oo,ar as Mo,as as Go,at as No}from"./pages-BPhRdaQm.js";import{en as qo,bZ as Vo,R as Wo,eo as _o,ep as Bo}from"./components-DIphpoYn.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-KgXtr1rz.js";import"./vendor-shiki-BsLqKLvc.js";import"./vendor-recharts-Cm-8_DB9.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))i(c);new MutationObserver(c=>{for(const g of c)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function u(c){const g={};return c.integrity&&(g.integrity=c.integrity),c.referrerPolicy&&(g.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?g.credentials="include":c.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function i(c){if(c.ep)return;c.ep=!0;const g=u(c);fetch(c.href,g)}})();const Ko=e`
  :root {
...
`;function ol(){const{theme:a="dark"}=k();return o(f,{styles:e(Zo,$o,a==="dark"?Ho:Jo,Qo(a),Ko,Uo,Xo,Yo)})}const ll=y(v(r(l,{path:"/",errorElement:o(Oo,{}),children:[o(l,{path:"/v1/*",element:o(x,{to:"/",replace:!0})}),o(l,{path:"/login",element:o(L,{})}),o(l,{path:"/reset-password",element:o(I,{}),loader:C}),o(l,{path:"/reset-password-with-token",element:o(R,{})}),o(l,{path:"/forgot-password",element:o(j,{})}),o(l,{element:o(Fo,{}),loader:E,children:r(l,{element:o(To,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(A,{})}),o(l,{index:!0,loader:D}),r(l,{path:"/model",handle:{crumb:()=>"model"},element:o(G,{}),children:[o(l,{index:!0,element:o(s,{})}),o(l,{element:o(s,{}),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",element:o(F,{}),loader:T})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",element:o(M,{}),loader:O,handle:{crumb:a=>a.embedding.name}})})]}),r(l,{path:"/projects",handle:{crumb:()=>"projects"},element:o(Q,{}),children:[o(l,{index:!0,element:o(N,{})}),r(l,{path:":projectId",loader:q,handle:{crumb:a=>a.project.name},element:o(J,{}),children:[o(l,{index:!0,element:o(V,{})}),r(l,{element:o(H,{}),children:[o(l,{path:"traces",element:o(W,{}),children:o(l,{path:":traceId",element:o(t,{})})}),o(l,{path:"spans",element:o(_,{}),children:o(l,{path:":traceId",element:o(t,{})})}),o(l,{path:"sessions",element:o($,{}),children:o(l,{path:":sessionId",element:o(K,{}),loader:B})}),o(l,{path:"config",element:o(Z,{})})]})]})]}),r(l,{path:"/dashboards",handle:{crumb:()=>"dashboards"},children:[o(l,{index:!0,element:o(U,{})}),o(l,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(X,{})})]}),r(l,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(l,{index:!0,element:o(Y,{})}),r(l,{path:":datasetId",loader:d,handle:{crumb:a=>a.dataset.name},children:[r(l,{element:o(ro,{}),loader:d,children:[o(l,{index:!0,element:o(p,{}),loader:m}),o(l,{path:"experiments",element:o(p,{}),loader:m}),o(l,{path:"examples",element:o(ao,{}),loader:oo,children:o(l,{path:":exampleId",element:o(lo,{})})})]}),o(l,{path:"compare",handle:{crumb:()=>"compare"},loader:co,element:o(go,{})})]})]}),r(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(eo,{})}),o(l,{path:"spans/:spanId",element:o(no,{}),loader:bo,handle:{crumb:a=>a.span.__typename==="Span"?`span ${a.span.spanId}`:"span unknown"}})]}),r(l,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(l,{index:!0,element:o(so,{}),loader:io}),r(l,{path:":promptId",loader:to,shouldRevalidate:()=>!0,handle:{crumb:a=>a.prompt.__typename==="Prompt"?a.prompt.name:"unknown"},children:[r(l,{element:o(xo,{}),children:[o(l,{index:!0,element:o(mo,{})}),o(l,{path:"versions",loader:po,element:o(yo,{}),children:o(l,{path:":versionId",loader:uo,element:o(fo,{})})}),o(l,{path:"config",element:o(ho,{}),loader:vo})]}),o(l,{path:"playground",element:o(wo,{}),loader:zo,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(Po,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(ko,{}),handle:{crumb:()=>"support"}}),r(l,{path:"/settings",element:o(Do,{}),handle:{crumb:()=>"settings"},children:[o(l,{path:"general",loader:So,element:o(Lo,{}),handle:{crumb:()=>"general"}}),o(l,{path:"providers",loader:Co,element:o(Io,{}),handle:{crumb:()=>"providers"}}),o(l,{path:"annotations",loader:Ro,element:o(jo,{}),handle:{crumb:()=>"annotations"}}),o(l,{path:"data",element:o(Ao,{}),handle:{crumb:()=>"data retention"},loader:Eo})]})]})})]})),{basename:window.Config.basename});function al(){return o(h,{router:ll})}function rl(){return o(Mo,{children:o(qo,{children:o(cl,{})})})}function cl(){const{theme:a}=Vo();return o(S,{theme:a,mountGlobalStyles:!1,children:r(w.RelayEnvironmentProvider,{environment:Wo,children:[o(ol,{}),o(Go,{children:o(_o,{children:o(No,{children:o(z.Suspense,{children:o(Bo,{children:o(al,{})})})})})})]})})}const gl=document.getElementById("root"),el=P.createRoot(gl);el.render(o(rl,{}));
