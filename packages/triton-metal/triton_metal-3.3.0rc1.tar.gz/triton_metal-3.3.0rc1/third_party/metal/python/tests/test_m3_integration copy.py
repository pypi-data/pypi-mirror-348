...
class TestM3FusionOptimizations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.mock_ops = [
                {"type": "triton_metal.mul", "id": "mul1", "inputs": ["x", "y"], "outputs": ["mul_out"]},
                {"type": "triton_metal.add", "id": "add1", "inputs": ["mul_out", "bias"], "outputs": ["add_out"]},
                {"type": "triton_metal.tanh", "id": "tanh1", "inputs": ["add_out"], "outputs": ["tanh_out"]},
                {"type": "triton_metal.mul", "id": "mul2", "inputs": ["tanh_out", "scale"], "outputs": ["final_out"]}
            ]
        except (AttributeError, TypeError) as e:
