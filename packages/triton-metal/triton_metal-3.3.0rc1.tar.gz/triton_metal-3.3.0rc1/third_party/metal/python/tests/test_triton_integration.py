...
try:
    ...
    from triton_metal.runtime.autotuner import Autotuner, autotune
...
class TestTritonMetalIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.has_metal_backend = 'metal' in triton_metal.runtime.backends
    ...
    def test_backend_initialization(self):
        ...
        self.assertIn('metal', triton_metal.runtime.backends)
        print(f"Available backends: {list(triton_metal.runtime.backends.keys())}")
    ...
    def test_reduction_with_autotuning(self):
        ...
        @autotune(
            configs=[
                triton_metal.Config({'BLOCK_SIZE': 64}),
