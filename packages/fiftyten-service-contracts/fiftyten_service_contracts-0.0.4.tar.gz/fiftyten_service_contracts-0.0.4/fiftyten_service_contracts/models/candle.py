...
class Candle(BaseModel):
    ...
    open: Union[StrictFloat, StrictInt] = Field(description="Opening price")
    high: Union[StrictFloat, StrictInt] = Field(description="Highest price")
    low: Union[StrictFloat, StrictInt] = Field(description="Lowest price")
    close: Union[StrictFloat, StrictInt] = Field(description="Closing price")
    volume: Union[StrictFloat, StrictInt] = Field(description="Trading volume")
