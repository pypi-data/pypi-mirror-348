...
class TestLoadContext(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoadContext:
        """Test LoadContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoadContext`
        """
        model = LoadContext()
        if include_optional:
            return LoadContext(
