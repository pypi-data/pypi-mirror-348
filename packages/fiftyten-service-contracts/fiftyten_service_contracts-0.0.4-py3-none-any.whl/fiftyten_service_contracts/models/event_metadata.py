...
class EventMetadata(BaseModel):
    ...
    data_quality: Optional[Dict[str, Any]] = Field(default=None, alias="dataQuality")
    completion_rate: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, alias="completionRate")
    ...
    __properties: ClassVar[List[str]] = ["loadType", "dataQuality", "completionRate", "itemCount", "timestamp"]
