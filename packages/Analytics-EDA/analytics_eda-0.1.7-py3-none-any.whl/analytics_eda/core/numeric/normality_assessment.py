...
def normality_assessment(
    ...
    Assumptions & behavior:
      ...
      - Always runs Jarque–Bera (moment-based) regardless of n.
    ...
    for key in ('shapiro', 'dagostino_pearson', 'anderson', 'jarque_bera'):
        if key in result and result[key]['reject']:
            rejects.append(True)
    result['reject_normality'] = any(rejects)
