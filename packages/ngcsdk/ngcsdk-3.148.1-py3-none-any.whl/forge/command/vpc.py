...
class VpcCommand(ForgeCommand):  # noqa: D101
    ...
    def create(self, args):
        """Create VPC."""
        resp = self.api.create(args.name, args.site, args.org, args.team, args.description, args.security_group)
    ...
    def update(self, args):
        """Update VPC."""
        resp = self.api.update(args.vpc, args.org, args.team, args.name, args.description, args.security_group)
        self.printer.print_info(resp)
