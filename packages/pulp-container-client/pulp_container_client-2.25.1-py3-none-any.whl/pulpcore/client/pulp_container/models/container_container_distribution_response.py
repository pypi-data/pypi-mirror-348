...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "pulp_href", "pulp_last_updated", "prn", "pulp_labels", "pulp_created", "no_content_change_since", "base_path", "repository", "name", "hidden", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
