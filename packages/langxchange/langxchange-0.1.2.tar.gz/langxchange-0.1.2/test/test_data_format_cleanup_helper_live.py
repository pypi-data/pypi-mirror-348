...
os.environ["OPENAI_API_KEY"] = "sk-svcacct-bMTSkNFJzk-"
...
llm = OpenAIHelper()
cleanup_helper = DataFormatCleanupHelper(llm_helper=llm)

# 4. Clean the data
df_clean = cleanup_helper.clean(df_raw,examples,"json")
