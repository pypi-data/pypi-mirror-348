            ...
            try:
                ...
                for col_name in df_copy.columns:
                    if pd.api.types.is_bool_dtype(df_copy[col_name].dtype):
                        ...
                        # Convert datetimes to ISO format strings if not already
                        # Ensure this is done before to_dict if type is still datetime
                        # NaT will become None after .to_dict("records") if handled by replace below.
                        pass  # Handled by replace NaT to None later
